...
# $Id: gb_adobe_shockwave_player_use_after_free_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will let the user-assisted remote attackers to execute
  arbitrary code via a crafted web site related to the Shockwave Settings
  window and an unloaded library.
  Impact Level: Application.";
tag_affected = "Adobe Shockwave Player Version 11.5.9.615 on Windows.";
tag_insight = "The flaw is due to a use-after-free error in an automatically installed
  compatibility component.";
tag_solution = "No solution or patch is available as of 09th November, 2010. Information
