...
# $Id: gb_adobe_reader_mult_vuln_sep11_lin.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Adobe Reader version 9.x through 9.4.5";
tag_insight = "Multiple flaws are due to memory corruptions, and buffer overflow
  errors.";
tag_solution = "Upgrade to Adobe Reader version 9.4.6 or later
