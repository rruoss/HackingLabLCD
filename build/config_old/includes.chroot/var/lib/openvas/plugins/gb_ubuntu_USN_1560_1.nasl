...
tag_insight = "It was discovered that Django incorrectly validated the scheme of a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1560-1";
tag_affected = "python-django on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS";
