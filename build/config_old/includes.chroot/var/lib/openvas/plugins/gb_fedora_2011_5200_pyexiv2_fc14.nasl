...
tag_affected = "pyexiv2 on Fedora 14";
tag_insight = "pyexiv2 is a python binding to exiv2, the C++ library for manipulation
...
if(description)
{
  ...
  script_summary("Check for the Version of pyexiv2");
