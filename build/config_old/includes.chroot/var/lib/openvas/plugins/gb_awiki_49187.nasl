...
# $Id: gb_awiki_49187.nasl 13 2013-10-27 12:16:33Z jan $
#
...
desc = "
 ...
 script_summary("Determine if awiki is prone to local file-include vulnerabilities");
...
dirs = make_list("/awiki","/wiki",cgi_dirs());
files = traversal_files();

foreach dir (dirs) {
  foreach file (keys(files)) {
   
    url = string(dir, "/index.php?page=/",files[file]); 
