...
tag_insight = "Simon Ruderich discovered that APT incorrectly handled repositories that
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1385-1";
tag_affected = "apt on Ubuntu 11.04";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001614.html");
  script_id(840924);
