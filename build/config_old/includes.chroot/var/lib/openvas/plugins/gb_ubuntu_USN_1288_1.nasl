...
tag_insight = "It was discovered that the 2.6.35 and earlier Linux kernel does not
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1288-1";
tag_affected = "vsftpd on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-December/001507.html");
  script_id(840831);
