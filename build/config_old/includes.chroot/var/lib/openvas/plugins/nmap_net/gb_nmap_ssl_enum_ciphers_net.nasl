...
# $Id: gb_nmap_ssl_enum_ciphers_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script repeatedly initiates SSL/TLS connections, each time trying a new cipher or compressor
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ssl-enum-ciphers");
