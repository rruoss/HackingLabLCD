...
# $Id: gb_nmap_svn_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs brute force password auditing against Subversion source code control servers.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: svn-brute");
