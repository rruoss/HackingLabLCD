...
# $Id: gb_nmap_oracle_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs brute force password auditing against Oracle servers.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: oracle-brute");
