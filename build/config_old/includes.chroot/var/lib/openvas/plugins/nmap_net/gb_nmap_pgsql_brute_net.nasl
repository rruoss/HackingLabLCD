...
# $Id: gb_nmap_pgsql_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs password guessing against PostgreSQL.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: pgsql-brute");
