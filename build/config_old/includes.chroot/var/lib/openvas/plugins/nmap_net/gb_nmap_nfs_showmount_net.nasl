...
# $Id: gb_nmap_nfs_showmount_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Shows NFS exports, like the 'showmount -e' command.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: nfs-showmount");
