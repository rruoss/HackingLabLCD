...
# $Id: gb_nmap_couchdb_databases_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Gets database tables from a CouchDB database.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: couchdb-databases");
