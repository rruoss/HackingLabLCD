...
# $Id: gb_nmap_ms_sql_empty_password_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to authenticate using an empty password for the sysadmin (sa) account.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ms-sql-empty-password");
