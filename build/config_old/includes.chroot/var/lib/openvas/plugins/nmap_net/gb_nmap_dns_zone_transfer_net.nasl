...
# $Id: gb_nmap_dns_zone_transfer_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Requests a zone transfer (AXFR) from a DNS server.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: dns-zone-transfer");
