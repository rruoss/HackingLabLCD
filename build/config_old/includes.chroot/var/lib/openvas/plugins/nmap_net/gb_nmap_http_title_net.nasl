...
# $Id: gb_nmap_http_title_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Shows the title of the default page of a web server.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-title");
