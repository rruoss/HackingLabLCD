...
# $Id: gb_nmap_http_favicon_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Gets the favicon ('favorites icon') from a web page and matches it against a database of the icons
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-favicon");
