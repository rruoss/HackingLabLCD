...
# $Id: gb_nmap_drda_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs password guessing against databases supporting the IBM DB2 protocol such as Informix, DB2
and Derby
...
if(description)
{
    ...
    script_summary("Nmap NSE net: drda-brute");
