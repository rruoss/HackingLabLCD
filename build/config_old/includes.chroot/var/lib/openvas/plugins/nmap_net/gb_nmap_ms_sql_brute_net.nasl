...
# $Id: gb_nmap_ms_sql_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs password guessing against Microsoft SQL Server (ms-sql).
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ms-sql-brute");
