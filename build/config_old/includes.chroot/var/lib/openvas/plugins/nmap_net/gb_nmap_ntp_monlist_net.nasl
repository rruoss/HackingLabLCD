...
# $Id: gb_nmap_ntp_monlist_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
by sending an innoccuous looking Client Mode request. This can be acheived easily using Nmap:
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ntp-monlist");
