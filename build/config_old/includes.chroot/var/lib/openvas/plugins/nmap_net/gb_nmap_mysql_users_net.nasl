...
# $Id: gb_nmap_mysql_users_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to list all users on a MySQL server.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: mysql-users");
