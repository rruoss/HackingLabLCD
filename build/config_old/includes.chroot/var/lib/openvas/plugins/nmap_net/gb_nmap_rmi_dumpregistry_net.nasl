...
# $Id: gb_nmap_rmi_dumpregistry_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Connects to a remote RMI registry and attempts to dump all of its objects.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: rmi-dumpregistry");
