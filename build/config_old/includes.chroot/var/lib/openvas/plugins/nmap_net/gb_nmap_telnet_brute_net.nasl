...
# $Id: gb_nmap_telnet_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Tries to get Telnet login credentials by guessing usernames and passwords.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: telnet-brute");
