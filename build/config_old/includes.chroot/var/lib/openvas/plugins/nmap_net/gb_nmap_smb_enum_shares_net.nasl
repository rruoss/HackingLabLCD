...
# $Id: gb_nmap_smb_enum_shares_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to list shares using the 'srvsvc.NetShareEnumAll' MSRPC function and retrieve
...
if(description)
{
    ...
    script_summary("Nmap NSE net: smb-enum-shares");
