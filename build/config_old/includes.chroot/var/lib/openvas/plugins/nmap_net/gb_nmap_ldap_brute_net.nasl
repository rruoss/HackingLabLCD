...
# $Id: gb_nmap_ldap_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to brute-force LDAP authentication. By default it uses the built-in username and password
...
different error messages depending on whether an account exists or not. If the script recieves an
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ldap-brute");
