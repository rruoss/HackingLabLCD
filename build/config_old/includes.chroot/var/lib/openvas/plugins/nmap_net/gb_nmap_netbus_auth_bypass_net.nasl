...
# $Id: gb_nmap_netbus_auth_bypass_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Checks if a NetBus server is vulnerable to an authentication bypass vulnerability which allows ful
...
login to the service by typing Password;1; into the console.";
...
if(description)
{
    ...
    script_summary("Nmap NSE net: netbus-auth-bypass");
