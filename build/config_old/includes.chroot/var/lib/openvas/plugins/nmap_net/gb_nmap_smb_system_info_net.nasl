...
# $Id: gb_nmap_smb_system_info_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Pulls back information about the remote system from the registry. Getting all of the information
...
if(description)
{
    ...
    script_summary("Nmap NSE net: smb-system-info");
