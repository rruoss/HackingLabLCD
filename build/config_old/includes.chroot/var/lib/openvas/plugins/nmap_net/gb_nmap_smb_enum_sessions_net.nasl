...
# $Id: gb_nmap_smb_enum_sessions_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Enumerates the users logged into a system either locally or through
...
if(description)
{
    ...
    script_summary("Nmap NSE net: smb-enum-sessions");
