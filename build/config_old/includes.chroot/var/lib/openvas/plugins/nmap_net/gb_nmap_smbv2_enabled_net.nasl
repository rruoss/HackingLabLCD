...
# $Id: gb_nmap_smbv2_enabled_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Checks whether or not a server is running the SMBv2 protocol.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: smbv2-enabled");
