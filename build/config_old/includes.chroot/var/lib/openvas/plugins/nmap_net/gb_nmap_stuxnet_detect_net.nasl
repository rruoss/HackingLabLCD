...
# $Id: gb_nmap_stuxnet_detect_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Detects whether a host is infected with the Stuxnet worm (http://en.wikipedia.org/wiki/Stuxnet).
...
if(description)
{
    ...
    script_summary("Nmap NSE net: stuxnet-detect");
