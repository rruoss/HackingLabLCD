...
# $Id: gb_nmap_domcon_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs brute force password auditing against the Lotus Domino Console.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: domcon-brute");
