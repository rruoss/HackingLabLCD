...
# $Id: gb_viart_cms_xss_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "ViArt CMS Version 3.6";
tag_insight = "The flaw is caused by improper validation of user-supplied input via the 's'
  parameter to 'admin/admin_articles.php' that allows the attackers to execute
  arbitrary HTML and script code in a logged-in user's browser session in
  context of an affected site.";
tag_solution = "No solution or patch is available as of 22nd July, 2010. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.viart.com/cms.html";
tag_summary = "This host is running ViArt CMS and is prone to cross site scripting
  vulnerability.";
...
if(description)
{
  ...
  script_summary("Check for the version of ViArt CMS");
...
foreach dir (make_list("/viart_shop", "/viart_cms", "/", cgi_dirs()))
{
  ## Send and Recieve the response
  req = http_get(item:string(dir,"/viart_shop.xml"), port:port);
