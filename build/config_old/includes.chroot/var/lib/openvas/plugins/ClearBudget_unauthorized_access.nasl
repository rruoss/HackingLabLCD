...
# $Id: ClearBudget_unauthorized_access.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if ClearBudget is prone to an unauthorized-access vulnerability");
