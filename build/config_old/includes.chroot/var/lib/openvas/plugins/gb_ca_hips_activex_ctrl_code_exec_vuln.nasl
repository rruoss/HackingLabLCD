...
# $Id: gb_ca_hips_activex_ctrl_code_exec_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_solution = "CA Host-Based Intrusion Prevention System (HIPS) r8.1:
  ...
  *****
  ...
  No solution or patch is available as of 7th March, 2011. Information
...
tag_impact = "Successful exploitation could allow attackers to execute arbitrary code in
  the context of the logged-in user. Failed exploits result in denial-of-service
  conditions.
...
tag_insight = "The flaw is caused by a design error in the XMLSecDB ActiveX control installed
  with the HIPSEngine component, which could allow attackers to create arbitrary
  files on a vulnerable system by tricking a user into visiting a web page which
  calls the 'SetXml()' and 'Save()' methods.";
