...
tag_insight = "USN-1463-1 fixed vulnerabilities in Firefox. The new package caused a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1463-3";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001731.html");
  script_id(841051);
