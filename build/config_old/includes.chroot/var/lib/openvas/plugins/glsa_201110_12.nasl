...
tag_insight = "Multiple Denial of Service vulnerabilities were found in Unbound.";
tag_solution = "All Unbound users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-dns/unbound-1.4.10'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201110-12
http://bugs.gentoo.org/show_bug.cgi?id=309117
http://bugs.gentoo.org/show_bug.cgi?id=368981";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201110-12 (unbound)");
