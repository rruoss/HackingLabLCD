...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001610.html");
  script_id(840919);
  ...
  script_summary("Check for the Version of openjdk-6b18");
