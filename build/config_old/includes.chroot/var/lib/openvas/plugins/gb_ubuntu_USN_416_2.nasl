...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-March/000492.html");
  script_id(840144);
  ...
  script_summary("Check for the Version of linux-restricted-modules-2.6.17 regression");
