...
# $Id: secpod_wordpress_photoracer_plugin_id_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to improper validation of user-supplied input passed
  via the 'id' parameter to '/wp-content/plugins/photoracer/viewimg.php', which
  allows attackers to manipulate SQL queries by injecting arbitrary SQL code.";
tag_solution = "No solution or patch is available as of 27th August, 2011. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://wordpress.org/extend/plugins/photoracer";
...
if(description)
{
  ...
  script_summary("Check if WordPress Photoracer Plugin is vulnerable to SQL Injection");
