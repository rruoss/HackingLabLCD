...
# $Id: home_ftp_server_37041.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if Home FTP Server is prone to a directory-traversal vulnerability");
...
if(login_details)
{
  ...
  if(result && "directory created" >< result) {
    desc += string("\n\nIt was possible for OpenVAs to create the directory ", dir, " outside the FTP root directory.\n");
