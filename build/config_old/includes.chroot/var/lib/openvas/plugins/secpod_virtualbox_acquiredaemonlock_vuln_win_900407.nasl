...
# $Id: secpod_virtualbox_acquiredaemonlock_vuln_win_900407.nasl 16 2013-10-27 13:09:52Z jan $
# Description: Sun xVM VirtualBox Insecure Temporary Files Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Sun xVM VirtualBox Insecure Temporary Files Vulnerability (Win)");
  script_summary("Check for vulnerable version of Sun xVM VirtualBox");
  desc = "
  Summary:
  " + tag_summary + "
