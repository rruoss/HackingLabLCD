...
# $Id: gb_seamonkey_mult_vuln_july08_lin.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_impact = "Successful exploitation could result in remote arbitrary code execution,
  ...
  Impact Level: System";
tag_summary = "The host is installed with Mozilla Seamonkey, that is prone
  to multiple vulnerabilities.";

tag_affected = "Seamonkey version prior to 1.1.10 on Linux.";
...
if(description)
{
  ...
  script_mandatory_keys("login/SSH/success","Seamonkey/Linux/Ver");
