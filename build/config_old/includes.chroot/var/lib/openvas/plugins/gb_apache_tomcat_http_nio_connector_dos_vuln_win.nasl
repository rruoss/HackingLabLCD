...
# $Id: gb_apache_tomcat_http_nio_connector_dos_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
# check the version for 6.0 < 6.0.36 and 7.0 < 7.0.27
if(!isnull(tomvers) && tomvers >!< "unknown" &&
   (version_in_range(version:tomvers, test_version:"6.0", test_version2:"6.0.35")||
    version_in_range(version:tomvers, test_version:"7.0", test_version2:"7.0.27")))
{
