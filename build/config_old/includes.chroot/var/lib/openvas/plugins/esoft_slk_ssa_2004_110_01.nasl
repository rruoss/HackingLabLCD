...
# $Id: esoft_slk_ssa_2004_110_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New utempter packages are available for Slackware 9.1 and -current to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-110-01";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2004-110-01 utempter security update ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2004-110-01 utempter security update");
...
vuln = 0;
if(isslkpkgvuln(pkg:"utempter", ver:"1.1.1-i486-1", rls:"SLK9.1")) {
    vuln = 1;
}
