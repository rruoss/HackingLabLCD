...
if(description)
{
 ...
 script_summary("Checks for existence of Java for Mac OS X 10.6 Update 1");
...
if (osx_rls_name(rls:ssh_osx_rls) == osx_rls_name(rls:"Mac OS X 10.6.2")) {
	if (isosxpkgvuln(fixed:"com.apple.pkg.JavaForMacOSX10.6Update", diff:"1")) { security_hole(0); exit(0);}
}
