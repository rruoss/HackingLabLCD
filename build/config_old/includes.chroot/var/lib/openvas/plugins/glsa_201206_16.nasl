...
tag_insight = "Multiple vulnerabilities have been found in TagLib, possibly
resulting in Denial of Service.";
tag_solution = "All TagLib users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-16
http://bugs.gentoo.org/show_bug.cgi?id=407673
http://bugs.gentoo.org/show_bug.cgi?id=410953";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-16 (TagLib)");
