...
# $Id: secpod_caucho_resin_mult_xss_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(description)
{
  ...
  script_summary("Determine if Caucho Resin is prone to cross-site scripting vulnerability");
