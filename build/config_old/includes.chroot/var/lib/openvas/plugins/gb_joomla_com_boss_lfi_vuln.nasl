...
# $Id: gb_joomla_com_boss_lfi_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Joomla Boss Component";
...
tag_summary = "This host is running Joomla Boss component and is prone to local
...
foreach file (keys(files))
{
  ...
  url = string(joomlaDir, "/index.php?option=com_boss&controller=",
