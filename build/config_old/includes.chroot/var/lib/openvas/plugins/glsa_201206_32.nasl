...
tag_insight = "An error in the verification of SSL certificates in Links might
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-32
http://bugs.gentoo.org/show_bug.cgi?id=253847
http://bugs.gentoo.org/show_bug.cgi?id=411493
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-32 (Links)");
