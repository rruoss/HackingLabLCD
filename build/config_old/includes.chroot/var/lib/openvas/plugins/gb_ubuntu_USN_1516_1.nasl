...
tag_insight = "It was discovered that OpenSSL incorrectly handled the SSL_OP_ALL setting.
  This resulted in TLS 1.1 and TLS 1.2 being inadvertently disabled for
  certain server and client applications.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1516-1";
tag_affected = "openssl on Ubuntu 12.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-July/001769.html");
  script_id(841091);
