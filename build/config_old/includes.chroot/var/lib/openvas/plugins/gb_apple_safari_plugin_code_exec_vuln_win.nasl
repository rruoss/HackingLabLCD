...
# $Id: gb_apple_safari_plugin_code_exec_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
# Apple Safari Plugin Unloading Remote Code Execution Vulnerability (Win)
#
# Authors:
...
tag_insight = "The flaw is due to unloading of plug-ins when navigating to a new
  page, which allows remote attackers to execute arbitrary code via a crafted
  web page while the user interacts with the plug-in.";
tag_solution = "No solution or patch is available as of 19th March, 2012. Information
...
if(description)
{
  ...
  script_name("Apple Safari Plugin Unloading Remote Code Execution Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
