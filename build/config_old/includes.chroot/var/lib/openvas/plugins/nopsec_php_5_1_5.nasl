...
tag_summary = "PHP 5.1.x < 5.1.5 suffers multiple vulnerabilities such as buffer overfLow, user authetication bypass and Multiple heap-based buffer overfLows.
...
if(get_port_state(my_port))
{
  ...
  if (version_in_range(version:php_version,test_version:"5.1", test_version2:"5.1.5"))
