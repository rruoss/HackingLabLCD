...
tag_insight = "It was discovered that the decode_xs function in the Encode module is
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1643-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001908.html");
  script_id(841232);
