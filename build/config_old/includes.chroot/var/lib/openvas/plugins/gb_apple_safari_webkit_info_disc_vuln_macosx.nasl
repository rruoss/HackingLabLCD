...
# $Id: gb_apple_safari_webkit_info_disc_vuln_macosx.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to WebKit does not prevent capture of data about the
  time required for image loading, which makes it easier for remote attackers
