...
# $Id: secpod_ocs_inventory_ng_mult_sql_inj_vuln_may10.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/61942");
