...
tag_insight = "It was discovered that cvs incorrectly handled certain responses from
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1371-1";
tag_affected = "cvs on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
 ...
 script_version("$Revision: 12 $");
  ...
  script_summary("Check for the Version of cvs");
