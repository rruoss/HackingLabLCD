...
tag_insight = "Two format string vulnerabilities have been found in the Perl
    DBD-Pg module, allowing a remote PostgreSQL servers to execute
arbitrary
    code.";
tag_solution = "All users of the Perl DBD-Pg module should upgrade to the latest
      version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201204-08
http://bugs.gentoo.org/show_bug.cgi?id=407549";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201204-08 (DBD-Pg)");
