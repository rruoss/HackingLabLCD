...
# $Id: secpod_home_ftp_server_dir_trav_n_dos_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "The host is running Home Ftp Server and is prone to Denail of Service and
...
if(description)
{
  ...
  script_summary("Check for the version of Home Ftp Server");
