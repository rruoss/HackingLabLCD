...
# $Id: gb_nullftp_server_detect.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "This script finds the installed NULL FTP Server version
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_summary("Set Version of NULL FTP Server in KB");
