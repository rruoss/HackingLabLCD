...
tag_insight = "A vulnerability has been found and corrected in ncompress:
...
tag_affected = "ncompress on Mandriva Linux 2010.1,
...
if(description)
{
  ...
  script_summary("Check for the Version of ncompress");
