...
# $Id: gb_adobe_reader_mult_vuln_july10_lin.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "Adobe Reader version 8.x before 8.2.3 and 9.x before 9.3.3 on Linux.";
...
tag_solution = "Upgrade to Adobe Reader version 9.3.3 or 8.2.3
