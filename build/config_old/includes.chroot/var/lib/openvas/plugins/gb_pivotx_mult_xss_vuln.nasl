...
# $Id: gb_pivotx_mult_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/70674");
...
if(pxDir)
{
  ...
  if('><script>alert("OpenVAS-XSS-Testing");</script>' >< pxRes)
  {
    security_warning(pxPort);
    exit(0);
  }
}
