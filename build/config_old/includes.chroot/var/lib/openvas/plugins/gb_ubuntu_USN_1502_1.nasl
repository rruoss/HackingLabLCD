...
tag_insight = "Ken Mixter discovered a format string vulnerability in the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1502-1";
tag_affected = "xorg-server on Ubuntu 12.04 LTS";
