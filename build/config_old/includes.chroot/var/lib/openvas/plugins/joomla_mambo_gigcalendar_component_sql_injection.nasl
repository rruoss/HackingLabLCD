...
# $Id: joomla_mambo_gigcalendar_component_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if gigCalendar Component for Joomla! and Mambo is vulnerable to SQL Injection");
