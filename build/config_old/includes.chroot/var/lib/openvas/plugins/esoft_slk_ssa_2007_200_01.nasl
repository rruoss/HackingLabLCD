...
# $Id: esoft_slk_ssa_2007_200_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-200-01";
...
if(description)
{
 ...
 name = "Slackware Advisory SSA:2007-200-01 firefox ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2007-200-01 firefox");
...
vuln = 0;
if(isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.5-i686-1", rls:"SLK11.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.5-i686-1", rls:"SLK12.0")) {
    vuln = 1;
}
