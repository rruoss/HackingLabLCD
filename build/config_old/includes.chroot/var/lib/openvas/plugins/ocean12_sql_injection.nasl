...
# $Id: ocean12_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "Ocean12 Membership Manager Pro is prone to an SQL-injection
...
if (description)
{
 ...
 script_summary("Determine if Ocean12 Membership Manager Pro is vulnerable to SQL Injection");
