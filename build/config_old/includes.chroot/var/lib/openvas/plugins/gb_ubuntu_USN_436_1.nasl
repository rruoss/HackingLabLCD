...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-March/000502.html");
  script_id(840186);
  ...
  script_summary("Check for the Version of ktorrent vulnerabilities");
