...
# $Id: kerberos_CB-A08-0044.nasl 16 2013-10-27 13:09:52Z jan $
...
if(description)
{
 ...
 " + tag_summary + "
 Solution:
 " + tag_solution;script_xref(name : "URL" , value : "http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-0062");
