...
# $Id: secpod_homeseer_hs2_web_interface_mult_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation will allow attacker to execute arbitrary HTML and
  ...
  and gain sensitive information via directory traversal attacks.
...
tag_solution = "No solution or patch is available as of 23rd December, 2011. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.homeseer.com/downloads/";
tag_summary = "This host is running HomeSeer HS2 and is prone to multiple vulnerabilities.";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/show/osvdb/77587");
  script_xref(name : "URL" , value : "http://osvdb.org/show/osvdb/77588");
  script_xref(name : "URL" , value : "http://osvdb.org/show/osvdb/77589");
