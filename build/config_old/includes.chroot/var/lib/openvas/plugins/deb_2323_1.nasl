...
# $Id: deb_2323_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "Multiple security issues were discovered by Vasiliy Kulikov in radvd, an
...
tag_summary = "The remote host is missing an update to radvd
announced via advisory DSA 2323-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202323-1";
...
if((res = isdpkgvuln(pkg:"radvd", ver:"1:1.8-1.2", rls:"DEB7.0")) != NULL) {
    report += res;
}
