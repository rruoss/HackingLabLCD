...
# $Id: gb_trendmicro_internet_security_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the installed Trend Micro Internet Security
...
if(description)
{
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Set the version of Trend Micro Internet Security in KB");
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if("Trend Micro Internet Security" >< name)
  {
