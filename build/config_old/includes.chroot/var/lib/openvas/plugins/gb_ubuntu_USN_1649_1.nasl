...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1649-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001915.html");
  script_id(841228);
