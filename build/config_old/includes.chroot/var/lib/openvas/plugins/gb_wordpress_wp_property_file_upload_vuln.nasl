...
# $Id: gb_wordpress_wp_property_file_upload_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_solution = "No solution or patch is available as of 11th June, 2012. Information
  ...
  For updates refer to http://wordpress.org/extend/plugins/wp-property/";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/82656");
