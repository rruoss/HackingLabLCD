...
tag_insight = "A flaw was discovered in the byterange filter in Apache. A remote attacker
  could exploit this to cause a denial of service via resource exhaustion.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1199-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-September/001405.html");
  script_id(840734);
