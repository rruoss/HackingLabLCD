...
# $Id: RHSA_2009_1461.nasl 15 2013-10-27 12:49:54Z jan $
...
if(description)
{
 ...
 script_summary("Redhat Security Advisory RHSA-2009:1461");
...
if(!isnull(matches)) {
    ...
    if(!isnull(match2) && revcomp(a:match2[1], b:"2.2.11")>=0) {
	rhas = 1;
    }
}
if(rhas==0) {
