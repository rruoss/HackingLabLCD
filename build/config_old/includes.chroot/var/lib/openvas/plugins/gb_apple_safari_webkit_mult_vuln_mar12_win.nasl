...
# $Id: gb_apple_safari_webkit_mult_vuln_mar12_win.nasl 12 2013-10-27 11:15:33Z jan $
#
# Apple Safari Webkit Multiple Vulnerabilities - March12 (Win)
#
# Authors:
...
tag_affected = "Apple Safari versions prior to 5.1.4 on Windows";
tag_insight = "For more information on the vulnerabilities refer the reference section.";
tag_solution = "Upgrade to Apple Safari version 5.1.4 or later,
...
if(description)
{
  ...
  script_name("Apple Safari Webkit Multiple Vulnerabilities - March12 (Win)");
  desc = "
  Summary:
  " + tag_summary + "
...
## Grep for Apple Safari Versions prior to 5.1.4 -> 5.34.54.16
