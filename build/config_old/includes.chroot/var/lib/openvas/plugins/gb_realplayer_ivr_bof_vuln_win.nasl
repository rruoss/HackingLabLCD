...
# $Id: gb_realplayer_ivr_bof_vuln_win.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation allows remote attackers to execute arbitrary code in
  the context of the vulnerable application. Failed exploit attempts will result
  in a denial-of-service condition.";
tag_affected = "RealPlayer versions 14.0.2.633 and prior";
tag_insight = "The flaws are due to improper bounds checking by the 'rvrender.dll'
  when processing Internet Video Recording (IVR) files.";
