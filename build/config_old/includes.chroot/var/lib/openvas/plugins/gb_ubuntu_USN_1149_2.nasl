...
tag_insight = "USN-1149-1 fixed vulnerabilities in Firefox. Unfortunately, a regression
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1149-2";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-June/001364.html");
  script_id(840692);
