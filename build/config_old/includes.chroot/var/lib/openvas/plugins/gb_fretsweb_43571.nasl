...
# $Id: gb_fretsweb_43571.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "Fretsweb is prone to multiple local file-include vulnerabilities
...
desc = "
 ...
 script_summary("Determine if Fretsweb is prone to multiple local file-include vulnerabilities");
...
dirs = make_list("/fretsweb",cgi_dirs());
