...
# $Id: msrpc-spike27.nasl 17 2013-10-27 14:01:43Z jan $
# Description: MS RPC Services null pointer reference DoS
#
# Authors:
...
tag_summary = "MS Windows RPC service (RPCSS) crashes trying to dereference a
...
tag_solution = "Block access to TCP port 135.";
...
if (description) {
  ...
  name = "MS RPC Services null pointer reference DoS";
  script_name(name);
  ...
  summary = "Attempts to crash MS RPC service the Spike 2.7-way";
