...
# $Id: phpScheduleIt_detect.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of phpScheduleIt");
...
dirs = make_list("/conference","/schedule",cgi_dirs());
