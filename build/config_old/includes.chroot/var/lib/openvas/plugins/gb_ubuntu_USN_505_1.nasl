...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-August/000581.html");
  script_id(840173);
  ...
  script_summary("Check for the Version of vim vulnerability");
