...
# $Id: secpod_ibm_db2_clnt_intrfc_unspecified_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if(description)
{
  ...
  script_name("IBM DB2 Client Interfaces component Unspecified Vulnerabilities (Win)");
  desc = "
  Summary:
  " + tag_summary + "
...
# Check for IBM DB2 Version 9.1 before 9.1 FP8  (IBM DB2 9.1 FP 8 = 9.1.800.1023)
