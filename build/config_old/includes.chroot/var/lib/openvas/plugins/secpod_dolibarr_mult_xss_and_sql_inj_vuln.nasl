...
# $Id: secpod_dolibarr_mult_xss_and_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/77339");
...
if(http_vuln_check(port:port, url:url, pattern:"onerror=javascript" +
