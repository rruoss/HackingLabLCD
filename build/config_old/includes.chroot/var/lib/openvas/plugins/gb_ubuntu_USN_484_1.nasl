...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-July/000557.html");
  script_id(840112);
  ...
  script_summary("Check for the Version of curl vulnerability");
