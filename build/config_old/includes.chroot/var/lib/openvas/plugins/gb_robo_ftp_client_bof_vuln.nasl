...
# $Id: gb_robo_ftp_client_bof_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will let the user execute arbitrary code in the context
...
tag_insight = "The flaw is due to a boundary error when processing certain responses from
