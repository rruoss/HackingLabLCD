...
# $Id: gb_wireshark_asn1ber_dissector_dos_vuln_win.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Wireshark versions 1.4.0 through 1.4.2.";
...
if(description)
{
  ...
  script_name("Wireshark ASN.1 BER Dissector Denial of Service Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
