...
# $Id: gb_mozilla_prdts_code_exec_vuln_jun12_win.nasl 12 2013-10-27 11:15:33Z jan $
#
# Mozilla Products 'nsHTMLSelectElement' Remote Code Execution Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Mozilla Products 'nsHTMLSelectElement' Remote Code Execution Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
