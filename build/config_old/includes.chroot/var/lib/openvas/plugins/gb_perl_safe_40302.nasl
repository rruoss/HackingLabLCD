...
# $Id: gb_perl_safe_40302.nasl 14 2013-10-27 12:33:37Z jan $
#
...
desc = "
 ...
 script_summary("Determine if Safe version is < 2.25");
...
if(version_is_less(version: version, test_version: "2.25")) {
  security_hole(0);
}  
