...
# $Id: secpod_ms12-005.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_impact = "Successful exploitation could allow local attackers to run arbitrary code
...
tag_insight = "The flaw is due to an error within the Windows Packager when
