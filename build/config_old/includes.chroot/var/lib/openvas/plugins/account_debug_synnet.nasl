...
# $Id: account_debug_synnet.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password ('synnet') for 'debug' account
#
# Authors:
# Michel Arboi
#
...
tag_summary = "The account 'debug' has the password 'synnet'
...
if(description)
{
 ...
 script_name("Default password ('synnet') for 'debug' account");
