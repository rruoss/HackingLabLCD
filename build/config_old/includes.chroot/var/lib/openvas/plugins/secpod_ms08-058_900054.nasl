...
# $Id: secpod_ms08-058_900054.nasl 16 2013-10-27 13:09:52Z jan $
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Internet Explorer");
  desc = "
  Summary:
  " + tag_summary + "
...
if(sysPath)
{
  ...
  if(dllVer)
  {
    ...
    if(hotfix_check_sp(winVista:2) > 0)
    {
      ...
      if("Service Pack 1" >< SP)
      {
        # Grep for mshtml.dll version 7.0 < 7.0.6001.18148
