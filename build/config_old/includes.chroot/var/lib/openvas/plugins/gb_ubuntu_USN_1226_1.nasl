...
tag_insight = "Dan Rosenberg discovered that Samba incorrectly handled changes to the mtab
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1226-1";
tag_affected = "samba on Ubuntu 10.04 LTS ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-October/001438.html");
  script_id(840769);
