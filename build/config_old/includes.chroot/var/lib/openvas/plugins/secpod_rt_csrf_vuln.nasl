...
# $Id: secpod_rt_csrf_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "RT (Request Tracker) versions 3.8.0 through 3.8.9 and 4.0.0rc through 4.0.0rc7.";
tag_insight = "The flaw is caused by an error in the external custom field feature, which
  allows remote authenticated users to execute arbitrary code via unspecified
  vectors.";
tag_solution = "Upgrade to RT (Request Tracker) version 3.8.10 or 4.0.0rc8.
