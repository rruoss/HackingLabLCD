...
tag_insight = "Evan Broder discovered that usb-creator did not properly enforce
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1127-1";
tag_affected = "usb-creator on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-May/001321.html");
  script_id(840639);
  ...
  script_summary("Check for the Version of usb-creator");
