...
# $Id: dns_response_flood.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Multiple Vendor DNS Response Flooding Denial Of Service
#
# Authors:
...
if(description)
{
 ...
 script_summary("send malformed DNS query on port 53");
