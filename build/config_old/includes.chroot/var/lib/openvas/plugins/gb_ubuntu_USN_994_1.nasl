...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-September/001172.html");
  script_id(840508);
  ...
  script_summary("Check for the Version of libhx vulnerability");
