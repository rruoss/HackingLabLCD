...
tag_insight = "A vulnerability has been found and corrected in html2ps:
...
tag_affected = "html2ps on Mandriva Linux 2011.0";
...
if(description)
{
  ...
  script_summary("Check for the Version of html2ps");
