...
tag_affected = "pam_yubico on Fedora 16";
tag_insight = "This is pam_yubico, a pluggable authentication module that can be used with
...
if(description)
{
  ...
  script_summary("Check for the Version of pam_yubico");
