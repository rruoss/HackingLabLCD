...
# $Id: gb_lotus_domino_46231.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "IBM Lotus Domino is prone to a remote buffer-overflow vulnerability
because it fails to perform adequate boundary checks on user-
supplied input.

Successfully exploiting this issue can allow remote attackers to
execute arbitrary code with SYSTEM-level privileges, resulting in the
complete compromise of affected computers. Failed attacks will cause
