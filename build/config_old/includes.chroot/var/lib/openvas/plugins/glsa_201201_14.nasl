...
tag_insight = "Multiple vulnerabilities have been found in MIT Kerberos 5
    Applications, the most severe of which may allow execution of
arbitrary
    code.";
tag_solution = "All MIT Kerberos 5 Applications users should upgrade to the latest
      version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201201-14
http://bugs.gentoo.org/show_bug.cgi?id=374229
http://bugs.gentoo.org/show_bug.cgi?id=396137";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201201-14 (mit-krb5-appl)");
