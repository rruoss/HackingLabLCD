...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-October/000609.html");
  script_id(840037);
  ...
  script_summary("Check for the Version of nagios-plugins vulnerability");
