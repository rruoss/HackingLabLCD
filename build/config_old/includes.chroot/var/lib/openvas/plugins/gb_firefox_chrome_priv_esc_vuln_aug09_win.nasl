...
# $Id: gb_firefox_chrome_priv_esc_vuln_aug09_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Firefox version 3.5 before 3.5.2 on Windows.";
...
if(description)
{
  ...
  script_name("Mozilla Firefox Chrome Privilege Escalation Vulnerability Aug-09 (Win)");
  desc = "
