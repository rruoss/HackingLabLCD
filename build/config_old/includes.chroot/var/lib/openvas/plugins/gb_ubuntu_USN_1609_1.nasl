...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1609-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001868.html");
  script_id(841193);
