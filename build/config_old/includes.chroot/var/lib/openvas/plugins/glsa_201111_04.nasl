...
tag_insight = "phpDocumentor bundles Smarty which contains an input sanitation
    flaw, allowing attackers to call arbitrary PHP functions.";
tag_solution = "All phpDocumentor users should upgrade to the latest stable version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201111-04
http://bugs.gentoo.org/show_bug.cgi?id=213318";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201111-04 (PhpDocumentor)");
