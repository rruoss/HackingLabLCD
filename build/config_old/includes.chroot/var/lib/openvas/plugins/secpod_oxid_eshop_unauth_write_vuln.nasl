...
# $Id: secpod_oxid_eshop_unauth_write_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will allow remote attackers to gain unauthorized
  write access to product reviews via specially crafted URLs.
  Impact Level: Application";
tag_affected = "OXID eShop Community Edition version 4.x through 4.1.1";
tag_insight = "User supplied data passed to and unspecified variable is not sanitised
  before processing.";
tag_solution = "Upgrade to version 4.1.2
