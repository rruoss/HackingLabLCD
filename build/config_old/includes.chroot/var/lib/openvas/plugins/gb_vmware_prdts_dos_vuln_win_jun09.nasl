...
# $Id: gb_vmware_prdts_dos_vuln_win_jun09.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if(description)
{
  ...
  script_name("VMware Products Descheduled Time Accounting Driver DoS Vulnerability (Win)");
  desc = "
