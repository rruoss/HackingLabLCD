...
tag_insight = "Hans Spaans discovered that the Context plugin in Rhythmbox created a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1503-1";
tag_affected = "rhythmbox on Ubuntu 12.04 LTS ,
  Ubuntu 11.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-July/001756.html");
  script_id(841081);
  ...
  script_summary("Check for the Version of rhythmbox");
