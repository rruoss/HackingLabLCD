...
# $Id: secpod_php_icalendar_detect.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "This script detects the installed version of PHP iCalendar and
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_summary("Sets the KB for the version of PHP iCalendar");
