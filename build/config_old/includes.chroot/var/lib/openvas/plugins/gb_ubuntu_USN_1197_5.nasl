...
tag_insight = "USN-1197-1 addressed an issue in Firefox and Xulrunner pertaining to the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1197-5";
tag_affected = "ca-certificates on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-September/001409.html");
  script_id(840738);
