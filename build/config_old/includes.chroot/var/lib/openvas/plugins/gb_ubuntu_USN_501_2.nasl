...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-October/000612.html");
  script_id(840110);
  ...
  script_summary("Check for the Version of ghostscript, gs-gpl vulnerability");
