...
# $Id: gb_apache_tomcat_39635.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(!isnull(vers) && vers >!< "unknown") {
  ...
  if(version_in_range(version:vers, test_version:"5.5", test_version2:"5.5.29") ||
     version_in_range(version:vers, test_version:"6.0", test_version2:"6.0.26")) {
