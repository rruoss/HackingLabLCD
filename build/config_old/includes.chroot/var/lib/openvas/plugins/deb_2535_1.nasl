...
# $Id: deb_2535_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "It was discovered that rtfm, the Request Tracker FAQ Manager, contains
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202535-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2535-1 (rtfm)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"rt3.8-rtfm", ver:"2.4.2-4+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
