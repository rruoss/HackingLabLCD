...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-April/001083.html");
  script_id(840423);
  ...
  script_summary("Check for the Version of ffmpeg, ffmpeg-debian vulnerabilities");
