...
tag_insight = "USN-1483-1 fixed a vulnerability in NetworkManager by disabling the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1483-2";
tag_affected = "network-manager-applet on Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001736.html");
  script_id(841058);
  ...
  script_summary("Check for the Version of network-manager-applet");
