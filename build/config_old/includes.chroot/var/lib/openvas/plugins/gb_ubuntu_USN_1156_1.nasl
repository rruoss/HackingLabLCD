...
tag_insight = "It was discovered that tgt incorrectly handled long iSCSI name strings, and
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1156-1";
tag_affected = "tgt on Ubuntu 11.04 ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-June/001357.html");
  script_id(840689);
  ...
  script_summary("Check for the Version of tgt");
