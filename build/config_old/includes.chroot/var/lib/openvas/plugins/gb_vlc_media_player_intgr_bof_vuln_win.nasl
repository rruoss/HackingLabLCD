...
# $Id: gb_vlc_media_player_intgr_bof_vuln_win.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_affected = "VLC media player 0.9.0 through 0.9.7 on Windows (Any).";
...
if(description)
{
  ...
  script_name("VLC Media Player Buffer Overflow Vulnerability (Win)");
  desc = "
