...
tag_insight = "James Kettle discovered Django did not properly filter the Host HTTP header
  when processing certain requests. An attacker could exploit this to
  generate and display arbitrary URLs to users.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1632-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001896.html");
  script_id(841217);
