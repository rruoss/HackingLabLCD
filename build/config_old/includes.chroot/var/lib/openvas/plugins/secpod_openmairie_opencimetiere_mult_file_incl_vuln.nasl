...
# $Id: secpod_openmairie_opencimetiere_mult_file_incl_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_solution = "No solution or patch is available as of 20th May, 2010. Information
  ...
  For updates refer to http://adullact.net/frs/?group_id=284";
...
if(description)
{
  ...
  script_summary("Check for the exploit string on OpenMairie openCimetiere");
