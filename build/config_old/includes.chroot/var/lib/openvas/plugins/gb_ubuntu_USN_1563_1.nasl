...
tag_insight = "A flaw was found in the Linux kernel's Reliable Datagram Sockets (RDS)
  protocol implementation. A local, unprivileged user could use this flaw to
  cause a denial of service.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1563-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-September/001818.html");
  script_id(841140);
