...
# $Id: gb_ibm_rational_busi_developer_info_disc_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_name("IBM RBD Web Services Information Disclosure Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/85867");
  ...
  script_summary("Check for the version of IBM Rational Business Developer on Windows");
