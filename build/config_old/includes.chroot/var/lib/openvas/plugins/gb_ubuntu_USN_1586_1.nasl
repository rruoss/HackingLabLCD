...
tag_insight = "Hiroshi Oota discovered that Emacs incorrectly handled search paths. If a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1586-1";
tag_affected = "emacs23 on Ubuntu 12.04 LTS ,
  Ubuntu 11.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-September/001844.html");
  script_id(841172);
  ...
  script_summary("Check for the Version of emacs23");
