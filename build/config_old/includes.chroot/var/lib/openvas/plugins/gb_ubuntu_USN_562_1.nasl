...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-January/000648.html");
  script_id(840216);
  ...
  script_summary("Check for the Version of opal vulnerability");
