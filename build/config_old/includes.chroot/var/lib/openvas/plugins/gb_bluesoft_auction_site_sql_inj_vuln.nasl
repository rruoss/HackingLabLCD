...
# $Id: gb_bluesoft_auction_site_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "BlueSoft Auction Site Script.";
tag_insight = "The flaw is due to input passed via the 'id' parameter to 'item.php',
...
tag_summary = "This host is running BlueSoft Auction Site and is prone to SQL
...
foreach dir (make_list("/script", "/Auction", cgi_dirs()))
{
