...
# $Id: secpod_netscape_select_obj_dos_vuln_lin.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "Error occurs while calling the 'select()' method with a large integer that
  ...
  after a while.";
tag_solution = "No solution or patch is available as of 28th July, 2009, Information
