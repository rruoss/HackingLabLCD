...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-September/001170.html");
  script_id(840507);
  ...
  script_summary("Check for the Version of libmikmod vulnerabilities");
