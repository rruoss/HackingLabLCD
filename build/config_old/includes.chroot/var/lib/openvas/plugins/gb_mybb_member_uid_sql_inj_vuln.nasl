...
# $Id: gb_mybb_member_uid_sql_inj_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "MyBB version 1.6.8";
tag_insight = "The application fails to sufficiently sanitize user supplied input to the
  'uid' parameter in 'member.php' before using it in an SQL query, which
  allows attackers to execute arbitrary SQL commands in the context of an
  affected site.";
tag_solution = "No solution or patch is available as of 08th June, 2012. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.mybb.com";
tag_summary = "This host is running MyBB and is prone to SQL injection
  vulnerability.";
