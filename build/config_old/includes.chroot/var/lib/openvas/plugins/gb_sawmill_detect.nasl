...
# $Id: gb_sawmill_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
# Sawmill Detection
#
# Authors:
...
tag_summary = "This host is running Sawmill, a hierarchical log analysis tool.";
...
if (description)
{
 ...
 script_summary("Checks for the presence of Sawmill");
...
SCRIPT_DESC = "Sawmill Detection";

port = get_http_port(default:8988);

if(!get_port_state(port))exit(0);
banner = get_http_banner(port:port);
if(!banner || "Server: Sawmill/" >!< banner)exit(0);
...
register_host_detail(name:"App", value:string("cpe:/a:sawmill:sawmill:",vers), nvt:SCRIPT_OID, desc:SCRIPT_DESC);
