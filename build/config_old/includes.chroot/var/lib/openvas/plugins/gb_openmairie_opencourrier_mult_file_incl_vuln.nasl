...
# $Id: gb_openmairie_opencourrier_mult_file_incl_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_solution = "No solution or patch is available as of 19th May, 2010. Information
  ...
  For updates refer to http://adullact.net/frs/?group_id=297";
...
if(description)
{
  ...
  script_summary("Check for the exploit string on OpenMairie openCourrier");
