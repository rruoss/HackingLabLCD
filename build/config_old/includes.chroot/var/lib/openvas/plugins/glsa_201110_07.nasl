...
tag_insight = "A Denial of Service vulnerability was found in vsftpd.";
tag_solution = "All vsftpd users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-ftp/vsftpd-2.3.4'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201110-07
http://bugs.gentoo.org/show_bug.cgi?id=357001";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201110-07 (vsftpd)");
