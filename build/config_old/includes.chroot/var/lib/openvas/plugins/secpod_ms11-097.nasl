...
# $Id: secpod_ms11-097.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Csrsrv.dll' file version");
...
dllVer = fetch_file_version(sysPath, file_name:"system32\Csrsrv.dll");
if(!dllVer){
  exit(0);
}
