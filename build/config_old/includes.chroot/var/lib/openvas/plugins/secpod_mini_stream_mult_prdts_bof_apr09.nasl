...
# $Id: secpod_mini_stream_mult_prdts_bof_apr09.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation allows attackers to execute arbitrary code or crash
  the system.
...
tag_insight = "A boundary error occurs in multiple Mini-stream products due to inadequate
...
tag_solution = "No solution or patch is available as of 29th April, 2009. Information
  ...
  For updates refer tohttp://www.mini-stream.com/";
tag_summary = "This host has Mini-Stream products installed and is prone to Buffer
