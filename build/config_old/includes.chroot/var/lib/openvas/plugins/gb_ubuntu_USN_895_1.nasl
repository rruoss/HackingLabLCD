...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-February/001047.html");
  script_id(840390);
  ...
  script_summary("Check for the Version of Firefox 3.0 and Xulrunner 1.9 vulnerabilities");
