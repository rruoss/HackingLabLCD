...
# $Id: smtp_AV_42zip_DoS.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "This script sends the 42.zip recursive archive to the
mail server. If there is an antivirus filter, it may start eating huge
amounts of CPU or memory.";

tag_solution = "Reconfigure your antivirus / upgrade it";
...
if(description)
{
 ...
 name = "SMTP antivirus scanner DoS";
 script_name(name);
