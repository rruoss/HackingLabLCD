...
# $Id: joomla_mambo_joomRadio_component_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if Joomla! and Mambo JoomRadio Component is vulnerable to SQL Injection");
