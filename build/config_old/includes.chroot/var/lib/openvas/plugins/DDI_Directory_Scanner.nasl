...
# $Id: DDI_Directory_Scanner.nasl 41 2013-11-04 19:00:12Z jan $
...
tag_summary = "This plugin attempts to determine the presence of various
...
if(description)
{
 ...
 script_summary("Directory Scanner");
 script_category(ACT_GATHER_INFO);
 script_copyright("This script is Copyright (C) 2002 Digital Defense Inc.");
 script_family("Service detection");
 script_dependencies("find_service.nasl", "httpver.nasl", "embedded_web_server_detect.nasl");
