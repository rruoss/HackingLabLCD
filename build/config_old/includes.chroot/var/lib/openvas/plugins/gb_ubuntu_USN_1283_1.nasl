...
tag_insight = "It was discovered that APT incorrectly handled the Verify-Host
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1283-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-November/001503.html");
  script_id(840825);
