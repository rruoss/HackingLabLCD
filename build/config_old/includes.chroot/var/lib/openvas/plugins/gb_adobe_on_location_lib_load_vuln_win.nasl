...
# $Id: gb_adobe_on_location_lib_load_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(description)
{
  ...
  script_name("Adobe On Location Insecure Library Loading Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  script_summary("Check for the version of Adobe On Location");
