...
tag_insight = "Wilfried Weissmann discovered that Apache Commons Daemon incorrectly
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1298-1";
tag_affected = "commons-daemon on Ubuntu 11.04";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-December/001517.html");
  script_id(840836);
  ...
  script_summary("Check for the Version of commons-daemon");
