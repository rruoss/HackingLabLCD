...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-July/001128.html");
  script_id(840465);
  ...
  script_summary("Check version of packages updated in Ubuntu Update USN-930-5");
