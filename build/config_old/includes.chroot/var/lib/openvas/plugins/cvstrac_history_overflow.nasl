...
# $Id: cvstrac_history_overflow.nasl 17 2013-10-27 14:01:43Z jan $
# Description: CVSTrac history.c history_update function overflow
#
# Authors:
...
if(description)
{
 ...
 name = "CVSTrac history.c history_update function overflow";
