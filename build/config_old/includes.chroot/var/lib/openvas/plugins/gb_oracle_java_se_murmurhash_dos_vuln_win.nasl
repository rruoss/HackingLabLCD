...
# $Id: gb_oracle_java_se_murmurhash_dos_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_insight = "The flaw is caused by hash functions based on the 'MurmurHash' algorithm,
  which is vulnerable to predictable hash collisions.";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/show/osvdb/87862");
