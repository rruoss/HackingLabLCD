...
# $Id: webmirror.nasl 43 2013-11-04 19:51:40Z jan $
#
# WEBMIRROR 2.0
#
# Saved from
...
tag_summary = "This script makes a mirror of the remote web site
...
if(description)
{
 ...
 script_dependencies("find_service.nasl", "httpver.nasl", "DDI_Directory_Scanner.nasl");
