...
# $Id: gb_wireshark_ber_dissector_stack_consumption_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaw is due to stack consumption  in the 'dissect_ber_unknown()'
  function in 'epan/dissectors/packet-ber.c' in the BER dissector, whcih allows
...
if(description)
{
  ...
  script_name("Wireshark BER Dissector Stack Consumption Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
