...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-February/000483.html");
  script_id(840099);
  ...
  script_summary("Check for the Version of linux-source-2.6.12/2.6.15/2.6.17 vulnerabilities");
