...
# $Id: verity_ultraseek_xss.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Verity Ultraseek search request XSS
#
# Authors:
...
tag_summary = "The remote host runs Verity Ultraseek, an Enterprise Search Engine Software.
...
tag_solution = "Upgrade to version 5.3.3 or higher";
...
if(description)
{
 ...
 desc = "
  ...
  script_summary("Checks  Verity Ultraseek search request XSS");
