...
# $Id: deb_2446_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "It was discovered that incorrect memory handling in the png_set_text2()
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202446-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2446-1 (libpng)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libpng12-0", ver:"1.2.44-1+squeeze4", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"libpng12-0-udeb", ver:"1.2.44-1+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"libpng12-dev", ver:"1.2.44-1+squeeze4", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"libpng3", ver:"1.2.44-1+squeeze4", rls:"DEB6.0")) != NULL) {
    report += res;
}
