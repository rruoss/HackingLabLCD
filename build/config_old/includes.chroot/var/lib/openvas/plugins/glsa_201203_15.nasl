...
tag_insight = "Multiple vulnerabilities have been found in gif2png, the worst of
    which might allow execution of arbitrary code.";
tag_solution = "All gif2png users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=media-gfx/gif2png-2.5.8'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201203-15
http://bugs.gentoo.org/show_bug.cgi?id=351698";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201203-15 (gif2png)");
