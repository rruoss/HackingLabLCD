...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-February/000485.html");
  script_id(840048);
  ...
  script_summary("Check for the Version of imagemagick vulnerabilities");
