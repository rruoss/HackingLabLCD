...
# $Id: esoft_slk_ssa_2007_152_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New php5 packages are available for Slackware 10.2, 11.0, and -current to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-152-01";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2007-152-01 php5 ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2007-152-01 php5");
...
vuln = 0;
if(isslkpkgvuln(pkg:"php", ver:"5.2.3-i486-1_slack10.2", rls:"SLK10.2")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"php", ver:"5.2.3-i486-1_slack11.0", rls:"SLK11.0")) {
    vuln = 1;
}
