...
# $Id: deb_2461_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "Several vulnerabilities have been found in SPIP, a website engine for
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202461-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2461-1 (spip)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"spip", ver:"2.1.1-3squeeze3", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"spip", ver:"2.1.13-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
