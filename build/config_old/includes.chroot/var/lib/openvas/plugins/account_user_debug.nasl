...
# $Id: account_user_debug.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password 'debug' for account 'user'
#
# Authors:
# Michel Arboi
#
...
tag_summary = "The account 'user' has the password 'debug'.  An attacker may use it to
