...
# $Id: secpod_macosx_su11-002.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Checks for existence of Mac OS X 10.6.7 Update/Mac OS X Security Update 2011-002");
