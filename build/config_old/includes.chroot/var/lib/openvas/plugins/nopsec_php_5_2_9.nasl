...
# $Id: nopsec_php_5_2_9.nasl.nasl 110187
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 5.2.9
#
# Authors:
...
tag_solution = "Update PHP to version 5.2.9 or later.";
tag_summary = "PHP version smaller than 5.2.9 suffers vulnerability.";
...
script_name("PHP version smaller than 5.2.9");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"5.2.9"))
