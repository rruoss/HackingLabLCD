...
tag_insight = "It was discovered that Update Manager created system state archive files
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1443-1";
tag_affected = "update-manager on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-May/001684.html");
  script_id(841009);
