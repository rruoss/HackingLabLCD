...
# $Id: gb_oprofile_detect.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
 ...
 script_version("$Revision: 13 $");
  ...
  script_summary("Set the version of OProfile in KB");
...
foreach binary_opName (opName)
{
  ...
  if(opVer[1])
  {
    ...
    security_note(data:"OProfile version " + opVer[1] + " running at location "
