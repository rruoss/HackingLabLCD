...
# $Id: mt-load_cgi.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_solution = "Remove the mt-load.cgi script after installation.";

tag_summary = "mt-load.cgi is installed by the Movable Type Publishing  
Platform. 
...
if(description)
{
 ...
 script_summary("Checks for the existence of /mt/mt-load.cgi");
