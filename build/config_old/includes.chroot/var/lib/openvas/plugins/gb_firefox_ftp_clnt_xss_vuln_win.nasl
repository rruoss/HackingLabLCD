...
# $Id: gb_firefox_ftp_clnt_xss_vuln_win.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_solution = "No solution or patch is available as of 24th October, 2008. Information
...
if(description)
{
  ...
  script_name("Firefox Web Browser FTP Client XSS Vulnerability (Win)");
  desc = "
