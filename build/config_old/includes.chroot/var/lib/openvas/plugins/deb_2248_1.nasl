...
# $Id: deb_2248_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "Wouter Coekaerts discovered that ejabberd, a distributed XMPP/Jabber server
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202248-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2248-1 (ejabberd)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"ejabberd", ver:"2.0.1-6+lenny3", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"ejabberd", ver:"2.1.5-3+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
