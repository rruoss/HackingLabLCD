...
tag_insight = "Glen Eustace discovered that the DHCP server incorrectly handled IPv6
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1571-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-September/001828.html");
  script_id(841157);
