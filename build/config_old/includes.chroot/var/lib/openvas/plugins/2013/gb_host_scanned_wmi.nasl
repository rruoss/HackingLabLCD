...
# $Id: gb_host_scanned_wmi.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if (description)
{
 ...
 " + tag_summary;
  ...
  script_summary("Leave information on scanned Windows hosts");
  script_category(ACT_END);
  script_family("General");
  script_copyright("This script is Copyright (C) 2013 Greenbone Networks GmbH");
  script_dependencies("smb_reg_service_pack.nasl", "smb_login.nasl", "host_scan_end.nasl");
  script_mandatory_keys("SMB/login","SMB/password");
