...
# $Id: gb_otrs_email_body_xss_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected =
"OTRS (Open Ticket Request System) version 2.4.x before 2.4.15, 3.0.x before
3.0.17, and 3.1.x before 3.1.11";

tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 2.4.15, 3.0.17 and 3.1.11
or later, For updates refer to http://www.otrs.com/en/ or Apply patch from the
vendor advisory link http://otrs.org/advisory/OSA-2012-03-en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/85074");
  ...
  script_summary("Determine if the OTRS version is 2.4 to 2.4.14,3.0 to 3.0.16 and 3.1 to 3.1.10");
