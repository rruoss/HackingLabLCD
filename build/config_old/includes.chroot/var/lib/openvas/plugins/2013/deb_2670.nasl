...
# $Id: deb_2670.nasl 39 2013-11-04 11:37:28Z mime $
...
tag_affected  = "request-tracker3.8 on Debian Linux";
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2670-1 (request-tracker3.8 - several vulnerabilities)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"request-tracker3.8", ver:"3.8.8-7+squeeze7", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rt3.8-apache2", ver:"3.8.8-7+squeeze7", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rt3.8-clients", ver:"3.8.8-7+squeeze7", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rt3.8-db-mysql", ver:"3.8.8-7+squeeze7", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rt3.8-db-postgresql", ver:"3.8.8-7+squeeze7", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"rt3.8-db-sqlite", ver:"3.8.8-7+squeeze7", rls:"DEB6.0")) != NULL) {
    report += res;
}
