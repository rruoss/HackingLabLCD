...
# $Id: deb_2610.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-01-21 00:00:00 +0100 (Mo, 21 Jan 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2610-1 (ganglia - arbitrary script execution)");
