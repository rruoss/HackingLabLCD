...
# $Id: deb_2624.nasl 32 2013-10-31 13:05:08Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-02-16 00:00:00 +0100 (Sa, 16 Feb 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2624-1 (ffmpeg - several vulnerabilities)");
