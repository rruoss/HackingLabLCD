...
tag_affected = "gogoc on Fedora 18";
tag_insight = "TSP is a control protocol used to establish and maintain static tunnels.
...
if(description)
{
  ...
  script_summary("Check for the Version of gogoc");
