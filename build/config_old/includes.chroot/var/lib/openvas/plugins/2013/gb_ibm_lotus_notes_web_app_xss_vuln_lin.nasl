...
# $Id: gb_ibm_lotus_notes_web_app_xss_vuln_lin.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "IBM Lotus Notes Version 8.x before 8.5.3 FP3 on Linux";
...
if(description)
{
  ...
  script_dependencies("secpod_ibm_lotus_notes_detect_lin.nasl" ,"ssh_authorization_init.nasl");
...
## Check for IBM Lotus Notes Version 8.x < 8.5.3 FP3 [8.5.33.2283]
if(lotusVer =~ "^8.5" &&
