...
# $Id: gb_siemens_scalance_default_web_credential.nasl 11 2013-10-27 10:12:02Z jan $
#
...
desc = "
 ...
 script_summary("Checks if it is possible to login as user admain");
 script_category(ACT_ATTACK);
 script_family("Default Accounts");
 script_copyright("This script is Copyright (C) 2013 Greenbone Networks GmbH");
 script_dependencies("gb_siemens_scalance_web_detect.nasl");
 script_require_ports("Services/www", 80);
 script_require_keys("siemens_scalance/installed");
