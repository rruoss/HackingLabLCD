...
tag_insight = "USN-1831-1 fixed a vulnerability in OpenStack Nova. The upstream fix
...
if(description)
{
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-May/002126.html");
