...
tag_affected = "gnome-online-accounts on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 11.10";
tag_insight = "It was discovered that GNOME Online Accounts did not properly check SSL
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-March/002056.html");
  script_id(841377);
