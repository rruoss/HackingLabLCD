...
if(description)
{
  ...
  tag_insight = "Vows is an asynchronous behavior-driven development (BDD) framework for
Node.js.
...
";
  ...
  tag_affected = "nodejs-vows on Fedora 18";
  ...
  script_summary("Check for the Version of nodejs-vows");
