...
if(description)
{
  ...
  tag_insight = "It was discovered that ImageMagick incorrectly handled decoding GIF image
...
the user invoking the program.";
  ...
  tag_affected = "imagemagick on Ubuntu 13.04 ,
  Ubuntu 12.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-September/002237.html");
