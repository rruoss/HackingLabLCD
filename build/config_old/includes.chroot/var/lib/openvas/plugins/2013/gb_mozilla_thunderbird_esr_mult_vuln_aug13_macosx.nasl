...
# $Id: gb_mozilla_thunderbird_esr_mult_vuln_aug13_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if (description)
{
  ...
  tag_summary =
"The host is installed with Mozilla Thunderbird ESR and is prone to multiple
vulnerabilities.";
...
also be possible.";
  ...
  tag_affected =
"Mozilla Thunderbird ESR 17.x before 17.0.8 on Mac OS X";
