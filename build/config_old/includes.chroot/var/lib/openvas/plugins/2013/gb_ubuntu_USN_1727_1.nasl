...
tag_affected = "boost1.49 on Ubuntu 12.10";
tag_insight = "It was discovered that the Boost.Locale library incorrectly validated some
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/001999.html");
  script_id(841328);
  ...
  script_summary("Check for the Version of boost1.49");
