...
# $Id: deb_2616.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-02-03 00:00:00 +0100 (So, 03 Feb 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2616-1 (nagios3 - buffer overflow in CGI scripts)");
