...
# $Id: deb_2789.nasl 56 2013-11-11 15:55:30Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-11-01 00:00:00 +0100 (Fr, 01 Nov 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2789-1 (strongswan - Denial of service and authorization bypass)");
