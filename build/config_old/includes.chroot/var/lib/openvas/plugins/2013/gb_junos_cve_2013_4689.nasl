...
# $Id: gb_junos_cve_2013_4689.nasl 70 2013-11-21 03:20:24Z ckuerste $
#
...
SCRIPT_DESC = "Junos CSRF Protection Bypass Vulnerability in J-Web";

tag_insight = "A vulnerability in J-Web may allow remote attackers to bypass
CSRF (Cross-Site Request Forgery) Protection in J-Web.";

tag_impact = "An attacker can perform adimistrative actions such as creating
new administrative accounts to gain complete control over the device.";

tag_affected = "Plattforms running Junos OS 10.4, 11.4, 12.1, 12.1X44, 12.2,
12.3, or 13.1.";

tag_summary = "A CSRF Protection bypass in J-Web allows an attacker to gain
...
" + tag_solution;
  ...
  script_xref(name:"URL", value:"http://kb.juniper.net/InfoCenter/index?page=content&id=JSA10597");
  ...
  script_summary("Junos CVE-2013-4689");
