...
# $Id: deb_2732.nasl 55 2013-11-11 15:38:51Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-07-31 00:00:00 +0200 (Mi, 31 Jul 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2732-1 (chromium-browser - several vulnerabilities)");
