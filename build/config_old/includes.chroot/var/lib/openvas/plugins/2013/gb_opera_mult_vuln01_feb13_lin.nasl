...
tag_affected = "Opera version prior to 12.13 on Linux";
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Opera on Linux");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2013 Greenbone Networks GmbH");
  script_family("General");
  script_dependencies("secpod_opera_detection_linux_900037.nasl","ssh_authorization_init.nasl");
