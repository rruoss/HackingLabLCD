...
tag_affected = "perl-Dancer on Fedora 17";
tag_insight = "Dancer is a web application framework designed to be as effortless as
...
if(description)
{
  ...
  script_summary("Check for the Version of perl-Dancer");
