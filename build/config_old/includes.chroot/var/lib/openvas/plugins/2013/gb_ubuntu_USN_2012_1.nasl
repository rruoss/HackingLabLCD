...
if(description)
{
  ...
  tag_insight = "Christian Prim discovered that Light Display Manager
...
sensitive information.";
  ...
  tag_affected = "lightdm on Ubuntu 13.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-November/002300.html");
