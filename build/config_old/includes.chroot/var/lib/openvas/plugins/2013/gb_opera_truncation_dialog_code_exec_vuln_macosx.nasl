...
# $Id: gb_opera_truncation_dialog_code_exec_vuln_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight = "An error in handling of truncated dialogs, can be used to cause the user
  ...
  actions.";
tag_affected = "Opera version before 11.67 and 12.x before 12.02 on Mac OS X";
