...
tag_insight = "USN-1763-1 fixed a vulnerability in NSS. This update provides the NSPR
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-March/002040.html");
  script_id(841360);
