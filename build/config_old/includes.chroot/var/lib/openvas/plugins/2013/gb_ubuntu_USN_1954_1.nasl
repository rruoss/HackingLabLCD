...
if(description)
{
  ...
  tag_insight = "It was discovered that libvirt used the pkcheck tool in an unsafe manner. A
...
13.04. (CVE-2013-5651)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-September/002246.html");
