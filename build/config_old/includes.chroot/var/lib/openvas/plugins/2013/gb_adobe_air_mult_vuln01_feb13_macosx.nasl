...
# $Id: gb_adobe_air_mult_vuln01_feb13_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Adobe AIR Version prior to 3.6.0.597 on Mac OS X";
...
if(description)
{
  ...
  script_require_keys("Adobe/Air/MacOSX/Version");
