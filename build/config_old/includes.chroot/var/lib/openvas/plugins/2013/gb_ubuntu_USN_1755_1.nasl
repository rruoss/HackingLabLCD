...
tag_insight = "It was discovered that OpenJDK did not properly validate certain types
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-March/002029.html");
  script_id(841350);
