...
# $Id: gb_wordpress_fgallery_plus_xss_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  tag_summary =
"This host is installed with WordPress fgallery_plus plugin and is prone to
...
cookie or not.";
  ...
  tag_insight =
"Input passed via the 'album' parameter to fim_rss.php script is not properly
...
Impact Level: Application";
  ...
  tag_affected =
"WordPress fgallery_plus Plugin.";

  tag_solution =
"No solution or patch is available as of 04th October, 2013. Information
...
For updates refer to http://wordpress.org/plugins";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/97625");
  ...
  script_summary("Check if WordPress fgallery_plus plugin is prone to xss");
