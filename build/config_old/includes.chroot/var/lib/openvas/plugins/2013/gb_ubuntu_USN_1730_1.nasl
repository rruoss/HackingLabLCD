...
tag_insight = "Nathanael Burton discovered that Keystone did not properly verify disabled
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/002002.html");
  script_id(841324);
