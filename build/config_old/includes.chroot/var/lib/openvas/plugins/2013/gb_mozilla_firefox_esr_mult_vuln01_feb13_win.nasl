...
# $Id: gb_mozilla_firefox_esr_mult_vuln01_feb13_win.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Mozilla Firefox ESR version 17.x prior to 17.0.3 on Windows";
...
if(description)
{
  ...
  script_require_keys("Firefox-ESR/Win/Ver");
