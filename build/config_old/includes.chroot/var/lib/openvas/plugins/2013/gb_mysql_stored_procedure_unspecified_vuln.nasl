...
# $Id: gb_mysql_stored_procedure_unspecified_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "MySQL version 5.5.x before 5.5.31 and 5.6.x before 5.6.11";
tag_insight = "Unspecified error in some unknown vectors related to Stored Procedure.";
tag_solution = "Upgrade to MySQL version 5.5.31 or 5.6.11 or later,
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://www.osvdb.com/92477");
