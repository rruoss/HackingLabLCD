...
# $Id: deb_2785.nasl 58 2013-11-12 10:51:52Z mime $
...
if(description)
{
    ...
    script_tag(name: "last_modification", value:"$Date: 2013-11-12 11:51:52 +0100 (Di, 12. Nov 2013) $");
    script_tag(name: "creation_date", value:"2013-10-26 00:00:00 +0200 (Sa, 26 Okt 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2785-1 (chromium-browser - several vulnerabilities)");
