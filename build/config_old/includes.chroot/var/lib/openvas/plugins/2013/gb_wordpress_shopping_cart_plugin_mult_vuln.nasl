...
# $Id: gb_wordpress_shopping_cart_plugin_mult_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/88856");
  script_xref(name : "URL" , value : "http://www.osvdb.org/88857");
  script_xref(name : "URL" , value : "http://www.osvdb.org/88858");
  script_xref(name : "URL" , value : "http://www.osvdb.org/88863");
  ...
  script_summary("Check if WP Shopping Cart Plugin is vulnerable to SQL Injection");
