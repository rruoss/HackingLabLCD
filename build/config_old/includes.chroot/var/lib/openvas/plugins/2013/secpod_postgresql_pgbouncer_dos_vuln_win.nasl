...
# $Id: secpod_postgresql_pgbouncer_dos_vuln_win.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  script_name("PostgreSQL PgBouncer Denial of Service Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/87560");
  ...
  script_summary("Check for the version of PostgreSQL PgBouncer Pooler on Windows");
