...
# $Id: deb_2660.nasl 39 2013-11-04 11:37:28Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-04-20 00:00:00 +0200 (Sa, 20 Apr 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2660-1 (curl - exposure of sensitive information)");
