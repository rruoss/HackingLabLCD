...
tag_insight = "USN-1698-1 fixed vulnerabilities in the Linux kernel. Due to an unrelated
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/001984.html");
  script_id(841301);
