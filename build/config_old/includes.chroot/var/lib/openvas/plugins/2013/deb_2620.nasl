...
# $Id: deb_2620.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-02-12 00:00:00 +0100 (Di, 12 Feb 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2620-1 (rails - several vulnerabilities)");
