...
if(description)
{
  ...
  tag_insight = "A cookie handling and cookie jar library for Node.js.
";

  tag_affected = "nodejs-cookie-jar on Fedora 18";
  ...
  script_summary("Check for the Version of nodejs-cookie-jar");
