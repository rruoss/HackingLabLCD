...
# $Id: deb_2733.nasl 55 2013-11-11 15:38:51Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-08-02 00:00:00 +0200 (Fr, 02 Aug 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2733-1 (otrs2 - SQL injection)");
