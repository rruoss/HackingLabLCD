...
# $Id: gb_kyocera_printers_default_credentials.nasl 11 2013-10-27 10:12:02Z jan $
# OVAS-B-A10
...
tag_summary = "The remote Kyocera Printer is prone to a default account
...
desc = "
 ...
 script_require_keys("kyocera_printer/installed");
...
ret = check_ky_default_login(model:model); 

if(ret) {

  if(ret == 1) {
    message = 'It was possible to login into the remote Kyocera ' + model + ' with user "' + last_user + '" and password "' + last_pass + '"\n';
  } 
  else if(ret == 2) {
