...
if(description)
{
  ...
  tag_insight = "nodejs-asn1 is a library for encoding and decoding Abstract Syntax Notation One
...
";
  ...
  tag_affected = "nodejs-asn1 on Fedora 18";
  ...
  script_summary("Check for the Version of nodejs-asn1");
