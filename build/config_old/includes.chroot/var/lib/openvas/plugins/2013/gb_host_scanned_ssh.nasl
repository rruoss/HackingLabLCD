...
# $Id: gb_host_scanned_ssh.nasl 11 2013-10-27 10:12:02Z jan $
#
...
* File: A filename under /tmp can be choosen where the message is left. It is
...
if (description)
{
 ...
 script_summary("Leave information on scanned hosts");
 script_category(ACT_END);
 script_family("General");
 script_copyright("This script is Copyright (C) 2012 Greenbone Networks GmbH");
 script_mandatory_keys("login/SSH/success");
 script_dependencies("host_scan_end.nasl","ssh_authorization.nasl");
