...
#
# Adobe Reader Remote Code Execution Vulnerability(Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Adobe Reader Remote Code Execution Vulnerability(Win)");
...
Execution Vulnerability.";
  ...
  tag_vuldetect =
"Get the installed version of Adobe Reader with the help of detect NVT and
