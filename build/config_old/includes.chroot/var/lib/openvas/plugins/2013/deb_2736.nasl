...
# $Id: deb_2736.nasl 55 2013-11-11 15:38:51Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-08-11 00:00:00 +0200 (So, 11 Aug 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2736-1 (putty - several vulnerabilities)");
