...
# $Id: deb_2765.nasl 55 2013-11-11 15:38:51Z mime $
...
tag_affected  = "davfs2 on Debian Linux";
tag_insight   = "Web Distributed Authoring and Versioning (WebDAV), an extension to the
...
tag_summary   = "Davfs2, a filesystem client for WebDAV, calls the function system()
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-09-26 00:00:00 +0200 (Do, 26 Sep 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2765-1 (davfs2 - privilege escalation)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"davfs2", ver:"1.4.6-1.1+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"davfs2", ver:"1.4.6-1.1+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
