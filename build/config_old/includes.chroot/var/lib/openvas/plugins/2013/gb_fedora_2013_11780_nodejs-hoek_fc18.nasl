...
if(description)
{
  ...
  tag_insight = "This package contains some general purpose Node.js utilities, including
utilities for working with objects, timers, binary encoding/decoding, escaping
characters, errors, and loading files.
";

  tag_affected = "nodejs-hoek on Fedora 18";
  ...
  script_summary("Check for the Version of nodejs-hoek");
