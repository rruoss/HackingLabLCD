...
if(description)
{
  ...
  tag_insight = "It was discovered that ICU contained a race condition affecting multi-
...
invoking the program. (CVE-2013-2924)";
  ...
  tag_affected = "icu on Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002277.html");
