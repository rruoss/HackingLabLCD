...
# $Id: gb_otrs_itsm_mul_input_val_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"An error exists in AgentITSMConfigItemSearch which does not sanitize
user-supplied input properly";

tag_impact =
"Successful exploitation will allow remote attackers to gain access steal the
victim's cookie-based authentication credentials or execute SQL query.

Impact Level: Application";

tag_affected =
"OTRS (Open Ticket Request System) version 3.0.x up to and including 3.0.21,
...
tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 3.0.22, 3.1.18, 3.2.9
...
http://otrs.org/advisory/OSA-2013-05-en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/95014");
  script_xref(name : "URL" , value : "http://osvdb.org/95015");
