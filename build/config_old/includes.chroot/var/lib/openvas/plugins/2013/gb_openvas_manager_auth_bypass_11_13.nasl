...
# $Id: gb_openvas_manager_auth_bypass_11_13.nasl 68 2013-11-19 12:41:31Z mime $
#
...
" + tag_solution;
 ...
 script_summary("Determine if it is possible to bypass OMP authentcation.");
 script_category(ACT_ATTACK);
 script_family("General");
 script_copyright("This script is Copyright (C) 2013 Greenbone Networks GmbH");
 script_dependencies("gb_openvas_manager_detect.nasl");
 script_require_keys("openvas_manager/installed");
