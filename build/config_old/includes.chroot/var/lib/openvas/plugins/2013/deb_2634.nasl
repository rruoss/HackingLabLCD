...
# $Id: deb_2634.nasl 32 2013-10-31 13:05:08Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-02-27 00:00:00 +0100 (Mi, 27 Feb 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2634-1 (python-django - several vulnerabilities)");
