...
# $Id: gb_apache_subversion_log_report_dos_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Apache Subversion 1.7.0 through 1.7.8";
tag_insight = "An error within the 'mod_dav_svn' module when handling crafted log 'REPORT'
  request with a limit outside the allowed range.";
tag_solution = "Upgrade to Apache Subversion version 1.7.9 or later,
  For updates refer to http://subversion.apache.org";
tag_summary = "The host is running Apache Subversion and is prone denial of
...
foreach path (make_list("/", "/repo/", "/repository/", "/trunk/", "/svn/", "/svn/trunk/",
                        "/repo/trunk/", "/repo/projects/", "/projects/", "/svn/repos/", cgi_dirs()))
{
