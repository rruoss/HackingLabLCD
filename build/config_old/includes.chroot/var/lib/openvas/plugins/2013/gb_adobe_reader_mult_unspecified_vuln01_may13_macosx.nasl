...
# $Id: gb_adobe_reader_mult_unspecified_vuln01_may13_macosx.nasl 29729 2013-05-28 10:15:11Z may$
#
...
Impact Level: System/Application";
  ...
  tag_affected =
"Adobe Reader Version 9.x prior to 9.5.5 on Mac OS X
Adobe Reader X Version 10.x prior to 10.1.7 on Mac OS X
Adobe Reader XI Version 11.x prior to 11.0.03 on Mac OS X";

  tag_solution =
"Update to Adobe Reader Version 11.0.03 or 10.1.7 or 9.5.5 or later,
...
{
  ## Check Adobe Reader version is 9.x <= 9.5.4, 10.x <= 10.1.6 and 11.x <= 11.0.02
