...
# $Id: deb_2640.nasl 32 2013-10-31 13:05:08Z mime $
...
tag_affected  = "zoneminder on Debian Linux";
tag_insight   = "ZoneMinder is intended for use in single or multi-camera video security
...
tag_summary   = "Multiple vulnerabilities were discovered in zoneminder, a Linux video
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2640-1 (zoneminder - several issues)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"zoneminder", ver:"1.24.2-8+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"zoneminder", ver:"1.25.0-4", rls:"DEB7.0")) != NULL) {
    report += res;
}
