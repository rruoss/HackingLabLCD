...
# $Id: deb_2597.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-01-04 00:00:00 +0100 (Fr, 04 Jan 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2597-1 (rails - input validation error)");
