...
# $Id: deb_2706.nasl 49 2013-11-07 12:55:54Z mime $
...
tag_summary   = "Several vulnerabilities have been discovered in the Chromium web
browser.
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-06-10 00:00:00 +0200 (Mo, 10 Jun 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2706-1 (chromium-browser - several vulnerabilities)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"chromium", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-browser", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-browser-dbg", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-browser-inspector", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-browser-l10n", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-dbg", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-inspector", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"chromium-l10n", ver:"27.0.1453.110-1~deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
