...
# $Id: gb_samiftp_retr_cmd_dos_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_impact = "Successful exploitation will allow the remote attackers to cause a denial
  of service.
  Impact Level: Application";

tag_affected = "SamiFTP Server version 2.0.1";
tag_insight = "The flaw is due to an error while parsing RETR command, which can be
  exploited to crash the FTP service by sending crafted data via 'RETR'
  command.";
tag_solution = "No solution or patch is available as of 13th June, 2013. Information
