...
tag_insight = "Suleiman Souhlal, Salman Qazi, Aaron Durbin and Michael Davidson discovered
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/002011.html");
  script_id(841330);
