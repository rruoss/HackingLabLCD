...
if(description)
{
  ...
  tag_insight = "Provides access to V8's 'raw' CallSites from Node.js.

This is useful for custom traces, C-style assertions, getting the line number in
execution, and more.
";

  tag_affected = "nodejs-callsite on Fedora 18";
  ...
  script_summary("Check for the Version of nodejs-callsite");
