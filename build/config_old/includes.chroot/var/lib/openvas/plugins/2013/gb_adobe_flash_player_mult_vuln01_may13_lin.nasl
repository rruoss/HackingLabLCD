...
# $Id: gb_adobe_flash_player_mult_vuln01_may13_lin.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Adobe Flash Player version before 10.3.183.76 and 11.x before 11.2.202.281
  on Linux";
tag_insight = "Multiple memory corruption flaws due to improper sanitation of user
  supplied input via a file.";
tag_solution = "Update to Adobe Flash Player version 10.3.183.86 or 11.2.202.285 or later
