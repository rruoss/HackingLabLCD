...
if(description)
{
  ...
  tag_insight = "It was discovered that Nova did not properly enforce the is_public property
...
instead of Qpid. (CVE-2013-4261)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002288.html");
