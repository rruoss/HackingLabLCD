...
tag_insight = "Adam Langley and Wolfgang Ettlingers discovered that OpenSSL incorrectly
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/002004.html");
  script_id(841327);
