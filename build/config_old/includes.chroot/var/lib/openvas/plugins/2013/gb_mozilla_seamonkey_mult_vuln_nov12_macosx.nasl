...
# $Id: gb_mozilla_seamonkey_mult_vuln_nov12_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Mozilla SeaMonkey version before 2.13.2 on Mac OS X";
tag_insight = "Multiple errors
  ...
  - Within handling of 'Location' object can be exploited to bypass security
    wrapper protection.";
tag_solution = "Upgrade to Mozilla SeaMonkey version to 2.13.2 or later,
