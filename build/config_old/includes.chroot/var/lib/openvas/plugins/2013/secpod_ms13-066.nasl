...
# $Id: secpod_ms13-066.nasl 11 2013-10-27 10:12:02Z jan $
#
...
or not.";
  ...
  tag_insight =
"Flaw is due to an error within the Active Directory Federation
Services (ADFS)";
...
http://technet.microsoft.com/en-us/security/bulletin/ms13-066";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/96181");
...
## Get File version
if(adfs1){
  adfs1file_ver = fetch_file_version(sysPath, file_name:"\ADFS\bin\ref\System.web.security.singlesignon.dll");
}

if(adfs2 || adfs3){
  adfs2file_ver = fetch_file_version(sysPath, file_name:"\ADFS\Microsoft.identityserver.dll");
}
...
{
  ## Check for System.web.security.singlesignon.dl
...
{
  ## Check for System.web.security.singlesignon.dl and Microsoft.identityserver.dll
  if(version_in_range(version:adfs1file_ver, test_version:"6.0.6002.18000", test_version2:"6.0.6002.18879")||
     ...
     version_in_range(version:adfs2file_ver, test_version:"6.1.7600.17000", test_version2:"6.1.7600.17337")||
...
{
  ## Check for System.web.security.singlesignon.dll and Microsoft.identityserver.dll
  if(version_in_range(version:adfs1file_ver, test_version:"6.1.7601.18000", test_version2:"6.1.7601.18198")||
     ...
     version_in_range(version:adfs2file_ver, test_version:"6.1.7601.18000", test_version2:"6.1.7601.18234")||
...
{
  ## Check for Microsoft.identityserver.dll
