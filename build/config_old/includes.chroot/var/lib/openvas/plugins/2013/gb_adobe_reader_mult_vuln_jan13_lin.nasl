...
# $Id: gb_adobe_reader_mult_vuln_jan13_lin.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Adobe Reader versions 9.x to 9.5.2 on Linux";
tag_insight = "For more details about the vulnerabilities refer the reference section.";
tag_solution = "Upgrade to Adobe Reader version 9.5.3 or later,
...
if(description)
{
  ...
  script_dependencies("gb_adobe_prdts_detect_lin.nasl", "ssh_authorization_init.nasl");
