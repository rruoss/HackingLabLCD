...
tag_affected = "keystone on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
tag_insight = "Dan Prince discovered that Keystone did not properly perform input
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/001987.html");
  script_id(841309);
