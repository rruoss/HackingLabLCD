...
tag_affected = "libxxf86vm on Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-June/002153.html");
  script_summary("Check for the Version of libxxf86vm");
