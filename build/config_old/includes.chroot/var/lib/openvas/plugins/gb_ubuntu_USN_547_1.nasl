...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-November/000629.html");
  script_id(840087);
  ...
  script_summary("Check for the Version of pcre3 vulnerabilities");
