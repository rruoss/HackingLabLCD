...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001738.html");
  script_id(841070);
  ...
  script_summary("Check for the Version of python-crypto");
