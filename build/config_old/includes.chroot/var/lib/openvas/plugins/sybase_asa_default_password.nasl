...
# $Id: sybase_asa_default_password.nasl 16 2013-10-27 13:09:52Z jan $
# Description: Sybase ASA default database password
#
# Authors:
...
if(description)
{
 ...
 name = "Sybase ASA default database password";
 script_name(name);
 ...
 summary = "ASA Default Database Password";
