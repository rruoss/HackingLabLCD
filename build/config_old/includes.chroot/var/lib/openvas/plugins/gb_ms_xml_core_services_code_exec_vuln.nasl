...
# $Id: gb_ms_xml_core_services_code_exec_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_insight = "Microsoft XML Core Services attempts to access an object in memory that has
  not been initialized, which allows  an attacker to corrupt memory.";
tag_solution = "Apply the Patch from below links,
  http://technet.microsoft.com/en-us/security/advisory/2719615
  http://technet.microsoft.com/en-us/security/bulletin/ms12-043";
tag_summary = "This host is installed with Microsoft XML Core Services and
  ...
  if(dllVer3)
  {
    ...
    else if(hotfix_check_sp(win7:2, win7x64:2, win2008r2:2) > 0)
    {
      ...
      if(version_is_less(version:dllVer3, test_version:"8.110.7600.17036") ||
         version_in_range(version:dllVer3, test_version:"8.110.7600.20000", test_version2:"8.110.7600.21226")||
         version_in_range(version:dllVer3, test_version:"8.110.7601.17000", test_version2:"8.110.7601.17856")||
         version_in_range(version:dllVer3, test_version:"8.110.7601.21000", test_version2:"8.110.7601.22011"))
      {
        security_hole(0);
        exit(0);
      }
  ...
  if(dllVer6)
  {
    ...
    else if(hotfix_check_sp(win7:2, win7x64:2, win2008r2:2) > 0)
    {
      ...
      if(version_is_less(version:dllVer6, test_version:"6.30.7600.17036") ||
         version_in_range(version:dllVer6, test_version:"6.30.7600.20000", test_version2:"6.30.7600.21226")||
         version_in_range(version:dllVer6, test_version:"6.30.7601.17000", test_version2:"6.30.7601.17856")||
         version_in_range(version:dllVer6, test_version:"6.30.7601.21000", test_version2:"6.30.7601.22011"))
      {
        security_hole(0);
        exit(0);
      }
