...
# $Id: gb_wordpress_amazon_associate_plugin_xss_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_solution = "No solution or patch is available as of 16th November, 2012. Information
  ...
  For updates refer to http://wordpress.org/extend/plugins/wordpress-amazon-associate/";
tag_summary = "This host is running WordPress Amazon Associate Plugin and is prone to
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/87348");
