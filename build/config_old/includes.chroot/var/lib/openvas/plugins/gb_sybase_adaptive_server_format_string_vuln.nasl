...
# $Id: gb_sybase_adaptive_server_format_string_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Determine Sybase Adaptive Server Format String Vulnerability");
