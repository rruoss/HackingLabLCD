...
# $Id: gb_coldfusion_42342.nasl 14 2013-10-27 12:33:37Z jan $
#
...
desc = "
 ...
 script_summary("Determine if Adobe ColdFusion is prone to a directory-traversal vulnerability");
 script_category(ACT_ATTACK);
 script_family("Web application abuses");
 script_copyright("This script is Copyright (C) 2010 Greenbone Networks GmbH");
 script_dependencies("os_fingerprint.nasl", "gb_coldfusion_detect.nasl");
