...
# $Id: DDI_IIS_Compromised.nasl 17 2013-10-27 14:01:43Z jan $
# Description: IIS Possible Compromise
#
# Authors:
...
tag_summary = "One or more files were found on this host that 
indicate a possible compromise.";

tag_solution = "Investigate the discovered files";
...
if(description)
{
    ...
    summary = "Searches for traces of a system compromise.";
    ...
    script_dependencies("find_service.nasl", "http_version.nasl", "DDI_Directory_Scanner.nasl", "webmirror.nasl");
