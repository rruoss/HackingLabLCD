...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-September/001152.html");
  script_id(840494);
  ...
  script_summary("Check for the Version of lftp vulnerability");
