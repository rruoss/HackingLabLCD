...
# $Id: vbulletin_calender_command_execution.nasl 17 2013-10-27 14:01:43Z jan $
# Description: vBulletin's Calender Command Execution Vulnerability
#
# Authors:
# SecurITeam
#
...
tag_summary = "A vulnerability in vBulletin enables attackers to craft special URLs 
...
if(description)
{
 ...
 name = "vBulletin's Calender Command Execution Vulnerability";
 script_name(name);
 
 script_description(desc);
 
 summary = "vBulletin's Calender  Command Execution Vulnerability";
