...
# $Id: groupwise_web_interface_help_hole.nasl 17 2013-10-27 14:01:43Z jan $
# Description: GroupWise Web Interface 'HELP' hole
#
# Authors:
# SecurITeam
#
...
tag_summary = "By modifying the GroupWise Web Interface HELP URL request,
...
if(description)
{
 ...
 name = "GroupWise Web Interface 'HELP' hole";
 script_name(name);
 ...
 summary = "GroupWise Web Interface 'HELP' hole";
