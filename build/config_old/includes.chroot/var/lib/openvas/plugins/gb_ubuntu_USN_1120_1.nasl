...
tag_insight = "It was discovered that the TIFF library incorrectly handled certain JPEG
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1120-1";
tag_affected = "tiff on Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001314.html");
  script_id(840657);
