...
# $Id: secpod_ms_ie_dos_vuln_mar10.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaw is due to error in createElement method which does not initialize
  certain  data structures during execution when processing crafted JavaScript
  code.";
