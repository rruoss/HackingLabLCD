...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1114-1";
tag_affected = "kdenetwork on Ubuntu 10.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 9.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001306.html");
  script_id(840643);
