...
if(description)
{
 ...
 script_summary("Checks for existence of Java for Mac OS X 10.5 Update 3");
...
if (osx_rls_name(rls:ssh_osx_rls) == osx_rls_name(rls:"Mac OS X 10.5.6")) {
	if (isosxpkgvuln(fixed:"com.apple.pkg.JavaForMacOSX10.5Update", diff:"3")) { security_hole(0); exit(0);}
}
