...
# $Id: gb_sunway_force_control_webserver_bof_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw exists due to an error in the WebServer component (httpsvr.exe) and
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/73124");
