...
# $Id: gb_adobe_prdts_mult_vuln_aug12_macosx.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Adobe Reader versions 9.x through 9.5.1 and 10.x through 10.1.3 on Mac OS X";
tag_insight = "The flaws are due to unspecified errors which can be exploited to
  corrupt memory.";
tag_solution = "Upgrade to Adobe Reader version 9.5.2 or 10.1.4 or later
