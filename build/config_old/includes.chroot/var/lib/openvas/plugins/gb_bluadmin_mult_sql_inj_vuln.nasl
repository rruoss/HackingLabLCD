...
# $Id: gb_bluadmin_mult_sql_inj_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Bluadmin";
tag_insight = "The input passed via 'ver' parameter to 'get_imagesf.php' and
...
tag_solution = "No solution or patch is available as of 18th June, 2012. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.bludomain.com/";
tag_summary = "This host is running Bluadmin and is prone to multiple SQL
...
if(description)
{
  ...
  script_summary("Check if Bluadmin is vulnerable to SQL Injection");
...
foreach dir (make_list("", "/bluadmin", cgi_dirs()))
{
