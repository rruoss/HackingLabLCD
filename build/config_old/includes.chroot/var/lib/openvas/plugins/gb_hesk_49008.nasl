...
# $Id: gb_hesk_49008.nasl 13 2013-10-27 12:16:33Z jan $
#
...
dirs = make_list("/hesk","/help","/helpdesk",cgi_dirs());

foreach dir (dirs) {
   
  url = string(dir,"/language/en/text.php/<script>alert('openvas-xss-test');</script>"); 
