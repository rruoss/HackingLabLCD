...
# $Id: gb_allocPS_47860.nasl 13 2013-10-27 12:16:33Z jan $
#
...
desc = "
 ...
 script_summary("Determine if allocPSA is prone to a cross-site scripting vulnerability");
...
foreach dir (dirs) {
  ...
  if(http_vuln_check(port:port, url:url,pattern:"<script>alert\(/openvas-xss-test/\)</script>",extra_check:"<title>allocPSA")) {
