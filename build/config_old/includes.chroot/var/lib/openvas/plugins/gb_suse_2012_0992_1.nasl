...
tag_insight = "Opera was updated to version 12.1, fixing various bugs and
  ...
  with Google Maps Labs that occured when compiling top-level loops inside strict evals
...
if(description)
{
  script_xref(name : "URL" , value : "http://195.135.221.135/opensuse-security-announce/2012-08/msg00008.html");
  script_id(850311);
