...
# $Id: secpod_ms08-048_900031.nasl 16 2013-10-27 13:09:52Z jan $
...
tag_impact = "Remote attackers can construct a specially crafted Web page,
...
tag_affected = "MS Outlook Express 5.5 & 6 on MS Windows 2000
        MS Outlook Express 6 on MS Windows 2003 and XP";

tag_insight = "Issue is due to the MHTML protocol handler incorrectly interprets
...
if(dllVer)
{
  ...
  if(hotfix_check_sp(winVista:2) > 0)
  {
    ...
    if("Service Pack 1" >< SP)
    {
      # Grep for inetcomm.dll version < 6.0.6001.18049
