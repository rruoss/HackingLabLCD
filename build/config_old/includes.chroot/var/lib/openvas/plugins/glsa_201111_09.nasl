...
tag_insight = "The Safe module for Perl does not properly restrict code, allowing
    a remote attacker to execute arbitrary Perl code outside of a
restricted
    compartment.";
tag_solution = "All users of the standalone Perl Safe module should upgrade to the
      latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201111-09
http://bugs.gentoo.org/show_bug.cgi?id=325563";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201111-09 (Safe)");
