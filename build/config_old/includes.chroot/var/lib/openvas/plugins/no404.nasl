...
# $Id: no404.nasl 41 2013-11-04 19:00:12Z jan $
# Description: No 404 check
#
# Authors:
...
tag_insight = "This web server is [mis]configured in that it does not return
...
tag_summary = "Remote web server does not reply with 404 error code.";
...
if(description)
{
 ...
 script_summary("Checks if the remote webserver issues 404 errors");
