...
tag_insight = "This updates introduces several fixes:

  - upstream encryption patch from
    https://cfengine.com/bugtracker/view.php?id=416
...
tag_affected = "cfengine3 on Mandriva Enterprise Server 5,
...
if(description)
{
  ...
  script_summary("Check for the Version of cfengine3");
