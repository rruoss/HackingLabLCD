...
# $Id: gb_firefox_mult_vuln_mar09_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Firefox version prior to 3.0.7 on Windows.";
...
tag_solution = "Upgrade to Firefox version 3.0.7
  http://www.mozilla.com/en-US/firefox/all.html";
tag_summary = "This host is installed with Mozilla Firefox and is prone to
...
if(description)
{
  ...
  script_name("Mozilla Firefox Multiple Vulnerabilities Mar-09 (Win)");
  desc = "
