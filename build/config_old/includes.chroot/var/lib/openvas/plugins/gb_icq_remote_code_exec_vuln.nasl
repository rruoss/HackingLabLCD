...
# $Id: gb_icq_remote_code_exec_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation allows the man-in-the-middle attackers to execute
  arbitrary code via a crafted file that is fetched through an automatic-update
  mechanism.
  Impact Level: System/Application";
tag_affected = "ICQ version 7.0 to 7.2(7.2.0.3525) on Windows";
tag_insight = "The flaw is due to an error in automatic update mechanism. It does
  not check the identity of the update server or the authenticity of the
  updates that it downloads through its automatic update mechanism.";
