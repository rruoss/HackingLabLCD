...
tag_insight = "David B. discovered that Software Center incorrectly validated server
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1270-1";
tag_affected = "software-center on Ubuntu 11.04 ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-November/001486.html");
  script_id(840820);
 ...
 script_version("$Revision: 13 $");
  ...
  script_summary("Check for the Version of software-center");
