...
# $Id: deb_2231_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "Multiple cross-site scripting vulnerabilities were discovered in Open
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202231-1";
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"otrs2", ver:"2.4.9+dfsg1-3+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
