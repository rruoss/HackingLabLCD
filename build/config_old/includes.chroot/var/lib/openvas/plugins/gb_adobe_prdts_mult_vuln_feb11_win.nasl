...
# $Id: gb_adobe_prdts_mult_vuln_feb11_win.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "Multiple flaws are caused by insecure permissions, input validation
  errors, memory corruptions, and buffer overflow errors when processing
  malformed contents within a PDF document.";
