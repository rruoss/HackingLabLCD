...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001629.html");
  script_id(840947);
  ...
  script_summary("Check for the Version of gdm-guest-session");
