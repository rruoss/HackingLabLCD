...
# $Id: apoll_7_5_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "Dragan Mitic Apoll is prone to an SQL-injection vulnerability because it
  ...
  Dragan Mitic Apoll 0.7.5 is vulnerable; other versions may also be affected.";
...
foreach dir (dirs) {
    ...
    filename = string(dir + "/admin/lost-pass.php");
    ...
    if(
       egrep(pattern: "You successfully generate new password", string: result)
      ) 
       {
         security_hole(port);
         exit(0);
