...
tag_insight = "Marc Deslauriers discovered that system-config-printer's cupshelpers
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1265-1";
tag_affected = "system-config-printer on Ubuntu 11.04";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-November/001483.html");
  script_id(840807);
