...
# $Id: gb_adobe_prdts_mult_vuln_oct09_lin.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Adobe Reader version 7.x before 7.1.4, 8.x before 8.1.7 and 9.x before 9.2
  on Linux.";
tag_insight = "For more information about the vulnerabilities refer the links mentioned in
  references.";
tag_solution = "Upgrade to Adobe Reader versions 9.2, 8.1.7, or 7.1.4
