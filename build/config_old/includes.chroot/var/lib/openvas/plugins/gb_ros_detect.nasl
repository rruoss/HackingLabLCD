...
# $Id: gb_ros_detect.nasl 18 2013-10-27 14:14:13Z jan $
#
...
tag_summary = "Detection of Rugged Operating System.
...
if (description)
{
 ...
 script_summary("Checks for the presence of Rugged Operating System");
...
if(vers && !isnull(vers)) {
  ...
  register_host_detail(name:"OS", value:cpe, nvt:SCRIPT_OID,desc:'Detection of Rugged Operating System');
