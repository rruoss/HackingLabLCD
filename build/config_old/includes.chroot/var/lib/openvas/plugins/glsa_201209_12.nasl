...
tag_insight = "A vulnerability in Libtasn1 might cause a Denial of Service condition.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-12
http://bugs.gentoo.org/show_bug.cgi?id=409031";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-12 (libtasn1)");
