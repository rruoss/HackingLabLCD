...
# $Id: gb_newsportal_46961.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "NewsPortal is prone to a cross-site scripting vulnerability because it
...
dirs = make_list("/newsportal",cgi_dirs());

foreach dir (dirs) {
   
  url = string(dir,"/post.php?newsgroups=<script>alert('openvas-xss-test')</script>"); 
