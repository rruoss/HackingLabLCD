...
# $Id: gb_ibm_tivoli_dir_server_digest_md5_dos_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "IBM Tivoli Directory Server (ITDS) before 6.0.0.8-TIV-ITDS-IF0006";
tag_insight = "The flaw is caused by improper handling of 'DIGEST-MD5' authentication
...
tag_solution = "Apply cumulative interim fix 6.0.0.8-TIV-ITDS-IF0006
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/66782");
