...
tag_insight = "Dan Prince discovered that the Nova scheduler, when using
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1501-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-July/001755.html");
  script_id(841078);
