...
if(description)
{
  script_xref(name : "URL" , value : "http://www.novell.com/linux/security/advisories/2008_50_mozilla.html");
  script_id(850048);
  ...
  script_summary("Check for the Version of MozillaFirefox,MozillaThunderbird,seamonkey,mozilla");
