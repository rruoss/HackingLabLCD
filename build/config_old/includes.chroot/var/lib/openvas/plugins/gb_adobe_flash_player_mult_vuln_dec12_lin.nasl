...
# $Id: gb_adobe_flash_player_mult_vuln_dec12_lin.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Adobe Flash Player version before 10.3.183.48, 11.x before 11.2.202.258 on Linux";
tag_insight = "Multiple unspecified errors and integer overflow exists that could lead to
  code execution.";
tag_solution = "Update to Adobe Flash Player version 10.3.183.48 or 11.2.202.258 or later,
...
if(playerVer)
{
  # Grep for version less than 10.3.183.43 and 11.x less than 11.2.202.258
