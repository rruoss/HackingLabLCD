...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1260-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-November/001478.html");
  script_id(840937);
