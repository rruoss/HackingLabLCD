...
if(description)
{
 ...
 name = "Yahoo Messenger Detection";
 script_name(name);
 ...
 summary = "Detects Yahoo Messenger on remote hosts";
...
PORT = 5101; #Yahoo Messeger client listening port!!! FILE SHARING
...
pkt_len = raw_string(0x00, 0x3D); #data section lenght in bytes
