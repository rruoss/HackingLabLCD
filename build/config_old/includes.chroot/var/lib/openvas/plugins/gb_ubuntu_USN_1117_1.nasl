...
tag_insight = "Neel Mehta discovered that PolicyKit did not correctly verify the user
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1117-1";
tag_affected = "policykit-1 on Ubuntu 10.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 9.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001311.html");
  script_id(840653);
  ...
  script_summary("Check for the Version of policykit-1");
