...
# $Id: PHPFootball_password_hash_information_disclosure.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if PHPFootball is vulnerable to Password Hash Information Disclosure");
