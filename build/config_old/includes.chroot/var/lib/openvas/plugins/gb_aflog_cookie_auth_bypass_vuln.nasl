...
# $Id: gb_aflog_cookie_auth_bypass_vuln.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_impact = "Exploitation will allow an attacker to gain administrative access and bypass
  authentication.
  Impact Level: System";
tag_affected = "aflog versions 1.01 and prior on all running platform";
tag_insight = "The flaw is due to inadequacy in verifying user-supplied input used
  ...
  and edit_form.php.";
tag_solution = "No solution or patch is available as of 10th November, 2008. Information
  regarding this issue will updated once the solution details are available.
  For updates refer to http://e107.org/edownload.php";
tag_summary = "This host is running aflog and is prone to cookie-based authentication
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2008-4784");
