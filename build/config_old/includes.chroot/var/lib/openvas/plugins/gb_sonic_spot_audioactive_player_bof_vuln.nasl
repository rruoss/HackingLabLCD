...
# $Id: gb_sonic_spot_audioactive_player_bof_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will let the attacker execute arbitrary
  ...
  the application.";
tag_affected = "Audioactive Player version 1.93b and prior on Windows.";
tag_insight = "A boundary error occurs while processing playlist ('.mp3', '.m3u')
...
tag_solution = "No solution or patch is available as of 01st June, 2009. Information
  ...
  available. For updates refer to
  http://www.sonicspot.com/audioactiveplayer/audioactiveplayer.html";
tag_summary = "This host is running Sonic Spot Audioactive Player and is prone
