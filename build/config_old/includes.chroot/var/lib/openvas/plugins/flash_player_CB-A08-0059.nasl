...
# $Id: flash_player_CB-A08-0059.nasl 16 2013-10-27 13:09:52Z jan $
# Description: Adobe Flash Player 9.0.115.0 and earlier vulnerability (Lin)
#
# Authors:
...
if(description)
{
  ...
  name = "Adobe Flash Player 9.0.115.0 and earlier vulnerability (Lin)";
  script_name(name);
  ...
  " + tag_impact + "
  Solution:
  " + tag_solution;script_xref(name : "URL" , value : "http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2007-5275");
