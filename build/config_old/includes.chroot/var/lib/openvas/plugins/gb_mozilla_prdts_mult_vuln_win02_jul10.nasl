...
# $Id: gb_mozilla_prdts_mult_vuln_win02_jul10.nasl 14 2013-10-27 12:33:37Z jan $
#
# Mozilla Products Multiple Vulnerabilitie jul-10 (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Mozilla Products Multiple Vulnerabilitie jul-10 (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  script_summary("Check for the version of Mozilla Firefox/Tunderbird");
