...
# $Id: account_user_forgot.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password 'forgot' for account 'user'
#
# Authors:
# Michel Arboi
#
...
tag_summary = "The account 'user' has the password 'forgot'.  An attacker may use it to
