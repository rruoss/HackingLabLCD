...
# $Id: secpod_ms10-049.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "A flaw exists in the Microsoft Windows SChannel (Secure Channel)
...
if(sysPath)
{
  dllVer = get_file_version(sysPath, file_name:"Schannel.dll");
  if(!dllVer){
    exit(0);
  }
}
