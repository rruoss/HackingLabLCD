...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1530-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001783.html");
  script_id(841103);
