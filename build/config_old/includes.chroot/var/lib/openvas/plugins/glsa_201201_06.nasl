...
tag_insight = "Format string vulnerabilities in iSCSI Enterprise Target could
    result in execution of arbitrary code or a Denial of Service.";
tag_solution = "All iSCSI Enterprise Target users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201201-06
http://bugs.gentoo.org/show_bug.cgi?id=314187";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201201-06 (iscsitarget)");
