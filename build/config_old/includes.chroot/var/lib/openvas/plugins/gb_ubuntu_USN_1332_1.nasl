...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1332-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001552.html");
  script_id(840863);
