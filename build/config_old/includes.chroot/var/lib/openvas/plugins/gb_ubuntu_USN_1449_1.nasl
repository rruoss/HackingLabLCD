...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-May/001690.html");
  script_id(841014);
  ...
  script_summary("Check for the Version of feedparser");
