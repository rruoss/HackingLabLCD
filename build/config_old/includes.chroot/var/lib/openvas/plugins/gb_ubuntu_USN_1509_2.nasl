...
tag_insight = "USN-1509-1 fixed vulnerabilities in Firefox. This update provides an updated
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1509-2";
tag_affected = "ubufox on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-July/001764.html");
  script_id(841087);
