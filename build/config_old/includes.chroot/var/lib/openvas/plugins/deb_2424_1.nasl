...
# $Id: deb_2424_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "It was discovered that the XML::Atom Perl module did not disable
...
tag_summary = "The remote host is missing an update to libxml-atom-perl
announced via advisory DSA 2424-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202424-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2424-1 (libxml-atom-perl)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"libxml-atom-perl", ver:"0.37-1+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"libxml-atom-perl", ver:"0.41-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
