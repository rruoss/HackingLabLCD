...
# $Id: gb_bluesoft_classifieds_script_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "BlueSoft Classifieds script.";
tag_insight = "The flaw is due to input passed via the 'c' parameter to 'search.php',
...
tag_summary = "This host is running BlueSoft Classifieds Script and is prone to
...
foreach dir (make_list("/script", "/demo", cgi_dirs()))
{
