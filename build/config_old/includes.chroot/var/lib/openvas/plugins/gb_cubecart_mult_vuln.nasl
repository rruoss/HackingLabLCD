...
# $Id: gb_cubecart_mult_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/88690");
  script_xref(name : "URL" , value : "http://www.osvdb.org/88691");
