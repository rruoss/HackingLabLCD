...
# $Id: policy_file_checksums_errors.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "List files with checksum errors (missing files or other errors)";
...
" + tag_summary;
  ...
  script_summary("List files with errors during the checksum check");
...
md5error = get_kb_item("policy/md5cksum_err");
sha1error = get_kb_item("policy/sha1cksum_err");
