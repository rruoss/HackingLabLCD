...
# $Id: policy_file_checksums_win_violation.nasl 67 2013-11-18 08:50:51Z mwiegand $
#
...
tag_summary = "List Windows files with checksum violations";
...
" + tag_summary;
  ...
  script_summary("List Windows file Checksum Violations");
