...
# $Id: policy_file_checksums_ok.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "List files with no checksum violation or error";
...
" + tag_summary;
  ...
  script_summary("List File Checksum Matches");
