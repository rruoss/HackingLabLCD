...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-April/000516.html");
  script_id(840132);
  ...
  script_summary("Check for the Version of freetype, libxfont, xorg, xorg-server vulnerabilities");
