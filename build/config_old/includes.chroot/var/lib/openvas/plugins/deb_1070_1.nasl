...
# $Id: deb_1070_1.nasl 16 2013-10-27 13:09:52Z jan $
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 1070-1 (kernel-source-2.4.19,kernel-image-sparc-2.4,kernel-patch-2.4.19-mips)");
