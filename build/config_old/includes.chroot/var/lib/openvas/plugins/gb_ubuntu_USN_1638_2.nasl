...
tag_insight = "USN-1638-1 fixed vulnerabilities in Firefox. This update provides an
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1638-2";
tag_affected = "ubufox on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001903.html");
  script_id(841225);
