...
tag_insight = "It was discovered that the perl Config::IniFiles module created temporary
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1543-1";
tag_affected = "libconfig-inifiles-perl on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001797.html");
  script_id(841119);
  ...
  script_summary("Check for the Version of libconfig-inifiles-perl");
