...
tag_insight = "Einar Lonn discovered that Bind incorrectly initialized the failing-query
  cache. A remote attacker could use this flaw to cause Bind to crash,
  resulting in a denial of service.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1518-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-July/001771.html");
  script_id(841094);
