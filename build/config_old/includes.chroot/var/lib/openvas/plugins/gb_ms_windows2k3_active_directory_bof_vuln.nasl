...
# $Id: gb_ms_windows2k3_active_directory_bof_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to an error in Active Directory in 'Mrxsmb.sys', which
...
if(description)
{
  ...
  script_summary("Check for the existance of Mrxsmb.sys file");
