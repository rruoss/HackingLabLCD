...
# $Id: esoft_slk_ssa_2007_348_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-348-01";
...
";
 ...
 script_summary("Slackware Advisory SSA:2007-348-01 mysql");
...
vuln = 0;
if(isslkpkgvuln(pkg:"mysql", ver:"5.0.51-i486-1_slack11.0", rls:"SLK11.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"mysql", ver:"5.0.51-i486-1_slack12.0", rls:"SLK12.0")) {
    vuln = 1;
}
