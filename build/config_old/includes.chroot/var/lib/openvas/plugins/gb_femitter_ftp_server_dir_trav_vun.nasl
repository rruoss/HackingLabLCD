...
# $Id: gb_femitter_ftp_server_dir_trav_vun.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_solution = "No solution or patch is available as of 12th November, 2010. Information
  ...
  For updates refer to  http://acritum.com/fem";
tag_summary = "The host is running Femitter FTP server and is prone to directory traversal
  vulnerabilities.";
...
if(description)
{
  ...
  script_summary("Check for the directory traversal attack on Femitter FTP server");
