...
# $Id: gb_openoffice_senddoc_tmp_file_creation_vuln_win.nasl 16 2013-10-27 13:09:52Z jan $
#
...
if(description)
{
  ...
  script_name("OpenOffice senddoc Insecure Temporary File Creation Vulnerability (Win)");
  desc = "
