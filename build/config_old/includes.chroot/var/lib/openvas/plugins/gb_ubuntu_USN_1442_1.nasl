...
tag_insight = "It was discovered that sudo incorrectly handled network masks when using Host
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1442-1";
tag_affected = "sudo on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-May/001683.html");
  script_id(841006);
