...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-August/000740.html");
  script_id(840190);
  ...
  script_summary("Check for the Version of postfix vulnerability");
