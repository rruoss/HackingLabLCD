...
# $Id: mssql_brute_force.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Microsoft's SQL Server Brute Force
#
# Authors:
# H D Moore
#
...
tag_summary = "The SQL Server has a common password for one or more accounts.
 These accounts may be used to gain access to the records in 
 the database or even allow remote command execution.";

tag_solution = "Please set a difficult to guess password for these accounts.";
