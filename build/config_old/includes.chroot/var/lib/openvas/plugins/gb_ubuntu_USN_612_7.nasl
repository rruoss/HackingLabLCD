...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-May/000711.html");
  script_id(840268);
  ...
  script_summary("Check for the Version of openssh update");
