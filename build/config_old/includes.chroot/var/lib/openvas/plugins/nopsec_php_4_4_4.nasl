...
# $Id: nopsec_php_4_4_4.nasl.nasl 110188
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 4.4.4
#
# Authors:
...
tag_summary = "PHP version smaller than 4.4.4 suffers vulnerability.";
if (description)
{
  script_id(110188);
...
script_name("PHP version smaller than 4.4.4");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"4.4.4"))
