...
# $Id: gb_joomla_maian_media_comp_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_solution = "An Update is availble from vendor,
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/69358");
