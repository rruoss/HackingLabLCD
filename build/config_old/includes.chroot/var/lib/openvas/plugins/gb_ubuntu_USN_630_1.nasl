...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-July/000733.html");
  script_id(840272);
  ...
  script_summary("Check for the Version of ffmpeg vulnerability");
