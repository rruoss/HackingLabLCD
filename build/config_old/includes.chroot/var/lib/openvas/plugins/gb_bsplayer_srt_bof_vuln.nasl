...
# $Id: gb_bsplayer_srt_bof_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "BSPlayer version 2.27.958 and prior on Windows.";
tag_insight = "This flaw is due to boundary check error while the user supplies input data
  in the context of the application.";
tag_solution = "No solution or patch is available as of 07th April, 2009. Information
