...
# $Id: gb_php_cgi_2012.nasl 45 2013-11-05 15:43:35Z mime $
#
...
tag_summary = "When PHP is used in a CGI-based setup (such as Apache's mod_cgid), the
...
if (description)
{
 ...
 script_tag(name:"last_modification", value:"$Date: 2013-11-05 16:43:35 +0100 (Tue, 05 Nov 2013) $");
 script_tag(name:"creation_date", value:"2012-05-04 10:40:34 +0100 (Fri, 05 May 2012)");
...
phps = make_list("/cgi-bin/php","/cgi-bin/php5","/cgi-bin/php-cgi","/cgi-bin/php.cgi","/cgi-bin/php4", phps);
