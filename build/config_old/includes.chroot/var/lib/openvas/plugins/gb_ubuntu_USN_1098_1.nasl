...
tag_insight = "It was discovered that vsftpd incorrectly handled certain glob expressions.
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1098-1";
tag_affected = "vsftpd vulnerability on Ubuntu 6.06 LTS ,
  Ubuntu 8.04 LTS ,
  Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001291.html");
  script_id(840623);
  ...
  script_summary("Check for the Version of vsftpd vulnerability");
