...
tag_insight = "Felipe Ortega discovered that kadmind did not correctly handle password
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1116-1";
tag_affected = "krb5 on Ubuntu 10.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 9.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001310.html");
  script_id(840644);
