...
# $Id: gb_mozilla_prdts_addr_bar_spoofing_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
# Mozilla Products Address Bar Spoofing Vulnerability (Win)
#
# Authors:
...
tag_affected = "Mozilla Firefox version 3.5.1 and 3.5.2, Seamonkey 1.1.17 and on Windows.";
...
if(description)
{
  ...
  script_name("Mozilla Products Address Bar Spoofing Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
