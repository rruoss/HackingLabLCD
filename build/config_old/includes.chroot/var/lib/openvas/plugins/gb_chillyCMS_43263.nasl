...
# $Id: gb_chillyCMS_43263.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if ChillyCMS is prone to a vulnerability that lets attackers upload arbitrary files");
