...
tag_insight = "Stephane Chauveau discovered that OProfile did not properly perform input
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1166-1";
tag_affected = "oprofile on Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-July/001369.html");
  script_id(840701);
