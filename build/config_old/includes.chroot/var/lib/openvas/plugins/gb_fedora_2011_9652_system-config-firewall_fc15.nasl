...
tag_affected = "system-config-firewall on Fedora 15";
tag_insight = "system-config-firewall is a graphical user interface for basic firewall setup.";
...
if(description)
{
  ...
  script_summary("Check for the Version of system-config-firewall");
