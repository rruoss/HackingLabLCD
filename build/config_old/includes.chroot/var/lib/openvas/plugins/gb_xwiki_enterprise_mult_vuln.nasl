...
# $Id: gb_xwiki_enterprise_mult_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/68976");
  script_xref(name : "URL" , value : "http://www.osvdb.org/68977");
