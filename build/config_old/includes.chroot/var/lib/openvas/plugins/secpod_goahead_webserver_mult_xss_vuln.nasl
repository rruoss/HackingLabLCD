...
# $Id: secpod_goahead_webserver_mult_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "GoAhead Webserver version 2.5";
...
tag_solution = "No solution or patch is available as of 23rd November 2011. Information
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/77198");
