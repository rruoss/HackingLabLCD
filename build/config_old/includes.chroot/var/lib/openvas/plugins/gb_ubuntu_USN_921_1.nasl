...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-April/001076.html");
  script_id(840415);
  ...
  script_summary("Check for the Version of Firefox 3.5 and Xulrunner vulnerabilities");
