...
tag_affected = "myproxy on Fedora 13";
tag_insight = "MyProxy is open source software for managing X.509 Public Key Infrastructure
...
if(description)
{
 ...
 script_version("$Revision: 13 $");
  ...
  script_summary("Check for the Version of myproxy");
