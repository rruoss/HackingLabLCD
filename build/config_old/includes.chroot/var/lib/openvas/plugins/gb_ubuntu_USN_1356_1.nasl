...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1356-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001578.html");
  script_id(840890);
