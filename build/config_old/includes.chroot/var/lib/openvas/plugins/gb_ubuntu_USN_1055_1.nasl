...
tag_insight = "It was discovered that IcedTea for Java did not properly verify
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1055-1";
tag_affected = "openjdk-6, openjdk-6b18 vulnerabilities on Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-February/001238.html");
  script_id(840578);
  ...
  script_summary("Check for the Version of openjdk-6, openjdk-6b18 vulnerabilities");
