...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-November/001195.html");
  script_id(840531);
  ...
  script_summary("Check for the Version of cups, cupsys vulnerability");
