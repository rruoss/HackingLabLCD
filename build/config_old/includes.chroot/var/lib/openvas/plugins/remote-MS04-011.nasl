...
# $Id: remote-MS04-011.nasl 15 2013-10-27 12:49:54Z jan $
# Description:
...
#
# [Windows 2000]
# Windows 2000 SP0                    -> Not vulnerable
# Windows 2000 SP1                    -> Not vulnerable
# Windows 2000 SP2                    -> Vulnerable
# Windows 2000 SP3                    -> Vulnerable
# Windows 2000 SP4                    -> Vulnerable
# Windows 2000 SRP                    -> Not vulnerable
# Windows 2000 Windows Update         -> Not vulnerable
#
# [Windows XP]
# Windows XP SP0                      -> Vulnerable
# Windows XP SP1                      -> Vulnerable
# Windows XP SP2                      -> Not vulnerable
# 
# [Windows 2003]
# Windows 2003 SP0                    -> Vulnerable
# Windows 2003 SP1                    -> Not vulnerable
# Windows 2003 Windows Update         -> Not vulnerable
#
#
# Author:
...
tag_summary = "Windows operating system are affected to multiple remote code execution and privileges escalation vulnerabilities.
...
including installing programs; viewing, changing, or deleting data; or creating new accounts that have full privileges.
...
tag_solution = "Microsoft has released a patch to fix these issues.";
...
summary = "MS04-011 Multiples Remote Code Execution and privileges escalation Vulnerabilities";
...
if(microsoft_ds)
{
	...
	if(vulnerable == TRUE)
		security_hole(port:microsoft_ds);
}
...
if(netbios_ssn)
{
	...
	if(vulnerable == TRUE)
		security_hole(port:netbios_ssn);
}
