...
tag_insight = "USN-1443-1 fixed vulnerabilities in Update Manager. The fix for
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1443-2";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001702.html");
  script_id(841031);
