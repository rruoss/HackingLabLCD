...
tag_insight = "Steve Manzuik discovered that FFmpeg incorrectly handled certain malformed
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1320-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001540.html");
  script_id(840858);
