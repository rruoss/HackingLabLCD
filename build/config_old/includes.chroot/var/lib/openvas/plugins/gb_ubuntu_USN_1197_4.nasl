...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1197-4";
tag_affected = "nss on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-September/001408.html");
  script_id(840736);
