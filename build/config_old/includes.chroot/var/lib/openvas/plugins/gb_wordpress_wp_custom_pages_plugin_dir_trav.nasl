...
# $Id: gb_wordpress_wp_custom_pages_plugin_dir_trav.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "WordPress WP Custom Pages Version 0.5.0.1, Other versions may also be
  affected.";
tag_insight = "The flaw is due to input validation error in 'url' parameter to
  'wp-content/plugins/wp-custom-pages/wp-download.php', which allows
  attackers to read arbitrary files via a ../(dot dot) sequences.";
tag_solution = "No solution or patch is available as of 07th April, 2011. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://wordpress.org/extend/plugins/wp-custom-pages/";
tag_summary = "This host is installed with WordPress WP Custom Pages Plugin and is prone to
...
foreach file (keys(files))
{
  ...
  url = string(dir, "/wp-content/plugins/wp-custom-pages/wp-download.php?url="
