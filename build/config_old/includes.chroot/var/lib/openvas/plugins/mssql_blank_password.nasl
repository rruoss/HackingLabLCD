...
# $Id: mssql_blank_password.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "The remote MS SQL server has the default 'sa' account
...
tag_solution = "disable this account, or set a password to it. In addition
...
if(description)
{
 ...
 name = "Microsoft's SQL Blank Password";
 script_name(name);
 ...
 summary = "Microsoft's SQL Blank Password";
