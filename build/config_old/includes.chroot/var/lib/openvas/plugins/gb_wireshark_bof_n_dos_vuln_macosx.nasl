...
# $Id: gb_wireshark_bof_n_dos_vuln_macosx.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Wireshark version 1.4.0 through 1.4.9 and 1.6.x before 1.6.3 on Mac OS X";
...
tag_summary = "This host is installed with Wireshark and is prone to heap based
