...
# $Id: http_header_name_format_string.nasl 17 2013-10-27 14:01:43Z jan $
...
if(description)
{
  ...
  name = "Format string on HTTP header name";
  script_name(name);
 ...
 summary = "Sends an HTTP request with %s in an HTTP header name";
