...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001312.html");
  script_id(840637);
  ...
  script_summary("Check for the Version of openslp-dfsg");
