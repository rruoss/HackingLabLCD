...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-May/000536.html");
  script_id(840049);
  ...
  script_summary("Check for the Version of linux-source-2.6.15/2.6.17/2.6.20 vulnerabilities");
