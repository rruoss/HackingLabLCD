...
tag_insight = "Ryan Lortie discovered that a guest session script bundled in the Light
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1399-2";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001630.html");
  script_id(840931);
