...
# $Id: gb_pecio_cms_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script detects the installed version of Pecio CMS and
...
if(description)
{
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Set the version of Pecio CMS in KB");
...
foreach dir (make_list("/pecio", "/pecio_cms", cgi_dirs()))
{
