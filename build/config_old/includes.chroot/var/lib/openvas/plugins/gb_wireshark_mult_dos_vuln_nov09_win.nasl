...
# $Id: gb_wireshark_mult_dos_vuln_nov09_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Wireshark version 1.2.0 to 1.2.2 on Windows.";
...
if(description)
{
  ...
  script_name("Wireshark Multiple Denial Of Service Vulnerabilities - Nov09 (Win)");
  desc = "
  Summary:
  " + tag_summary + "
