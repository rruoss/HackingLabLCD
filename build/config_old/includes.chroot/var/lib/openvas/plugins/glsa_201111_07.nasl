...
tag_insight = "Multiple vulnerabilities have been reported in TinTin++ which could
    allow a remote attacker to conduct several attacks, including the
execution
    of arbitrary code and Denial of Service.";
tag_solution = "All TinTin++ users should upgrade to the latest stable version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201111-07
http://bugs.gentoo.org/show_bug.cgi?id=209903";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201111-07 (TinTin++)");
