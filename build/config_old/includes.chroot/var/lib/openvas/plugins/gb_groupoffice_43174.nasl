...
# $Id: gb_groupoffice_43174.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "Group-Office is prone to an SQL-injection vulnerability because it
...
Group-Office 3.5.9 is vulnerable; other versions may also be affected.";
...
desc = "
 ...
 script_summary("Determine if installed Group-Office version is	vulnerable");
