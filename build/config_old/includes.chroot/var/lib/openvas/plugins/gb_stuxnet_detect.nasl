...
# $Id: gb_stuxnet_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
# Stuxnet Detection
#
# Authors:
...
if(description)
{
 ...
 script_summary("Checks for the presence of Stuxnet");
...
report = string("\n\nThe following Stuxnet related files are detected on the remote Host:\n\n");
