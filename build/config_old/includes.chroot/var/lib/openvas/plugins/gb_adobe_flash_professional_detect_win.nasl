...
# $Id: gb_adobe_flash_professional_detect_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
 ...
 script_version("$Revision: 12 $");
  ...
  script_summary("Detection of installed version of Adobe Flash Professional for Windows");
