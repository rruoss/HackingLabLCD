...
# $Id: secpod_vim_shell_cmd_injection_vuln_win_900411.nasl 16 2013-10-27 13:09:52Z jan $
# Description: Vim Shell Command Injection Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Vim Shell Command Injection Vulnerability (Win)");
  script_summary("Check for vulnerable version of Vim");
  desc = "
  Summary:
  " + tag_summary + "
