...
tag_insight = "A buffer overflow in Pidgin might allow remote attackers to execute
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-17
http://bugs.gentoo.org/show_bug.cgi?id=425076";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-17 (pidgin)");
