...
# $Id: secpod_f-prot_av_sec_bypass_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
# F-PROT AntiVirus Security Bypass Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("F-PROT AntiVirus Security Bypass Vulnerability (Win)");
  desc = "
