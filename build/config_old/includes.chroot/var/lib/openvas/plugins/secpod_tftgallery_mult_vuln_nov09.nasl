...
# $Id: secpod_tftgallery_mult_vuln_nov09.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "- Error exists when input passed via the 'sample' parameter to settings.php
...
tag_solution = "No solution or patch is available as of 16th November, 2009. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.tftgallery.org/";
tag_summary = "This host is installed with TFT Gallery and is prone to Cross-Site
