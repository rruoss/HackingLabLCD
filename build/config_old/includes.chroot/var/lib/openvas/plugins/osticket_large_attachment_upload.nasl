...
# $Id: osticket_large_attachment_upload.nasl 17 2013-10-27 14:01:43Z jan $
...
if (description) {
  ...
  name = "osTicket Large Attachment Vulnerability";
  script_name(name);
 
  script_description(desc);
 
  summary = "Checks for Large Attachment Vulnerability in osTicket";
