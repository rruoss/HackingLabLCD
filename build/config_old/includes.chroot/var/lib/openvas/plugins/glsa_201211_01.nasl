...
tag_insight = "Multiple vulnerabilities have been found in MantisBT, the worst of
which allowing for local file inclusion.";
tag_solution = "All MantisBT users should upgrade to the latest version:
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201211-01 (MantisBT)");
