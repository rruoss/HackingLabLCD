...
tag_insight = "It was discovered that AWStats did not correctly filter the LoadPlugin
  configuration option. A local attacker on a shared system could use this
  to inject arbitrary code into AWStats.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1047-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001233.html");
  script_id(840572);
