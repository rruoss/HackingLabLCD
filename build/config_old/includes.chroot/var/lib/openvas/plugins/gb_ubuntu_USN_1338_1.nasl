...
tag_insight = "Peter Eisentraut discovered that Rsyslog would not properly perform input
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1338-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001559.html");
  script_id(840877);
