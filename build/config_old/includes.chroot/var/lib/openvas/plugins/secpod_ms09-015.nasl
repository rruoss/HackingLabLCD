...
# $Id: secpod_ms09-015.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Remote attackers could execute arbitrary code by convincing a user to
...
tag_insight = "The flaw is due to an error in the way SearchPath function in
...
if(sysPath)
{
  dllVer = get_file_version(sysPath, file_name:"secur32.dll");
  if(dllVer)
  {
...
if(sysPath)
{
  dllVer = get_file_version(sysPath, file_name:"System32\secur32.dll");
  if(!dllVer){
    exit(0);
  }
}
