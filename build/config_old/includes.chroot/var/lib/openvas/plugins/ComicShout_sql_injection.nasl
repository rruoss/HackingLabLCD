...
# $Id: ComicShout_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
dir = make_list("/comic", cgi_dirs());
foreach d (dir)
{ 
 url = string(d, "/news.php?news_id=4+union+all+select+0,1,2,0x4f70656e5641532d53514c2d496e6a656374696f6e2d54657374");
