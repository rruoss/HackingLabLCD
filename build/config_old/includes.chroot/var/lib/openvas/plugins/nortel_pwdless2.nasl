...
# $Id: nortel_pwdless2.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Nortel Networks  passwordless router (user level)
#
# Authors:
...
if(description)
{
   ...
   name = "Nortel Networks  passwordless router (user level)";
   script_name(name);
