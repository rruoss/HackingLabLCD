...
# $Id: secpod_sorinara_mp3_player_bof_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will let the attacker craft a malicious m3u playlist
...
tag_insight = "This flaw is due to an improper boundary checking when processing
  '.m3u' files.";
...
tag_summary = "This host is running Sorinara Soritong MP3 Player and is prone to
...
if(description)
{
  ...
  script_summary("Check for the version of Sorinara Soritong MP3 Player");
