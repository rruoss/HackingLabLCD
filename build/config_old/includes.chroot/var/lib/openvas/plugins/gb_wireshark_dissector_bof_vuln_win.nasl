...
# $Id: gb_wireshark_dissector_bof_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# Wireshark Stack-based Buffer Overflow Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Wireshark Stack-based Buffer Overflow Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
