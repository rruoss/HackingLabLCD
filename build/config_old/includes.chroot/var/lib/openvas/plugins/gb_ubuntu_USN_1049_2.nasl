...
tag_insight = "USN-1049-1 fixed vulnerabilities in Firefox and Xulrunner. That update
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1049-2";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001274.html");
  script_id(840609);
