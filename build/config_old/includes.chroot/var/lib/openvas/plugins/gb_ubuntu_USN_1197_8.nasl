...
tag_insight = "USN-1197-7 fixed a vulnerability in ca-certificates-java. The new package
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1197-8";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001649.html");
  script_id(840971);
  ...
  script_summary("Check for the Version of ca-certificates-java");
