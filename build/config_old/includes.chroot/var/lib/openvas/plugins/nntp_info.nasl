...
# $Id: nntp_info.nasl 17 2013-10-27 14:01:43Z jan $
...
if(description)
{
 ...
 summary = "Misc information on News server";
...
msg = strcat(
	...
	"Subject: OpenVAS post test ", rand(), ' (ignore)\r\n',
	"From: ", fromaddr, '\r\n',
	"Message-ID: ", msgid, '\r\n',
	more_headers,
...
sup = strcat(
	"Supersedes: ", msgid, '\r\n',
	"Newsgroups: ", testNGlist, '\r\n',
	"Subject: OpenVAS supersede test ", rand(), ' (ignore)\r\n',
	"From: ", fromaddr, '\r\n',
	"Message-ID: ", supid, '\r\n',
	more_headers,
	'Content-Type: text/plain; charset: us-ascii\r\n',
