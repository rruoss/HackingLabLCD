...
# $Id: gb_mozilla_prdts_js_uri_xss_vuln_sep09_lin.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Mozilla, Firefox version 3.0.13 and prior, 3.5 and 3.6/3.7 a1 pre
           Moziila Browser 1.7.x and prior.
           Seamonkey 1.1.17 on Linux.";
...
if(description)
{
  ...
  script_summary("Check for the version of Mozilla Product(s)");
