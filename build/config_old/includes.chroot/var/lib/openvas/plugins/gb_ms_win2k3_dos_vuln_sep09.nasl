...
# $Id: gb_ms_win2k3_dos_vuln_sep09.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will allow attakers to cause denial of service via
  a specially-crafted file containing EOT font embedded in the document thus
  crashing the operating system.
  Impact Level: System";
tag_affected = "Microsoft Windows 2003 Service Pack 2 and prior.";
tag_insight = "The vulnerability is due to an error in 'win32k.sys' when processing
  Embedded OpenType font.";
tag_solution = "No solution or patch is available as of 1st Sep, 2009. Information
