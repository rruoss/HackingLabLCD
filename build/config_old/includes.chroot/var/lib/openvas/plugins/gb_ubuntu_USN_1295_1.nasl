...
tag_insight = "It was discovered that Dovecot incorrectly validated certificate hostnames
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1295-1";
tag_affected = "dovecot on Ubuntu 11.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-December/001514.html");
  script_id(840950);
