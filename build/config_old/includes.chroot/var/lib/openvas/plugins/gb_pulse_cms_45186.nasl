...
# $Id: gb_pulse_cms_45186.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "Pulse CMS Basic is prone to a local file-include vulnerability.
...
tag_solution = "Reportedly, the issue is fixed in version 1.2.9, but Symantec has not
...
desc = "
 ...
 script_summary("Determine if Pulse CMS Basic is prone to a local file-include vulnerability");
...
dirs = make_list("/cms","/pulse","/pulsecms",cgi_dirs());
