...
# $Id: gb_opera_mult_vuln_oct08_win.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_affected = "Opera version prior to 9.61 on Windows.";
...
if(description)
{
  ...
  script_name("Opera Web Browser Multiple XSS Vulnerability (Win)");
  desc = "
