...
# $Id: gb_FishEye_detect.nasl 44 2013-11-04 19:58:48Z jan $
#
# FishEye Detection
#
# Authors:
...
if (description)
{
 ...
 script_summary("Checks for the presence of FishEye");
...
foreach dir (dirs) {
  ...
  if("<h3>Administration log in to FishEye" >< buf)
  {
     ...
     log_message(data: build_detection_report(app:"FishEye", version:vers, install:dir, cpe:cpe, concluded: version[1]),
                 port:port);
