...
# $Id: secpod_livezilla_track_module_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "LiveZilla version 3.2.0.2";
tag_insight = "The flaw is caused by an input validation error in the 'server.php' script
...
if(!dir = get_dir_from_kb(port:port, app:"LiveZilla")){
  exit(0);
}
