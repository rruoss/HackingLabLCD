...
tag_insight = "Geoff Keating reported that a buffer overflow exists in the intarray
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1058-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-February/001242.html");
  script_id(840577);
  ...
  script_summary("Check for the Version of PostgreSQL vulnerability");
