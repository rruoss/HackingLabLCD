...
tag_affected = "widelands on Fedora 14";
tag_insight = "Widelands is an open source (GPLed), realtime-strategy game, using SDL and
...
if(description)
{
  ...
  script_summary("Check for the Version of widelands");
