...
# $Id: open_media_collectors_database_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of Open Media Collectors Database");
...
dirs = make_list("/opendb",cgi_dirs());
