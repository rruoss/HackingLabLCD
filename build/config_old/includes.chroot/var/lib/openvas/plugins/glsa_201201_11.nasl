...
tag_insight = "Insecure temporary file usage in Firewall Builder could allow
    attackers to overwrite arbitrary files.";
tag_solution = "All Firewall Builder users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201201-11
http://bugs.gentoo.org/show_bug.cgi?id=235809
http://bugs.gentoo.org/show_bug.cgi?id=285861";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201201-11 (fwbuilder)");
