...
# $Id: gb_mozilla_thunderbird_esr_mult_vuln01_nov12_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Thunderbird ESR version 10.x before 10.0.11 on Windows";
...
tag_summary = "This host is installed with Mozilla Thunderbird ESR prone to multiple
  vulnerabilities.";
...
{
  # Grep for Thunderbird ESR version
