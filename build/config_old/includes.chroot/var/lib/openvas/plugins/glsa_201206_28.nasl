...
tag_insight = "Multiple vulnerabilities were found in texlive-core, allowing
attackers to execute arbitrary code.";
tag_solution = "All texlive-core users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=app-text/texlive-core-2009-r2'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-28
http://bugs.gentoo.org/show_bug.cgi?id=264598
http://bugs.gentoo.org/show_bug.cgi?id=324019";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-28 (TeX Live)");
