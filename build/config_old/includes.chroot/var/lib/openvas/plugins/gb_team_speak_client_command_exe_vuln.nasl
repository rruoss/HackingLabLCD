...
# $Id: gb_team_speak_client_command_exe_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(description)
{
  ...
  script_name("TeamSpeak Client Arbitrary command execution vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  script_summary("Check for the version of Teamspeak");
