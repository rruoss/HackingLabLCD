...
tag_insight = "Vadim Ponomarev discovered a flaw in the Linux kernel causing a reference
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1607-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001866.html");
  script_id(841187);
