...
tag_insight = "USN-1540-1 fixed vulnerabilities in NSS. This update provides the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1540-2";
tag_affected = "nss on Ubuntu 12.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001798.html");
  script_id(841122);
