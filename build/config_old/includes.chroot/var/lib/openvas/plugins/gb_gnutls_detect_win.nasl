...
# $Id: gb_gnutls_detect_win.nasl 43 2013-11-04 19:51:40Z jan $
#
...
tag_summary = "This script finds the installed GnuTLS version and saves the
  result in KB item.";
...
if(description)
{
 ...
 script_version("$Revision: 43 $");
  ...
  script_tag(name:"creation_date", value:"2009-08-07 06:06:49 +0200 (Fri, 07 Aug 2009)");
...
if(!registry_key_exists(key:"SOFTWARE\")){
    exit(0);
}
