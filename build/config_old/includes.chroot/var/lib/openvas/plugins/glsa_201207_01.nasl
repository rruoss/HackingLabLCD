...
tag_insight = "A vulnerability has been found in sudo which may allow local users
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201207-01
http://bugs.gentoo.org/show_bug.cgi?id=416281";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201207-01 (sudo)");
