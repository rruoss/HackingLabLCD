...
# $Id: gb_novell_zenworks_mobile_management_detect.nasl 18 2013-10-27 14:14:13Z jan $
#
...
tag_summary = "Detection of Novell ZENworks Mobile Management.
...
if("<title>ZENworks Mobile Management" >< buf && "DUSAP.php" >< buf) {
