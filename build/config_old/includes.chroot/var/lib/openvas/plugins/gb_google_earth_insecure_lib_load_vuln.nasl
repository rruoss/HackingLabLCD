...
# $Id: gb_google_earth_insecure_lib_load_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "This flaw is due to the application insecurely loading certain
  ...
  network share.";
tag_solution = "No solution or patch is available as of 6th September, 2010. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://earth.google.com/";
...
if(description)
{
  ...
  script_summary("Check for the version of Google Earth");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2010 Greenbone Networks GmbH");
  script_family("General");
  script_dependencies("gb_google_earth_detect.nasl");
  script_require_keys("Google/Earth/Ver");
