...
tag_affected = "glpi-data-injection on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "This additional package for Mandriva Enterprise Server 5.2 provides
...
if(description)
{
  ...
  script_summary("Check for the Version of glpi-data-injection");
