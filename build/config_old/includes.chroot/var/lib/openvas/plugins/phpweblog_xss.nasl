...
# $Id: phpweblog_xss.nasl 17 2013-10-27 14:01:43Z jan $
# Description: phpWebLog Cross Site Scripting
#
# Authors:
# Noam Rathaus
#
...
tag_summary = "The remote web server contains PHP scripts that are prone to several
...
if(description)
{
 ...
 name = "phpWebLog Cross Site Scripting";
 ...
 summary = "Checks for the presence of a phpWebLog XSS";
