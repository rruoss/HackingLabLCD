...
# $Id: gb_arkeia_virtual_appliance_detect.nasl 18 2013-10-27 14:14:13Z jan $
#
...
if (description)
{
  ...
  tag_summary =
"The script sends a connection request to the Arkeia Appliance and attempts
...
req = http_get(item:"/", port:http_port);
...
if(version[1])
{
  ...
  register_product(cpe:cpe, location:'/http', nvt:SCRIPT_OID, port:http_port);
