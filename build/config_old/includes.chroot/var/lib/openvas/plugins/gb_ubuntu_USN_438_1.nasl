...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-March/000506.html");
  script_id(840104);
  ...
  script_summary("Check for the Version of inkscape vulnerability");
