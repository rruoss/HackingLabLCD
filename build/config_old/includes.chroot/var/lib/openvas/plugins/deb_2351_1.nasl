...
# $Id: deb_2351_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "Huzaifa Sidhpurwala discovered a buffer overflow in Wireshark's ERF
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202351-1";
...
if((res = isdpkgvuln(pkg:"tshark", ver:"1.2.11-6+squeeze5", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"wireshark", ver:"1.2.11-6+squeeze5", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"wireshark-common", ver:"1.2.11-6+squeeze5", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"wireshark-dbg", ver:"1.2.11-6+squeeze5", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"wireshark-dev", ver:"1.2.11-6+squeeze5", rls:"DEB6.0")) != NULL) {
    report += res;
}
