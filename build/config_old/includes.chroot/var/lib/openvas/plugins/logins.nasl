...
# $Id: logins.nasl 41 2013-11-04 19:00:12Z jan $
...
tag_summary = "Provide the username/password for the common servers :
...
default_ftp_password = "openvas@openvas.org";
...
if(description)
{
 ...
 summary = "Logins for HTTP, FTP, NNTP, POP2, POP3, IMAP and SMB";
 ...
 script_add_preference(name:"NTLMSSP", type:"checkbox", value:"no");
