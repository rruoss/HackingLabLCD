...
# $Id: GSHB_SMB_SDDL.nasl 9 2013-10-27 09:38:41Z jan $
#
...
tag_summary = "The script List File and Folder ACL (Win).";
...
if(description)
{
  ...
  script_name("File and Folder ACL (Win)");
  desc = "
  Summary:
  " + tag_summary;

  script_description(desc);
  script_summary("File and Folder ACL (Win)");
