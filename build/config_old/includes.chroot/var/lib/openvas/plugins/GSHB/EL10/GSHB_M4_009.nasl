...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.009
#
# Authors:
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-10/M4_009/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-10/M4_009/desc", value:"Leider setzen Sie einen zu alte OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-10/M4_009/name", value:name);
...
set_kb_item(name:"GSHB-10/M4_009/result", value:result);
set_kb_item(name:"GSHB-10/M4_009/desc", value:desc);
set_kb_item(name:"GSHB-10/M4_009/name", value:name);
