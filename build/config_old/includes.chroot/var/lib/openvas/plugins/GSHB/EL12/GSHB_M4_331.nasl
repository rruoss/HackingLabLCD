...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.331
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_331/result", value:result);
set_kb_item(name:"GSHB-12/M4_331/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_331/name", value:name);
