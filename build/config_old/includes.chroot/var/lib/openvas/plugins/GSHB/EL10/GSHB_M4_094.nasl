...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.094
#
# Authors:
...
if(brokenwww == "1"){
  ...
  result = string("Fehler");
  desc = string("Beim Testen des Systems trat ein Fehler auf, es konnte von Nikto kein Ergebniss ermittelt werden!");
}else if(nikto == "none" && !brockenwww){
    result = string("erf¸llt");
    desc = string('Nikto konnte keinen in der -Open Source Vulnerability Database-, aufgef¸hrten Fehler finden.');
}else if(nikto != "none" && !brockenwww){
    result = string("nicht erf¸llt");
    desc = string('Nikto hat folgende in der -Open Source Vulnerability Database-, aufgef¸hrten Fehler gefunden:\n' + nikto);
} 
