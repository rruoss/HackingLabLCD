...
tag_summary = "This plugin uses ssh to Read /etc/fstab and search for Volumes with reiserfs.";
...
if(description)
{
  ...
  script_summary("Read /etc/fstab and search for Volumes with reiserfs");
