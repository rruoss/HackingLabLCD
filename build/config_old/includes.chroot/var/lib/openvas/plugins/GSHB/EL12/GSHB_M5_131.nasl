...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.131
#
# Authors:
...
for(i=0; i<max_index(SNMPCommunitiesSP); i++)
{
  ...
  {
    DefCom = "true";
    set_kb_item(name:"GSHB-12/M5_131/DefCom" + i, value:DefCom);

    set_kb_item(name:"GSHB-12/M5_131/ExistComm" + i, value:ExistComm);
  }
  else DefCom = "false";
...
set_kb_item(name:"GSHB-12/M5_131/result", value:result);
set_kb_item(name:"GSHB-12/M5_131/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_131/name", value:name);
