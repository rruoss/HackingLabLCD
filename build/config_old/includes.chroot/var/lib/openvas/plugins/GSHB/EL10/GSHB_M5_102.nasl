...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 5.102
#
# Authors:
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  desc = string("Auf dem System wurde kein URL-Filter installiert. Evtl. setzen Sie einen Filter ein, der nicht ¸berpr¸ft wird.");
}
