...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.190
#
# Authors:
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  desc = string("Auf dem System l‰uft Samba, es ist kein Microsoft System.");
    ...
    desc = string("Entfernen der RDS-Unterst¸tzung des IIS ist richtig konfiguriert!");
} else {
  if(GSHB_4_190_1 >< "off"){
                 GSHB_4_190_1_desc = string ("Entfernen der RDS-Unterst¸tzung (RDSServer.DataFactory) des IIS ist richtig konfiguriert! \n");
      }else{
                 GSHB_4_190_1_desc = string ("Entfernen der RDS-Unterst¸tzung (RDSServer.DataFactory) des IIS ist NICHT richtig konfiguriert! \n");
     }
        if(GSHB_4_190_2 >< "off"){
                 GSHB_4_190_2_desc = string ("Entfernen der RDS-Unterst¸tzung (AdvancedDataFactory) des IIS ist richtig konfiguriert! \n");
            }else{
                 GSHB_4_190_2_desc = string ("Entfernen der RDS-Unterst¸tzung (AdvancedDataFactory) des IIS ist NICHT richtig konfiguriert! \n");
                 }
        if(GSHB_4_190_3 >< "off"){
                 GSHB_4_190_3_desc = string ("Entfernen der RDS-Unterst¸tzung (VbBusObj.VbBusObjCls) des IIS ist richtig konfiguriert! \n");
            }else{
                 GSHB_4_190_3_desc = string ("Entfernen der RDS-Unterst¸tzung (VbBusObj.VbBusObjCls) des IIS ist NICHT richtig konfiguriert! \n");
                 }
