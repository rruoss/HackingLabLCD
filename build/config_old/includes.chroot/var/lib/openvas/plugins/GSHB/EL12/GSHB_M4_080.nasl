...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.080
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_080/result", value:result);
set_kb_item(name:"GSHB-12/M4_080/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_080/name", value:name);
