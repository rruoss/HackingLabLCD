...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.016
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"Mon Feb 08 10:22:28 2010 +0100");
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-11/M4_016/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_016/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_016/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_016/result", value:result);
set_kb_item(name:"GSHB-11/M4_016/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_016/name", value:name);
