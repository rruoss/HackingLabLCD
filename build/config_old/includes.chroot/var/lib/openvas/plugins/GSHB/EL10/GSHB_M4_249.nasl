...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.249
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.249: Windows XP Systeme aktuell halten.
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  result = string("Fehler");
  desc = string('wsusscn2.cab und/oder wuredist.cab konnte von wget nicht herruntergeladen werden.\n ‹berpr¸fen Sie ggf. im winslad Pluginverzeichnis mbsa, die runmbsa.bat,\n ob ggf. die Proxyeinstellungen konfiguriert oder angepasst werden m¸ssen.');
  ...
  result = string("Fehler");
  desc = string('Sie haben nicht gen¸gend Rechte auf dem System. Das Problem taucht in der Regel unter Windows Vista und Windows 7, bei aktiviertem UAC auf') + MBSAUPDATE;
  ...
  result = string("Fehler");
  desc = string('Sie haben nicht gen¸gend Rechte auf dem System. Das Problem taucht unter Windows Vista und Windows 7, bei aktiviertem UAC auf');;
