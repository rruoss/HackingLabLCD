...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.036
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_036/result", value:result);
set_kb_item(name:"GSHB-12/M4_036/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_036/name", value:name);
