...
tag_summary = "Test System if cryptsetup is installed and the SWAP Partition encrypted.";
...
if(description)
{
  ...
  script_summary("Test System if cryptsetup is installed and the SWAP Partition encrypted");
