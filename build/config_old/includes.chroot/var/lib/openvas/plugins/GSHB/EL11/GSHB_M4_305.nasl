...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.305
#
# Authors:
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-11/M4_305/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_305/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_305/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_305/result", value:result);
set_kb_item(name:"GSHB-11/M4_305/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_305/name", value:name);
