...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.096
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_096/result", value:result);
set_kb_item(name:"GSHB-12/M4_096/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_096/name", value:name);
