...
if(description)
{
  ...
  script_summary("Read /etc/inittab, /etc/init/rcS.conf and /etc/event.d/rcS-sulogin");
...
if(rcSconf >!< "none" && rcSconf >!< "noperm"){
  ...
  else if((rcSconfright == "" && rcSconfwrong == "") || (rcSconfright != "" && rcSconfwrong != "")) rcSconf = "unknow:" + rcSconfright + rcSconfwrong;
}
...
if(rcSsulogin >!< "none" && rcSsulogin >!< "noperm"){
  ...
  else if((rcSsuloginright == "" && rcSsuloginwrong == "") || (rcSsuloginright != "" && rcSsuloginwrong != "")) rcSsulogin = "unknow:" + rcSsuloginright + ":" + rcSsuloginwrong;
}
