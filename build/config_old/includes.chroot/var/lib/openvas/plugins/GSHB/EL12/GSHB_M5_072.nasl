...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.072
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_072/result", value:result);
set_kb_item(name:"GSHB-12/M5_072/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_072/name", value:name);
