...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.066
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_066/result", value:result);
set_kb_item(name:"GSHB-12/M5_066/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_066/name", value:name);
