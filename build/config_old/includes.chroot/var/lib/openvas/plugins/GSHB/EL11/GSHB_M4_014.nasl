...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.014
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"Thu Mar 18 11:06:19 2010 +0100");
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_014/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_014/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_014/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_014/result", value:result);
set_kb_item(name:"GSHB-11/M4_014/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_014/name", value:name);
