...
# $Id: GSHB_WMI_PolSecSet.nasl 9 2013-10-27 09:38:41Z jan $
#
...
tag_summary = "The script read all Windows Policy Security Settings.";
...
if(description)
{
  ...
  script_name("Read all Windows Policy Security Settings (Win)");
  desc = "
  Summary:
  " + tag_summary;

  script_description(desc);
  script_summary("Read all Windows Policy Security Settings (Win)");
