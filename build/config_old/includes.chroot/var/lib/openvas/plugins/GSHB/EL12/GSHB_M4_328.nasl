...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.328
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_328/result", value:result);
set_kb_item(name:"GSHB-12/M4_328/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_328/name", value:name);
