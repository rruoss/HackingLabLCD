...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.033
#
# Authors:
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  desc = string("Das System ist ein Windows XP System kleiner oder gleich Service Pack 1 und kann nicht getestet werden");
    ...
    if ("True" >< AntivirEnable[2] && "True" >< AntivirUptoDate[2]){
      ...
      desc = string("Das System hat einen Virenscanner installiert, welcher l‰uft und aktuelle ist");
    }else if ("True" >< AntivirEnable[2] && "False" >< AntivirUptoDate[2]){
      result = string("nicht erf¸llt");
      desc = string("Das System hat einen Virenscanner istalliert, welcher l‰uft aber veraltet ist");
    ...
    if ("266240" >< AntivirState[2]){
      ...
      result = string("nicht erf¸llt");
      desc = string("Das System hat einen Virenscanner installiert, welcher l‰uft aber veraltet ist");
