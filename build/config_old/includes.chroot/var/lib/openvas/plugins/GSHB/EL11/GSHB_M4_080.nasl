...
# $Id: GSHB_M4_080.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.080
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.080: Sichere Zugriffsmechanismen bei Fernadministration (Win).
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_080/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_080/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_080/name", value:name);
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  if (FTP == 1)desc = desc + string('Auf dem System l‰uft ein FTP-Server.\n‹berpr¸fen Sie bitte ob dies notwendig ist.\n');
  if (community)desc = desc + string('Auf dem System existieren folgende standardm‰ﬂig\nvoreingestellten Community-Namen:\n' + SNMPHOLE);
}

set_kb_item(name:"GSHB-11/M4_080/result", value:result);
set_kb_item(name:"GSHB-11/M4_080/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_080/name", value:name);
