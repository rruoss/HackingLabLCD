...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.018
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_018/result", value:result);
set_kb_item(name:"GSHB-12/M4_018/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_018/name", value:name);
