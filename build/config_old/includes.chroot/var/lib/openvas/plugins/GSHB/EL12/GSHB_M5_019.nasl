...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.019
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_019/result", value:result);
set_kb_item(name:"GSHB-12/M5_019/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_019/name", value:name);
