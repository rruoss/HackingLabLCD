...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 5.105
#
# Authors:
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  if ("None" >< Backlog) desc = desc + string("Einstellen der zunehmenden Verbindungsblˆcke (INCREASING CONNECTION BLOCK INCREMENT) wurde nicht korrekt konfiguriert" + '\n');
  if ("None" >< MaxCon) desc = desc + string("Einstellen der maximalen Verbindungsblˆcke (MAXIMUM CONNECTION BLOCKS) wurde nicht korrekt konfiguriert" + '\n');
