...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.098
#
# Authors:
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  if (IPFilter == "True"){
    result = string("erf¸llt");
    desc = string("Auf dem System ist die Windows Firewall f¸r folgende Netzwerkkarte aktiviert: " + NWCard);
    }else{
  ...
  if (STD == "off" && PUB == "off"){
    ...
    result = string("unvollst‰ndig");
    desc = string("Auf dem System ist die Windows Firewall nur f¸r -÷ffentliche Netzwerke- aktiviert.\nSie sollten Die Windows Firewall f¸r s‰mtliche Netzwerke Aktivieren");  
  }else if (STD == "1" && PUB == "off"){
    result = string("unvollst‰ndig");
    desc = string("Auf dem System ist die Windows Firewall nur f¸r -Private- / Arbeitsplatz Netzwerke- aktiviert.\nSie sollten Die Windows Firewall f¸r s‰mtliche Netzwerke Aktivieren");  
  }
