...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.135
#
# Authors:
...
OSTNAME = get_kb_item("WMI/WMI_NAME");
...
##########################################
  ...
  else if(OSVER > '5.0' && OSVER < '6.0' && OSTYPE != 2)
  {
    ...
    if (ROOTSDDL == "O:BAG:SYD:(A;OICI;0x001f01ff;;;BA)(A;OICI;0x001f01ff;;;SY)(A;OICIIO;GA;;;CO)(A;OICI;0x001200a9;;;S-1-5-32-545)(A;CI;LC;;;S-1-5-32-545)(A;CIIO;DC;;;S-1-5-32-545)(A;;0x001200a9;;;WD)" && WINSDDL == "O:BAG:SYD:PAI(A;;0x001200a9;;;S-1-5-32-545)(A;OICIIO;GRGX;;;S-1-5-32-545)(A;;0x001301bf;;;S-1-5-32-547)(A;OICIIO;SDGRGWGX;;;S-1-5-32-547)(A;;0x001f01ff;;;BA)(A;OICIIO;GA;;;BA)(A;;0x001f01ff;;;SY)(A;OICIIO;GA;;;SY)(A;;0x001f01ff;;;BA)(A;OICIIO;GA;;;CO)"){
      ...
      desc = string('F¸r das Systemlaufwerk und f¸r das Windows Verzeichnis sind die default Sicherheitseinstellungen hinterlegt.\n Bitte ¸berpr¸fen Sie die Sicherheitseinstellungen und passen sie diese ggf. an.' + '\nRechte Systemlaufwerk:\n' + DEFINITION + '\n' + ROOTFULLACE + '\nRechte Windows Verzeichnis:\n' + DEFINITION + '\n' + WINFULLACE);

    }else if(ROOTSDDL != "O:BAG:SYD:(A;OICI;0x001f01ff;;;BA)(A;OICI;0x001f01ff;;;SY)(A;OICIIO;GA;;;CO)(A;OICI;0x001200a9;;;S-1-5-32-545)(A;CI;LC;;;S-1-5-32-545)(A;CIIO;DC;;;S-1-5-32-545)(A;;0x001200a9;;;WD)" && WINSDDL == "O:BAG:SYD:PAI(A;;0x001200a9;;;S-1-5-32-545)(A;OICIIO;GRGX;;;S-1-5-32-545)(A;;0x001301bf;;;S-1-5-32-547)(A;OICIIO;SDGRGWGX;;;S-1-5-32-547)(A;;0x001f01ff;;;BA)(A;OICIIO;GA;;;BA)(A;;0x001f01ff;;;SY)(A;OICIIO;GA;;;SY)(A;;0x001f01ff;;;BA)(A;OICIIO;GA;;;CO)"){

      result = string("unvollst‰ndig");
      desc = string('F¸r das Windows Verzeichnis sind die default Sicherheitseinstellungen hinterlegt.\n Die Sicherheitseinstellungen f¸r das Systemlaufwerk wurden ge‰ndert.\n Bitte ¸berpr¸fen Sie die Sicherheitseinstellungen und passen sie diese ggf. an.' + '\nRechte Systemlaufwerk:\n' + DEFINITION + '\n' + ROOTFULLACE + '\nRechte Windows Verzeichnis:\n' + DEFINITION + '\n' + WINFULLACE);

    }else if(ROOTSDDL == "O:BAG:SYD:(A;OICI;0x001f01ff;;;BA)(A;OICI;0x001f01ff;;;SY)(A;OICIIO;GA;;;CO)(A;OICI;0x001200a9;;;S-1-5-32-545)(A;CI;LC;;;S-1-5-32-545)(A;CIIO;DC;;;S-1-5-32-545)(A;;0x001200a9;;;WD)" && WINSDDL != "O:BAG:SYD:PAI(A;;0x001200a9;;;S-1-5-32-545)(A;OICIIO;GRGX;;;S-1-5-32-545)(A;;0x001301bf;;;S-1-5-32-547)(A;OICIIO;SDGRGWGX;;;S-1-5-32-547)(A;;0x001f01ff;;;BA)(A;OICIIO;GA;;;BA)(A;;0x001f01ff;;;SY)(A;OICIIO;GA;;;SY)(A;;0x001f01ff;;;BA)(A;OICIIO;GA;;;CO)"){

      result = string("unvollst‰ndig");
      desc = string('F¸r das Systemlaufwerk sind die default Sicherheitseinstellungen hinterlegt.\n Die Sicherheitseinstellungen f¸r das Windows Verzeichnis wurden ge‰ndert.\n Bitte ¸berpr¸fen Sie die Sicherheitseinstellungen und passen sie diese ggf. an.' + '\nRechte Systemlaufwerk:\n' + DEFINITION + '\n' + ROOTFULLACE + '\nRechte Windows Verzeichnis:\n' + DEFINITION + '\n' + WINFULLACE);
    }else{

      result = string("unvollst‰ndig");
      desc = string('F¸r das Systemlaufwerk und Windows Verzeichnis wurden die Sicherheitseinstellungen ge‰ndert.\n Sie entsprechen nicht mehr den default Einstellungen.\n Bitte ¸berpr¸fen Sie die Sicherheitseinstellungen und passen sie diese ggf. an.' + '\nRechte Systemlaufwerk:\n' + DEFINITION + '\n' + ROOTFULLACE + '\nRechte Windows Verzeichnis:\n' + DEFINITION + '\n' + WINFULLACE);
    }
  }
  ...
  if(Writeperm >< "error"){
    result = string("Fehler");
    if (!Writepermlog)desc = string('Beim Testen des Systems trat ein unbekannter Fehler auf, siehe Log Message!');
    if (Writepermlog)desc = string('Beim Testen des Systems trat ein Fehler auf:\n' + log);
  }else if(Writeperm >< "none"){
    result = string("erf¸llt");
    desc = string('Es wurden, ausgenommen von /home/* und /tmp/*, keine Verzeichnisse mit Schreibrecht f¸r User gefunden.');
  }else if(Writeperm >< "windows") {
    result = string("Fehler");
    if (OSNAME >!< "none" && OSNAME >!< "error") desc = string('Das System ist ein ' + OSNAME + ' System\n. Allerdings konnten die Sicherheitseinstellungen der Verzeichnisse nicht gelesesen werden. Folgende Fehler sind aufgetreten: \n' + log);
    else desc = string('Das System scheint ein Windows System zu sein.\n Allerdings konnten die Sicherheitseinstellungen der Verzeichnisse nicht gelesesen werden. Folgende Fehler sind aufgetreten: \n' + log);
  }else if(Writeperm >< "nofind") {
    result = string("Fehler");
    desc = string('Beim Testen des Systems, wurde der Befehl -find- nicht gefunden.');
  }else{
    result = string("nicht erf¸llt");
    desc = string('Es wurden, ausgenommen von /home/* und /tmp/*, folgende Verzeichnisse mit Schreibrecht f¸r User gefunden:\n' + Writeperm);
  }
