...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.057
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_057/result", value:result);
set_kb_item(name:"GSHB-12/M4_057/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_057/name", value:name);
