...
# $Id: GSHB_M4_285.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.285
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.285: Deinstallation nicht benˆtigter Client-Funktionen von Windows Server 2003 (Win).
...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.285: Deinstallation nicht benˆtigter Client-Funktionen von Windows Server 2003 (Win)");
  if (! OPENVAS_VERSION)
  {
    desc = "
    ...
    script_summary("IT-Grundschutz M4.285: Deinstallation nicht benˆtigter Client-Funktionen von Windows Server 2003 (Win).");
...
name = 'IT-Grundschutz M4.285: Deinstallation nicht benˆtigter Client-Funktionen von Windows Server 2003 (Win)\n';

if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_285/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_285/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_285/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_285/result", value:result);
set_kb_item(name:"GSHB-11/M4_285/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_285/name", value:name);
