...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.049
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_049/result", value:result);
set_kb_item(name:"GSHB-12/M4_049/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_049/name", value:name);
