...
# $Id: GSHB_WMI_ProtectedMode.nasl 9 2013-10-27 09:38:41Z jan $
#
...
if(description)
{
  ...
  script_name("Checks InternetExplorer Policy for Protected Mode over WMI (Win)");
  desc = "
  Summary:
  " + tag_summary;

  script_description(desc);
  script_summary("Read the config of the User Account Control feature over WMI. (Win)");
