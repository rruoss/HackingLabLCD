...
# $Id: GSHB_WMI_EventLogPolSet.nasl 9 2013-10-27 09:38:41Z jan $
#
...
if(description)
{
  ...
  script_name("Read all EventLog Config Policy(ELCP) Settings (Win)");
  desc = "
  Summary:
  " + tag_summary;

  script_description(desc);
  script_summary("Read all EventLog Config Policy(ELCP) Settings (Win)");
