...
tag_summary = "This plugin uses ssh to Check if X11 tunnel in sshd_config is enabled, list 'xhost' rights.";
...
if(description)
{
  ...
  script_summary("Check if X11 tunnel in sshd_config is enabled, list 'xhost' rights");
