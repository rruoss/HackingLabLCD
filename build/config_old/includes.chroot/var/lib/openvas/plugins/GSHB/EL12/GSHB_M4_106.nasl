...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.106
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_106/result", value:result);
set_kb_item(name:"GSHB-12/M4_106/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_106/name", value:name);
