...
# $Id: GSHB-12.nasl 9 2013-10-27 09:38:41Z jan $
#
...
massnahmen = make_list("M4_001", "M4_002", "M4_003", "M4_004", "M4_005",
 ...
 "M4_366", "M4_367", "M4_368", "M4_369", "M4_370", "M5_001", "M5_002", "M5_003",
 "M5_004", "M5_005", "M5_006", "M5_007", "M5_008", "M5_009", "M5_010", "M5_011",
 ...
 "M5_153", "M5_154", "M5_155", "M5_156", "M5_157", "M5_158", "M5_159", "M5_160",
 "M5_160", "M5_161", "M5_162", "M5_163", "M5_164");
...
#Vorläufig entfernt#
#  "M4_347", "M4_350", "M4_351", "M4_352", "M4_360", "M4_366"
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2011-11-09 15:38:53 +0100 (Fri, 09 Dec 2011)");
...
M4.108 Vereinfachtes und sicheres Netzmanagement mit DNS Services\n                unter Novell NetWare 4.11
...
M4.121 Konfiguration der Zugriffsrechte auf das Namens- und Adressbuch\n                von Lotus Notes
...
M4.124 Konfiguration der Authentisierungsmechanismen beim Browser-\n                Zugriff auf Lotus Notes
M4.125 Einrichten von Zugriffsbeschränkungen beim Browser-Zugriff auf\n                Lotus Notes Datenbanken
...
M4.336 Aktivierung von Windows Vista Clients aus einem\n                Volumenlizenzvertrag
M4.337 Einsatz von BitLocker Drive Encryption
M4.338 Einsatz von Windows Vista File und Registry Virtualization
...
M4.361 Sichere Konfiguration von Webanwendungen
...
M5.086 Einsatz von Verschlüsselungsverfahren beim Browser-Zugriff auf\n                Lotus Notes
...
M5.100 Einsatz von Verschlüsselungs- und Signaturverfahren für die\n                Exchange 2000 Kommunikation
...
M5.129 Sichere Konfiguration der HTTP-basierten Dienste von\n                SAP Systemen
...
M5.153 Planung des Netzes fr virtuelle Infrastrukturen
M5.154 Sichere Konfiguration eines Netzes fr virtuelle Infrastrukturen
...
M5.159 Übersicht ber Protokolle und Kommunikationsstandards für\n                Webserver
...
M5.164 Sichere Nutzung eines Terminalservers aus einem entfernten Netz

";

report = 'Prüfergebnisse gemäß IT-Grundschutz, 12. Ergänzungslieferung:\n\n\n';
log = string('');

foreach m (massnahmen) {
  result = get_kb_item("GSHB-12/" + m + "/result");
  desc = get_kb_item("GSHB-12/" + m + "/desc");
  name = get_kb_item("GSHB-12/" + m + "/name");
  mn = substr(m, 0, 1);
  mz = substr(m, 3);
