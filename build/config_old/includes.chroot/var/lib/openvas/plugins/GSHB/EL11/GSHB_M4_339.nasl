...
# $Id: GSHB_M4_339.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.339
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.339: Verhindern unautorisierter Nutzung von Wechselmedien unter Windows Vista (Win)
  ...
  http://www.bsi.bund.de/grundschutz/kataloge/m/m04/m04339.html";
...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.339: Verhindern unautorisierter Nutzung von Wechselmedien unter Windows Vista (Win)");
  if (! OPENVAS_VERSION)
  {
    desc = "
    ...
    script_summary("IT-Grundschutz M4.339: Verhindern unautorisierter Nutzung von Wechselmedien unter Windows Vista (Win)");
...
name = 'IT-Grundschutz M4.339: Verhindern unautorisierter Nutzung von Wechselmedien unter Windows Vista (Win)\n';

if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_339/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_339/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_339/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_339/result", value:result);
set_kb_item(name:"GSHB-11/M4_339/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_339/name", value:name);
