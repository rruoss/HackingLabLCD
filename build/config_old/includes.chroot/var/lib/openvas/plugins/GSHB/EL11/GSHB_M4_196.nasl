...
# $Id: GSHB_M4_196.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.196
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.196: Sicherer Betrieb eines Apache-Webservers (Win).
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_196/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_196/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_196/name", value:name);
...
log = get_kb_item("WMI/Apache/log");
...
else
{
   ...
   if (ER404F >< "FALSE" && ER403F >< "FALSE")
   {
     ...
     desc = string("In keinem der Custom-Logfiles wurde 403er oder 404er\nFehler gefunden.");
   }
   else
   {
     result = string("nicht erf¸llt");
     desc = string('In folgenden Custom-Logfiles wurden Fehler gefunden:\n') + ER404F + '\n' + ER403F;
   }
}


set_kb_item(name:"GSHB-11/M4_196/result", value:result);
set_kb_item(name:"GSHB-11/M4_196/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_196/name", value:name);
