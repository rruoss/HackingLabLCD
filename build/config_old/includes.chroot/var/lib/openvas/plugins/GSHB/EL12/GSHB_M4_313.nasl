...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.313
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_313/result", value:result);
set_kb_item(name:"GSHB-12/M4_313/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_313/name", value:name);
