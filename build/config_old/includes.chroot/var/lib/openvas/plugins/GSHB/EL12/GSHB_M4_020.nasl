...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.020
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_020/result", value:result);
set_kb_item(name:"GSHB-12/M4_020/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_020/name", value:name);
