...
# $Id: gb_SolarWinds_TFTP_40333.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "SolarWinds TFTP Server is prone to a denial-of-service
vulnerability.

A successful exploit can allow attackers to crash the server process,
resulting in a denial-of-service condition.

SolarWinds TFTP Server 10.4.0.10 is vulnerable; other versions may
also be affected.";
