...
# $Id: secpod_aphpkb_detect.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "The script detects the version of Andy's PHP Knowledgebase on
...
if(description)
{
 ...
 script_version("$Revision: 13 $");
  ...
  script_summary("Check for Andy's PHP Knowledgebase version");
...
foreach dir (make_list("/aphpkb","/kb",cgi_dirs()))
{
  ...
  if(">Andy's PHP Knowledgebase" >< rcvRes)
  {
