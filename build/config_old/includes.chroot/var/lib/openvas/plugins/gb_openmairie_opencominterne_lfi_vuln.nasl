...
# $Id: gb_openmairie_opencominterne_lfi_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "OpenMairie openComInterne version 1.01 and prior";
...
tag_solution = "No solution or patch is available as of 20th May, 2010. Information
  ...
  For updates refer tohttp://adullact.net/frs/?group_id=349";
tag_summary = "This host is running openMairie openComInterne and is prone to
...
if(description)
{
  ...
  script_summary("Check for the exploit string on OpenMairie openComInterne");
