...
tag_insight = "It was discovered that the DHCP server incorrectly handled certain
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1309-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-December/001527.html");
  script_id(840837);
