...
tag_insight = "Chris Evans discovered that libvpx did not properly perform bounds
  checking. If an application using libvpx opened a specially crafted WebM
  file, an attacker could cause a denial of service.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1087-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001276.html");
  script_id(840612);
