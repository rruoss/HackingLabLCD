...
tag_insight = "Multiple vulnerabilities were found in VirtualBox, allowing local
    attackers to gain escalated privileges.";
tag_solution = "All VirtualBox users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201204-01
http://bugs.gentoo.org/show_bug.cgi?id=386317
http://bugs.gentoo.org/show_bug.cgi?id=399807";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201204-01 (virtualbox)");
