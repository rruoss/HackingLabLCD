...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-June/001352.html");
  script_id(840682);
  ...
  script_summary("Check for the Version of nagios3");
