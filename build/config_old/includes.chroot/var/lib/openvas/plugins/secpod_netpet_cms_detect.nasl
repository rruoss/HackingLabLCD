...
# $Id: secpod_netpet_cms_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the running Netpet CMS version and
...
foreach path (make_list("/", "/netpet", "/netpet/netpet", cgi_dirs()))
{
  sndReq = http_get(item:string(path, "/index.php"), port:netPort);
  rcvRes = http_send_recv(port:netPort, data:sndReq);
  if("Netpet Content Management System" >< rcvRes)
  {
