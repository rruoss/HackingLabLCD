...
# $Id: esoft_slk_ssa_2005_242_02.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2005-242-02";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2005-242-02 PHP ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2005-242-02 PHP");
...
vuln = 0;
if(isslkpkgvuln(pkg:"php", ver:"4.3.11-i386-4", rls:"SLK8.1")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"php", ver:"4.3.11-i386-4", rls:"SLK9.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"php", ver:"4.3.11-i486-4", rls:"SLK9.1")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"php", ver:"4.3.11-i486-3", rls:"SLK10.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"php", ver:"4.3.11-i486-3", rls:"SLK10.1")) {
    vuln = 1;
}
