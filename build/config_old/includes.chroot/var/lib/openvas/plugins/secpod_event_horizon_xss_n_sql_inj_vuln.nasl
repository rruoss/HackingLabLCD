...
# $Id: secpod_event_horizon_xss_n_sql_inj_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(description)
{
  ...
  script_summary("Check Event Horizon is vulnerable to XSS and SQL injection attacks");
