...
# $Id: deb_2480_2.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "It was discovered that the recent request-tracker3.8 update,
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202480-2";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2480-2 (request-tracker3.8)");
