...
# $Id: gb_cogent_datahub_unicode_bof_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to a stack based unicode buffer overflow error in the
...
tag_summary = "The host is running Cogent DataHub and is prone to buffer overflow
  vulnerability.";
