...
# $Id: secpod_tightvnc_mult_int_overflow_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if(description)
{
  ...
  script_name("TightVNC ClientConnection Multiple Integer Overflow Vulnerabilities (Win)");
  desc = "
