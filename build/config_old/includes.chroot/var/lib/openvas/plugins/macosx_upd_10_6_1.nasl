...
if(description)
{
 ...
 script_summary("Checks for existence of Mac OS X 10.6.1 Update");
...
if (osx_rls_name(rls:ssh_osx_rls) == osx_rls_name(rls:"Mac OS X 10.6")) {
    if (version_is_less(version:osx_ver(ver:ssh_osx_rls), test_version:"10.6.1")) { security_hole(0); exit(0); }
}
