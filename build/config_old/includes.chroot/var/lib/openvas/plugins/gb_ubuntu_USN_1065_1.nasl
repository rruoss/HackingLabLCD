...
tag_insight = "Kees Cook discovered that some shadow utilities did not correctly validate
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1065-1";
tag_affected = "shadow vulnerability on Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-February/001249.html");
  script_id(840588);
  ...
  script_summary("Check for the Version of shadow vulnerability");
