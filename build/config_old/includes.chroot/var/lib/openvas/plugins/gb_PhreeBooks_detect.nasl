...
# $Id: gb_PhreeBooks_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of PhreeBooks");
...
dirs = make_list("/phreeBooks","/phreebooks","/pb",cgi_dirs());
