...
# $Id: deb_2445_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202445-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2445-1 (typo3-src)");
...
if((res = isdpkgvuln(pkg:"typo3", ver:"4.5.15+dfsg1-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"typo3-database", ver:"4.5.15+dfsg1-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"typo3-dummy", ver:"4.5.15+dfsg1-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"typo3-src-4.5", ver:"4.5.15+dfsg1-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
