...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-September/000746.html");
  script_id(840260);
  ...
  script_summary("Check for the Version of ipsec-tools vulnerabilities");
