...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-November/000625.html");
  script_id(840103);
  ...
  script_summary("Check for the Version of samba vulnerabilities");
