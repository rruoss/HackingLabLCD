...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-March/000503.html");
  script_id(840054);
  ...
  script_summary("Check for the Version of gnupg2, gpgme1.0 vulnerability");
