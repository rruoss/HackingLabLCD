...
# $Id: secpod_tcp_sequence_approx_dos_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
closed it or not.";
  ...
  script_xref(name : "URL" , value : "http://www.osvdb.org/4030");
...
## Get acknowledgement number and tcp flags
...
if(res)
{
  ## Get the flag and confirm the vulnerability
  flags = get_tcp_element(tcp:res, element:"th_flags");
