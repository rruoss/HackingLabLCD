...
tag_insight = "David Black discovered that Software Properties incorrectly validated
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1352-1";
tag_affected = "software-properties on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001572.html");
  script_id(840880);
  ...
  script_summary("Check for the Version of software-properties");
