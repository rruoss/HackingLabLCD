...
# $Id: secpod_ms10-001.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "An integer overflow error in the LZCOMP decompressor within the Embeded
...
if(sysPath)
{
  dllVer = get_file_version(sysPath, file_name:"Fontsub.dll");
  if(!dllVer){
     exit(0);
  }
}
