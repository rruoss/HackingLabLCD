...
# $Id: gb_vmware_prdts_vmx_info_disc_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# VMware Products 'vmware-vmx' Information Disclosure Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("VMware Products 'vmware-vmx' Information Disclosure Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
