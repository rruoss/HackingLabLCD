...
# $Id: gb_a_v_tronics_inetserv_pop3_dos_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation will allow remote attackers to crash the service.
  Impact Level: Application";
tag_affected = "Inetserv POP3 version 3.23. Other versions may also be affected.";
tag_insight = "The flaw is due to the way server handles certain specially crafted
  commands which allows remote attackers to cause a denial of service
  condition.";
tag_solution = "No solution or patch is available as of 19th January 2011. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.avtronics.net/inetserv.php";
tag_summary = "This host is running A-V Tronics InetServ POP3  Server and is prone
