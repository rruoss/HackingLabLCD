...
tag_insight = "Multiple vulnerabilities have been found in Wicd, the worst of
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-08
http://bugs.gentoo.org/show_bug.cgi?id=401005
http://bugs.gentoo.org/show_bug.cgi?id=411729";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-08 (wicd)");
