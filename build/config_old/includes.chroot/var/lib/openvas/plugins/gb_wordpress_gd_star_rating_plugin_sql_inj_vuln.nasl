...
# $Id: gb_wordpress_gd_star_rating_plugin_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is caused by improper validation of user-supplied input passed via
  the 'votes' parameter to /wp-content/plugins/gd-star-rating/ajax.php, which
