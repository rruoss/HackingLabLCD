...
# $Id: gb_wordpress_user_id_and_user_name_disclosure.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if WordPress is prone to User IDs and User Names Disclosure");
