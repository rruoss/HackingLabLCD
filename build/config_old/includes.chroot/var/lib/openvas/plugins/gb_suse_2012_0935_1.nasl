...
tag_insight = "Seamonkey was updated to version 2.11 (bnc#771583)
...
tag_affected = "seamonkey on openSUSE 12.1, openSUSE 11.4";
...
if(description)
{
  script_xref(name : "URL" , value : "http://195.135.221.135/opensuse-security-announce/2012-08/msg00000.html");
  script_id(850240);
  ...
  script_xref(name: "openSUSE-SU", value: "2012:0935_1");
