...
# $Id: secpod_ms11-020.nasl 13 2013-10-27 12:16:33Z jan $
#
...
## Get Version from Srv.sys file
sysVer = fetch_file_version(sysPath, file_name:"system32\drivers\Srv.sys");
if(!sysVer){
  exit(0);
}
...
if(hotfix_check_sp(xp:4) > 0)
{
  ...
  {
    ## Check for Srv.sys version < 5.1.2600.6082
...
else if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  {
    ## Check for Srv.sys version < 5.2.3790.4832
