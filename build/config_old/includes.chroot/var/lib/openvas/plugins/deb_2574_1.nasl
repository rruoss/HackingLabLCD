...
# $Id: deb_2574_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202574-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2574-1 (typo3-src)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"typo3", ver:"4.3.9+dfsg1-1+squeeze6", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"typo3-database", ver:"4.3.9+dfsg1-1+squeeze6", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"typo3-src-4.3", ver:"4.3.9+dfsg1-1+squeeze6", rls:"DEB6.0")) != NULL) {
    report += res;
}
