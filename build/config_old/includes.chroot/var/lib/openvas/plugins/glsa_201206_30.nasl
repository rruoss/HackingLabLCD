...
tag_insight = "An error in the hostname matching in sendmail might enable remote
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-30
http://bugs.gentoo.org/show_bug.cgi?id=299120";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-30 (sendmail)");
