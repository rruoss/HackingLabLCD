...
# $Id: secpod_novell_iprint_client_actvx_mult_vuln_900040.nasl 16 2013-10-27 13:09:52Z jan $
...
if(description)
{
 ...
 script_summary("Check for the vulnerable version of Novell iPrint");
 desc = "
 Summary:
 " + tag_summary + "
