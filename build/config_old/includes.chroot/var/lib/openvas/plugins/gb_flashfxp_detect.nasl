...
# $Id: gb_flashfxp_detect.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Detection of installed version of FlashFXP");
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if("FlashFXP" >< name)
  {
    ...
    if(flashVer)
    {
      ...
      register_product(cpe:cpe, location:flashPath, nvt:SCRIPT_OID);
