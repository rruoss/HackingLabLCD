...
# $Id: nopsec_php_5_2_14.nasl.nasl 110171
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 5.2.14
#
# Authors:
...
tag_summary = "PHP version smaller than 5.2.14 suffers vulnerability.";
if (description)
{
  script_id(110171);
...
script_name("PHP version smaller than 5.2.14");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"5.2.14"))
