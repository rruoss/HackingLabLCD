...
# $Id: gb_mozilla_prdts_mult_code_exec_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# Mozilla Products Multiple vulnerabilities apr-10 (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Mozilla Products Multiple vulnerabilities apr-10 (Win)");
  desc = "
  Summary:
  " + tag_summary + "
