...
# $Id: gb_joomla_com_car_mult_sql_inj_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_insight = "The flaws are due to an input passed via the 'modelsid', 'markid',
  'rand_id', 'cid[]' parameters to 'index.php' is not properly sanitised
...
tag_summary = "This host is running Joomla car component and is prone to multiple
...
if(description)
{
  ...
  script_summary("Check if Joomla Car is vulnerable to SQL injection attack");
