...
# $Id: gb_clamav_mult_vuln_apr09_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "ClamAV before 0.95 on Windows.";
...
tag_solution = "Upgrade to ClamAV 0.95 or later
  http://www.clamav.net";
...
if(description)
{
  ...
  script_name("ClamAV Multiple Vulnerabilities (Win)");
  desc = "
