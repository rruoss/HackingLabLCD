...
tag_insight = "Petr Matousek discovered that libvirt did not always honor read-only
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1094-1";
tag_affected = "libvirt vulnerability on Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001287.html");
  script_id(840620);
  ...
  script_summary("Check for the Version of libvirt vulnerability");
