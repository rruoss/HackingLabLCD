...
# $Id: niteserver_ftp_dir_trav.nasl 17 2013-10-27 14:01:43Z jan $
...
if(description)
{
 ...
 summary = "Attempts to set the current directory to the root of the disk";
...
if (! ftp_authenticate(socket:soc, user: "anonymous", pass: "openvas@openvas.org"))
{
