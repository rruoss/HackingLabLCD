...
# $Id: secpod_ecoder_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "ECoder version 0.4.10 and prior.";
tag_insight = "The flaw is due to an input passed via the 'editor' parameter to the
  'edit.php' script is not   properly sanitised before being returned to the
  user.";
...
tag_summary = "This host is running ECoder and is prone to reflected cross-site
...
if(description)
{
  ...
  script_summary("Check for ECoder Cross Site Scripting Vulnerability");
...
foreach dir (make_list("/ecoder", "/demo", cgi_dirs()))
{
