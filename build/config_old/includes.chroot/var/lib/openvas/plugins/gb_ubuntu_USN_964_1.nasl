...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-July/001132.html");
  script_id(840472);
  ...
  script_summary("Check for the Version of likewise-open vulnerability");
