...
# $Id: gb_adobe_prdts_xss_vuln_win_jun11.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "This host is installed with Adobe Flash Player, Adobe Reader or
  Acrobat and is prone to cross-site scripting vulnerability.";
...
if(description)
{
  ...
  script_summary("Check for the version of Adobe Flash Player, Adobe Reader or Acrobat");
