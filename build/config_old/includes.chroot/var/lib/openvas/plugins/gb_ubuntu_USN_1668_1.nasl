...
tag_insight = "Dan Rosenberg discovered that an application running under an AppArmor
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1668-1";
tag_affected = "apport on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-December/001936.html");
  script_id(841256);
