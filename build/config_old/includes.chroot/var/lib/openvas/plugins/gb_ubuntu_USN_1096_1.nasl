...
tag_insight = "Philip Martin discovered that the Subversion mod_dav_svn module for Apache
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1096-1";
tag_affected = "subversion vulnerability on Ubuntu 6.06 LTS ,
  Ubuntu 8.04 LTS ,
  Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001288.html");
  script_id(840621);
  ...
  script_summary("Check for the Version of subversion vulnerability");
