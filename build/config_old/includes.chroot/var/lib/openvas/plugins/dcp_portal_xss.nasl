...
# $Id: dcp_portal_xss.nasl 17 2013-10-27 14:01:43Z jan $
# Description: DCP-Portal XSS
#
# Authors:
...
tag_summary = "You are running a version of DCP-Portal which is older or equals to v5.3.2
...
if (description)
{
 ...
 script_summary("Check for DCP-Portal XSS flaws");
