...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-April/001086.html");
  script_id(840427);
  ...
  script_summary("Check for the Version of ffmpeg, ffmpeg-debian regression");
