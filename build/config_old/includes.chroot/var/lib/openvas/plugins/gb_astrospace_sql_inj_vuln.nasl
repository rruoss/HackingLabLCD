...
# $Id: gb_astrospace_sql_inj_vuln.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_impact = "Successful attack could lead to application compromise or access
  or modify the data.
  Impact Level: Application";
tag_affected = "AstroSPACES 1.1.1 and prior on all running platform.";
tag_insight = "The flaw is due to input passed to the id parameter in profile.php
  file is not properly sanitised before being used in SQL queries.";
tag_solution = "No solution or patch is available as of 22nd October, 2008. Information
  regarding this issue will updated once the solution details are available.
  For updates refer to http://sourceforge.net/projects/astrospaces/";
tag_summary = "The host is running AstroSPACES, and is prone to SQL Injection
  Vulnerability.";
...
if(description)
{
  ...
  script_summary("Check for the SQL Injection attack on AstroSPACES");
