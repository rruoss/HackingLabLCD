...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-October/001179.html");
  script_id(840517);
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Check for the Version of webkit vulnerabilities");
