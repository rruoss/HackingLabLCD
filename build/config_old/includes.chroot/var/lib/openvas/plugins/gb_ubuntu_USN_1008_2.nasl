...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-October/001186.html");
  script_id(840519);
  ...
  script_summary("Check for the Version of virtinst update");
