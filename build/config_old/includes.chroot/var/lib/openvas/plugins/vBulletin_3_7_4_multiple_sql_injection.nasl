...
# $Id: vBulletin_3_7_4_multiple_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if VBulletin 3.7.4 is running, which is known to be vulnerable to SQL Injection");
