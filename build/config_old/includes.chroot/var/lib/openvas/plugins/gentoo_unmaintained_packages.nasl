...
# $Id: gentoo_unmaintained_packages.nasl 16 2013-10-27 13:09:52Z jan $
...
tag_solution = "Remove or upgrade those packages.";
...
if (description)
{
 ...
 script_summary( 'Find obsolete Gentoo packages that cannot be installed any more');
