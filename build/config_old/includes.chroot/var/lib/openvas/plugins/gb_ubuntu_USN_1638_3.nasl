...
tag_insight = "USN-1638-1 fixed vulnerabilities in Firefox. The new packages introduced
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1638-3";
