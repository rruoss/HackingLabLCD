...
# $Id: secpod_realplayer_mult_code_exec_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# RealNetworks RealPlayer Multiple Code Execution Vulnerabilities (Win)
#
# Authors:
...
tag_affected = "RealPlayer versions before 10.5(6.0.12.1741) and
...
tag_solution = "Upgrade to RealPlayer version 10.5(6.0.12.1741) or 11.0.5
...
if(description)
{
  ...
  script_name("RealNetworks RealPlayer Multiple Code Execution Vulnerabilities (Win)");
  desc = "
  Summary:
  " + tag_summary + "
