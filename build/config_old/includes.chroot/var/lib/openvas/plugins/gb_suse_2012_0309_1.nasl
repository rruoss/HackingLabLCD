...
tag_insight = "java-1_6_0-openjdk was updated to the b24 release, fixing
...
if(description)
{
  script_xref(name : "URL" , value : "http://195.135.221.135/opensuse-security-announce/2012-02/msg00025.html");
  script_id(850255);
  ...
  script_xref(name: "openSUSE-SU", value: "2012:0309_1");
