...
# $Id: gb_phpbugtracker_sql_inj_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "The flaw is due to error in 'index.php', it fails to sufficiently
  sanitize user-supplied data before using it in an SQL query.";
tag_solution = "No solution or patch is available as of 05th June, 2009. Information
  regarding this issue will updated once the solution details are available.
  For updates refer tohttp://phpbt.sourceforge.net/";
