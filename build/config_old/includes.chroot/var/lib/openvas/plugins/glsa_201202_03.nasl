...
tag_insight = "A hash collision vulnerability in MaraDNS allows remote attackers
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201202-03
http://bugs.gentoo.org/show_bug.cgi?id=397431";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201202-03 (maradns)");
