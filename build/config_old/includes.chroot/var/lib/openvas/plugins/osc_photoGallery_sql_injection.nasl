...
# $Id: osc_photoGallery_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will allow the attacker to acces the whole Database.";
...
if (description)
{
 ...
 script_summary("Determine if Photo Gallery for osCommerce is vulnerable to SQL Injection");
