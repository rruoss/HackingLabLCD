...
# $Id: counter.nasl 17 2013-10-27 14:01:43Z jan $
# Description: counter.exe vulnerability
#
# Authors:
...
tag_summary = "The CGI 'counter.exe' exists on this webserver.
...
if(description)
{
 ...
 name = "counter.exe vulnerability";
 script_name(name);
 ...
 summary = "Checks for the counter.exe file";
