...
# $Id: gb_nmap_smbv2_enabled.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to check whether a server is running the SMBv2
  protocol or not.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smbv2-enabled.nse.";
...
if(description)
{
  ...
  script_summary("Checks whether a server is running the SMBv2 protocol");
...
argv = make_list("nmap", "--script=smbv2-enabled.nse", "-p", port,
                  get_host_ip());
