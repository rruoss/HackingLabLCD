...
# $Id: gb_nmap_http_passwd.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to check if a web server is vulnerable to
  directory traversal attack.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) http-passwd.nse.";
...
if(description)
{
  ...
  script_summary("check if a web server is vulnerable to directory traversal");
...
argv = make_list("nmap", "--script=http-passwd.nse", "-p", port,
                  get_host_ip());
