...
# $Id: gb_nmap_citrix_enum_apps_xml.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to extract a list of applications, ACLs, and
  settings from the Citrix XML service.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) citrix-enum-apps-xml.nse.";
...
if(description)
{
  ...
  script_summary("Extracts a list of applications, ACLs, and settings from the Citrix XML service");
...
argv = make_list("nmap", "--script=citrix-enum-apps-xml.nse", "-p", port,
                 get_host_ip());
