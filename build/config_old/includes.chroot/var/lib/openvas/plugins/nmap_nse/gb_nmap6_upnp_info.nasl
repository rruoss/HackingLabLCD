...
# $Id: gb_nmap6_upnp_info.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to extract system information from the UPnP service.
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: upnp-info");
