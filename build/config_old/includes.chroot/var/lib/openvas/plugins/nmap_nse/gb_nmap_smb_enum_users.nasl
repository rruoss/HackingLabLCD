...
# $Id: gb_nmap_smb_enum_users.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to enumerate the users on a remote Windows system,
  with as much information as possible.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smb-enum-users.nse.";
...
if(description)
{
  ...
  script_summary("Enumerate the users on a Windows System");
