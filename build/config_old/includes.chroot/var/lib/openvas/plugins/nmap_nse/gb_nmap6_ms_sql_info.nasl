...
# $Id: gb_nmap6_ms_sql_info.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to determine configuration and version information for Microsoft SQL Server instances.
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: ms-sql-info");
