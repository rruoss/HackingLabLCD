...
# $Id: gb_nmap6_smb_os_discovery.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to determine the operating system, computer name, domain, workgroup, and current time over
...
The following fields may be included in the output, depending on the  cirumstances (e.g. the
workgroup name is mutually exclusive with domain and forest names) and the information available: *
OS * Computer name * Domain name * Forest name * FQDN * NetBIOS computer name * NetBIOS domain name
* Workgroup * System time
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: smb-os-discovery");
