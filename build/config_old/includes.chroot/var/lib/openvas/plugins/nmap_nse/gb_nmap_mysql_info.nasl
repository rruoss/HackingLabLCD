...
# $Id: gb_nmap_mysql_info.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to connect to a MySQL server and extract
  information.
...
if(description)
{
  ...
  script_summary("Get MySQL Information");
