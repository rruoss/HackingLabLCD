...
# $Id: gb_nmap_http_date.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to get the date from HTTP-like services.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) http-date.nse";
...
if(description)
{
  ...
  script_summary("Get the date from HTTP-like services");
