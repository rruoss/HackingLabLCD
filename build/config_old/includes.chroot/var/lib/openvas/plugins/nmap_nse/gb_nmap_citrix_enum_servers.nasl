...
# $Id: gb_nmap_citrix_enum_servers.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to extract a list of Citrix servers from the
  ICA Browser service.
...
if(description)
{
  ...
  script_summary("Extracts a list of Citrix servers from the ICA Browser service");
...
res = pread(cmd: "nmap", argv: make_list("nmap", "-sU", "--script=citrix-enum-servers.nse",
                                         "-p", port, get_host_ip()));
if(res)
{
