...
# $Id: gb_nmap_pjl_ready_message.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to retrieve or set the ready message on
...
if(description)
{
  ...
  script_summary("Retrieves or sets the ready message on printers");
