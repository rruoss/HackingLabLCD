...
# $Id: gb_nmap6_whois.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Queries the WHOIS services of Regional Internet Registries (RIR) and attempts to retrieve
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: whois");
...
argv = make_list("nmap", "--script=whois", "-sn", "-Pn",
                                       get_host_ip());
