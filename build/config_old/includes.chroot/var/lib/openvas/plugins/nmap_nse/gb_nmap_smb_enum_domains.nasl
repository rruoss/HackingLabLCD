...
# $Id: gb_nmap_smb_enum_domains.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to enumerate domains on a Windows system,
  along with their policies.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smb-enum-domains.nse.";
...
argv = make_list("nmap", "--script=smb-enum-domains.nse", "-p", port,
                  get_host_ip());
