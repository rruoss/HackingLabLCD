...
# $Id: gb_nmap_ssl_cert.nasl 10 2013-10-27 10:03:59Z jan $
#
...
if(description)
{
  ...
  script_summary("Retrieve a server's SSL certificate");
...
res = pread(cmd: "nmap", argv: make_list("nmap", "--script=ssl-cert.nse",
                                         "-p", port, get_host_ip()));
if(res)
{
