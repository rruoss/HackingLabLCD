...
# $Id: gb_nmap6_smb_psexec.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Implements remote process execution similar to the Sysinternals' psexec tool,  allowing a user to
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: smb-psexec");
