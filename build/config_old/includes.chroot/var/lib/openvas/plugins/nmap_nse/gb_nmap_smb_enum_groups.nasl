...
# $Id: gb_nmap_smb_enum_groups.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to get a list of groups from a Windows system over
  the SMB protocol.
...
if(description)
{
  ...
  script_summary("Obtains a list of groups from the Windows system");
...
argv = make_list("nmap", "--script=smb-enum-groups.nse", "-p", port,
                  get_host_ip());
