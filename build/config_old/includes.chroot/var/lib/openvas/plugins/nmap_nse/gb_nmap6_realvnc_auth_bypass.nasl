...
# $Id: gb_nmap6_realvnc_auth_bypass.nasl 10 2013-10-27 10:03:59Z jan $
#
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: realvnc-auth-bypass");
...
argv = make_list("nmap", "--script=realvnc-auth-bypass.nse",
                                         "-p", port, get_host_ip());
