...
# $Id: gb_nmap_imap_capabilities.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to retrieve IMAP email server capabilities.
...
res = pread(cmd: "nmap", argv:  make_list("nmap", "-p", port,
                "--script=imap-capabilities.nse", get_host_ip()));
if(res)
{
