...
# $Id: secpod_php_raincheck_sql_injection_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will allow attacker to execute arbitrary SQL queries and
  gain sensitive information.
  Impact Level: Application";
tag_affected = "PHP RAINCHECK 1.0.1 and prior";
...
tag_summary = "This host is running phpRAINCHECK and is prone to SQL injection
  vulnerabilities.";
...
if(description)
{
  ...
  script_summary("Check for the version of phpRAINCHECK");
...
foreach dir (make_list("/", "/rainchecks", "/phprainchecks", cgi_dirs()))
{
  ## Send and Recieve the response
  req = http_get(item:string(dir,"/settings.php"),  port:port);
