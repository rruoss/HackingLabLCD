...
tag_insight = "It was discovered that Eucalyptus did not verify password resets from
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1033-1";
tag_affected = "eucalyptus vulnerability on Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-December/001217.html");
  script_id(840556);
  ...
  script_summary("Check for the Version of eucalyptus vulnerability");
