...
tag_insight = "Andrew Griffiths discovered that QEMU did not correctly drop privileges
  when using the 'runas' argument. Under certain circumstances a local
  attacker could exploit this to escalate privileges.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1177-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-July/001383.html");
  script_id(840711);
