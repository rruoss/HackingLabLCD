...
tag_insight = "Dan Prince discovered that Nova did not properly perform input validation on
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1413-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001648.html");
  script_id(840973);
