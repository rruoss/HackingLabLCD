...
# $Id: dcshop_information_disclosure.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "We detected a vulnerable version of the DCShop CGI. 
...
tag_solution = "1. Rename following directories to something hard to guess:
 - Data
 - User_carts
 - Orders
 - Auth_data
...
if(description)
{
 ...
 summary = "DCShop exposes sensitive files";
