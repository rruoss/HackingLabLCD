...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-January/000465.html");
  script_id(840133);
  ...
  script_summary("Check for the Version of openoffice.org/-amd64, openoffice.org2/-amd64 vulnerability");
