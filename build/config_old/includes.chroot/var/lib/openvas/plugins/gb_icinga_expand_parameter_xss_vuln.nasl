...
# $Id: gb_icinga_expand_parameter_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Icinga versions 1.4.0 and prior.";
tag_insight = "The flaw is caused by improper validation of user-supplied input passed
  via the 'expand' parameter in cgi-bin/config.cgi, which allows attackers
...
tag_summary = "This host is running Icinga and is prone to cross site scripting
  vulnerability.";
