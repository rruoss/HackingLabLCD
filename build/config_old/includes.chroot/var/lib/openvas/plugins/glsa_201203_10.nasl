...
tag_insight = "Multiple buffer overflow vulnerabilities in libmikmod may allow an
    attacker to execute arbitrary code or cause a Denial of Service
condition.";
tag_solution = "All libmikmod 3.2 users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201203-10
http://bugs.gentoo.org/show_bug.cgi?id=335892";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201203-10 (libmikmod)");
