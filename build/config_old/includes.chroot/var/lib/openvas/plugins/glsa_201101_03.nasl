...
tag_insight = "Timothy B. Terriberry discovered that libvpx contains an integer overflow
    vulnerability in the processing of video streams that may allow
    user-assisted execution of arbitrary code.";
tag_solution = "All libvpx users should upgrade to the latest stable version:
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201101-03 (libvpx)");
