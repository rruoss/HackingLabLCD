...
tag_insight = "Ben Hutchings reported a flaw in the kernel's handling of corrupt LDM
  partitions. A local user could exploit this to cause a denial of service or
  escalate privileges.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1392-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001622.html");
  script_id(840925);
