...
# $Id: secpod_imeraieplugin_actvx_ctrl_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_solution = "No solution or patch is available as of 23rd March, 2009. Information
  ...
  For updates refer to http://www.imera.com/index.html
...
if(description)
{
  ...
  script_summary("Check for the Version of ImeraIEPlugin.dll");
