...
tag_insight = "The GPGSM utility included in GnuPG contains a use-after-free
    vulnerability that may allow an unauthenticated remote attacker to
execute
    arbitrary code.";
tag_solution = "All GnuPG 2.x users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=app-crypt/gnupg-2.0.16-r1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201110-15
http://bugs.gentoo.org/show_bug.cgi?id=329583";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201110-15 (GnuPG)");
