...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-December/000793.html");
  script_id(840247);
  ...
  script_summary("Check for the Version of libvorbis vulnerabilities");
