...
# $Id: ibproarcade_sql_injection.nasl 17 2013-10-27 14:01:43Z jan $
# Description: IBProArcade index.php SQL Injection
#
# Authors:
# Ami Chayun
#
...
if(description)
{
 ...
 name = "IBProArcade index.php SQL Injection";
 ...
 summary = "Checks for the presence of an SQL injection in index.php";
