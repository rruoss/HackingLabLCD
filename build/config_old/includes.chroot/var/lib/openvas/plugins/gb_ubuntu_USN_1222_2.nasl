...
tag_insight = "USN-1222-1 fixed vulnerabilities in Firefox. This update provides updated
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1222-2";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-October/001440.html");
  script_id(840767);
