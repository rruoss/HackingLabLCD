...
tag_insight = "Dstat is a versatile replacement for the vmstat, iostat, and netstat tools.
...
tag_affected = "dstat on CentOS 5";
...
if(description)
{
  ...
  script_summary("Check for the Version of dstat");
