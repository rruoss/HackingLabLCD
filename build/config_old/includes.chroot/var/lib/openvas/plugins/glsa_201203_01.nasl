...
tag_insight = "A buffer overflow in spamdyke might allow remote attackers to
    execute arbitrary code.";
tag_solution = "All spamdyke users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=mail-filter/spamdyke-4.3.0'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201203-01
http://bugs.gentoo.org/show_bug.cgi?id=399157";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201203-01 (spamdyke)");
