...
# $Id: secpod_php_nuke_userlog_sql_inj_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "PHP-Nuke version 8.0 and prior on all platforms.";
tag_insight = "The flaw is generated because the user supplied data passed into 'referer'
  header element when requesting the '/main/tracking/userLog.php' is not
  properly sanitized before it is used in an SQL query.";
tag_solution = "Upgrade to version or later
