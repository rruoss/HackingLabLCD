...
# $Id: secpod_phpmyadmin_setup_host_var_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "phpMyAdmin versions 3.4.x before 3.4.9";
tag_insight = "The flaw is due to improper validation of user-supplied input via
  ...
  of an affected site.";
tag_solution = "Upgrade to phpMyAdmin version 3.4.9 or later,
