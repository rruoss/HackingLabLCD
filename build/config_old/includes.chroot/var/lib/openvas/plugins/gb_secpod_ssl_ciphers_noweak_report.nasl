...
# $Id: gb_secpod_ssl_ciphers_noweak_report.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_summary = "This Plugin report about supported SSL Ciphers.";
...
if (description)
{
 ...
 script_name("Check for supported SSL Ciphers");
 desc = "
 Summary:
 " + tag_summary; script_description(desc);
 script_summary("Checks for supported SSL Weak");
 script_category(ACT_GATHER_INFO);
 script_family("General");
 script_copyright("This script is Copyright (C) 2012 Greenbone Networks GmbH");
 script_dependencies("secpod_ssl_ciphers.nasl");
 script_exclude_keys("secpod_ssl_ciphers/weak");
...
SCRIPT_DESC = "Check for supported SSL Ciphers";
