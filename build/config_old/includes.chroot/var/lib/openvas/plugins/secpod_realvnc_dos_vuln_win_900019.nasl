...
# $Id: secpod_realvnc_dos_vuln_win_900019.nasl 16 2013-10-27 13:09:52Z jan $
# Description: RealVNC vncviewer.exe Remote DoS Vulnerability (Win)
#
# Authors:
...
if(description)
{
 ...
 script_name("RealVNC vncviewer.exe Remote DoS Vulnerability (Win)");
 script_summary("Check for the version of RealVNC");
 desc = " 
 Summary:
 " + tag_summary + "
