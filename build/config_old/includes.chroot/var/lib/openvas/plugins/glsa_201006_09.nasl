...
tag_insight = "A flaw in sudo's -e option may allow local attackers to execute arbitrary
    commands.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201006-09
http://bugs.gentoo.org/show_bug.cgi?id=321697";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201006-09 (sudo)");
