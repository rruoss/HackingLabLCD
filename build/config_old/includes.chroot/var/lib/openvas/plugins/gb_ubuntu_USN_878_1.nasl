...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-January/001021.html");
  script_id(840363);
  ...
  script_summary("Check for the Version of firefox-3.5, xulrunner-1.9.1 regression");
