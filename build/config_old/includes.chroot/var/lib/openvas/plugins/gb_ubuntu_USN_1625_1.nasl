...
tag_insight = "Arthur Gerkis discovered a buffer overflow in the Icedtea-Web plugin. If a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1625-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001888.html");
  script_id(841212);
