...
tag_affected = "yubikey-val on Fedora 16";
tag_insight = "This is a server that validates Yubikey OTPs. It is written in PHP, for use
...
if(description)
{
  ...
  script_summary("Check for the Version of yubikey-val");
