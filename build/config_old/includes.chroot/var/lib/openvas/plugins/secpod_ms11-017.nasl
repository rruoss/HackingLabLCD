...
# $Id: secpod_ms11-017.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Remote Desktop Connection 5.2 Client
...
tag_impact = "Successful exploitation could allow authenticated attackers to execute
  ...
  Impact Level: System";
tag_insight = "The flaw is caused by the way Windows Remote Desktop Client handles loading
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Mstscax.dll' file version");
...
dllVer = fetch_file_version(sysPath, file_name:"System32\Mstscax.dll");
if(!dllVer){
  if(hotfix_check_sp(xp:4) > 0){
    dllVer = fetch_file_version(sysPath, file_name:"System32\2k3mstscax.dll");
  } else{
    exit(0);
  }
