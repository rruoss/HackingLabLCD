...
# $Id: gb_firefox_mult_vuln_nov08_win.nasl 16 2013-10-27 13:09:52Z jan $
#
# Mozilla Firefox Multiple Vulnerabilities November-08 (Win)
#
# Authors:
...
tag_impact = "Successful exploitation could result in remote arbitrary code execution,
  ...
  of the signed user.
  Impact Level: System";
tag_affected = "Firefox version prior to 2.0.0.18 and 3.x to 3.0.3 on Windows.";
...
if(description)
{
  ...
  script_name("Mozilla Firefox Multiple Vulnerabilities November-08 (Win)");
  desc = "
