...
tag_insight = "It was discovered that the Ubuntu One Client incorrectly validated server
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1465-1";
tag_affected = "ubuntuone-client on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001706.html");
  script_id(841030);
 ...
 script_version("$Revision: 12 $");
  ...
  script_summary("Check for the Version of ubuntuone-client");
