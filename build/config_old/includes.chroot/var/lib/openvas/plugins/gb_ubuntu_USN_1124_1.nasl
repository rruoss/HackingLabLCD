...
tag_insight = "It was discovered that rsync incorrectly handled memory when certain
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1124-1";
tag_affected = "rsync on Ubuntu 10.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 9.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001315.html");
  script_id(840655);
