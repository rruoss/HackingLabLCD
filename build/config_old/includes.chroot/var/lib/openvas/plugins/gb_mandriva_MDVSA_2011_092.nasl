...
tag_insight = "A vulnerability has been found and corrected in perl-IO-Socket-SSL:
...
tag_affected = "perl-IO-Socket-SSL on Mandriva Linux 2010.1,
...
if(description)
{
  ...
  script_summary("Check for the Version of perl-IO-Socket-SSL");
