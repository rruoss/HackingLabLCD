...
# $Id: gb_vlc_media_player_mem_crptn_vuln_win.nasl 16 2013-10-27 13:09:52Z jan $
#
...
if(description)
{
  ...
  script_name("VLC Media Player XSPF Playlist Memory Corruption Vulnerability (Win)");
  desc = "
