...
# $Id: secpod_google_chrome_rss_n_atom_xss_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Google Chrome version 2.x and 3.x before 3.0.195.21 on Windows.";
tag_insight = "An XSS vulnerability exists when the application fails to handle 'RSS' and 'Atom'
