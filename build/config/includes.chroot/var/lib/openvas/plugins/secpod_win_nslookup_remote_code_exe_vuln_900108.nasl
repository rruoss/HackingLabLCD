...
# $Id: secpod_win_nslookup_remote_code_exe_vuln_900108.nasl 16 2013-10-27 13:09:52Z jan $
...
tag_impact = "Successfull exploitation causes remote code execution, and
        Denial-of-Service.
 Impact Level : System";
...
tag_affected = "Microsoft Windows 2K and XP.";

tag_insight = "The flaw is due to an unspecified error in 'NSlookup.exe' file,
        which could be exploited by attackers.";


tag_summary = "The host is running Windows XP SP2, which prone to remote code
...
if(description)
{
 ...
 script_summary("Check for vulnerable version of Microsoft Windows");
 desc = "
 Summary:
 " + tag_summary + "
