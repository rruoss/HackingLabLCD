...
# $Id: Allied_Telesyn_telnet.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Allied Telesyn Router/Switch found with default password
#
# Authors:
...
tag_solution = "Telnet to this Router/Switch and change the default password.";
...
if(description)
{
    ...
    name = "Allied Telesyn Router/Switch found with default password";
    script_name(name);
   ...
   summary = "Logs into Allied Telesyn routers and switches with default password";
