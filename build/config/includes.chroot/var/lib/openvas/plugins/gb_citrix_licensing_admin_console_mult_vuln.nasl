...
# $Id: gb_citrix_licensing_admin_console_mult_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation could allow remote attackers to bypass certain
  security restrictions and cause denial-of-service condition.
  Impact Level: Application";
tag_affected = "Citrix Licensing Administration Console 11.6 and Prior.";
tag_insight = "The flaws are caused by errors in a third-party component that is used by the
  administration console, which could allow an attacker to cause a denial of
  service or gain unauthorized access to some license administration functionality
  by tricking an administrator into visiting a malicious web site.";
tag_solution = "No solution or patch is available as of 03th March, 2011. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to
  http://www.citrix.com/site/SS/downloads/details.asp?downloadId=1688507&productId=1679389";
