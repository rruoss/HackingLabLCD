...
# $Id: gb_wordpress_php_speedy_plugin_code_exec_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaws are caused by improper validation of user-supplied input via the
  'page' parameter to '/wp-content/plugins/php_speedy_wp/libs/php_speedy/view
  /admin_container.php', which allows attackers to execute arbitrary PHP code
  in the context of an affected site.

  NOTE: Exploit will work properly when,
  register_globals=On, allow_url_include=On and magic_quotes_gpc=Off";

tag_impact = "Successful exploitation will allow remote attackers to execute malicious
...
tag_solution = "No solution or patch is available as of 16th March, 2011. Information
  ...
  For updates refer to http://aciddrop.com";
tag_summary = "This host is installed with WordPress PHP Speedy Plugin and is prone to
