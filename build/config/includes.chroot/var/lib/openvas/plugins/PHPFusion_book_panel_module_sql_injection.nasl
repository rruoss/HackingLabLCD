...
# $Id: PHPFusion_book_panel_module_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("PHP-Fusion Book Panel Module 'books.php' SQL Injection Vulnerability");
