...
tag_insight = "Andrew McCreight and Olli Pettay discovered a use-after-free vulnerability
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1360-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001584.html");
  script_id(840903);
