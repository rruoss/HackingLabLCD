...
# $Id: gb_symantec_web_gateway_detect.nasl 44 2013-11-04 19:58:48Z jan $
#
...
foreach dir (dirs)
{
  ...
  if(egrep(pattern: "<title>Symantec Web Gateway - Login", string: buf, icase: TRUE))
  {
    ...
    set_kb_item(name: string("www/", port, "/symantec_web_gateway"), value: string(vers," under ",install));
