...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-July/000560.html");
  script_id(840118);
  ...
  script_summary("Check for the Version of libapache2-mod-perl2 vulnerability");
