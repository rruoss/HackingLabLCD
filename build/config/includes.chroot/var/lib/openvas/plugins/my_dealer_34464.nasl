...
# $Id: my_dealer_34464.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "My Dealer CMS is prone to multiple SQL-injection vulnerabilities
...
if (description)
{
 ...
 script_summary("Determine if My Dealer CMS is vulnerable to SQL Injection");
