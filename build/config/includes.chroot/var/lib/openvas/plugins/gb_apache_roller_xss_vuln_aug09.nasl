...
# $Id: gb_apache_roller_xss_vuln_aug09.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/51151");
  script_xref(name : "URL" , value : "http://secunia.com/advisories/31523");

  script_description(desc);
  script_summary("Check the version of Apache Roller");
