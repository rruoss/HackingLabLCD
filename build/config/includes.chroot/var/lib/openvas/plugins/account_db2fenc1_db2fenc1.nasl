...
# $Id: account_db2fenc1_db2fenc1.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password (db2fenc1) for db2fenc1
#
# Authors:
# Chris Foster
#
...
if(description)
{
 ...
 script_name("Default password (db2fenc1) for db2fenc1");
