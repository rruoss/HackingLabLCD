...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001275.html");
  script_id(840611);
  ...
  script_summary("Check for the Version of linux-ec2 vulnerabilities");
