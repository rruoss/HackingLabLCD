...
tag_insight = "Two directory traversal vulnerabilities have been found in fastjar,
    allowing remote attackers to create or overwrite arbitrary files.";
tag_solution = "All fastjar users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=app-arch/fastjar-0.98-r1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-21
http://bugs.gentoo.org/show_bug.cgi?id=325557";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-21 (fastjar)");
