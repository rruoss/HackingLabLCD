...
# $Id: gb_wordpress_processing_embed_plugin_xss.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to input validation error in 'pluginurl' parameter to
  'wp-content/plugins/wordpress-processing-embed/data/popup.php', which is not
  properly sanitised before being returned to the user.";
tag_solution = "No solution or patch is available as of 15th March, 2011. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://wordpress.org/extend/plugins/wordpress-processing-embed/";
tag_summary = "This host is installed with WordPress Processing Embed Plugin and is prone to
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/69764");
  ...
  script_summary("check for WordPress Processing Embed plugin Cross Site Scripting Vulnerability");
...
if("Wordpress Processing Embed" >< rcvRes)
{
   ...
   if(http_vuln_check(port:port, url:url, pattern:"<script>alert\(11111\)</script>")){
