...
# $Id: gb_apache_archiva_multiple_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Check the version of Apache Archiva");
...
## Confirm the exploit
if("test<script>alert('XSS-TEST')</script>/test" >< rcvRes){
  security_hole(port);
}
