...
# $Id: esoft_slk_ssa_2003_345_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2003-345-01";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2003-345-01 cvs security update ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2003-345-01 cvs security update");
...
vuln = 0;
if(isslkpkgvuln(pkg:"cvs", ver:"1.11.10-i386-1", rls:"SLK8.1")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"cvs", ver:"1.11.10-i386-1", rls:"SLK9.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"cvs", ver:"1.11.10-i486-1", rls:"SLK9.1")) {
    vuln = 1;
}
