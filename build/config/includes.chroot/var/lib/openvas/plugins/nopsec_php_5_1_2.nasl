...
# $Id: nopsec_php_5_1_2.nasl.nasl 110177
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 5.1.2
#
# Authors:
...
tag_solution = "Update PHP to version 5.1.2 or later.";
tag_summary = "PHP version smaller than 5.1.2 suffers vulnerability.";
if (description)
{
  script_id(110177);
...
script_name("PHP version smaller than 5.1.2");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"5.1.2"))
