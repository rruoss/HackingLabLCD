...
# $Id: gb_clearsite_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
# Clearsite Detection
#
# Authors:
...
tag_summary = "This host is running Clearsite, a Free Open-Source Network Graphing
...
if (description)
{
 ...
 script_summary("Checks for the presence of Clearsite");
...
dirs = make_list("/clearsite",cgi_dirs());

foreach dir (dirs) {

 url = string(dir, "/about.php");
