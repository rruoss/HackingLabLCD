...
# $Id: compaq_web_mgmt_password.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "Checks the administrator account on Compaq Web-based Management / HP System Management agents for the default or predictable passwords.";
...
if(description)
{
    ...
    name = "Compaq Web-based Management Login";
    script_name(name);
    ...
    summary = "Detect Predictable Compaq Web-based Management / HP System Management Agent Administrator Passwords";
