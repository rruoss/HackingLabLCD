...
# $Id: ProQuiz_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "ProQuiz is prone to an SQL-injection vulnerability because it fails
...
if (description)
{
 ...
 script_summary("Determine if ProQuiz is vulnerable to SQL Injection");
