...
# $Id: SalesCart_login_multiple_sql_injection.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "SalesCart is prone to multiple SQL-injection vulnerabilities because
...
if (description)
{
 ...
 script_summary("Determine if SalesCart is vulnerable to SQL Injection");
