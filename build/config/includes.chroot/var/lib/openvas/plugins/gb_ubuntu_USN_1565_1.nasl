...
tag_insight = "Thomas Biege discovered that the Horizon authentication mechanism
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1565-1";
tag_affected = "horizon on Ubuntu 12.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-September/001821.html");
  script_id(841144);
