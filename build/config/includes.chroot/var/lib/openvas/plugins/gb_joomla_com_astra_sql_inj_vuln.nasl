...
# $Id: gb_joomla_com_astra_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to input passed via the 'F' parameter to 'index.php'
  when 'option' is set to 'com_astra' is not properly sanitised before being
  used in the SQL query.";
tag_solution = "No solution or patch is available as of 3rd Aug 2011. Information
