...
tag_affected = "gnome-system-log on Fedora 17";
tag_insight = "gnome-system-log lets you view various log files on your system.";
...
if(description)
{
  ...
  script_summary("Check for the Version of gnome-system-log");
