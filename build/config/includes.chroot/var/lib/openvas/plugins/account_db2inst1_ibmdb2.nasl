...
# $Id: account_db2inst1_ibmdb2.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password (ibmdb2) for db2inst1
#
# Authors:
# Chris Foster
#
...
tag_summary = "The account 'db2finst1' has the password 'ibmdb2'
...
if(description)
{
 ...
 script_name("Default password (ibmdb2) for db2inst1");
