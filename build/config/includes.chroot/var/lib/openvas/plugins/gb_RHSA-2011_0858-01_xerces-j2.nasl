...
tag_insight = "The xerces-j2 packages provide the Apache Xerces2 Java Parser, a
...
tag_affected = "xerces-j2 on Red Hat Enterprise Linux Server (v. 6),
...
if(description)
{
  ...
  script_summary("Check for the Version of xerces-j2");
