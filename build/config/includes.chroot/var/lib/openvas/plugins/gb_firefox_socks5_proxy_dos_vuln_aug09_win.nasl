...
# $Id: gb_firefox_socks5_proxy_dos_vuln_aug09_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Firefox version before 3.0.12 or 3.5 before 3.5.2 on Windows.";
...
if(description)
{
  ...
  script_name("Mozilla Firefox SOCKS5 Proxy Server DoS Vulnerability Aug-09 (Win)");
  desc = "
