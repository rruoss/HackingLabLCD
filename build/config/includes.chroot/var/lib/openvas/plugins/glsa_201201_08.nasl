...
tag_insight = "A stack-based buffer overflow flaw in FontForge could result in
    execution of arbitrary code or a Denial of Service.";
tag_solution = "All FontForge users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201201-08
http://bugs.gentoo.org/show_bug.cgi?id=386293";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201201-08 (FontForge)");
