...
tag_insight = "USN-1400-3 fixed vulnerabilities in Thunderbird. The new Thunderbird
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1400-4";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-April/001652.html");
  script_id(840975);
