...
# $Id: gb_wordpress_php_speedy_plugin_title_param_xss.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is caused by an input validation error in the 'title' parameter
  in 'wp-content/plugins/php_speedy_wp/libs/php_speedy/view/admin_container.php'
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/show/osvdb/71055");
