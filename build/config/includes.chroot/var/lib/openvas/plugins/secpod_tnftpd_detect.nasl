...
# $Id: secpod_tnftpd_detect.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "This script finds the running tnftpd Version and saves the
  result in KB.";
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_summary("Set version of tnftpd in KB");
