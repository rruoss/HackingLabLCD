...
# $Id: artmedic_kleinanzeigen_file_inclusion.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "Artmedic Kleinanzeigen, an email verifying PHP script,
...
if(description)
{
 ...
 name = "Artmedic Kleinanzeigen File Inclusion Vulnerability";
 script_name(name);
 ...
 summary = "Checks for Artmedic Kleinanzeigen's PHP inclusion vulnerability";
