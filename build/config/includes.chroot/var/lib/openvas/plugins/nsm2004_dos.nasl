...
# $Id: nsm2004_dos.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Juniper NetScreen-Security Manager Remote DoS flaw
#
# Authors:
...
tag_summary = "The remote server is affected by a remote denial of service flaw. 
...
if(description)
{
 ...
 name = "Juniper NetScreen-Security Manager Remote DoS flaw";
 ...
 summary = "Determines if Juniper NSM guiSrv is vulnerable to remote DoS";
