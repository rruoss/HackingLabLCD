...
# $Id: gb_disk_pulse_server_bof_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will allow attackers to cause a stack-based
  buffer overflow via a specially crafted packet sent to TCP port 912 which
  results in denial of service condition.
...
tag_solution = "No solution or patch is available as of 18th October, 2010. Information
  ...
  For updates refer to http://www.diskpulse.com/downloads.html";
tag_summary = "This host is running Disk Pulse Server and is prone to remote stack buffer
...
if(description)
{
  ...
  script_summary("Check stack based buffer overflow on Disk Pulse Server");
