...
# $Id: esoft_slk_ssa_2006_178_03.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New aRts packages are available for Slackware 10.0, 10.1, 10.2, and -current
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2006-178-03";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2006-178-03 arts ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2006-178-03 arts");
...
vuln = 0;
if(isslkpkgvuln(pkg:"arts", ver:"1.2.3-i486-2_slack10.0", rls:"SLK10.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"arts", ver:"1.3.2-i486-2_slack10.1", rls:"SLK10.1")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"arts", ver:"1.4.2-i486-2_slack10.2", rls:"SLK10.2")) {
    vuln = 1;
}
