...
# $Id: secpod_openmairie_opencatalogue_lfi_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will allow remote attackers to include or disclose
  the contents of local files with the privileges of the web server.
...
tag_solution = "No solution or patch is available as of 21th May, 2010. Information
  ...
  For updates refer to http://adullact.net/frs/?group_id=289";
...
if(description)
{
  ...
  script_summary("Check for the exploit string on OpenMairie openCatalogue");
