...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-December/000815.html");
  script_id(840311);
  ...
  script_summary("Check for the Version of nagios2 vulnerabilities");
