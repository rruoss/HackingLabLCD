...
# $Id: deb_2188_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "Several vulnerabilities have been discovered in webkit, a Web content engine
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202188-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2188-1 (webkit)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"girl1.0-webkit-1.0", ver:"1.2.7-0+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libwebkit-1.0-2", ver:"1.2.7-0+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libwebkit-1.0-2-dbg", ver:"1.2.7-0+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libwebkit-1.0-common", ver:"1.2.7-0+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libwebkit-dev", ver:"1.2.7-0+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libwebkit-dev", ver:"1.2.7-1", rls:"DEB7.0")) != NULL) {
    report += res;
}
