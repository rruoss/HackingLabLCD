...
# $Id: gb_energizer_duo_usb_unauth_access_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_solution = "No solution or patch is available as of 17th March, 2010. Information
  ...
  For updates refer to http://www.energizer.com/usbcharger/

  Workaround:
  Apply workaround,
  http://www.kb.cert.org/vuls/id/154421";

tag_impact = "Successful exploitation let attackers to remotely control a system, including
...
tag_insight = "As part of the installation process of 'USB charger software package', a
...
tag_summary = "This host is installed with Energizer DUO USB Battery Charger Software
