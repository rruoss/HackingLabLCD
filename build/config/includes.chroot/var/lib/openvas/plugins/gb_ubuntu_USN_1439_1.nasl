...
tag_insight = "Matthias Weckbecker discovered a cross-site scripting (XSS) vulnerability
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1439-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-May/001679.html");
  script_id(841003);
