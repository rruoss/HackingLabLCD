...
# $Id: gb_avg_av_detect_lin.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "This script detect the installed version of AVG Anti-Virus and
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_summary("Set KB for the version of AVG Anti-Virus");
...
foreach avgBin (avgPaths)
{
  ...
  # (since it gets build version alwasy reduced by one.
