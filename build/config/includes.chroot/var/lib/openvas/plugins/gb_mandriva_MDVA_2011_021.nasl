...
tag_affected = "glpi-massocsimport on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "This updates the installation path of the massocsimport plugin
...
if(description)
{
  ...
  script_summary("Check for the Version of glpi-massocsimport");
