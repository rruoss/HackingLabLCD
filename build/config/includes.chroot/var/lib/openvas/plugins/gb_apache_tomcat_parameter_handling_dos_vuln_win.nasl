...
# $Id: gb_apache_tomcat_parameter_handling_dos_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_name("Apache Tomcat Parameter Handling Denial of Service Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
...
if(version_in_range(version:tomcatVer, test_version:"5.5", test_version2:"5.5.34")||
   version_in_range(version:tomcatVer, test_version:"6.0", test_version2:"6.0.33")||
