...
# $Id: gb_plotsoft_pdfill_pdf_editor_detect.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
 ...
 script_version("$Revision: 13 $");
  ...
  script_summary("Set version of PlotSoft PDFill PDF Editor in KB");
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if("PDFill PDF Editor" >< pdfName)
  {
    ...
    if(!isnull(pdfVer))
    {
      ...
      security_note(data:"PlotSoft PDFill PDF Editor version " + pdfVer +
