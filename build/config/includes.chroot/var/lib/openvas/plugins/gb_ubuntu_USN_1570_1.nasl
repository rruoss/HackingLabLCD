...
tag_insight = "It was discovered that GnuPG used a short ID when downloading keys from a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1570-1";
tag_affected = "gnupg on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-September/001827.html");
  script_id(841152);
