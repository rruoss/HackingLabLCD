...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1677-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-December/001944.html");
  script_id(841259);
