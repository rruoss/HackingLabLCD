...
tag_insight = "A flaw was found in KVM's Programmable Interval Timer (PIT). When a virtual
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1363-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001588.html");
  script_id(840934);
