...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-August/001139.html");
  script_id(840479);
  ...
  script_summary("Check for the Version of gnupg2 vulnerability");
