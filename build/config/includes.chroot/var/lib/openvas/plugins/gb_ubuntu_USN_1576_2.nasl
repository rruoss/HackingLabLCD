...
tag_insight = "USN-1576-1 fixed vulnerabilities in DBus. The update caused a regression
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1576-2";
