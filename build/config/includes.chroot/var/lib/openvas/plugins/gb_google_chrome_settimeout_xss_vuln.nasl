...
# $Id: gb_google_chrome_settimeout_xss_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Google Chrome version 1.0.x";
tag_insight = "Error exist when javascript: URLs with unescaped spaces and quotes are
...
tag_summary = "The host is installed with Google Chrome and is prone to XSS
  vulnerability.";
