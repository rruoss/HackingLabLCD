...
# $Id: secpod_ms10-073.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "Microsoft Windows XP Service Pack 3 and prior.
  ...
  Micorsoft Windows 7";
tag_insight = "The flaw is due to an error in the kernel-mode device driver 'Win32k.sys'
...
if(sysPath)
{
  ...
  if(sysVer)
  {
    ...
    if(hotfix_check_sp(xp:4) > 0)
    {
      ...
      {
        ## Grep for Win32k.sys version < 5.1.2600.6033
    ...
    else if(hotfix_check_sp(win2003:3) > 0)
    {
      ...
      {
        ## Grep for Win32k.sys version < 5.2.3790.4769
...
if(hotfix_check_sp(winVista:2, win2008:2) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    ## Grep for Win32k.sys version < 6.0.6002.18305
...
{
  ## Grep for Win32k.sys version < 6.1.7600.16667
