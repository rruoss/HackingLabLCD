...
# $Id: secpod_mozilla_prdts_unspecified_vuln_win_jun10.nasl 14 2013-10-27 12:33:37Z jan $
#
# Mozilla Products Unspecified Vulnerability june-10 (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Mozilla Products Unspecified Vulnerability june-10 (Win)");
  desc = "
  Summary:
  " + tag_summary + "
