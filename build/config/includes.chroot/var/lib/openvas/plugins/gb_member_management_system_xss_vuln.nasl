...
# $Id: gb_member_management_system_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is due to improper validation of user-supplied input via
  the 'REF_URL' parameter to admin/index.asp, Which allows attacker to execute
...
tag_solution = "No solution or patch is available as of 6th December, 2011. Information
  ...
  For updates refer to http://www.expinion.net/Applications/MMS_overview.asp";
tag_summary = "The host is running Member Management System and is prone to cross
