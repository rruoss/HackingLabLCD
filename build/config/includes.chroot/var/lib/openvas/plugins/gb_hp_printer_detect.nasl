...
# $Id: gb_hp_printer_detect.nasl 18 2013-10-27 14:14:13Z jan $
#
...
tag_summary = "Detection of HP Printers.
...
foreach url (keys(urls)) {
  ...
  if(match = eregmatch(pattern:urls[url], string:buf, icase:TRUE)) {
    ...
    log_message(data: "The remote Host is a HP " + model + " printer device.\nCPE: " + cpe + "\nConcluded: " + match[0], port:port);
    exit(0);
