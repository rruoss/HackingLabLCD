...
tag_insight = "It was discovered that the Auerswald usb driver incorrectly handled lengths
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1236-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-October/001452.html");
  script_id(840778);
