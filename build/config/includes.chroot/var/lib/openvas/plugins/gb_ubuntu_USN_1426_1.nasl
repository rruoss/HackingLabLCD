...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1426-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-April/001665.html");
  script_id(840990);
