...
tag_insight = "Marcus Granado discovered that PAM incorrectly handled configuration files
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1140-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-May/001339.html");
  script_id(840672);
