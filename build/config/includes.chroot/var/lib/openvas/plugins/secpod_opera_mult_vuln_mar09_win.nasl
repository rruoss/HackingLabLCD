...
# $Id: secpod_opera_mult_vuln_mar09_win.nasl 15 2013-10-27 12:49:54Z jan $
#
# Opera Web Browser Multiple Vulnerabilities (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Opera Web Browser Multiple Vulnerabilities (Win)");
  desc = "
