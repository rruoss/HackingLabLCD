...
tag_solution = "Run Windows update or apply fixes available from the following 
  website:
  http://www.microsoft.com/technet/security/bulletin/ms07-033.mspx";
tag_summary = "Microsoft Internet Explorer 5.01, 6, and 7 allows remote attackers 
...
if(description)
{
  ...
  script_summary("Checks for version of Internet Explorer");
...
if(hotfix_check_sp(win2k:5) > 0)
{
  ...
  {
    if(version_in_range(version:vers, test_version:"5.01",
                       test_version2:"5.0.3853.3000") ||
     version_in_range(version:vers, test_version:"6.0",
                       test_version2:"6.0.2800.1595")){
...
else if(hotfix_check_sp(xp:4) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    if(version_in_range(version:vers, test_version:"6.0",
                        test_version2:"6.0.2900.3132") ||
	   version_in_range(version:vers, test_version:"7.0",
                        test_version2:"7.0.6000.16481")){
      security_hole(0); exit(0);
    }
  }
...
{
  SP = get_kb_item("SMB/Vista/ServicePack");
