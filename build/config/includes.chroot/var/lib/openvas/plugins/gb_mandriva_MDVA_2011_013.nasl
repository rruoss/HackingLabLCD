...
tag_affected = "tree on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "This additional package provides a useful tool to Mandriva Enterprise
  Server 5.2";
...
if(description)
{
  ...
  script_summary("Check for the Version of tree");
