...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-December/001214.html");
  script_id(840546);
  ...
  script_summary("Check for the Version of clamav vulnerabilities");
