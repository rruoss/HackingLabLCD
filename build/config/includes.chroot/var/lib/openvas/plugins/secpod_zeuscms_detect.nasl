...
# $Id: secpod_zeuscms_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the installed ZeusCMS version and
...
SCRIPT_DESC = "ZeusCMS Version Detection";
...
foreach dir (make_list("/zeuscms", "/ZeusCMS", "/", cgi_dirs()))
{
  ...
  if("ZeusCMS" >< rcvRes)
  {
    ...
    if(zeusVer[1] != NULL){
      ...
      tmp_version = zeusVer[1] + " under " + dir;
      ...
      cpe = build_cpe(value:tmp_version, exp:"^([0-9.]+)", base:"cpe:/a:zeuscms:zeuscms:");
      if(!isnull(cpe))
