...
# $Id: deb_2464_2.nasl 12 2013-10-27 11:15:33Z jan $
...
{
 script_id(71343);
 script_version("$Revision: 12 $");script_tag(name:"cvss_base", value:"6.8");
 ...
 script_summary("Debian Security Advisory DSA 2464-2 (icedove)");
