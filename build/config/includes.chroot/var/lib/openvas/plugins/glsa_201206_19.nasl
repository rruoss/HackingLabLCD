...
tag_insight = "A vulnerability in NVIDIA drivers may allow a local attacker to
gain escalated privileges.";
tag_solution = "All NVIDIA driver users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-19
http://bugs.gentoo.org/show_bug.cgi?id=411617";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-19 (nvidia-drivers)");
