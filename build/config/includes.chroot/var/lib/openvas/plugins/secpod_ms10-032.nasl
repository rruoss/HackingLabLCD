...
# $Id: secpod_ms10-032.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaws are due to an error in the kernel-mode device driver 'Win32k.sys', which
...
{
  ## Grep for Win32k.sys version < 5.0.2195.7397
...
else if(hotfix_check_sp(xp:4) > 0)
{
  ...
  {
    ## Grep for Win32k.sys version < 5.1.2600.3706
  ...
  {
     ## Grep for Win32k.sys version < 5.1.2600.5976
...
else if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for  Win32k.sys version <  5.2.3790.4702
...
if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  {
    # Grep for Win32k.sys version < 6.0.6001.18468
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for Win32k.sys version < 6.0.6002.18253
...
{
  # Grep for Win32k.sys version < 6.1.7600.16585
