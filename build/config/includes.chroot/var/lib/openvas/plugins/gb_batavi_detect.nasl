...
# $Id: gb_batavi_detect.nasl 13 2013-10-27 12:16:33Z jan $
#
# Batavi Detection
#
# Authors:
...
tag_summary = "This host is running the open source ecommerce solution
Batavia.";
...
if (description)
{
 ...
 script_summary("Checks for the presence of Batavi");
...
dirs = make_list("/batavi");#,"/shop",cgi_dirs());
