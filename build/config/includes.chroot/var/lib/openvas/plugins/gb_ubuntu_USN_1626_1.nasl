...
tag_insight = "Gabe Westmaas discovered that Glance did not always properly enforce access
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1626-1";
tag_affected = "glance on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001889.html");
  script_id(841210);
