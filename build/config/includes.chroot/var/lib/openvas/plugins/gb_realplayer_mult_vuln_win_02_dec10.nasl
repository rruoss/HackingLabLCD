...
# $Id: gb_realplayer_mult_vuln_win_02_dec10.nasl 14 2013-10-27 12:33:37Z jan $
#
# RealNetworks RealPlayer Multiple Vulnerabilities (Win) - Dec10
#
# Authors:
...
tag_affected = "RealPlayer SP 1.0 to 1.1.1 (12.x)
...
if(description)
{
  ...
  script_name("RealNetworks RealPlayer Multiple Vulnerabilities (Win) - Dec10");
  desc = "
  Summary:
  " + tag_summary + "
