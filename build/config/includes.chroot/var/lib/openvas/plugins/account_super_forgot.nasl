...
# $Id: account_super_forgot.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password 'forgot' for account 'super'
#
# Authors:
# Michel Arboi
#
...
tag_summary = "The account 'super' has the password 'forgot'.  An attacker may use it
