...
# $Id: secpod_ms10-054.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(hotfix_check_sp(xp:4) > 0)
{
  ...
  {
    ## Grep for Srv.sys < 5.1.2600.6002
...
if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  {
    ## Grep for Srv.sys version < 5.2.3790.4733
...
if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  {
    # Grep for srv.sys version < 6.0.6001.18495
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for srv.sys version < 6.0.6002.18274       
...
{
  # Grep for srv.sys version < 6.1.7600.16619
