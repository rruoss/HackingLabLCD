...
# $Id: secpod_mozilla_prdts_iframe_dos_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_solution = "Upgrade to Firefox version 3.5.9, 3.6.2
  ...
  NOTE:
  For Firefox version 3.0.x No solution or patch is available as of 21st May,
  2010. Information regarding this issue will be updated once the solution
  details are available. For updates refer to http://www.mozilla.com/en-US/firefox/all.html";
...
tag_insight = "The flaw is due to improper handling of an 'IFRAME' element with a
  mailto: URL in its 'SRC' attribute, which allows remote attackers to exhaust
  resources via an HTML document with many 'IFRAME' elements.";
tag_summary = "The host is installed with Mozilla Firefox/Seamonkey and is prone to Denial of
