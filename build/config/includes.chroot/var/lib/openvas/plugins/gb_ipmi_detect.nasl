...
# $Id: gb_ipmi_detect.nasl 79 2013-11-26 14:44:32Z mime $
#
# Detection of IPMI
#
# Authors:
...
if (description)
{
 ...
 script_tag(name:"creation_date", value:"2013-11-26 11039:47 +0100 (Tue, 26 Nov 2013)");
...
foreach req (reqs) {
  ...
  register_service(port: port, ipproto:"udp", proto: 'ipmi');
