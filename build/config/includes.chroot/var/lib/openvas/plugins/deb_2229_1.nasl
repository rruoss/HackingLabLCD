...
# $Id: deb_2229_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "A vulnerability has been found in SPIP, a website engine for publishing,
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202229-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2229-1 (spip)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"spip", ver:"2.1.1-3squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
