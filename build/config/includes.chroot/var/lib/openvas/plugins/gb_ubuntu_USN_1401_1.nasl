...
tag_insight = "It was discovered that a flaw in the Mozilla SVG implementation could
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1401-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001633.html");
  script_id(840957);
