...
# $Id: gb_hp_smh_unspecified_vuln_lin.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will allow remote attackers to partially access and
  modify data and cause partial denial of service conditions.
  Impact Level: Application.";
tag_affected = "HP System Management Homepage (SMH) 6.0 prior to 6.0.0-95";

tag_insight = "The flaw is caused by unspecified errors with unknown impacts and unknown
  attack vectors.";
tag_solution = "Upgarde to HP SMH version 6.0.0-95
...
if(description)
{
  ...
  script_dependencies("secpod_hp_smh_detect.nasl", "gather-package-list.nasl");
...
if(smhVer != NULL)
{
  ## Check HP SMH version < 6.0.0.95
  if(version_in_range(version:smhVer, test_version:"6.0", test_version2:"6.0.0.94")){
