...
# $Id: remote-MS03-018.nasl 15 2013-10-27 12:49:54Z jan $
# Description: 
...
tag_summary = "A Cross-Site Scripting (XSS) vulnerability affecting IIS 4.0, 5.0 and 5.1 involving the error message that's returned to advise that a 
...
summary = "Internet Information Service Multiples Vulnerabilities MS03-018";
