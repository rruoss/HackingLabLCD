...
tag_summary = "This security update resolves a privately reported vulnerability in the
...
if(description)
{
  ...
  script_summary("Checks for vulnerable version of Windows");
...
if(hotfix_check_sp(win2k:5) > 0)
{
  ...
  if("Service Pack 4" >< SP)
  {
    if(version_in_range(version:vers, test_version:"5.0",
                       test_version2:"5.0.3854.2499") ||
     version_in_range(version:vers, test_version:"6.0",
                       test_version2:"6.0.2800.1598")){
...
else if(hotfix_check_sp(xp:4) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    if(version_in_range(version:vers, test_version:"6.0",
                        test_version2:"6.0.2900.3163") ||
	   version_in_range(version:vers, test_version:"7.0",
                        test_version2:"7.0.6000.20627")){
      security_hole(0); exit(0);
    }
  }
}
