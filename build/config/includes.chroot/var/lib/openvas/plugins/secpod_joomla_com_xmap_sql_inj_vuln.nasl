...
# $Id: secpod_joomla_com_xmap_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Check if Joomla Xmap component is vulnerable to SQL Injection attack");
