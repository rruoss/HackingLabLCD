...
# $Id: gb_dotnetnuke_xss_search_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "DotNetNuke versions 4.8 through 5.1.4 on all running platforms.";
tag_insight = "The flaw is due to input passed to the search parameters are not properly
...
tag_summary = "The host is installed with DotNetNuke and is prone to Cross Site
...
if(dnnVer[1] != NULL)
{
  if(version_in_range(version:dnnVer[1], test_version:"4.8", test_version2:"5.1.4")){
