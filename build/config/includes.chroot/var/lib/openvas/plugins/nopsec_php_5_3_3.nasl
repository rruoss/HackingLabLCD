...
# $Id: nopsec_php_5_3_3.nasl.nasl 110182
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 5.3.3
#
# Authors:
...
tag_solution = "Update PHP to version 5.3.3 or later.";
tag_summary = "PHP version smaller than 5.3.3 suffers vulnerability.";
if (description)
{
  script_id(110182);
...
script_name("PHP version smaller than 5.3.3");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"5.3.3"))
