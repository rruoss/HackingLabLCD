...
tag_insight = "It was discovered that PostgreSQL incorrectly handled certain bytes passed
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1461-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001703.html");
  script_id(841032);
