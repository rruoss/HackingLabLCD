...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-November/000772.html");
  script_id(840273);
  ...
  script_summary("Check for the Version of tk8.0, tk8.3, tk8.4 vulnerability");
