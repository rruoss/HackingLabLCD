...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-September/000597.html");
  script_id(840065);
  ...
  script_summary("Check for the Version of fetchmail vulnerabilities");
