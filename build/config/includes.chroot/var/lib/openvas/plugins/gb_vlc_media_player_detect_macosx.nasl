...
if(description)
{
  ...
  tag_summary =
"Detection of installed version of VLC Media Player.
The script logs in via ssh, searches for folder 'VLC.app' and
...
via command line option 'defaults read'.";
  ...
  script_summary("Detection of installed version of VLC Media Player");
...
register_product(cpe:cpe, location:'/Applications/VLC.app', nvt:SCRIPT_OID);
