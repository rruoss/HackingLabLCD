...
# $Id: deb_2308_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "Several vulnerabilities were found in Mantis, a  web-based bug
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202308-1";
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mantis", ver:"1.1.6+dfsg-2lenny6", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"mantis", ver:"1.1.8+dfsg-10squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
