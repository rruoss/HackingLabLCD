...
# $Id: gb_wordpress_asset_manager_file_upload_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "WordPress Asset Manager Plugin version 0.2";
tag_insight = "The flaw is due to the wp-content/plugins/asset-manager/upload.php
...
tag_solution = "No solution or patch is available as of 15th June, 2012. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://wordpress.org/extend/plugins/asset-manager/";
tag_summary = "This host is running WordPress Asset Manager Plugin and is prone to
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/82653");
  ...
  script_summary("Check if Asset Manager is vulnerable to arbitrary file upload");
