...
# $Id: postgresql_detect.nasl 43 2013-11-04 19:51:40Z jan $
#
...
tag_summary = "Detection of PostgreSQL, a open source object-relational
...
if ((dump[0] == "E")  &&
  ...
  register_product(cpe:cpe, location:string(port, "/tcp"), nvt:SCRIPT_OID, port:port);
  set_kb_item(name:"PostgreSQL/installed", value:TRUE);

  log_message(port:port, data:  build_detection_report(app:"PostgreSQL", version:vers, install:port + '/tcp', cpe:cpe, concluded:concluded));
  exit(0);
}
