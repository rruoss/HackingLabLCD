...
tag_insight = "It was discovered that Django did not properly validate HTTP requests that
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1066-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-February/001250.html");
  script_id(840586);
  ...
  script_summary("Check for the Version of python-django vulnerabilities");
