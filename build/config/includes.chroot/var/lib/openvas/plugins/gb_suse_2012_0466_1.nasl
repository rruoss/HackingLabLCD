...
tag_insight = "- Update to 19.0.1079 Security Fixes (bnc#754456):
...
if(description)
{
  script_xref(name : "URL" , value : "http://195.135.221.135/opensuse-security-announce/2012-04/msg00000.html");
  script_id(850298);
  ...
  script_xref(name: "openSUSE-SU", value: "2012:0466_1");
