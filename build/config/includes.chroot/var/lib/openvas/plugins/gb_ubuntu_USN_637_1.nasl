...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-August/000742.html");
  script_id(840325);
  ...
  script_summary("Check for the Version of linux, linux-source-2.6.15/20/22 vulnerabilities");
