...
tag_insight = "Mulitple overflows and vulnerabilities exist in Ethereal which may allow an
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 200403-07 (ethereal)");
