...
# $Id: gb_coldusergroup_xss_n_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "ColdGen ColdUserGroup 1.06";
tag_insight = "- Input passed via the 'Keywords' POST parameter when performing a search
...
tag_solution = "No solution or patch is available as of 13th, October 2011. Information
  ...
  http://coldgen.com/index.cfm?ColdGen=ProductDetails&ProductID=8";
tag_summary = "This host is running ColdGen ColdUserGroup and is prone to cross
...
if(description)
{
  ...
  script_summary("Check if ColdUserGroup is vulnerable to Cross-Site Scripting");
...
foreach dir(make_list("/coldusr", "", cgi_dirs()))
{
