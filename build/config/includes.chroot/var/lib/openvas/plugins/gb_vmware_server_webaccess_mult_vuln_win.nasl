...
# $Id: gb_vmware_server_webaccess_mult_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# VMware WebAccess Multiple Vulnerabilities (Win)
#
# Authors:
...
tag_impact = "Successful exploitation will lets attackers to spoof the origin of requests
  via unspecified vectors and execution of JavaScript.
  Impact Level: Application";
tag_affected = "VMware Server version 2.0 on Windows.";
...
if(description)
{
  ...
  script_name("VMware WebAccess Multiple Vulnerabilities (Win)");
  desc = "
  Summary:
  " + tag_summary + "
