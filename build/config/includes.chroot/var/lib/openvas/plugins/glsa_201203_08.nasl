...
tag_insight = "A vulnerability in libxslt could result in Denial of Service.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201203-08
http://bugs.gentoo.org/show_bug.cgi?id=402861";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201203-08 (libxslt)");
