...
tag_insight = "Tenho Tuhkala discovered that the LTSP Display Manager (ldm) incorrectly
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1398-1";
tag_affected = "ldm on Ubuntu 11.10 ,
  Ubuntu 11.04";
