...
tag_summary = "Create a System Characteristics element as defined by the OVAL specification and store it in the Knowledge Base";
...
if (description)
{
 ...
 script_summary ("Create System Characteristics");
