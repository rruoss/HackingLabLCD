...
# $Id: gb_vmware_prdts_mult_vuln_win_jun11.nasl 13 2013-10-27 12:16:33Z jan $
#
# VMware Products Multiple Vulnerabilities (Win) - jun 11
#
# Authors:
...
if(description)
{
  ...
  script_name("VMware Products Multiple Vulnerabilities (Win) - jun 11");
  desc = "
  Summary:
  " + tag_summary + "
