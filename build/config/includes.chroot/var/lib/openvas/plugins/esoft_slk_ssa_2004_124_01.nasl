...
# $Id: esoft_slk_ssa_2004_124_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New rsync packages are available for Slackware 8.1, 9.0, 9.1, and -current to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-124-01";
...
";
 ...
 script_summary("Slackware Advisory SSA:2004-124-01 rsync update");
...
vuln = 0;
if(isslkpkgvuln(pkg:"rsync", ver:"2.6.2-i386-1", rls:"SLK8.1")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"rsync", ver:"2.6.2-i386-1", rls:"SLK9.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"rsync", ver:"2.6.2-i486-1", rls:"SLK9.1")) {
    vuln = 1;
}
