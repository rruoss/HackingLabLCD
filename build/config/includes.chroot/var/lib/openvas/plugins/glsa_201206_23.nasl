...
tag_insight = "PyCrypto generates weak ElGamal keys.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-23
http://bugs.gentoo.org/show_bug.cgi?id=417625";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-23 (pycrypto)");
