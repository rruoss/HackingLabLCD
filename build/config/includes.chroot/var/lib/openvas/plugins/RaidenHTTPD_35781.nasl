...
# $Id: RaidenHTTPD_35781.nasl 15 2013-10-27 12:49:54Z jan $
#
...
";
 ...
 script_summary("Determine if RaidenHTTPD Version is <= 2.0.26");
...
if(!version)exit(0);
if(!matches = eregmatch(string:version, pattern:"Server: RaidenHTTPD/([0-9.]+)"))exit(0);
