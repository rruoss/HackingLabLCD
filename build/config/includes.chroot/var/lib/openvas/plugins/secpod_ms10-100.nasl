...
# $Id: secpod_ms10-100.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation could allow an attacker to bypass security
  restrictions and gain the privileges.
  Impact Level: System";
tag_affected = "Microsoft Windows 7.
  Microsoft Windows Vista Service Pack 2 and prior.
  Microsoft Windows Server 2008 Service Pack 2 and prior.";
tag_insight = "Consent UI does not properly process a registry key that has been set to a
  specific value.";
...
if(description)
{
  ...
  script_summary("Check for the version of Consent.exe file");
...
## Get Version from Consent.exe file
...
if(hotfix_check_sp(winVista:3, win2008:3) > 0)
{
  ...
  {
    ## Check for Consent.exe version < 6.0.6001.18539
  ...
  {
    ## Check for Consent.exe version < 6.0.6002.18328
...
{
  ## Check for Consent.exe version < 6.1.7600.16688
