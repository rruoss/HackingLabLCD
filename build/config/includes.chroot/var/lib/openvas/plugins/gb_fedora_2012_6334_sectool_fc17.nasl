...
tag_affected = "sectool on Fedora 17";
tag_insight = "sectool is a security tool that can be used both as a security audit
...
if(description)
{
  ...
  script_summary("Check for the Version of sectool");
