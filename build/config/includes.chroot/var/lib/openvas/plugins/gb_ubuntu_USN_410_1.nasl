...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-January/000469.html");
  script_id(840167);
  ...
  script_summary("Check for the Version of kdegraphics, koffice, poppler vulnerability");
