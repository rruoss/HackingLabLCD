...
# $Id: ezpublish_xss.nasl 17 2013-10-27 14:01:43Z jan $
# Description: ezPublish Cross Site Scripting Bugs
#
# Authors:
...
tag_summary = "ezPublish 2.2.7  has a cross site scripting bug. An attacker may use it to 
...
if (description)
{
 ...
 script_name("ezPublish Cross Site Scripting Bugs");
 desc = "
 Summary:
 " + tag_summary + "
 Solution:
 ...
 script_summary("Determine if ezPublish is vulnerable to xss attack");
 script_category(ACT_GATHER_INFO);
 script_family("Web application abuses");
 script_copyright("This script is Copyright (C) 2003 k-otik.com");
 script_dependencies("find_service.nasl", "no404.nasl", "cross_site_scripting.nasl");
