...
# $Id: deb_2173_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "It was discovered that pam-pgsql, a PAM module to authenticate using
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"libpam-pgsql", ver:"0.6.3-2+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"libpam-pgsql", ver:"0.7.1-4+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
