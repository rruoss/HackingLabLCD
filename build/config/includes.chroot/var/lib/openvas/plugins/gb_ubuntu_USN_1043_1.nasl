...
tag_insight = "It was discovered that a NULL pointer dereference in the code for
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1043-1";
tag_affected = "lcms vulnerability on Ubuntu 8.04 LTS ,
  Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001227.html");
  script_id(840563);
  ...
  script_summary("Check for the Version of lcms vulnerability");
