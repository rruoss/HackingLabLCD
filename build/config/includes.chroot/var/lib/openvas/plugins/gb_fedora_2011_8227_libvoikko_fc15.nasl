...
tag_insight = "This is libvoikko, library for spellcheckers and hyphenators using Malaga
...
tag_affected = "libvoikko on Fedora 15";
...
if(description)
{
  ...
  script_summary("Check for the Version of libvoikko");
