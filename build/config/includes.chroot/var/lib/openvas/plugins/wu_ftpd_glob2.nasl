...
# $Id: wu_ftpd_glob2.nasl 17 2013-10-27 14:01:43Z jan $
...
if (safe_checks())
{
 if (egrep(string:banner, pattern:" FTP .*Version wu-2\.6\.(1|2|2\(1\)) ")) security_warning(port);
 exit(0);
}
...
if (t[0] == 0) t[0] = 1;
if (t[1] > 3 * t[0]) security_warning(port);
