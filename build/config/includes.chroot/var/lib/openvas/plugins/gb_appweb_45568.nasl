...
# $Id: gb_appweb_45568.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "Appweb is prone to a cross-site scripting vulnerability because it
...
if(http_vuln_check(port:port, url:url, pattern:"<script>alert\('openvas-xss-test'\)</script>", extra_check:make_list("Ejscript error"))) {
