...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001269.html");
  script_id(840605);
  ...
  script_summary("Check for the Version of linux-lts-backport-maverick vulnerabilities");
