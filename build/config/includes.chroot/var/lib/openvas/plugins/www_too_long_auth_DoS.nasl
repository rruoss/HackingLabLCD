...
# $Id: www_too_long_auth_DoS.nasl 17 2013-10-27 14:01:43Z jan $
...
if(description)
{
 ...
 name = "Too long basic authentication DoS";
 script_name(name);
 ...
 summary = "Too long Basic authentifcation chokes the web server";
