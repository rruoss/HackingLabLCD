...
# $Id: esoft_slk_ssa_2007_324_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-324-01";
...
";
 ...
 script_summary("Slackware Advisory SSA:2007-324-01 mozilla-thunderbird");
...
vuln = 0;
if(isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.9-i686-1", rls:"SLK10.2")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.9-i686-1", rls:"SLK11.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.9-i686-1", rls:"SLK12.0")) {
    vuln = 1;
}
