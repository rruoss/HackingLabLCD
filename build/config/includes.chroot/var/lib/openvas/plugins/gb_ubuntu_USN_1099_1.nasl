...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001292.html");
  script_id(840619);
  ...
  script_summary("Check for the Version of gdm vulnerability");
