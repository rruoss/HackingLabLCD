...
tag_insight = "Schacher Raindel discovered a flaw in the Linux kernel's memory handling
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1469-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001713.html");
  script_id(841043);
