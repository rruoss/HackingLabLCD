...
# $Id: cmsimple_search_xss.nasl 17 2013-10-27 14:01:43Z jan $
# Description: CMSimple index.php search XSS
#
# Authors:
...
if (description) {
  ...
  name = "CMSimple index.php search XSS";
  script_name(name);
  ...
  summary = "Checks for XSS in search field in index.php";
