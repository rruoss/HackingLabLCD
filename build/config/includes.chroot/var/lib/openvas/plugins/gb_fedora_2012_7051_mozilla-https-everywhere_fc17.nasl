...
tag_insight = "HTTPS Everywhere is a Firefox extension produced as a collaboration between
...
tag_affected = "mozilla-https-everywhere on Fedora 17";
...
if(description)
{
  ...
  script_summary("Check for the Version of mozilla-https-everywhere");
