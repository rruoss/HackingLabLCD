...
# $Id: gb_apple_quicktime_code_exec_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaw is due to error in 'IPersistPropertyBag2::Read()' function in
  'QTPlugin.ocx'. It allows remote attackers to execute arbitrary code via the
  '_Marshaled_pUnk attribute', which triggers unmarshaling of an untrusted
   pointer.";
tag_solution = "No solution or patch is available as of th 01st September, 2010. Information
