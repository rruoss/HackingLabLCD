...
# $Id: account_db2inst1_db2inst1.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password (db2inst) for db2inst1
#
# Authors:
# Chris Foster
#
...
tag_summary = "The account 'db2finst1' has the password 'db2inst1'
...
if(description)
{
 ...
 script_name("Default password (db2inst) for db2inst1");
