...
# $Id: secpod_freetype_detect_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the installed FreeType version and saves
  the version in KB.";
...
if(description)
{
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Set the version of FreeType in KB");
...
## Get FreeType version from registry
