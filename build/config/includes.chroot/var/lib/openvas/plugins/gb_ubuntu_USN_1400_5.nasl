...
tag_insight = "USN-1400-1 fixed vulnerabilities in Firefox. Firefox 11 started using
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1400-5";
tag_affected = "gsettings-desktop-schemas on Ubuntu 11.04";
...
if(description)
{
  ...
  script_summary("Check for the Version of gsettings-desktop-schemas");
