...
# $Id: http_version.nasl 41 2013-11-04 19:00:12Z jan $
...
tag_summary = "This detects the HTTP Server's type and version.";

tag_solution = "Configure your server to use an alternate name like
...
if(description)
{
 ...
 script_dependencies("find_service.nasl", "http_login.nasl", "httpver.nasl", "no404.nasl", "webmin.nasl", "embedded_web_server_detect.nasl");
