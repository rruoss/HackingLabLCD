...
# $Id: gb_lotus_domino_46232.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "IBM Lotus Domino is prone to a remote stack-based buffer-overflow
...
exploits will completely compromise affected computers. Failed exploit
...
if(version_is_less(version:domVer,test_version:"8.5.FP1")) {
