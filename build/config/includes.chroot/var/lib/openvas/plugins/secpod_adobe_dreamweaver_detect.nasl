...
# $Id: secpod_adobe_dreamweaver_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the installed Adobe Dreamweaver version and saves
  the version in KB.";
...
if(description)
{
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Set the Version of Adobe Dreamweaver in KB");
