...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001218.html");
  script_id(840557);
  ...
  script_summary("Check for the Version of evince vulnerabilities");
