...
tag_insight = "Stephane Chazelas discovered the bytecode engine of ClamAV improperly
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1258-1";
