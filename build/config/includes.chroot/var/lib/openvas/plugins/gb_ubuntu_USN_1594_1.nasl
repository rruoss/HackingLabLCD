...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1594-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001852.html");
  script_id(841175);
