...
if(description)
{
  script_xref(name : "URL" , value : "http://www.novell.com/linux/security/advisories/2007_57_mozilla.html");
  script_id(850105);
  ...
  script_summary("Check for the Version of MozillaFirefox,mozilla,seamonkey");
