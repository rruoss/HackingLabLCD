...
# $Id: secpod_opera_info_disc_vuln_feb10_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# Opera Information Disclosure Vulnerability - (Win)
#
# Authors:
...
tag_affected = "Opera version prior to 10.50b1 on Windows.";
...
if(description)
{
  ...
  script_name("Opera Information Disclosure Vulnerability - (Win)");
  desc = "
  Summary:
  " + tag_summary + "
