...
tag_insight = "A vulnerability in SquidClamav may result in Denial of Service.";
tag_solution = "All SquidClamav users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-proxy/squidclamav-6.8'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-08
http://bugs.gentoo.org/show_bug.cgi?id=428778
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-08 (squidclamav)");
