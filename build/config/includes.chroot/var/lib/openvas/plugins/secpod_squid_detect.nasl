...
# $Id: secpod_squid_detect.nasl 43 2013-11-04 19:51:40Z jan $
#
...
if(description)
{
  ...
  tag_summary =
"This scripts determines the version of squid server and sets the
value in KB.";
  ...
  script_summary("Set Version of Squid Proxy Server in KB");
