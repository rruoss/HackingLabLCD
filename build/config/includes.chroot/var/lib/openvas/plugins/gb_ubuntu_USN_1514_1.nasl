...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1514-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001781.html");
  script_id(841112);
