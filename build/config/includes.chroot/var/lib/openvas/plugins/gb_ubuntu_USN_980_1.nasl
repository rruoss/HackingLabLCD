...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-August/001148.html");
  script_id(840490);
  ...
  script_summary("Check for the Version of bogofilter vulnerability");
