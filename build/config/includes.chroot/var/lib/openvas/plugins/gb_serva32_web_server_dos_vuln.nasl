...
# $Id: gb_serva32_web_server_dos_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Serva32 1.2.00 RC1, Other versions may also be affected.";
tag_insight = "The flaw is caused the way Serva32 web server handles certain requests having
  huge length URI, which causes application to crash.";
tag_solution = "Upgrade to Serva32 Version 1.2.1 or later.
  For updates refer to http://www.vercot.com/~serva/";
tag_summary = "This host is running Serva32 web server and is prone to denial of service
  vulnerability.";
...
if(description)
{
  ...
  script_summary("Check Serva32 web server is vulnerable by sending crafted packets");
