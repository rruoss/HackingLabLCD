...
# $Id: gb_groupoffice_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of Group-Office");
...
dirs = make_list("/go","/groupware","/group-office","groupoffice",cgi_dirs());
