...
# $Id: phpldapadmin_detect.nasl 43 2013-11-04 19:51:40Z jan $
#
...
tag_summary = "This host is running phpLDAPadmin, a web-based LDAP administration
...
dirs =
make_list("/phpldapadmin","/ldapadmin","/ldap","/phpldapadmin/htdocs","/ldapadmin/htdocs",cgi_dirs());
