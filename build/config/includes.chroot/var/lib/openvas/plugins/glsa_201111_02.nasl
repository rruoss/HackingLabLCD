...
tag_insight = "Multiple vulnerabilities have been found in the Oracle JRE/JDK,
    allowing attackers to cause unspecified impact.";
tag_solution = "All Oracle JDK 1.6 users should upgrade to the latest version:
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201111-02 (sun-jre-bin sun-jdk emul-linux-x86-java)");
