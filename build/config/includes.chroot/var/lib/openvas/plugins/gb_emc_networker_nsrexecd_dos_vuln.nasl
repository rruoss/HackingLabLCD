...
# $Id: gb_emc_networker_nsrexecd_dos_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_solution = "No solution or patch is available as of 16th April, 2012. Information
  ...
  For updates refer to http://www.emc.com/backup-and-recovery/networker/networker.htm";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/80590");
  ...
  script_summary("Check if EMC NetWorker 'nsrexecd' service is vulnerable to DoS");
