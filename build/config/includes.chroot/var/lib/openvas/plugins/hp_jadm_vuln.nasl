...
# $Id: hp_jadm_vuln.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "The remote HP Web JetAdmin suffers from a number of vulnerabilities. The 
...
tag_solution = "To set a password for the HP Web Jet Admin service follow these steps:
...
if(description)
{
    ...
    name = "HP Jet Admin 7.x Directory Traversal";
    script_name(name);
    ...
    summary = "HP JetAdmin directory traversal attack";
