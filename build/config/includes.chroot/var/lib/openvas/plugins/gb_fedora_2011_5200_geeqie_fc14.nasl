...
tag_affected = "geeqie on Fedora 14";
tag_insight = "Geeqie has been forked from the GQview project with the goal of picking up
...
if(description)
{
  ...
  script_summary("Check for the Version of geeqie");
