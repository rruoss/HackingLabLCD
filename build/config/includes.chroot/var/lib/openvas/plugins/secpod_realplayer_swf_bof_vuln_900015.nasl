...
# $Id: secpod_realplayer_swf_bof_vuln_900015.nasl 16 2013-10-27 13:09:52Z jan $
# Description: RealPlayer SWF Frame Handling Buffer Overflow Vulnerability (Win)
#
# Authors:
...
tag_insight = "The flaw exist due to a design error in handling/parsing of frames
...
if(description)
{
 ...
 script_summary("Check for the vulnerable version of RealPlayer");
 desc = "
 Summary:
 " + tag_summary + "
