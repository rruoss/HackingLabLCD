...
tag_insight = "Strigi is a fast and light desktop search engine. It can handle a large range
...
tag_affected = "strigi on Fedora 14";
...
if(description)
{
  ...
  script_summary("Check for the Version of strigi");
