...
# $Id: gb_realplayer_mp4_file_dos_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_name("RealNetworks RealPlayer MP4 File Handling Denial of Service Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
