...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-September/000750.html");
  script_id(840349);
  ...
  script_summary("Check for the Version of rdesktop vulnerabilities");
