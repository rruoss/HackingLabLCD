...
# $Id: gb_adobe_reader_pdf_doc_mult_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# Adobe Reader PDF Handling Multiple Vulnerabilities (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Adobe Reader PDF Handling Multiple Vulnerabilities (Win)");
  desc = "
  Summary:
  " + tag_summary + "
