...
tag_insight = "A double-free flaw in Logsurfer allows a remote attacker to execute
    arbitrary code.";
tag_solution = "All Logsurfer users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=app-admin/logsurfer+-1.8'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201201-04
http://bugs.gentoo.org/show_bug.cgi?id=387397";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201201-04 (Logsurfer)");
