...
tag_insight = "USN-1024-1 fixed vulnerabilities in OpenJDK. Some of the additional
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1024-2";
tag_affected = "openjdk-6 regression on Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-December/001216.html");
  script_id(840555);
  ...
  script_summary("Check for the Version of openjdk-6 regression");
