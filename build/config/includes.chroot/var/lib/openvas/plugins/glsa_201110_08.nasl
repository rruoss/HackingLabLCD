...
tag_insight = "Multiple vulnerabilities were found in feh, the worst of which
    leading to remote passive code execution.";
tag_solution = "All feh users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=media-gfx/feh-1.12'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201110-08
http://bugs.gentoo.org/show_bug.cgi?id=325531
http://bugs.gentoo.org/show_bug.cgi?id=354063";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201110-08 (feh)");
