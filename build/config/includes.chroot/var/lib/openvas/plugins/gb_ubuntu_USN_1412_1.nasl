...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1412-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001647.html");
  script_id(840972);
