...
# $Id: gb_thunderbird_mult_vuln_july08_win.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_affected = "Thunderbird version prior to 2.0.0.16 on Windows.";

tag_summary = "The host is installed with Mozilla Thunderbird, that
...
if(description)
{
  ...
  script_name("Mozilla Thunderbird Multiple Vulnerability July-08 (Win)");
  desc = "
