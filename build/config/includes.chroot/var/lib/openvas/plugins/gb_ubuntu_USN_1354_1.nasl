...
tag_insight = "It was discovered that usbmuxd did not correctly perform bounds checking
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1354-1";
tag_affected = "usbmuxd on Ubuntu 11.04";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001574.html");
  script_id(840883);
 ...
 script_version("$Revision: 12 $");
  ...
  script_summary("Check for the Version of usbmuxd");
