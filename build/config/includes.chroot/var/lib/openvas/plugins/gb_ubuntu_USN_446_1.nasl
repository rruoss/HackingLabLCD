...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-March/000514.html");
  script_id(840057);
  ...
  script_summary("Check for the Version of nas vulnerabilities");
