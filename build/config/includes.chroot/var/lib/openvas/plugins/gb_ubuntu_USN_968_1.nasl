...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-August/001135.html");
  script_id(840475);
  ...
  script_summary("Check for the Version of base-files vulnerability");
