...
# $Id: sparkleblog_sql_injection.nasl 17 2013-10-27 14:01:43Z jan $
# Description: SparkleBlog SQL Injection
#
# Authors:
# Noam Rathaus
#
...
tag_summary = "The remote host is running SparkleBlog, a web blog manager written in PHP.
...
tag_solution = "Upgrade to the newest version of this software or disable it.";
...
if(description)
{
 ...
 name = "SparkleBlog SQL Injection";
 ...
 summary = "Checks for the presence of an SQL injection in id parameter";
