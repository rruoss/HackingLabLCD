...
# $Id: theserver_cleartext.nasl 17 2013-10-27 14:01:43Z jan $
...
if(description)
{
 ...
 summary = "TheServer stores clear text passwords in server.ini";
 ...
 script_dependencies("find_service.nasl", "httpver.nasl", "http_version.nasl", "no404.nasl");
