...
tag_insight = "A buffer overflow in QtGui could result in execution of arbitrary
    code or Denial of Service.";
tag_solution = "All QtGui users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-02
http://bugs.gentoo.org/show_bug.cgi?id=384089";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-02 (qt-gui)");
