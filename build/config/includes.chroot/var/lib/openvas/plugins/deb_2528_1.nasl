...
# $Id: deb_2528_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202528-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2528-1 (icedove)");
...
res = "";
report = "";
if((res = isdpkgvuln(pkg:"icedove", ver:"3.0.11-1+squeeze12", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"icedove-dbg", ver:"3.0.11-1+squeeze12", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"icedove-dev", ver:"3.0.11-1+squeeze12", rls:"DEB6.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"calendar-google-provider", ver:"10.0.6-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"calendar-timezones", ver:"10.0.6-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"icedove", ver:"10.0.6-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"icedove-dbg", ver:"10.0.6-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"icedove-dev", ver:"10.0.6-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
if((res = isdpkgvuln(pkg:"iceowl-extension", ver:"10.0.6-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
