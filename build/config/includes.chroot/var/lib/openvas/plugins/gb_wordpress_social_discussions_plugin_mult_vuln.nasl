...
# $Id: gb_wordpress_social_discussions_plugin_mult_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_impact = "Successful exploitation could allow attackers to attackers to execute
  arbitrary PHP code and to gain sensitive information like installation path
  location.
...
tag_summary = "This host is running WordPress Social Discussions Plugin and is prone
  to remote file inclusion and full path disclosure vulnerabilities.";
