...
tag_insight = "An insecure temporary file usage has been reported in virtualenv,
possibly allowing symlink attacks.";
tag_solution = "All virtualenv users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=dev-python/virtualenv-1.5.1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-17
http://bugs.gentoo.org/show_bug.cgi?id=395285";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-17 (virtualenv)");
