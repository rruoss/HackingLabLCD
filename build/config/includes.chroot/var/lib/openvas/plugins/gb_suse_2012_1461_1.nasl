...
tag_insight = "Specially-crafted commits can cause code to be executed on
...
if(description)
{
  script_xref(name : "URL" , value : "http://195.135.221.135/opensuse-security-announce/2012-11/msg00004.html");
  script_id(850363);
  ...
  script_xref(name: "openSUSE-SU", value: "2012:1461_1");
