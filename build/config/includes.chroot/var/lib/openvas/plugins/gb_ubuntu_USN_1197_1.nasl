...
tag_insight = "It was discovered that Dutch Certificate Authority DigiNotar, had
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1197-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-September/001404.html");
  script_id(840733);
