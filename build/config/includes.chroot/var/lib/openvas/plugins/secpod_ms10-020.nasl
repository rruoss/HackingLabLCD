...
# $Id: secpod_ms10-020.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaws are due to multiple errors in SMB client implementation. It is
...
if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  {
    # Grep for Mrxsmb.sys version < 6.0.6001.18431
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for Mrxsmb.sys version < 6.0.6002.18213
...
{
  # Grep for Mrxsmb.sys version < 6.1.7600.16539
