...
# $Id: ftpglob.nasl 17 2013-10-27 14:01:43Z jan $
...
if (description)
{
    ...
    script_tag(name:"risk_factor", value:"Critical");
 	name = "FTPD glob Heap Corruption";
	script_name( name);
  ...
  " + tag_solution;
 	...
 	script_dependencies("find_service.nasl", "secpod_ftp_anonymous.nasl", "os_fingerprint.nasl");
