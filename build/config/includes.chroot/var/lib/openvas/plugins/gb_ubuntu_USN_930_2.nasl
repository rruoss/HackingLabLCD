...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-June/001113.html");
  script_id(840451);
  ...
  script_summary("Check for the Version of apturl, Epiphany, gecko-sharp, gnome-python-extras,	liferea, rhythmbox, totem, ubufox, yelp update");
