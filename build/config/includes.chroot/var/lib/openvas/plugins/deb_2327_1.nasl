...
# $Id: deb_2327_1.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_insight = "Ferdinand Smit discovered that libfcgi-perl, a Perl module for writing
...
tag_summary = "The remote host is missing an update to libfcgi-perl
announced via advisory DSA 2327-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202327-1";
...
if((res = isdpkgvuln(pkg:"libfcgi-perl", ver:"0.73-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
