...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001873.html");
  script_id(841194);
  ...
  script_summary("Check for the Version of python2.4");
