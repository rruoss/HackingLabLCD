...
tag_insight = "It was discovered that, when defining security groups in Nova using
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1466-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001710.html");
  script_id(841028);
