...
# $Id: gb_quick_n_easy_login_dos_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Quick 'n Easy FTP Server Version 3.2, other versions may also be affected.";
tag_insight = "The flaw is due to the way server handles 'USER' and 'PASS' commands,
  which can be exploited to crash the FTP service by sending 'USER' and 'PASS'
  commands with specially-crafted parameters.";
tag_solution = "No solution or patch is available as of 4th March, 2011. Information
  regarding this issue will updated once the solution details are available.
  For updates refer to http://www.pablosoftwaresolutions.com/html/quick__n_easy_ftp_server.html";
tag_summary = "The host is running Quick 'n Easy FTP Server and is prone to denial of service
  vulnerability.";
...
if(description)
{
  ...
  script_summary("Determine if Quick 'n Easy FTP Server is prone to DoS vulnerability");
