...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1210-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-September/001427.html");
  script_id(840756);
