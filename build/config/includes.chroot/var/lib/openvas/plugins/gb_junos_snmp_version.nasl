...
# $Id: gb_junos_snmp_version.nasl 18 2013-10-27 14:14:13Z jan $
#
...
if (description)
{
 ...
 tag_summary = "This script performs SNMP based detection of Junos.";
 ...
 script_summary("Checks for the presence of Junos");
