...
tag_insight = "Multiple vulnerabilities were found in libxml2 which could lead to
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201110-26
http://bugs.gentoo.org/show_bug.cgi?id=345555
http://bugs.gentoo.org/show_bug.cgi?id=370715
http://bugs.gentoo.org/show_bug.cgi?id=386985";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201110-26 (libxml2)");
