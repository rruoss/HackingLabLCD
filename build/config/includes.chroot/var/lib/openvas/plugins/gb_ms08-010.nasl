...
# $Id: gb_ms08-010.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(sysPath)
{
  ...
  if(vers)
  {
    ...
    {
      # Check for mshtml.dll version 5.0 < 5.0.3860.1000, 6.0 < 6.0.2800.1607
    ...
    else if(hotfix_check_sp(xp:4) > 0)
    {
      ...
      {
        # Check for mshtml.dll version 6.0 < 6.0.2900.3268, 7.0 < 7.0.6000.16608
   ...
   else if(hotfix_check_sp(win2003:3) > 0)
   {
     ...
     {
       # Check for mshtml.dll version 6.0 < 6.0.3790.3064
     ...
     {
       # Check for mshtml.dll version 6.0 < 6.0.3790.4210, 7.0 < 7.0.6000.16608
