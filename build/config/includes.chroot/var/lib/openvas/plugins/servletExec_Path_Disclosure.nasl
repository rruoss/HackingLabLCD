...
# $Id: servletExec_Path_Disclosure.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "By requesting a non-existent .JSP file, or by invoking the JSPServlet 
...
tag_solution = "Use the main ServletExec Admin UI to set a global error page for the entire 
...
if(description)
{
 ...
 name = "ServletExec 4.1 ISAPI Physical Path Disclosure";
 script_name(name);
...
";
 ...
 summary = "Tests for ServletExec 4.1 ISAPI Path Disclosure";
