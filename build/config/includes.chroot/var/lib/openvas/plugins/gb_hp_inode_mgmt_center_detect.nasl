...
# $Id: gb_hp_inode_mgmt_center_detect.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Detection of installed version of HP iNode Management Center");
  ...
  if(registry_key_exists(key:key))
  {
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(eregmatch(pattern:'^([0-9.]+)$', string:item))
      {
          ...
          ## Check the registry key existance
