...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001296.html");
  script_id(840627);
  ...
  script_summary("Check for the Version of tex-common vulnerability");
