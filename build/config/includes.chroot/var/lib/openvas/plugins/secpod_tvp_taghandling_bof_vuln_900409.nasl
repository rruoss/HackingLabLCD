...
# $Id: secpod_tvp_taghandling_bof_vuln_900409.nasl 16 2013-10-27 13:09:52Z jan $
...
tag_affected = "EffectMatrix Software, Total Video Player version 1.31 and prior on Windows.";
tag_insight = "The vulnerability is caused when the application parses a '.au' file containing
...
tag_solution = "No solution or patch is available as of 10th December, 2008.";
tag_summary = "This host is installed with Total Video Player and is prone to remote Buffer
