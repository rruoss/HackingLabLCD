...
tag_insight = "It was discovered that multiple integer overflows existed in the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1546-1";
tag_affected = "libgc on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001801.html");
  script_id(841125);
  ...
  script_summary("Check for the Version of libgc");
