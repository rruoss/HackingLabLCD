...
# $Id: esoft_slk_ssa_2004_154_02.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New PHP packages are available for Slackware 8.1, 9.0, 9.1, and -current
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-154-02";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2004-154-02 PHP local security issue ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2004-154-02 PHP local security issue");
