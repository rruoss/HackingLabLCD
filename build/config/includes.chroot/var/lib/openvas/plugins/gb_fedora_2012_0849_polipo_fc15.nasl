...
tag_affected = "polipo on Fedora 15";
tag_insight = "Polipo is a lightweight caching web proxy that was designed as a personal
...
if(description)
{
  ...
  script_summary("Check for the Version of polipo");
