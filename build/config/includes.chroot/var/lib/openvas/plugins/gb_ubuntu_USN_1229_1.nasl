...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-October/001444.html");
  script_id(840772);
  ...
  script_summary("Check for the Version of postgresql-8.4");
