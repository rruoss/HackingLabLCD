...
# $Id: gb_mozilla_prdts_jsinfer_dos_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the version of Mozilla Firefox/Thunderbird on Windows");
