...
# $Id: socks4_loop_connect.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Connect back to SOCKS4 server
#
# Authors:
...
if(description)
{
 ...
 name = "Connect back to SOCKS4 server";
 script_name(name);
 ...
 summary = "Connect back to SOCKS4 proxy";
