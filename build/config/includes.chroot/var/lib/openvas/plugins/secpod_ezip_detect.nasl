...
# $Id: secpod_ezip_detect.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "This script detects the installed version of eZip and sets
  the result in KB.";
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_name("eZip Version Detection");
  desc = "
  Summary:
  " + tag_summary;
  script_description(desc);
  script_summary("Sets the KB for the version of eZip");
