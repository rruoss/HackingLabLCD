...
# $Id: stun_detection.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Detect STUN Server
#
# Authors:
# Noam Rathaus
#
...
if(description)
{
 ...
 name = "Detect STUN Server";
 script_name(name);

 script_description(desc);
 summary = "STUN Server Detection";
...
#      display("ip: ", ip, "\n");
  ...
  {
   desc += '\n\nPlugin output :\n\n' + response;
   security_note(port:port, proto:"udp", data:desc);
