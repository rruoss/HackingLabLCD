...
tag_insight = "Ivano Cristofolini discovered that Samba incorrectly handled some Local
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1434-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-May/001673.html");
  script_id(840998);
