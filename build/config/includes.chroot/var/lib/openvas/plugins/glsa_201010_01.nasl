...
tag_insight = "Multiple vulnerabilities in libpng might lead to privilege escalation or a
    Denial of Service.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201010-01
http://bugs.gentoo.org/show_bug.cgi?id=307637
http://bugs.gentoo.org/show_bug.cgi?id=324153
http://bugs.gentoo.org/show_bug.cgi?id=335887";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201010-01 (libpng)");
