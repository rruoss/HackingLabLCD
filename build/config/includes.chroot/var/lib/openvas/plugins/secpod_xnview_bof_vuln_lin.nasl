...
# $Id: secpod_xnview_bof_vuln_lin.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "XnView versions prior to 1.97.2 on linux";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/62829");
