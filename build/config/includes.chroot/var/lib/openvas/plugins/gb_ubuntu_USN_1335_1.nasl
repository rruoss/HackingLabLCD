...
tag_insight = "Jon Larimer discovered that t1lib did not properly parse AFM fonts. If a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1335-1";
