...
tag_insight = "Aedla discovered that the kernel incorrectly handled /proc/&lt;pid&gt;/mem
  permissions. A local attacker could exploit this and gain root privileges.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1342-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001569.html");
  script_id(840882);
