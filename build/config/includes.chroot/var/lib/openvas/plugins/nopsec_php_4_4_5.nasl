...
# $Id: nopsec_php_4_4_5.nasl.nasl 110174
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 4.4.5
#
# Authors:
...
tag_solution = "Update PHP to version 4.4.5 or later.";
tag_summary = "PHP version smaller than 4.4.5 suffers vulnerability.";
...
script_name("PHP version smaller than 4.4.5");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"4.4.5"))
