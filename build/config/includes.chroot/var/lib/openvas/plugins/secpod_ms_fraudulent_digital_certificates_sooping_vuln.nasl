...
# $Id: secpod_ms_fraudulent_digital_certificates_sooping_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Microsoft Windows");
