...
tag_affected = "nspluginwrapper on Mandriva Linux 2010.1,
  Mandriva Linux 2010.1/X86_64";
tag_insight = "This is a bugfix and maintenance release that upgrades nspluginwrapper
...
if(description)
{
  ...
  script_summary("Check for the Version of nspluginwrapper");
