...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1534-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001787.html");
  script_id(841107);
