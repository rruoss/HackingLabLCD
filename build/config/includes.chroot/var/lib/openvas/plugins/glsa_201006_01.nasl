...
tag_insight = "Multiple vulnerabilities in FreeType might result in the remote execution
    of arbitrary code.";
tag_solution = "All FreeType 1 users should upgrade to an unaffected version:

# emerge --sync
# emerge --ask --oneshot --verbose '>=media-libs/freetype-1.4_pre20080316-r2'

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201006-01
http://bugs.gentoo.org/show_bug.cgi?id=271234
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201006-01 (freetype)");
