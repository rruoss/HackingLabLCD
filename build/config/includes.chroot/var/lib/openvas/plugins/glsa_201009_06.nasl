...
tag_insight = "Multiple vulnerabilities have been reported in Clam AntiVirus.";
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201009-06
http://bugs.gentoo.org/show_bug.cgi?id=314087
http://bugs.gentoo.org/show_bug.cgi?id=321157";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201009-06 (clamav)");
