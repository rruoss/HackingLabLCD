...
tag_insight = "Alec Warner discovered that xdiagnose improperly handled temporary files
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1591-1";
tag_affected = "- xdiagnose on Ubuntu 12.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001849.html");
  script_id(841167);
 ...
 script_version("$Revision: 12 $");
  ...
  script_summary("Check for the Version of - xdiagnose");
