...
# $Id: gb_oracle_virtualbox_unspecified_dos_vuln_win.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the version of Oracle VM VirtualBox on Windows");
