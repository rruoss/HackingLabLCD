...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1091-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-March/001283.html");
  script_id(840617);
