...
tag_insight = "It was discovered that the X wrapper incorrectly checked certain console
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1349-1";
tag_affected = "xorg on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001571.html");
  script_id(840878);
