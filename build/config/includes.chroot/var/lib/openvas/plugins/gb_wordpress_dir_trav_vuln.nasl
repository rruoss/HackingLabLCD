...
# $Id: gb_wordpress_dir_trav_vuln.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_impact = "Successful attack could lead to execution of arbitrary PHP code and
  can even access sensitive information.
  Impact Level: Application";
tag_affected = "WordPress 2.3.3 and earlier.";
tag_insight = "The flaw is due to improper validation of input passed via cat parameter
  to index.php which is not properly sanitized in the get_category_template()
  function.";
tag_solution = "Update to Version 2.5.1 or later.
  http://wordpress.org/";
tag_summary = "The host is installed with WordPress and is prone to Directory Traversal
  Vulnerability.";
