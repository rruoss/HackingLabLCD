...
# $Id: secpod_crawltrack_detect.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "The script detects the version of CrawlTrack on remote host
  and sets the KB.";
...
foreach dir (make_list("/crawltrack", "/crawler", "/", cgi_dirs()))
{
  ## Send and Recieve the response
  sndReq = http_get(item:string(dir, "/html/infoen.htm"), port:port);
