...
# $Id: gb_synergy_detect_win.nasl 13 2013-10-27 12:16:33Z jan $
#
...
## Get Synergy Version From Registry
foreach item (registry_enum_keys(key:key))
{
  ...
  if("Synergy" >< name)
  {
    ...
    if(ver != NULL)
    {
      set_kb_item(name:"Synergy/Win/Ver", value:ver);
      security_note(data:"Synergy version " + ver + " was detected on the host");
    }
  }
}
