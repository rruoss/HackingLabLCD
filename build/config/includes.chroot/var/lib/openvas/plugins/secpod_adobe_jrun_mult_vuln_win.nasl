...
# $Id: secpod_adobe_jrun_mult_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
# Adobe JRun Management Console Multiple Vulnerabilities (Win)
#
# Authors:
...
if(description)
{
  ...
  script_summary("Check for the version of Adobe JRun");
