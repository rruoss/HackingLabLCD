...
# $Id: gb_nuralstorm_webmail_41559.nasl 14 2013-10-27 12:33:37Z jan $
#
...
desc = "
 ...
 script_summary("Determine if NuralStorm Webmail is prone to multiple security vulnerabilities");
...
if(http_vuln_check(port:port,url:url,pattern:"<script>alert\('openvas-xss-test'\);</script>",extra_check:"selectedIndex")) {
