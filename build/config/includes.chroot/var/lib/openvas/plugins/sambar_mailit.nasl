...
# $Id: sambar_mailit.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Sambar /cgi-bin/mailit.pl installed ?
#
# Authors:
...
if(description)
{
 ...
 name = "Sambar /cgi-bin/mailit.pl installed ?";
 script_name(name);
 ...
 summary = "Checks for the presence of /cgi-bin/mailit";
