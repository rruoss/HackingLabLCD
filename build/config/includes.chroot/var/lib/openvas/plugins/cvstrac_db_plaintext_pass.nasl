...
# $Id: cvstrac_db_plaintext_pass.nasl 17 2013-10-27 14:01:43Z jan $
# Description: CVSTrac database plaintext password storage
#
# Authors:
...
if(description)
{
 ...
 name = "CVSTrac database plaintext password storage";
