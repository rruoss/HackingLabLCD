...
tag_insight = "This is a bugfix and maintenance update of the psmisc package(s)
...
tag_affected = "psmisc on Mandriva Linux 2010.1,
...
if(description)
{
  ...
  script_summary("Check for the Version of psmisc");
