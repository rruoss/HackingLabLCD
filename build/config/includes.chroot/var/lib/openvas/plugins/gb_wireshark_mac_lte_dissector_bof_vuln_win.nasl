...
# $Id: gb_wireshark_mac_lte_dissector_bof_vuln_win.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  script_name("Wireshark MAC-LTE dissector Buffer Overflow Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
