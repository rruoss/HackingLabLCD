...
tag_affected = "lsb-release on Mandriva Linux 2010.1,
  Mandriva Linux 2010.1/X86_64";
tag_insight = "This updates the version of lsb_release to 2010.2, fixes also an
...
if(description)
{
  ...
  script_summary("Check for the Version of lsb-release");
