...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001297.html");
  script_id(840629);
  ...
  script_summary("Check for the Version of ffmpeg vulnerabilities");
