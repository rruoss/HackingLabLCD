...
# $Id: gb_ms08-008.nasl 13 2013-10-27 12:16:33Z jan $
#
...
# Check for existance of Visual Basic
...
if(hotfix_check_sp(win2k:5) > 0)
{
  ...
  if(version_is_less(version:sysVer, test_version:"2.40.4532.0")){
      security_hole(0);
  }
  exit(0);
}
...
else if(hotfix_check_sp(xp:4) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    ...
    if(version_is_less(version:sysVer, test_version:"5.1.2600.3266")){
           security_hole(0);
    }
    exit(0);
  }
...
else if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  if("Service Pack 1" >< SP)
  {
    ...
    if(version_is_less(version:sysVer, test_version:"5.2.3790.3057")){
         security_hole(0);
    }
    exit(0);
  }
  ...
  if("Service Pack 2" >< SP)
  {
    ...
    if(version_is_less(version:sysVer, test_version:"5.2.3790.4202")){
       security_hole(0);
    }
    exit(0);
  }
...
else if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  if(version_is_less(version:sysVer, test_version:"6.0.6000.16607")){
    security_hole(0);
  }
  exit(0);
}
