...
# $Id: gb_logrover_sql_inj_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will allow remote attackers to conduct SQL injection
  attacks.
  Impact Level: Application";
tag_affected = "LogRover version 2.3.3 and prior";
tag_insight = "Input passed to the 'uname' and 'pword' parameters in 'login.asp' is not
...
tag_solution = "No solution or patch is available as of 08th October, 2009. Information
  ...
  For updates refer to http://logrover.com/index.cfm";
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/55825");
