...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-August/000576.html");
  script_id(840189);
  ...
  script_summary("Check for the Version of jasper vulnerability");
