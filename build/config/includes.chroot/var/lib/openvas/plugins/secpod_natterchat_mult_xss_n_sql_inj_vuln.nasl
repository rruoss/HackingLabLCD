...
# $Id: secpod_natterchat_mult_xss_n_sql_inj_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "- Multiple SQL injection flaws in login.asp, which can be caused via the
...
tag_summary = "The host is running NatterChat and is prone to multiple XSS and SQL
