...
# $Id: secpod_mozilla_prdts_mult_vuln_feb10_lin01.nasl 14 2013-10-27 12:33:37Z jan $
#
# Mozilla Products Multiple Vulnerabilities feb-10 (Lin)
#
# Authors:
...
if(description)
{
  ...
  script_name("Mozilla Products Multiple Vulnerabilities feb-10 (Lin)");
  desc = "
  Summary:
  " + tag_summary + "
