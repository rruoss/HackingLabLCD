...
tag_insight = "Xi Wang and Florian Weimer discovered that libssh incorrectly handled
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1640-1";
