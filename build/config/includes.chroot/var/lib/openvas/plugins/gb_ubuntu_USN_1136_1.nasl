...
tag_insight = "It was discovered that rdesktop incorrectly handled specially crafted
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1136-1";
tag_affected = "rdesktop on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-May/001333.html");
  script_id(840662);
