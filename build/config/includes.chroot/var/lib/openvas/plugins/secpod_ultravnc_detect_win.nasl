...
# $Id: secpod_ultravnc_detect_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "This script finds the installed version of UltraVNC and
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_name("UltraVNC Version Detection (Win)");
  desc = "
  Summary:
  " + tag_summary;
  script_description(desc);
  script_summary("Set Version of UltraVNC in KB");
