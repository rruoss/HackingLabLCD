...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-April/000689.html");
  script_id(840317);
  ...
  script_summary("Check for the Version of ghostscript, gs-esp, gs-gpl vulnerability");
