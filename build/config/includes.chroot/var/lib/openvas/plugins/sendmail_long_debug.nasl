...
# $Id: sendmail_long_debug.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_solution = "Install sendmail newer than versions 8.6.8 or install
...
if(description)
{
 ...
 name = "Sendmail long debug local overflow";
 script_name(name);
