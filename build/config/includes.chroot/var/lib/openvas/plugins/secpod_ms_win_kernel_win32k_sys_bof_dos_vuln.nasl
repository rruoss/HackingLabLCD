...
# $Id: secpod_ms_win_kernel_win32k_sys_bof_dos_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will allow attackers to crash an affected system or
...
tag_insight = "The flaw is due to a buffer overflow error in the 'CreateDIBPalette()'
...
## check the existance of the file for win2k, winxp, win2003
...
## check the existance of the file for , winVista, win2008, win7
