...
# $Id: deb_2215_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "Dylan Simon discovered that gitolite, a SSH-based gatekeeper for git
...
tag_summary = "The remote host is missing an update to gitolite
announced via advisory DSA 2215-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202215-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2215-1 (gitolite)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"gitolite", ver:"1.5.4-2+squeeze1", rls:"DEB6.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"gitolite", ver:"1.5.7-2", rls:"DEB7.0")) != NULL) {
    report += res;
}
