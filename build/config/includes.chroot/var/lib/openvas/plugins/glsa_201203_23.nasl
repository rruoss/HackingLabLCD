...
tag_insight = "Multiple vulnerabilities have been found in libzip, the worst of
    which might allow execution of arbitrary code.";
tag_solution = "All libzip users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=dev-libs/libzip-0.10.1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201203-23
http://bugs.gentoo.org/show_bug.cgi?id=409117";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201203-23 (libzip)");
