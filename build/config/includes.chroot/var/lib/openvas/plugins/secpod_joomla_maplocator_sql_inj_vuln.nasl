...
# $Id: secpod_joomla_maplocator_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation will let attackers to conduct SQL Injection attacks
...
tag_insight = "The flaw is caused by improper validation of user-supplied input via the
  'cid' parameter in 'index.php', which allows attacker to manipulate
   SQL queries by injecting arbitrary SQL code.";
tag_solution = "No solution or patch is available as of 25th, May 2011. Information
