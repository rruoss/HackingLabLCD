...
tag_insight = "Multiple vulnerabilities have been found in Postfixadmin which may
    lead to SQL injection or cross-site scripting attacks.";
tag_solution = "All Postfixadmin users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=www-apps/postfixadmin-2.3.5'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-18
http://bugs.gentoo.org/show_bug.cgi?id=400971";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-18 (postfixadmin)");
