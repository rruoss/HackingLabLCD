...
# $Id: secpod_ms10-022.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaw exists in the way 'VBScript' interacts with Windows Help files
...
if(sysPath)
{
  sysVer = get_file_version(sysPath, file_name:"Vbscript.dll");
  if(!sysVer){
    exit(0);
  }
}
...
if(sysPath)
{
  dllVer = get_file_version(sysPath, file_name:"System32\Vbscript.dll");
  if(!dllVer){
    exit(0);
  }
}
...
{
  # Grep for Vbscript.dll version < 5.8.7600.16546
