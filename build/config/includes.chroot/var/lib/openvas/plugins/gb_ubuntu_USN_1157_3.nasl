...
tag_insight = "USN-1157-1 fixed vulnerabilities in Firefox. Unfortunately, this update
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1157-3";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-June/001361.html");
  script_id(840690);
