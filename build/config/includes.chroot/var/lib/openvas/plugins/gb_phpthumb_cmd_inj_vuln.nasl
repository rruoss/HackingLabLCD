...
# $Id: gb_phpthumb_cmd_inj_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploitation will allow attacker to inject and execute arbitrary
  shell commands via specially crafted requests in the context of the web server.
...
tag_insight = "The flaw is caused by improper validation of user-supplied input via the
  'fltr[]' parameter to 'phpThumb.php', which allow attackers to inject
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/63939");
  ...
  script_summary("Check for the version of phpThumb");
