...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-January/001035.html");
  script_id(840377);
  ...
  script_summary("Check for the Version of python2.4 vulnerabilities");
