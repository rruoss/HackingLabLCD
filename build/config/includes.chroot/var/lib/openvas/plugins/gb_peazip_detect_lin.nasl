...
# $Id: gb_peazip_detect_lin.nasl 15 2013-10-27 12:49:54Z jan $
#
# PeaZIP Version Detection (Lin)
#
# Authors:
...
if(description)
{
 ...
 script_version("$Revision: 15 $");
  ...
  script_name("PeaZIP Version Detection (Lin)");
  desc = "
  Summary:
  " + tag_summary;
  script_description(desc);
  script_summary("Set KB for the version of PeaZIP");
