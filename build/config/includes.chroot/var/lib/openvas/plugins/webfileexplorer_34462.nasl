...
# $Id: webfileexplorer_34462.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_summary = "WebFileExplorer is prone to an SQL-injection vulnerability because
  ...
  WebFileExplorer 3.1 is vulnerable; other versions may also be
  affected.";
...
if (description)
{
 ...
 script_summary("Determine if WebFileExplorer is vulnerable to SQL Injection");
