...
# $Id: gb_apple_quicktime_mult_vuln_win_may12.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "QuickTime Player version prior to 7.7.2 on Windows";
tag_insight = "The flaws are due to
  ...
  - A boundary error in QuickTime.qts when extending a file path based on its
    short path.";
tag_solution = "Upgrade to QuickTime Player version 7.7.2 or later,
...
if(description)
{
  ...
  script_summary("Check the version of QuickTime Player on Windows");
...
## Check for QuickTime Player Version less than 7.7.2
