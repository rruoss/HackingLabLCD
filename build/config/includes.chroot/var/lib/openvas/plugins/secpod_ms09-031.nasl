...
# $Id: secpod_ms09-031.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Exploitation could allow remote attackers to bypass security restrictions
  and to execute arbitrary code with the privileges of the user.
  Impact Level: System/Network.";
tag_affected = "Microsoft Internet Security and Acceleration Server 2006 and with SP1.
  Microsoft Internet Security and Acceleration Server 2006 with Update";
tag_insight = "When ISA Server 2006 authentication is configured with Radius OTP
