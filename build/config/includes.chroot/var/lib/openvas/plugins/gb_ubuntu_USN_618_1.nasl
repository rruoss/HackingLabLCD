...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-June/000721.html");
  script_id(840280);
  ...
  script_summary("Check for the Version of linux-source-2.6.15/20/22 vulnerabilities");
