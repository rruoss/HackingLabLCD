...
# $Id: gb_pidgin_msnslp_dir_trav_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
# Pidgin MSN Custom Smileys File Disclosure Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Pidgin MSN Custom Smileys File Disclosure Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
