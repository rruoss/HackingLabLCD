...
tag_insight = "A buffer overflow vulnerability in nginx could result in the
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-07
http://bugs.gentoo.org/show_bug.cgi?id=411751";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-07 (nginx)");
