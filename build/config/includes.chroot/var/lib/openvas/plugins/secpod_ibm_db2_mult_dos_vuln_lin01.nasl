...
# $Id: secpod_ibm_db2_mult_dos_vuln_lin01.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "- An error in DRDA Services component can be exploited via an IPv6 address
...
# Check for IBM DB2 Products Version 8 before 8 FP17    => 8.1.17.617
# Check for IBM DB2 products Version 9.1 before 9.1 FP7 => 9.1.0.7
# Check for IBM DB2 Products Version 9.5 before 9.5 FP4 => 9.5.0.4
