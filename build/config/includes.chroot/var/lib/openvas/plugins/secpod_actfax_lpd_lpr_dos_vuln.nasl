...
# $Id: secpod_actfax_lpd_lpr_dos_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_insight = "The flaw is caused by a buffer overflow error when processing packets sent
  to port 515/TCP, which could be exploited by remote unauthenticated attackers
...
tag_summary = "The host is running ActFax LPD/LPR Server and is prone to denial of service
  vulnerability.";
