...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-August/000577.html");
  script_id(840169);
  ...
  script_summary("Check for the Version of kdebase, kdelibs vulnerabilities");
