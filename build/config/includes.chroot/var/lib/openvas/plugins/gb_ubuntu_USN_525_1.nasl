...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-October/000602.html");
  script_id(840055);
  ...
  script_summary("Check for the Version of libsndfile vulnerability");
