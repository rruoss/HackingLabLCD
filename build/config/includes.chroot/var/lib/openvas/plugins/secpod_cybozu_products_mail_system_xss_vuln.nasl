...
# $Id: secpod_cybozu_products_mail_system_xss_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Cybozu Office version 6
...
tag_insight = "The flaw is caused by improper validation of unspecified input related to
  ...
  affected site.";
tag_solution = "Upgrade to Cybozu Garoon version 2.5.0, Cybozu Office version 7
  Cybozu Dezie version 6.1, Cybozu Mailwise version 3.1 or later.
  For updates refer to http://products.cybozu.co.jp/";
tag_summary = "This host is running Cybozu Office, Cybozu Garoon, Cybozu Dezie or
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/73317");
  ...
  script_summary("Check for the version of Cybozu Products");
...
## Check for Cybozu Dezie versions before 6.1
...
## Check for Cybozu MailWise before 3.1
