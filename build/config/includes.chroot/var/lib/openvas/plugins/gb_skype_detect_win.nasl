...
# $Id: gb_skype_detect_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the installed version of Skype and saves the
  result in KB.";
...
if(description)
{
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Set version of Skype in KB");
...
foreach item (registry_enum_keys(key:key))
{
  ...
  if("Skype" >< name)
  {
    skypeVer = registry_get_sz(key:key + item, item:"DisplayVersion");
    if(skypeVer)
    {
