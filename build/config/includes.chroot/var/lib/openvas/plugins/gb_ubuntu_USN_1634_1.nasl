...
tag_insight = "Dwayne Litzenberger discovered that Python Keyring's CryptedFileKeyring
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1634-1";
tag_affected = "python-keyring on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 11.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-November/001897.html");
  script_id(841218);
