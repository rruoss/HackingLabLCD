...
tag_insight = "An integer overflow in ImageMagick might allow remote attackers to cause
    the remote execution of arbitrary code.";
tag_solution = "All ImageMagick users should upgrade to an unaffected version:
