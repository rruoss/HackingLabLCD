...
# $Id: secpod_ms_ie_web_script_exec_vuln_jun09.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "- Error exists while the HTTP Host header to determine the context of a
...
tag_solution = "No solution or patch is available as of 16th June, 2009. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to
  http://www.microsoft.com/windows/internet-explorer/download-ie.aspx";
tag_summary = "This host has Internet Explorer installed and is prone to Web Script
