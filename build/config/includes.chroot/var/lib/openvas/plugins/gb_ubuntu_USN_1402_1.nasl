...
tag_insight = "It was discovered that libpng did not properly process compressed chunks.
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1402-1";
tag_affected = "libpng on Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001635.html");
  script_id(840960);
