...
tag_insight = "Insecure usage of server provided filenames may allow the creation
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201110-10
http://bugs.gentoo.org/show_bug.cgi?id=329941";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201110-10 (Wget)");
