...
# $Id: gb_sun_java_jre_code_exe_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
# Sun Java JRE Remote Code Execution Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Sun Java JRE Remote Code Execution Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
