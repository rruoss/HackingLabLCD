...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1251-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-November/001476.html");
  script_id(840801);
