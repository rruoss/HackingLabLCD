...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-January/000650.html");
  script_id(840217);
  ...
  script_summary("Check for the Version of net-snmp vulnerability");
