...
# $Id: gb_openmairie_openannuaire_mult_file_incl_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "OpenMairie openAnnuaire version 2.00";
...
tag_solution = "No solution or patch is available as of 19th May, 2010. Information
  ...
  For updates refer to http://adullact.net/frs/?group_id=417";
tag_summary = "This host is running OpenMairie openAnnuaire and is prone to
...
if(description)
{
  ...
  script_summary("Check for the exploit string on OpenMairie openAnnuaire");
...
## Get openAnnuaire version from KB
