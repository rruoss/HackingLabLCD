...
# $Id: gb_oracle_database_mult_unspecified_vuln_jan08.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Oracle Database server versions 8.1.7.4, 9.0.1.5, 9.2.0.6, 10.1.0.3, 9.2.0.7,
  10.1.0.5, 10.2.0.1, 9.0.1.5 FIPS, 9.0.1.5 FIPS+, 9.2.0.8, 9.2.0.8DV,
  10.1.0.5, 10.2.0.3, 10.1.0.4 and 11.1.0.6";
tag_insight = "The flaws are due to unspecified errors in the multiple components.";
...
if(version_in_range(version:dbVer[1], test_version:"10.2.0.0", test_version2:"10.2.0.2") ||
   ...
   version_in_range(version:dbVer[1], test_version:"11.1.0", test_version2:"11.1.0.5"))
{
...
if(version_is_equal(version:dbVer[1], test_version:"8.1.7.4") ||
   ...
   version_is_equal(version:dbVer[1], test_version:"11.1.0.6")){
