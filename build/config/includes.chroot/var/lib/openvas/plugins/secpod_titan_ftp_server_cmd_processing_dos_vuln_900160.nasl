...
# $Id: secpod_titan_ftp_server_cmd_processing_dos_vuln_900160.nasl 16 2013-10-27 13:09:52Z jan $
...
if(description)
{
 ...
 script_bugtraq_id(31757);
  ...
  script_summary("Check for vulnerable version of Titan FTP Server");
  desc = "
  Summary:
  " + tag_summary + "
  Impact:
