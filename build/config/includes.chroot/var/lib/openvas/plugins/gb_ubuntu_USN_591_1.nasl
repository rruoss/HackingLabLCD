...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-March/000678.html");
  script_id(840278);
  ...
  script_summary("Check for the Version of icu vulnerabilities");
