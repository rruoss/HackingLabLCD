...
# $Id: esoft_slk_ssa_2007_243_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "Sun has released security advisories pertaining to both the Java
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2007-243-01";
...
if(description)
{
 ...
 name = "Slackware Advisory SSA:2007-243-01 java (jre, jdk) ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2007-243-01 java (jre, jdk)");
...
vuln = 0;
if(isslkpkgvuln(pkg:"jre", ver:"6u2-i586-1", rls:"SLK12.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"jdk", ver:"6u2-i586-1", rls:"SLK12.0")) {
    vuln = 1;
}
