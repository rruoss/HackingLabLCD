...
# $Id: telnetserver_detect_type_nd_version.nasl 41 2013-11-04 19:00:12Z jan $
# Description: Detect Server type and version via Telnet
#
# Authors:
...
tag_summary = "This detects the Telnet Server's type and version by connecting to the server 
...
if(description)
{
 ...
 name = "Detect Server type and version via Telnet";
 script_name(name);
