...
# $Id: cart32_xss.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Cart32 GetLatestBuilds XSS
#
# Authors:
# Noam Rathaus
#
...
tag_summary = "The remote web server contains a CGI which is contains a cross site scripting 
vulnerability.
...
if(description)
{
 ...
 summary = "Checks for the presence of an XSS bug in Cart32";
