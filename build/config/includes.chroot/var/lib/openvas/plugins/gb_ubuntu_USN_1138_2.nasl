...
tag_insight = "USN-1138-1 fixed a vulnerability in DBus-GLib. NetworkManager and
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1138-2";
tag_affected = "modemmanager on Ubuntu 10.04 LTS ,
  Ubuntu 8.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-May/001338.html");
  script_id(840665);
  ...
  script_summary("Check for the Version of modemmanager");
