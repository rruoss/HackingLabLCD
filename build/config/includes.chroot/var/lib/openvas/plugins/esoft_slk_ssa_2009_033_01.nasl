...
# $Id: esoft_slk_ssa_2009_033_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New xdg-utils packages are available for Slackware 12.2 and -current to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2009-033-01";
...
";
 ...
 script_summary("Slackware Advisory SSA:2009-033-01 xdg-utils");
...
vuln = 0;
if(isslkpkgvuln(pkg:"xdg-utils", ver:"1.0.2-noarch-3_slack12.2", rls:"SLK12.2")) {
    vuln = 1;
}
