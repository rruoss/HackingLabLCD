...
tag_insight = "It was discovered that Ubuntu One Couch did not perform any server
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1381-1";
tag_affected = "ubuntuone-couch on Ubuntu 11.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001611.html");
  script_id(840952);
  ...
  script_summary("Check for the Version of ubuntuone-couch");
