...
tag_insight = "A buffer overflow vulnerability in Calligra could result in the
execution of arbitrary code.";
tag_solution = "All Calligra users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=app-office/calligra-2.4.3-r1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-10
http://bugs.gentoo.org/show_bug.cgi?id=428890";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-10 (calligra)");
