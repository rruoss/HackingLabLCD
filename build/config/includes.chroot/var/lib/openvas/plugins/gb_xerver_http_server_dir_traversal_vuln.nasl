...
# $Id: gb_xerver_http_server_dir_traversal_vuln.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation will allow attackers to execute arbitrary HTML
...
tag_insight = "The flaw is due to improper sanitization of user supplied input passed via
...
tag_summary = "This host is running Xerver HTTP Server and is prone to the Directory
