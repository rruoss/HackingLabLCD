...
tag_insight = "Tom Lane discovered that ImageMagick would not always properly allocate
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1544-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-August/001799.html");
  script_id(841123);
