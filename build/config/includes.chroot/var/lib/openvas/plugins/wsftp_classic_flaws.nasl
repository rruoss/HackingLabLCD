...
# $Id: wsftp_classic_flaws.nasl 17 2013-10-27 14:01:43Z jan $
# Description: WS FTP server FTP bounce attack and PASV connection hijacking flaw
#
# Authors:
...
tag_summary = "According to its version number, the remote WS_FTP server is vulnerable
