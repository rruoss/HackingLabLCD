...
# $Id: secpod_ie_dos_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_impact = "Successful exploits will cause application to crash or become unresponsive,
...
tag_insight = "The flaw is due to improper bounds checking when processing '.ani' files
...
tag_solution = "No solution or patch is available as of 29th March, 2010. Information
...
if(description)
{
  ...
  script_summary("Check the Windows Platform");
