...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-September/000744.html");
  script_id(840355);
  ...
  script_summary("Check for the Version of tiff vulnerability");
