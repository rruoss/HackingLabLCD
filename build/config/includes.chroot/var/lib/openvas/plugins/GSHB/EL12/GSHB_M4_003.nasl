...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.003
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_003/result", value:result);
set_kb_item(name:"GSHB-12/M4_003/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_003/name", value:name);
