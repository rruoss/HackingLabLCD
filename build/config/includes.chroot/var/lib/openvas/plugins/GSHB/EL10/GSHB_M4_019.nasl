...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.019
#
# Authors:
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-10/M4_019/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-10/M4_019/desc", value:"Leider setzen Sie einen zu alte OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-10/M4_019/name", value:name);
...
if(OSNAME >!< "none"){
  ...
  desc = string('Es konnten keine Fehlerhaften umask Eintr‰ge und Dateien mit setuid-Bit unter /* gefunden werden.');
  ...
  if(tempsticky == "false") desc += string('F¸r das Verzeichnis /tmp wurde das sticky-Bit nicht gesetzt.');
}

set_kb_item(name:"GSHB-10/M4_019/result", value:result);
set_kb_item(name:"GSHB-10/M4_019/desc", value:desc);
set_kb_item(name:"GSHB-10/M4_019/name", value:name);
