...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.227
#
# Authors:
...
if(description)
{
  ...
  script_require_keys("WMI/NtpServer", "WMI/WMI_WindowsDomain", "GSHB/GSHB_WMI_OSInfo.nasl");
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  result = string("nicht zutreffend");
  desc = string("Auf dem System wurde kein Eintrag f¸r einen NTP Server gefunden");
