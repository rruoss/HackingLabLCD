...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.344: Überwachung eines Windows Vista Systems (Win)");
  desc = "
  Summary:
  " + tag_summary;
  script_description(desc);

  script_summary("IT-Grundschutz M4.344: Überwachung eines Windows Vista Systems (Win).");
...
name = 'IT-Grundschutz M4.344: Überwachung eines Windows Vista Systems (Win)\n';
...
set_kb_item(name:"GSHB-12/M4_344/result", value:result);
set_kb_item(name:"GSHB-12/M4_344/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_344/name", value:name);
