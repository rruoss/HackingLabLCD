...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.334
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"Mon May 31 12:03:21 2010 +0200");
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_334/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_334/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_334/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_334/result", value:result);
set_kb_item(name:"GSHB-11/M4_334/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_334/name", value:name);
