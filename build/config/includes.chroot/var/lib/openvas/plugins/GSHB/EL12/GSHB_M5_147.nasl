...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.147
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_147/result", value:result);
set_kb_item(name:"GSHB-12/M5_147/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_147/name", value:name);
