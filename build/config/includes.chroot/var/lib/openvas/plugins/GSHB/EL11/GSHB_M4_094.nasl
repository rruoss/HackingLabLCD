...
# $Id: GSHB_M4_094.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.094
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.094: Schutz der WWW-Dateien.
  ...
  http://www.bsi.bund.de/grundschutz/kataloge/m/m04/m04094.html";
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"Fri Feb 12 15:20:55 2010 +0100");
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-11/M4_094/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_094/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_094/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_094/result", value:result);
set_kb_item(name:"GSHB-11/M4_094/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_094/name", value:name);
