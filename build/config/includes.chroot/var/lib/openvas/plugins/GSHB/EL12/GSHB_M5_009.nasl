...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.009
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_009/result", value:result);
set_kb_item(name:"GSHB-12/M5_009/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_009/name", value:name);
