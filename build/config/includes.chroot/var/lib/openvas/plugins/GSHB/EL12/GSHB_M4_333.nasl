...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.333
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_333/result", value:result);
set_kb_item(name:"GSHB-12/M4_333/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_333/name", value:name);
