...
# $Id: GSHB_M4_077.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.077
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.077: Schutz der Administratorkonten unter Windows NT (Win)
...
# Da dieser Test noch nicht komplett ist, wird "result" auf unvollst‰ndig gesetzt wenn die vorhandenen Pr¸fungen erf¸llt sind.!
if (result >< "erf¸llt") result = string("unvollst‰ndig");
