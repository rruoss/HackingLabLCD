...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.147
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.147: Sichere Nutzung von EFS unter Windows (Win).
  ...
  *********************************ACHTUNG**************************************
  ...
  Einstellungen | Sicherheitseinstellungen | Richtlinien f¸r ˆffentlicher 
  ...
  Die Maﬂnahme ist in EL11 technisch fehlerhaft. 
  Der Test f¸hrt abweichend von der Maﬂnahme den korrekten Test aus.
