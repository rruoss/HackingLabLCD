...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.300
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_300/result", value:result);
set_kb_item(name:"GSHB-12/M4_300/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_300/name", value:name);
