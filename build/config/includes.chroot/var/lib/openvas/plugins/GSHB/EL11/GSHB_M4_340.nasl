...
# $Id: GSHB_M4_340.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.340
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.340: Einsatz der Windows Vista Benutzerkontensteuerung  - UACWin).
  ...
  http://www.bsi.bund.de/grundschutz/kataloge/m/m04/m04340.html";
...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.340: Einsatz der Windows Vista Benutzerkontensteuerung - UAC (Win)");
  ...
  if (! OPENVAS_VERSION)
  {
    ...
    script_summary("IT-Grundschutz M4.340: Einsatz der Windows Vista Benutzerkontensteuerung - UAC (Win).");
...
name = 'IT-Grundschutz M4.340: Einsatz der Windows Vista Benutzerkontensteuerung - UAC (Win)\n';



if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-11/M4_340/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_340/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_340/name", value:name);
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  else
  {
    ...
    {
      result = string("nicht erf¸llt");
      if (ConsentPromptBehaviorAdmin != "0") desc = string('Der Registry Wert f¸r ConsentPromptBehaviorAdmin ist\nnicht wie gefordert -0-!\n');
      if (ConsentPromptBehaviorUser != "1") desc += string('Der Registry Wert f¸r ConsentPromptBehaviorUser ist\nnicht wie gefordert -1-!\n');
    }
    else
    {
...
set_kb_item(name:"GSHB-11/M4_340/result", value:result);
set_kb_item(name:"GSHB-11/M4_340/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_340/name", value:name);
