...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.288
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"Fri Jun 04 11:48:40 2010 +0200");
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_288/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_288/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_288/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_288/result", value:result);
set_kb_item(name:"GSHB-11/M4_288/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_288/name", value:name);
