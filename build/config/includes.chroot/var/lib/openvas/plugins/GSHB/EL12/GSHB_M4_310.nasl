...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.310
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_310/result", value:result);
set_kb_item(name:"GSHB-12/M4_310/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_310/name", value:name);
