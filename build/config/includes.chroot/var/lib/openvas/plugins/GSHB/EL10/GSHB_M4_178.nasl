...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.178
#
# Authors:
...
if(description)
{
  ...
  script_mandatory_keys("Compliance/Launch/GSHB-10", "GSHB/GSHB_WMI_OSInfo.nasl");
...
if (WMIOSLOG == "On the Target System runs Samba, it is not an Microsoft System."){
  ...
  desc = string('Wie in Maﬂnahme 4.178 gefordern ist die passfilt.dll Installiert und Registriert.\n Bitte achten Sie auch darauf, dass das Administratorkonto mit passprop.exe\n gesichert ist und die SAM-Datei mit dem SYSKEY Verfahren verschl¸sselt ist.');
}else{
  result = string("nicht erf¸llt");
  desc = string('Die passfilt.dll ist nicht wie in Maﬂnahme 4.178 gefordern Installiert und Registriert.\n Bitte achten Sie auch darauf, dass das Administratorkonto mit passprop.exe\n gesichert ist und die SAM-Datei mit dem SYSKEY Verfahren verschl¸sselt ist.');
