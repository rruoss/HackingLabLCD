...
# $Id: GSHB_M5_107.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 5.107
#
# Authors:
...
tag_summary = "IT-Grundschutz M5.107: Verwendung von SSL im Apache-Webserver.
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M5_107/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M5_107/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M5_107/name", value:name);
    log_message(port:0, proto: "IT-Grundschutz", data:string("Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!"));  
    exit(0);
}


gshbm =  "GSHB Maﬂnahme 5.107: ";

SSL = get_kb_item("GSHB/APACHE/SSL");
log = get_kb_item("GSHB/APACHE/SSL/log");
...
else if ("inapplicable" >< SSL)
{
  ...
  desc = string("Auf dem Zielsystem ist kein Webserver ¸ber Port 443 erreichbar.");
}
else if ("false" >< SSL)
{
...
else if ("true" >< SSL)
{
  ...
  desc = string("SSL ist im Apache ¸ber Port 443 aktiviert.");
}

set_kb_item(name:"GSHB-11/M5_107/result", value:result);
set_kb_item(name:"GSHB-11/M5_107/desc", value:desc);
set_kb_item(name:"GSHB-11/M5_107/name", value:name);
