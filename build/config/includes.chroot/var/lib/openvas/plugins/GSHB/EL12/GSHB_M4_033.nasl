...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.033
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_033/result", value:result);
set_kb_item(name:"GSHB-12/M4_033/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_033/name", value:name);
