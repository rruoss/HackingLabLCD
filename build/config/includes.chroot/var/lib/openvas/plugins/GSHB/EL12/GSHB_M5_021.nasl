...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.021
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_021/result", value:result);
set_kb_item(name:"GSHB-12/M5_021/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_021/name", value:name);
