...
# $Id: GSHB-11.nasl 9 2013-10-27 09:38:41Z jan $
#
...
M4.004 Geeigneter Umgang mit Laufwerken für Wechselmedien und\n                externen Datenspeichern
...
M4.017 Sperren und Löschen nicht benötigter Accounts und\n                Terminals
...
M4.021 Verhinderung des unautorisierten Erlangens von Admini-\n                stratorrechten
M4.022 Verhinderung des Vertraulichkeitsverlusts schutzbe-\n                dürftiger Daten im Unix-System
...
M4.029 Einsatz eines Verschlüsselungsproduktes für tragbare\n                IT-Systeme
M4.030 Nutzung der in Anwendungsprogrammen angebotenen\n                Sicherheitsfunktionen
M4.031 Sicherstellung der Energieversorgung im mobilen Einsatz
M4.032 Physikalisches Löschen der Datenträger vor und nach-\n                Verwendung
M4.033 Einsatz eines Viren-Suchprogramms bei Datenträgeraus-\n                tausch und Datenübertragung
...
M4.045 Diese Maßnahme ist entfallen!
M4.046 Diese Maßnahme ist entfallen!
M4.047 Protokollierung der Sicherheitsgateway-Aktivitäten
M4.048 Passwortschutz unter NT-basierten Windows-Systemen
M4.049 Absicherung des Boot-Vorgangs für ein NT-basiertes Windows-System
M4.050 Diese Maßnahme ist entfallen!
M4.051 Diese Maßnahme ist entfallen!
M4.052 Geräteschutz unter NT-basierten Windows-Systemen
M4.053 Diese Maßnahme ist entfallen!
M4.054 Diese Maßnahme ist entfallen!
M4.055 Diese Maßnahme ist entfallen!
M4.056 Sicheres Löschen unter Windows-Betriebssystemen
M4.057 Deaktivieren der automatischen CD-ROM Erkennung
M4.058 Diese Maßnahme ist entfallen!
...
M4.061 Nutzung vorhandener Sicherheitsmechanismen der ISDN-\n                Komponenten
...
M4.075 Schutz der Registry unter NT-basierten Windows-Systemen
M4.076 Diese Maßnahme ist entfallen!
M4.077 Diese Maßnahme ist entfallen!
...
M4.090 Einsatz von kryptographischen Verfahren auf den ver-\n                schiedenen Schichten des ISO/OSIReferenzmodells
...
M4.108 Vereinfachtes und sicheres Netzmanagement mit DNS-\n                Services unter Novell NetWare 4.11
...
M4.121 Konfiguration der Zugriffsrechte auf das Namens- und\n                Adressbuch von Lotus Notes
M4.122 Konfiguration für den Browser-Zugriff auf Lotus Notes
M4.123 Einrichten des SSL-geschützten Browser-Zugriffs auf Lotus\n                Notes
M4.124 Konfiguration der Authentisierungsmechanismen beim\n                Browser-Zugriff auf Lotus Notes
M4.125 Einrichten von Zugriffsbeschränkungen beim Browser-\n                Zugriff auf Lotus Notes Datenbanken
...
M4.130 Sicherheitsmaßnahmen nach dem Anlegen neuer Lotus Notes\n                Datenbanken
...
M4.171 Schutz der Integrität der Index-Datenbank von Archiv-\n                systemen
...
M4.178 Absicherung der Administrator- und Benutzerkonten beim\n                IIS-Einsatz
M4.179 Schutz von sicherheitskritischen Dateien beim IIS-Einsatz
M4.180 Konfiguration der Authentisierungsmechanismen für den\n                Zugriff auf den IIS
...
M4.185 Absichern von virtuellen Verzeichnissen und Web-Anwen-\n                dungen beim IIS-Einsatz
M4.186 Entfernen von Beispieldateien und Administrations-Scripts\n                des IIS
...
M4.197 Servererweiterungen für dynamische Webseiten beim Apache-\n                Webserver
...
M4.253 Diese Maßnahme ist entfallen!
...
M4.264 Einschränkung von direkten Tabellenveränderungen in SAP\n                Systemen
...
M4.281 Sichere Installation und Bereitstellung von Windows\n                Server 2003
M4.282 Sichere Konfiguration der IIS-Basis-Komponente unter\n                Windows Server 2003
M4.283 Sichere Migration von Windows NT 4 Server und Windows\n                2000 Server auf Windows Server 2003
...
M4.290 Anforderungen an ein Sicherheitsgateway für den Einsatz\n                von VoIP
...
M4.299 Authentisierung bei Druckern, Kopierern und Multi-\n                funktionsgeräten
M4.300 Informationsschutz bei Druckern, Kopierern und Multi-\n                funktionsgeräten
M4.301 Beschränkung der Zugriffe auf Drucker, Kopierer und\n                Multifunktionsgeräte
M4.302 Protokollierung bei Druckern, Kopierern und Multi-\n                funktionsgeräten
...
M4.314 Sichere Richtlinieneinstellungen für Domänen und Domänen-\n                Controller
...
M4.323 Synchronisierung innerhalb des Patch- und Änderungs-\n                managements
M4.324 Konfiguration von Autoupdate-Mechanismen beim Patch- und\n                Änderungsmanagement
M4.325 Löschen von Auslagerungsdateien
M4.326 Sicherstellung der NTFS-Eigenschaften auf einem Samba-\n                Dateiserver
M4.327 Überprüfung der Integrität und Authentizität der Samba-\n                Pakete und -Quellen
M4.328 Sichere Grundkonfiguration eines Samba-Servers
M4.329 Sicherer Einsatz von Kommunikationsprotokollen beim\n                Einsatz eines Samba-Servers
...
M4.336 Aktivierung von Windows Vista Clients aus einem Volumen-\n                lizenzvertrag
M4.337 Einsatz von BitLocker Drive Encryption
M4.338 Einsatz von Windows Vista File und Registry\n                Virtualization
M4.339 Verhindern unautorisierter Nutzung von Wechselmedien\n                unter Windows Vista
M4.340 Einsatz der Windows Vista Benutzerkontensteuerung - UAC
M4.341 Integritätsschutz unter Windows Vista
M4.342 Aktivierung des Last Access Zeitstempels unter Windows  Vista
M4.343 Reaktivierung von Windows Vista Clients aus einem\n                Volumenlizenzvertrag
M4.344 Überwachung eines Windows Vista Systems
...
M5.003 Auswahl geeigneter Kabeltypen unter kommunikations-\n                technischer Sicht
...
M5.036 Diese Maßnahme ist entfallen!
M5.037 Diese Maßnahme ist entfallen!
M5.038 Diese Maßnahme ist entfallen!
M5.039 Diese Maßnahme ist entfallen!
M5.040 Diese Maßnahme ist entfallen!
M5.041 Diese Maßnahme ist entfallen!
M5.042 Diese Maßnahme ist entfallen!
M5.043 Diese Maßnahme ist entfallen!
...
M5.082 Diese Maßnahme ist entfallen!
M5.083 Sichere Anbindung eines externen Netzes mit Linux\n                FreeS/WAN
M5.084 Einsatz von Verschlüsselungsverfahren für die Lotus Notes\n                Kommunikation
M5.085 Einsatz von Verschlüsselungsverfahren für Lotus Notes\n                E-Mail
M5.086 Einsatz von Verschlüsselungsverfahren beim Browser-\n                Zugriff auf Lotus Notes
...
M5.100 Einsatz von Verschlüsselungs- und Signaturverfahren für\n                die Exchange 2000 Kommunikation
...
M5.106 Entfernen nicht vertrauenswürdiger Root-Zertifikate beim\n                IIS-Einsatz
...
M5.119 Integration einer Web-Anwendung mit Web-,Applikations-\n                und Datenbank-Server in ein Sicherheitsgateway
...
M5.124 Netzzugänge in Besprechungs-, Veranstaltungsund Schulungs-\n                räumen
...
M5.129 Sichere Konfiguration der HTTP-basierten Dienste von SAP\n                Systemen
...
M5.152 Austausch von Informationen und Ressourcen über Peer-to-\n                Peer-Dienste";

report = 'Prüfergebnisse gemäß IT-Grundschutz, 11. Ergänzungslieferung:\n\n\n';
log = string('');

foreach m (massnahmen) {
  result = get_kb_item("GSHB-11/" + m + "/result");
  desc = get_kb_item("GSHB-11/" + m + "/desc");
#  name = get_kb_item("GSHB-11/" + m + "/name");
  mn = substr(m, 0, 1);
  mz = substr(m, 3);
