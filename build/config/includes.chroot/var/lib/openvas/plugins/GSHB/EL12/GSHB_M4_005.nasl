...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.005
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_005/result", value:result);
set_kb_item(name:"GSHB-12/M4_005/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_005/name", value:name);
