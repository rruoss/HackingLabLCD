...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.342
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_342/result", value:result);
set_kb_item(name:"GSHB-12/M4_342/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_342/name", value:name);
