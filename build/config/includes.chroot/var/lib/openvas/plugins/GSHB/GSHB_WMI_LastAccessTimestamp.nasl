...
# $Id: GSHB_WMI_LastAccessTimestamp.nasl 9 2013-10-27 09:38:41Z jan $
#
...
tag_summary = "Read the status of NTFS MAC 'Last Access Timestamp' over WMI (Win).";
...
if(description)
{
  ...
  script_name("Read the status of NTFS MAC 'Last Access Timestamp' over WMI (Win)");
  desc = "
  Summary:
  " + tag_summary;

  script_description(desc);
  script_summary("Read the status of NTFS MAC 'Last Access Timestamp' over WMI (Win)");
