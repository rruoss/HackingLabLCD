...
# $Id: GSHB_WMI_SNMP_Communities.nasl 9 2013-10-27 09:38:41Z jan $
#
...
tag_summary = "The script List Valid SNMP Communities (Win).";
...
if(description)
{
  ...
  script_name("List Valid SNMP Communities (Win)");
  desc = "
  Summary:
  " + tag_summary;

  script_description(desc);
  script_summary("List Valid SNMP Communities (Win)");
