...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.003
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.003: Einsatz von Viren-Schutzprogrammen.
...
if(description)
{
  ...
  if (! OPENVAS_VERSION)
  {
    ...
    script_summary("IT-Grundschutz M4.003: Einsatz von Viren-Schutzprogrammen.");
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-11/M4_003/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_003/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_003/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_003/result", value:result);
set_kb_item(name:"GSHB-11/M4_003/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_003/name", value:name);
