...
tag_summary = "IT-Grundschutz M4.244: Sichere Systemkonfiguration von Windows Client-Betriebssystemen (Win).
...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.244: Sichere Systemkonfiguration von Windows Client-Betriebssystemen (Win).");
  if (! OPENVAS_VERSION)
  {
    desc = "
    ...
    script_summary("IT-Grundschutz M4.244 Sichere Systemkonfiguration von Windows Client-Betriebssystemen (Win).");
...
name = 'IT-Grundschutz M4.244: Sichere Systemkonfiguration von Windows Client-Betriebssystemen (Win)\n';

if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_244/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_244/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_244/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_244/result", value:result);
set_kb_item(name:"GSHB-11/M4_244/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_244/name", value:name);
