...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.049
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.049: Absicherung des Boot-Vorgangs f¸r ein NT basiertes Windows-System (Win).
...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.049: Absicherung des Boot-Vorgangs f¸r ein NT basiertes Windows-System (Win)");
  if (! OPENVAS_VERSION)
  {
    desc = "
    ...
    script_summary("IT-Grundschutz M4.049: Absicherung des Boot-Vorgangs f¸r ein NT basiertes Windows-System (Win).");
...
name = 'IT-Grundschutz M4.049: Absicherung des Boot-Vorgangs f¸r ein NT basiertes Windows-System (Win)\n';

if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_049/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_049/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_049/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_049/result", value:result);
set_kb_item(name:"GSHB-11/M4_049/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_049/name", value:name);
