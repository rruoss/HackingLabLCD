...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.096
#
# Authors:
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-10/M4_096/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-10/M4_096/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-10/M4_096/name", value:name);
...
if (www){
  ...
  set_kb_item(name:"GSHB-10/TEST/Lst", value:Lst);#TEST
...
if (VAL1 == "error" && OSNAME == "none"){
  ...
  desc = string('Das System scheint kein Internetserver zu sein.\nEs wurden bei der ‹berpr¸fung nur die Ports 80, 443, 8008, 8080 und 8088 beachtet.'); 
}else if (OSNAME != "none"){
  result = string("nicht zutreffend");
   desc = string('Das System ist ein ' + OSNAME + ' System.');
}else if (VAL1 == "TRUE" || VAL2 == "TRUE" || VAL3 == "TRUE" || VAL4 == "TRUE" || VAL5 == "TRUE"){
  result = string("nicht erf¸llt");
  desc = string('Das System scheint ein Internetserver zu sein.\nEntgegen der Empfehlung aus Maﬂnahme 4.096, l‰uft es mit aktiviertem DNS.'); 
}else{
  result = string("erf¸llt");
  desc = string('Das System scheint ein Internetserver zu sein.\nWie in der Maﬂnahme 4.096 Empfohlen, l‰uft es ohne aktiviertem DNS.'); 
}
...
set_kb_item(name:"GSHB-10/M4_096/result", value:result);
set_kb_item(name:"GSHB-10/M4_096/desc", value:desc);
set_kb_item(name:"GSHB-10/M4_096/name", value:name);
