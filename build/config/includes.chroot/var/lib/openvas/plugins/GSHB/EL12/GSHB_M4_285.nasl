...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.285
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_285/result", value:result);
set_kb_item(name:"GSHB-12/M4_285/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_285/name", value:name);
