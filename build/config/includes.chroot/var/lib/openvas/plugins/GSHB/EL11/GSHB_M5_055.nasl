...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 5.055
#
# Authors:
...
if (! OPENVAS_VERSION)
  {
        set_kb_item(name:"GSHB-11/M5_055/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M5_055/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M5_055/name", value:name);
...
if(OSNAME >!< "none"){
  ...
  result = string("erf¸llt");
  desc = string('Die Datei /etc/aliases wurde gefunden. Folgende Zugriffsrechte\ngelten: ' + Aliasesrights + '\n \nFolgenden Inhalt hat die Datei:\n' + Aliasescont);
}

set_kb_item(name:"GSHB-11/M5_055/result", value:result);
set_kb_item(name:"GSHB-11/M5_055/desc", value:desc);
set_kb_item(name:"GSHB-11/M5_055/name", value:name);
