...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.017
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_017/result", value:result);
set_kb_item(name:"GSHB-12/M5_017/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_017/name", value:name);
