...
#
# IT-Grundschutz, 10. EL, Maﬂnahme 4.195
#
# Authors:
...
#    set_kb_item(name:"GSHB-10/M4_195/ALLOW " + w, value:ALLOW[w]);#TEST
  ...
  else
  {
    ...
    if (ALLOWRSSUM >!< "TRUE") desc = desc + string('Es wurde keine Zugriffsbeschr‰nkungen oder Zugriffsbeschr‰nkungen auf Domainbasis hinterlegt!\n');
  }
}
