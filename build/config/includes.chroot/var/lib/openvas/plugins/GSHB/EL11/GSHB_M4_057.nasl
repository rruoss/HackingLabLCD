...
# $Id: GSHB_M4_057.nasl 9 2013-10-27 09:38:41Z jan $
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.057
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.057: Deaktivieren der automatischen CD-ROM Erkennung (Win)
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_057/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_057/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_057/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_057/result", value:result);
set_kb_item(name:"GSHB-11/M4_057/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_057/name", value:name);
