...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.015
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_015/result", value:result);
set_kb_item(name:"GSHB-12/M4_015/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_015/name", value:name);
