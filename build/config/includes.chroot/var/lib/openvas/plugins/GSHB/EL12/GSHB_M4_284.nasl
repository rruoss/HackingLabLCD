...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 4.284
#
# Authors:
...
set_kb_item(name:"GSHB-12/M4_284/result", value:result);
set_kb_item(name:"GSHB-12/M4_284/desc", value:desc);
set_kb_item(name:"GSHB-12/M4_284/name", value:name);
