...
#
# IT-Grundschutz, 11. EL, Maﬂnahme 4.325
#
# Authors:
...
tag_summary = "IT-Grundschutz M4.325: Lˆschen von Auslagerungsdateien
...
if(description)
{
  ...
  if (! OPENVAS_VERSION)
  {
    ...
    script_summary("IT-Grundschutz M4.325: Lˆschen von Auslagerungsdateien");
...
if (! OPENVAS_VERSION)
{
        set_kb_item(name:"GSHB-11/M4_325/result", value:"nicht zutreffend");
        set_kb_item(name:"GSHB-11/M4_325/desc", value:"Leider setzen Sie einen zu alten OpenVAS Scan-Server ein. Bitte wechseln Sie auf die 3.0er-Serie des Scan-Servers!");
        set_kb_item(name:"GSHB-11/M4_325/name", value:name);
...
set_kb_item(name:"GSHB-11/M4_325/result", value:result);
set_kb_item(name:"GSHB-11/M4_325/desc", value:desc);
set_kb_item(name:"GSHB-11/M4_325/name", value:name);
