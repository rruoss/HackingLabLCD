...
#
# IT-Grundschutz, 12. EL, Maﬂnahme 5.059
#
# Authors:
...
set_kb_item(name:"GSHB-12/M5_059/result", value:result);
set_kb_item(name:"GSHB-12/M5_059/desc", value:desc);
set_kb_item(name:"GSHB-12/M5_059/name", value:name);
