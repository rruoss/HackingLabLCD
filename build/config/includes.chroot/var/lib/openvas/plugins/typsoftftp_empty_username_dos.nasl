...
# $Id: typsoftftp_empty_username_dos.nasl 17 2013-10-27 14:01:43Z jan $
...
if(description)
{
 ...
 name = "TYPSoft empty username DoS";
 ...
 summary = "Checks for TYPSoft FTP server empty username DoS ";
