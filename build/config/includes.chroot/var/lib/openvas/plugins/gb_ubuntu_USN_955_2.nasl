...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-June/001108.html");
  script_id(840445);
  ...
  script_summary("Check for the Version of libpam-opie vulnerability");
