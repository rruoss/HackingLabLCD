...
tag_insight = "It was discovered that KDE PIM html renderer incorrectly enabled
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1512-1";
tag_affected = "kdepim on Ubuntu 12.04 LTS ,
  Ubuntu 11.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-July/001766.html");
  script_id(841089);
