...
# $Id: secpod_wireshark_infiniband_dos_vuln_win.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_affected = "Wireshark version 1.0.6 through 1.2.0 on Windows";
tag_insight = "An unspecified error in the infiniband dissector which can be exploited when
...
if(description)
{
  ...
  script_name("Wireshark Infiniband Dissector Denial of Service Vulnerability (Win)");
  desc = "
...
# Grep for Wireshark version 1.0.6 through 1.2.0
