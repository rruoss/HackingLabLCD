...
# $Id: secpod_skype_insecure_lib_load_vuln_win.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_insight = "The flaw is due to improper validation of search path, which allows remote
  attackers to execute arbitrary code and conduct DLL hijacking attacks via a
  Trojan horse wab32.dll that is located in the same folder as a .skype file.";
...
if(description)
{
  ...
  script_summary("Check for the version of Skype");
