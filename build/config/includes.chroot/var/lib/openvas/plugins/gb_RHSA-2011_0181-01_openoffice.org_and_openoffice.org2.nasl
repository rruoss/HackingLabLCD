...
tag_affected = "openoffice.org and openoffice.org2 on Red Hat Enterprise Linux AS version 4,
...
if(description)
{
  ...
  script_summary("Check for the Version of openoffice.org and openoffice.org2");
