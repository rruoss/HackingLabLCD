...
tag_insight = "It was discovered that APT set inappropriate permissions on the term.log
  file. A local attacker could use this flaw to possibly obtain sensitive
  information.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1662-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-December/001929.html");
  script_id(841251);
