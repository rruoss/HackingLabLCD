...
# $Id: webmedia_explorer_detect.nasl 43 2013-11-04 19:51:40Z jan $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of Webmedia Explorer");
...
dirs = make_list("/fileexplorer","/explorer","/wme",cgi_dirs());
