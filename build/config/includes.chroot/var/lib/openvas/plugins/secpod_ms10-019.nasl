...
# $Id: secpod_ms10-019.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  if("Service Pack 1" >< SP)
  {
    # Grep for Cabview.dll version < 6.0.6001.18404
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for Cabview.dll version < 6.0.6002.18184
...
{
  # Grep for Cabview.dll version < 6.1.7600.16500
