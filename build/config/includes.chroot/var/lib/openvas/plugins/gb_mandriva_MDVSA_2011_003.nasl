...
tag_insight = "Multiple vulnerabilities has been found and corrected in MHonArc:
...
tag_affected = "MHonArc on Mandriva Linux 2009.0,
...
if(description)
{
  ...
  script_summary("Check for the Version of MHonArc");
