...
tag_insight = "Remi Denis-Courmont discovered that D-Bus did not properly validate the
  number of nested variants when validating D-Bus messages. A local attacker
  could exploit this to cause a denial of service.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1044-1";
tag_affected = "dbus vulnerability on Ubuntu 8.04 LTS ,
  Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001229.html");
  script_id(840570);
