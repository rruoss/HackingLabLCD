...
# $Id: tftpd_overflow.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "The remote TFTP server dies when it receives a too big UDP datagram.
...
if(description)
{
 ...
 script_summary( "Crashes TFTPD with a big UDP datagram");
