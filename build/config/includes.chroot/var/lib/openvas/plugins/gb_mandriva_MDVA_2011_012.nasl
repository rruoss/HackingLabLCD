...
tag_affected = "iotop on Mandriva Enterprise Server 5,
  Mandriva Enterprise Server 5/X86_64";
tag_insight = "This additional package provides a useful administration tool to
...
if(description)
{
  ...
  script_summary("Check for the Version of iotop");
