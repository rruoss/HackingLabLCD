...
# $Id: sgallery_sql_injection.nasl 17 2013-10-27 14:01:43Z jan $
# Description: SGallery idimage SQL Injection
#
# Authors:
# Noam Rathaus
#
...
tag_summary = "The remote host is running SGallery, a module for PHP-Nuke.
...
if(description)
{
 ...
 name = "SGallery idimage SQL Injection";
 ...
 summary = "Checks for the presence of an SQL injection in idimage parameter";
