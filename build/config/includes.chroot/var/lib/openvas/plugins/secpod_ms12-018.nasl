...
# $Id: secpod_ms12-018.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_impact = "Successful exploitation could allow local attackers to gain escalated
  privileges.
  Impact Level: System";
...
tag_insight = "The flaw is due to an error in win32k.sys when handling the 'PostMessage()'
...
{
  ## Check for Win32k.sys version before 5.1.2600.6189
...
{
  ## Check for Win32k.sys version before 5.2.3790.4959
