...
# $Id: gb_wordpress_backwpup_plugin_mult_dir_traversal_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://www.osvdb.org/71242");
  script_xref(name : "URL" , value : "http://www.osvdb.org/71243");
