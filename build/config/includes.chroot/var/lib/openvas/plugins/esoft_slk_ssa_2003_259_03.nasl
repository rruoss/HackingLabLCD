...
# $Id: esoft_slk_ssa_2003_259_03.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "Upgraded WU-FTPD packages are available for Slackware 9.0 and
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2003-259-03";
...
";
 ...
 script_summary("Slackware Advisory SSA:2003-259-03 WU-FTPD Security Advisory");
...
vuln = 0;
if(isslkpkgvuln(pkg:"wu-ftpd", ver:"2.6.2-i386-3", rls:"SLK9.0")) {
    vuln = 1;
}
