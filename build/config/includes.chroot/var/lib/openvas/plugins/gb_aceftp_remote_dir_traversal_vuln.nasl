...
# $Id: gb_aceftp_remote_dir_traversal_vuln.nasl 16 2013-10-27 13:09:52Z jan $
#
...
tag_affected = "Visicom Media´s AceFTP Freeware/Pro Version 3.80.3 and prior on W
  Windows";
...
tag_solution = "No solution or patch is available as of 1st December, 2008. Information
...
if(description)
{
  ...
  script_summary("Check for the Version of AceFTP");
