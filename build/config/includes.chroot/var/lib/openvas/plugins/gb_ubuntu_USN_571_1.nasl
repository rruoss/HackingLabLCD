...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-January/000657.html");
  script_id(840279);
  ...
  script_summary("Check for the Version of libxfont, xorg-server vulnerabilities");
