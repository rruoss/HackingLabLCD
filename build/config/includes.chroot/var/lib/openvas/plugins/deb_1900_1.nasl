...
# $Id: deb_1900_1.nasl 15 2013-10-27 12:49:54Z jan $
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 1900-1 (postgresql-7.4, postgresql-8.1, postgresql-8.3, postgresql-8.4)");
