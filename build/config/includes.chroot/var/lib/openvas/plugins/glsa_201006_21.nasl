...
tag_insight = "Multiple vulnerabilities in UnrealIRCd might allow remote attackers to
    compromise the 'unrealircd' account, or cause a Denial of Service.";
tag_solution = "All UnrealIRCd users should upgrade to the latest version:
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201006-21 (unrealircd)");
