...
# $Id: guestbook_pl.nasl 17 2013-10-27 14:01:43Z jan $
# Description: guestbook.pl
#
# Authors:
...
tag_summary = "The 'guestbook.pl' is installed. This CGI has
...
if(description)
{
 ...
 summary = "Checks for the presence of /cgi-bin/guestbook.pl";
