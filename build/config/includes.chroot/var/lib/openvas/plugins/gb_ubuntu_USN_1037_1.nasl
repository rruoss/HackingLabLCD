...
tag_insight = "Under certain circumstances, the DHCP client could start before its
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1037-1";
tag_affected = "ifupdown update on Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001221.html");
  script_id(840562);
  ...
  script_summary("Check for the Version of ifupdown update");
