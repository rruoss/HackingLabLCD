...
# $Id: podcast_generator_detect.nasl 43 2013-11-04 19:51:40Z jan $
#
...
tag_summary = "This host is running Podcast Generator, a free web based podcast
...
if (description)
{
 ...
 script_summary("Checks for the presence of Podcast Generator");
...
dirs = make_list("/podcast",cgi_dirs());
foreach dir (dirs) {
 ...
 { 
    ...
    ### try to get version.
    version = eregmatch(string: buf, pattern: '<meta name="Generator" content="Podcast Generator ([0-9.]+[a-z ]*[0-9]*)"',icase:TRUE, multiline: TRUE);
