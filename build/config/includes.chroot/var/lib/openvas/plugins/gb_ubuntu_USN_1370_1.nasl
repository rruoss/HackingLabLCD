...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1370-1";
tag_affected = "libvorbis on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001599.html");
  script_id(840894);
