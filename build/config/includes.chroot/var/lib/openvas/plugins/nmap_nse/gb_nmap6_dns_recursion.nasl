...
# $Id: gb_nmap6_dns_recursion.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Checks if a DNS server allows queries for third-party names. It is expected that recursion will be
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: dns-recursion");
...
argv = make_list("nmap", "-sU", "--script=dns-recursion.nse",
                                         "-p", port, get_host_ip());
