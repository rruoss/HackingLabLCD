...
# $Id: gb_nmap6_smb_enum_sessions.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Enumerates the users logged into a system either locally or through an SMB share. The local users
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: smb-enum-sessions");
