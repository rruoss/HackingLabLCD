...
# $Id: gb_nmap6_smb_enum_groups.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Obtains a list of groups from the remote Windows system, as well as a list of the group's users.
...
Once the RIDs have been termined, the * 'Bind': bind to the LSA service. *
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: smb-enum-groups");
