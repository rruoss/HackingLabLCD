...
# $Id: gb_nmap_smb_enum_sessions.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to enumerate the users logged into a system
  either locally or through an SMB share.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smb-enum-sessions.nse.";
...
if(description)
{
  ...
  script_summary("Enumerates the users logged into a system");
...
argv = make_list("nmap", "--script=smb-enum-sessions.nse", "-p", port,
                  get_host_ip());
