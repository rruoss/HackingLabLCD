...
# $Id: gb_nmap6_banner.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "A simple banner grabber which connects to an open TCP port and prints out anything sent by the
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: banner");
...
argv = make_list("nmap", "--script=banner.nse", "-p", port,
                                          get_host_ip());
