...
# $Id: gb_nmap6_smb_enum_domains.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to enumerate domains on a system, along with their policies. This generally requires
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: smb-enum-domains");
