...
# $Id: gb_nmap_sql_injection.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to spiders an HTTP server looking for URLs
  containing queries vulnerable to an SQL injection attack.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) sql-injection.nse.";
...
if(description)
{
  ...
  script_summary("Spiders an HTTP server looking for URLs containing queries");
