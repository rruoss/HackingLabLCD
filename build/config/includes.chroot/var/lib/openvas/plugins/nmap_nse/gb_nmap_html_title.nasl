...
# $Id: gb_nmap_html_title.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to show the title of the default page of a web server.
...
if(description)
{
  ...
  script_summary("Shows the title of the default page of a web server");
