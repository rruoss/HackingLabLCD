...
# $Id: gb_nmap6_rpcinfo.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Connects to portmapper and fetches a list of all registered programs.  It then prints out a table
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: rpcinfo");
