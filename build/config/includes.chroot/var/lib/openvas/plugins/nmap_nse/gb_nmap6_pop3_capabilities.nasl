...
# $Id: gb_nmap6_pop3_capabilities.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Retrieves POP3 email server capabilities.
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: pop3-capabilities");
