...
# $Id: gb_nmap6_imap_capabilities.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Retrieves IMAP email server capabilities.
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: imap-capabilities");
