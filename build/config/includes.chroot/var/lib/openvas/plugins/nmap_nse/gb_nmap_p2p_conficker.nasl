...
# $Id: gb_nmap_p2p_conficker.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to check if a host is infected with Conficker.C
...
if(description)
{
  ...
  script_summary("Check if a host is infected with Conficker.C or higher");
