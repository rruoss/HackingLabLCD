...
# $Id: gb_nmap_smb_os_discovery.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to determine the operating system,
  computer name, domain, and current time over the SMB protocol.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smb-os-discovery.nse";
...
if(description)
{
  ...
  script_summary("Determine the Operating System");
...
argv = make_list("nmap", "--script=smb-os-discovery.nse", "-p", port,
                  get_host_ip());
