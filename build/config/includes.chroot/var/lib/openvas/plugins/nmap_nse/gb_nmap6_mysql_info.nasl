...
# $Id: gb_nmap6_mysql_info.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Connects to a MySQL server and prints information such as the protocol and version numbers, thread
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: mysql-info");
...
argv = make_list("nmap", "--script=mysql-info.nse",
                                         "-p", port, get_host_ip());
