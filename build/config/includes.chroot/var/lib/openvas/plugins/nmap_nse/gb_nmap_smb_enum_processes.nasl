...
# $Id: gb_nmap_smb_enum_processes.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to list all the running processes from a remote
  Windows system over the SMB protocol.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smb-enum-processes.nse.";
...
if(description)
{
  ...
  script_summary("List all the running processes from a remote server");
