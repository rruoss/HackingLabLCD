...
# $Id: gb_nmap6_http_trace.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Sends an HTTP TRACE request and shows if the method TRACE is enabled. If debug is enabled, it
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: http-trace");
...
argv = make_list("nmap", "--script=http-trace.nse",
                                         "-p", port, get_host_ip());
