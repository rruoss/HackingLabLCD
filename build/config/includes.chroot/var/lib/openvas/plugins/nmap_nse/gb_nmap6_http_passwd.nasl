...
# $Id: gb_nmap6_http_passwd.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Checks if a web server is vulnerable to directory traversal by attempting to retrieve
...
if(description)
{
    ...
    script_summary("Nmap NSE 6.01: http-passwd");
