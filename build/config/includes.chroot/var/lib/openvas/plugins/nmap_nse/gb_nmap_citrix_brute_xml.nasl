...
# $Id: gb_nmap_citrix_brute_xml.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to guess valid credentials for the Citrix PN
...
if(description)
{
  ...
  script_summary("Guess valid credentials for the Citrix PN Web Agent XML Service");
