...
# $Id: gb_nmap_sslv2.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to check whether the server supports obsolete
...
if(description)
{
  ...
  script_summary("Check if the server supports SSLv2");
...
res = pread(cmd: "nmap", argv: make_list("nmap", "--script=sslv2.nse",
                                         "-p", port, get_host_ip()));
if(res)
{
