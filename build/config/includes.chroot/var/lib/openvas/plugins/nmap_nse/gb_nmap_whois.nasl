...
# $Id: gb_nmap_whois.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script queries the WHOIS services of Regional Internet
...
res = pread(cmd:"nmap", argv:make_list("nmap", "--script=whois", "-sn", "-Pn",
                                       get_host_ip()));
if(res)
{
