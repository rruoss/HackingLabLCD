...
# $Id: gb_nmap_smtp_commands.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "This script attempts to get the commands supported by an SMTP server.

  This is a wrapper on the Nmap Security Scanner's (http://nmap.org) smtp-commands.nse";
...
if(description)
{
  ...
  script_summary("Get SMTP Commands");
