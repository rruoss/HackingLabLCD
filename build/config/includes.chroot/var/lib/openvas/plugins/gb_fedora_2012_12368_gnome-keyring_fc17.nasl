...
tag_affected = "gnome-keyring on Fedora 17";
tag_insight = "The gnome-keyring session daemon manages passwords and other types of
...
if(description)
{
  ...
  script_summary("Check for the Version of gnome-keyring");
