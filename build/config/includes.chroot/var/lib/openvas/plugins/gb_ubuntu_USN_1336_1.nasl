...
tag_insight = "J&#252;ri Aedla discovered that the kernel incorrectly handled /proc/&lt;pid&gt;/mem
  permissions. A local attacker could exploit this and gain root privileges.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1336-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001557.html");
  script_id(840941);
