...
# $Id: account_swift_swift.nasl 17 2013-10-27 14:01:43Z jan $
# Description: Default password 'swift' for account 'swift'
#
# Authors:
# Michel Arboi
#
...
tag_summary = "The account 'swift' has the password 'swift'.  An attacker may use it to
