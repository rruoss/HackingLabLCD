...
# $Id: secpod_openmairie_openregistrecil_mult_file_incl_vuln.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "OpenMairie openRegistreCIL version 1.02 and prior";
...
tag_solution = "No solution or patch is available as of 20th May, 2010. Information
  ...
  For updates refer to http://adullact.net/frs/?group_id=465";
tag_summary = "This host is running openMairie openRegistreCIL and is prone to
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/63964");
  ...
  script_summary("Check for the exploit string on OpenMairie openRegistreCIL");
