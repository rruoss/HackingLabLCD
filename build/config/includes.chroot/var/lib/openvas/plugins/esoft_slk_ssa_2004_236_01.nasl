...
# $Id: esoft_slk_ssa_2004_236_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New Qt packages are available for Slackware 9.0, 9.1, 10.0, and -current to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-236-01";
...
vuln = 0;
if(isslkpkgvuln(pkg:"kde", ver:"3.1.2-i486-4", rls:"SLK9.0")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"qt", ver:"3.2.1-i486-2", rls:"SLK9.1")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"qt", ver:"3.3.3-i486-1", rls:"SLK10.0")) {
    vuln = 1;
}
