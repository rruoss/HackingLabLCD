...
# $Id: secpod_geccbblite_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the running geccBBlite version and saves
  the result in KB.";
...
foreach path (make_list("/", "/geccBBlite", "/geccBB", cgi_dirs()))
{
  ...
  if("geccBB - il bordo dei bollettini" >< rcvRes)
  {
    ...
    if(gcbbVer[1] != NULL){
     ...
     security_note(data:"geccBBlite version " + gcbbVer[1] +
