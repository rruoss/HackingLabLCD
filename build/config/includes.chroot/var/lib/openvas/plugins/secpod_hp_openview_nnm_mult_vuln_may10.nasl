...
# $Id: secpod_hp_openview_nnm_mult_vuln_may10.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_affected = "HP OpenView Network Node Manager (OV NNM) 7.01, 7.51, and 7.53";
tag_insight = "The specific flaw exists,
...
if(nnmVer != NULL)
{
  ## Check for HP OpenView Network Node Manager = 07.01, 07.51, 07.53
  if(version_is_equal(version:nnmVer, test_version:"B.07.01") ||
     version_is_equal(version:nnmVer, test_version:"B.07.51") ||
