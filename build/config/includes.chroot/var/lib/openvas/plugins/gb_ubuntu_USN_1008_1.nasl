...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2010-October/001185.html");
  script_id(840522);
  ...
  script_summary("Check for the Version of libvirt vulnerabilities");
