...
# $Id: gb_joomla_com_lqm_sql_inj_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_insight = "The flaw is due to an input passed via the 'Itemid' parameter to
  'index.php' (when 'option' is set to 'com_lqm') is not properly sanitised
  before being used in an SQL query.";
tag_solution = "No solution or patch is available as of 12th April 2012. Information
