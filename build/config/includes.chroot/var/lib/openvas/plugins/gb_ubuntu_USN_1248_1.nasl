...
tag_insight = "Tim Brown discovered that KSSL in KDE-Libs did not properly perform input
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1248-1";
tag_affected = "kde4libs on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-October/001467.html");
  script_id(840792);
  ...
  script_summary("Check for the Version of kde4libs");
