...
# $Id: secpod_ms09-006.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_impact = "Successful exploitation may lead users to run arbitrary code with escalated
  privileges.
  Impact Level: System";
...
tag_insight = "- Input validation error when passing input from user-mode through the
...
if(sysPath)
{
  dllVer = get_file_version(sysPath, file_name:"System32\Win32k.sys");
  if(dllVer)
  {
    # Windows Vista
