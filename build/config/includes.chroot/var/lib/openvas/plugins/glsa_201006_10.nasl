...
tag_insight = "multipath-tools does not set correct permissions on the socket file, making
    it possible to send arbitrary commands to the multipath daemon for
local
    users.";
tag_solution = "All multipath-tools users should upgrade to the latest version:
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201006-10 (multipath-tools)");
