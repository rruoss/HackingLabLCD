...
tag_insight = "MozillaFirefox was updated to 14.0.1 to fix various bugs
  and security issues.
...
if(description)
{
  script_xref(name : "URL" , value : "http://195.135.221.135/opensuse-security-announce/2012-07/msg00013.html");
  script_id(850265);
  ...
  script_xref(name: "openSUSE-SU", value: "2012:0899_1");
