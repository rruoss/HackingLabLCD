...
# $Id: nopsec_php_5_2_11.nasl.nasl 110176
# 2012-07-02 11:43:12 +0100 (Mon, 02 Jul 2012) $
# 
# PHP smaller than 5.2.11
#
# Authors:
...
tag_solution = "Update PHP to version 5.2.11 or later.";
tag_summary = "PHP version smaller than 5.2.11 suffers vulnerability.";
...
script_name("PHP version smaller than 5.2.11");
...
if(get_port_state(my_port))
{
  ...
  if (version_is_less(version:php_version,test_version:"5.2.11"))
