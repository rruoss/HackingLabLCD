...
# $Id: deb_2146_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "D. Fabian and L. Weichselbaum discovered a directory traversal
...
tag_summary = "The remote host is missing an update to mydms
announced via advisory DSA 2146-1.";

tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=DSA%202146-1";
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2146-1 (mydms)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"mydms", ver:"1.7.0-1+lenny1", rls:"DEB5.0")) != NULL) {
    report += res;
}
