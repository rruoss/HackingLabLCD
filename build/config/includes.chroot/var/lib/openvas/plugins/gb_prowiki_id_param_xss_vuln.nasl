...
# $Id: gb_prowiki_id_param_xss_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "ProWiki versions 2.0.045 and prior.";
tag_insight = "The flaw is due to improper validation of user-supplied input to
  the 'id' parameter in 'wiki.cgi' (when 'action' is set to 'browse'), which
...
tag_solution = "No solution or patch is available as of 13th, February 2012. Information
  ...
  For updates refer to http://www.prowiki.org/prowiki/wiki.cgi";
tag_summary = "This host is running ProWiki and is prone to cross site scripting
  vulnerability.";
...
foreach dir (make_list("/prowiki", "/wiki", cgi_dirs()))
{
