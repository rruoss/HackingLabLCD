...
# $Id: secpod_ms09-025.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "Several flaws arise as the Windows kernel does not properly validate changes
...
if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  {
    # Grep for Win32k.sys version < 6.0.6001.18246
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for Win32k.sys version < 6.0.6002.18023
