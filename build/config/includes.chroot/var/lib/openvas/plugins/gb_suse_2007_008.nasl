...
if(description)
{
  script_xref(name : "URL" , value : "http://www.novell.com/linux/security/advisories/2007_08_x.html");
  script_id(850054);
  ...
  script_summary("Check for the Version of XFree86-server,xorg-x11-server,xloader");
