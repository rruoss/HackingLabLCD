...
# $Id: gb_joomla_com_some_lfi_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "Joomla Some Component";
tag_insight = "The flaw is due to an input validation error in 'controller' parameter
  to 'index.php', which allows attackers to read arbitrary files via
  a ../(dot dot) sequences.";
...
tag_summary = "This host is running Joomla Some component and is prone to local
...
if(description)
{
  ...
  script_summary("Check if Joomla Some Component is vulnerable to LFI");
...
foreach file (keys(files))
{
  ...
  url = string(joomlaDir, "/index.php?option=com_some&controller=",
