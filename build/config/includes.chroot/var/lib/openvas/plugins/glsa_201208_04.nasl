...
tag_insight = "Multiple vulnerabilities have been found in Gajim, the worst of
    which may allow execution of arbitrary code.";
tag_solution = "All Gajim users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-im/gajim-0.15-r1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201208-04
http://bugs.gentoo.org/show_bug.cgi?id=411269
http://bugs.gentoo.org/show_bug.cgi?id=412215";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201208-04 (gajim)");
