...
# $Id: esoft_slk_ssa_2004_136_01.nasl 18 2013-10-27 14:14:13Z jan $
...
tag_insight = "New mc packages are available for Slackware 9.0, 9.1, and -current to
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2004-136-01";
...
if(description)
{
 ...
 script_version("$");
 name = "Slackware Advisory SSA:2004-136-01 mc ";
 script_name(name);
...
";
 ...
 script_summary("Slackware Advisory SSA:2004-136-01 mc");
...
vuln = 0;
if(isslkpkgvuln(pkg:"mc", ver:"4.6.0-i486-2", rls:"SLK9.1")) {
    vuln = 1;
}
