...
tag_insight = "A vulnerability was found in stunnel, allowing remote attackers to
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201202-08
http://bugs.gentoo.org/show_bug.cgi?id=379859";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201202-08 (ebuild stunnel)");
