...
# $Id: gb_coppermine_photo_gallery_45600.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(http_vuln_check(port:port, url:url, pattern:"<script>alert\('header'\);</script></h1><script>alert\('text'\);</script>")) {
