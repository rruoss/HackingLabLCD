...
tag_insight = "Rafael Dominguez Vega discovered that PCSC-Lite incorrectly handled smart
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1125-1";
tag_affected = "pcsc-lite on Ubuntu 10.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 9.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001316.html");
  script_id(840649);
