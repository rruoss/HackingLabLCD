...
tag_insight = "Sebastian Krahmer discovered that the dhclient utility incorrectly filtered
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1108-1";
tag_affected = "dhcp3 vulnerability on Ubuntu 6.06 LTS ,
  Ubuntu 8.04 LTS ,
  Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001302.html");
  script_id(840633);
