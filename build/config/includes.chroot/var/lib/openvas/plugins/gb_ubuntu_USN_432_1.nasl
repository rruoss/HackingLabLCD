...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-March/000498.html");
  script_id(840050);
  ...
  script_summary("Check for the Version of gnupg vulnerability");
