...
# $Id: gb_ms11-035_remote.nasl 13 2013-10-27 12:16:33Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/show/osvdb/72234");
  ...
  script_summary("Determine if WINS is prone to remote code execution vulnerability");
