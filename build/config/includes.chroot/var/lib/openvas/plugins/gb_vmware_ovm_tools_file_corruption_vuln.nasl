...
# $Id: gb_vmware_ovm_tools_file_corruption_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_impact = "Successful exploitation will allows local users to trigger corruption of this
  file via a process with a small RLIMIT_FSIZE value.";
tag_affected = "VMware Open Virtual Machine Tools version 8.4.2-261024 and prior.";
tag_insight = "The flaw is due to an error in 'vmware-hgfsmounter', which attempts to
  append to the '/etc/mtab' file without first checking whether resource limits
  would interfere.";
...
tag_summary = "This host is installed with VMware Open Virtual Machine Tools and
  is prone to file corruption vulnerability.";
...
if(description)
{
  ...
  script_summary("Check for the version of VMware Open Virtual Machine Tools");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2011 Greenbone Networks GmbH");
  script_family("General");
  script_dependencies("gb_vmware_ovm_tools_detect_lin.nasl");
  script_require_keys("VMware/OVM/Tools/Ver");
...
if(version[1])
{
  ...
  ## Chek the version is less or equal to 8.4.2.261024
