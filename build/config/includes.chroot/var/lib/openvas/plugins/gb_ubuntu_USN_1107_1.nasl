...
tag_insight = "Sebastian Krahmer discovered that the xrdb utility incorrectly filtered
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1107-1";
tag_affected = "x11-xserver-utils vulnerability on Ubuntu 8.04 LTS ,
  Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-April/001300.html");
  script_id(840631);
  ...
  script_summary("Check for the Version of x11-xserver-utils vulnerability");
