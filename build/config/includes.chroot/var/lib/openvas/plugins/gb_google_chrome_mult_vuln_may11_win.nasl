...
# $Id: gb_google_chrome_mult_vuln_may11_win.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Google Chrome version prior to 11.0.696.57 on Windows";
tag_insight = "- An unspecified error related to a stale pointer exists in handling
    of floating objects.
