...
tag_insight = "It was discovered that if AppArmor was misconfigured, under certain
  circumstances the parser could generate policy using an unconfined fallback
  execute transition when one was not specified.";

tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1039-1";
tag_affected = "apparmor update on Ubuntu 9.10 ,
  Ubuntu 10.04 LTS ,
  Ubuntu 10.10";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001222.html");
  script_id(840558);
  ...
  script_summary("Check for the Version of apparmor update");
