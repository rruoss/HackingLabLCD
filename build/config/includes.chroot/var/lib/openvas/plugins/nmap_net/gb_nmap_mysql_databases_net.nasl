...
# $Id: gb_nmap_mysql_databases_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to list all databases on a MySQL server.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: mysql-databases");
