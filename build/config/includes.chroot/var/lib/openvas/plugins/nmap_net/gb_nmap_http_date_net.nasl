...
# $Id: gb_nmap_http_date_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Gets the date from HTTP-like services. Also prints how much the date differs from local time. Local
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-date");
