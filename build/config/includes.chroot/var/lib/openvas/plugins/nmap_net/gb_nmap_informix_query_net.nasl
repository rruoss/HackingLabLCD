...
# $Id: gb_nmap_informix_query_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Runs a query against IBM Informix Dynamic Server using the given authentication credentials (see
also: informix-brute).
...
if(description)
{
    ...
    script_summary("Nmap NSE net: informix-query");
