...
# $Id: gb_nmap_rpcinfo_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Connects to portmapper and fetches a list of all registered programs.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: rpcinfo");
