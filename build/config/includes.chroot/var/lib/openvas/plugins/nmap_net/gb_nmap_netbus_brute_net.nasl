...
# $Id: gb_nmap_netbus_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs brute force password auditing against the Netbus backdoor ('remote administration')
service.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: netbus-brute");
