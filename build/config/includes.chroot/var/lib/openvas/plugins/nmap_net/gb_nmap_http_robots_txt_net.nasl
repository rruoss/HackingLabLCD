...
# $Id: gb_nmap_http_robots_txt_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Checks for disallowed entries in '/robots.txt' on a web server.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-robots.txt");
