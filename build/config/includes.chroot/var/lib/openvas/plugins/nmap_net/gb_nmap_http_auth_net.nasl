...
# $Id: gb_nmap_http_auth_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Retrieves the authentication scheme and realm of a web service that requires authentication.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-auth");
