...
# $Id: gb_nmap_http_php_version_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to retrieve the PHP version from a web server. PHP has a number of magic queries that
...
Fool's Day. * '/?=PHPB8B5F2A0-3C92-11d3-A3A9-4C7B08C10000': gets an HTML credits page.

A list of magic queries is at http://www.0php.com/php_easter_egg.php. The script also checks if any
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-php-version");
