...
# $Id: gb_nmap_lexmark_config_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Retrieves configuration information from a Lexmark S300-S400 printer.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: lexmark-config");
