...
# $Id: gb_nmap_oracle_sid_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Guesses Oracle instance/SID names against the TNS-listener.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: oracle-sid-brute");
