...
# $Id: gb_nmap_broadcast_ms_sql_discover_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Discovers Microsoft SQL servers in the same broadcast domain.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: broadcast-ms-sql-discover");
