...
# $Id: gb_nmap_mysql_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs password guessing against MySQL
...
if(description)
{
    ...
    script_summary("Nmap NSE net: mysql-brute");
