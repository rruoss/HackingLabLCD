...
# $Id: gb_nmap_nfs_statfs_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Retrieves disk space statistics and information from a remote NFS share. The output is intended to
...
if(description)
{
    ...
    script_summary("Nmap NSE net: nfs-statfs");
