...
# $Id: gb_nmap_http_domino_enum_passwords_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to enumerate the hashed Domino Internet Passwords that are (by default) accessible by all
...
if(description)
{
    ...
    script_summary("Nmap NSE net: http-domino-enum-passwords");
