...
# $Id: gb_nmap_snmp_netstat_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to query SNMP for a netstat like output.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: snmp-netstat");
