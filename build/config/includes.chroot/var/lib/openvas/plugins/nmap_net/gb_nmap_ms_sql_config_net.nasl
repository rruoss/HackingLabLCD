...
# $Id: gb_nmap_ms_sql_config_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Queries Microsoft SQL Server (ms-sql) for a list of databases, linked servers, and configuration
settings.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ms-sql-config");
