...
# $Id: gb_nmap_smb_server_stats_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to grab the server's statistics over SMB and MSRPC, which uses TCP ports 445 or 139.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: smb-server-stats");
