...
# $Id: gb_nmap_citrix_brute_xml_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to guess valid credentials for the Citrix PN Web Agent XML Service. The XML service
...
if(description)
{
    ...
    script_summary("Nmap NSE net: citrix-brute-xml");
