...
# $Id: gb_nmap_ms_sql_info_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to extract information from Microsoft SQL Server instances.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ms-sql-info");
