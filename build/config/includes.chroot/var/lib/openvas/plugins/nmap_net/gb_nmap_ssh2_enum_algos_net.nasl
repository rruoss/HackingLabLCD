...
# $Id: gb_nmap_ssh2_enum_algos_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Reports the number of algorithms (for encryption, compression, etc.) that the target SSH2 server
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ssh2-enum-algos");
