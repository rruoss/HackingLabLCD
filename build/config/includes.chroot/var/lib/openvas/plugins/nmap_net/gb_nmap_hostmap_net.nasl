...
# $Id: gb_nmap_hostmap_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Tries to find hostnames that resolve to the target's IP address by querying the online database at
...
if(description)
{
    ...
    script_summary("Nmap NSE net: hostmap");
