...
# $Id: gb_nmap_dns_cache_snoop_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs DNS cache snooping against a DNS server.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: dns-cache-snoop");
