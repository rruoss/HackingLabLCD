...
# $Id: gb_nmap_daap_get_library_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Retrieves a list of music from a DAAP server. The list includes artist names and album and song
titles.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: daap-get-library");
