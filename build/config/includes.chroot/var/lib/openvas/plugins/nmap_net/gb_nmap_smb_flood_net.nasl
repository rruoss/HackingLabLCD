...
# $Id: gb_nmap_smb_flood_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Exhausts a remote SMB server's connection limit by by opening as many connections as we can.  Most
...
if(description)
{
    ...
    script_summary("Nmap NSE net: smb-flood");
