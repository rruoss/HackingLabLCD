...
# $Id: gb_nmap_wdb_version_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Detects vulnerabilities and gathers information (such as version numbers and hardware support) from
...
if(description)
{
    ...
    script_summary("Nmap NSE net: wdb-version");
