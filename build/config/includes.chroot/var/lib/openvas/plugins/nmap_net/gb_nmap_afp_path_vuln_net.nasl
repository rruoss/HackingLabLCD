...
# $Id: gb_nmap_afp_path_vuln_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
For additional information: * http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2010-0533 *
...
if(description)
{
    ...
    script_summary("Nmap NSE net: afp-path-vuln");
