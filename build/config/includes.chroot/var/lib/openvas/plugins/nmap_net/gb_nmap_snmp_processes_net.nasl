...
# $Id: gb_nmap_snmp_processes_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Attempts to enumerate running processes through SNMP.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: snmp-processes");
