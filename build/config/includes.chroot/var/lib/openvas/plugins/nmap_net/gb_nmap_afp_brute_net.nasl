...
# $Id: gb_nmap_afp_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Performs password guessing against Apple Filing Protocol (AFP)
...
if(description)
{
    ...
    script_summary("Nmap NSE net: afp-brute");
