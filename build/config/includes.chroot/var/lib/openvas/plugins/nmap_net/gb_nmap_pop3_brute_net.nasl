...
# $Id: gb_nmap_pop3_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Tries to log into a POP3 account by guessing usernames and passwords.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: pop3-brute");
