...
# $Id: gb_nmap_ftp_brute_net.nasl 10 2013-10-27 10:03:59Z jan $
#
...
tag_summary = "Tries to get FTP login credentials by guessing usernames and passwords.
...
if(description)
{
    ...
    script_summary("Nmap NSE net: ftp-brute");
