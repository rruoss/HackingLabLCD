...
tag_insight = "A vulnerability was found in tftp-hpa, which leads to remote
execution of arbitrary code.";
tag_solution = "All tftp-hpa users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-ftp/tftp-hpa-5.1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201206-12
http://bugs.gentoo.org/show_bug.cgi?id=374001";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201206-12 (tftp-hpa)");
