...
# $Id: amap.nasl 17 2013-10-27 14:01:43Z jan $
# Description: amap (NASL wrapper)
#
# Authors:
...
tag_summary = "This plugin runs amap to find open ports and identify applications.";
...
if(description)
{
 ...
 summary = "Performs portscan / RPC scan / application recognition";
 ...
 if(defined_func("script_mandatory_keys"))
  script_mandatory_keys("Tools/Present/amap");
...
exit_if_not_found (toolname: "amap");
