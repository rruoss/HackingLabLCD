...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-March/000673.html");
  script_id(840265);
  ...
  script_summary("Check for the Version of python2.4/2.5 vulnerabilities");
