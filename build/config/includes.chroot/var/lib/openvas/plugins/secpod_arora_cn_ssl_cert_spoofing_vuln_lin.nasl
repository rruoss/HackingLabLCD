...
tag_impact = "Successful exploitation will allow remote attackers to spoof the common name
  (CN) of a certificate via rich text.
  Impact Level: Application.";
tag_affected = "Arora version 0.11 and prior";

tag_insight = "The flaw is due to not using a certain font when rendering certificate
  fields in a security dialog.";
tag_solution = "No solution or patch is available as of 15th December 2011. Information
  regarding this issue will be updated once the solution details are available
  For updates refer to http://code.google.com/p/arora/downloads/list";
