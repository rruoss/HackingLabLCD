...
tag_insight = "Multiple vulnerabilities in bip might allow remote unauthenticated
    attackers to cause a Denial of Service or possibly execute arbitrary
code.";
tag_solution = "All bip users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201201-18
http://bugs.gentoo.org/show_bug.cgi?id=336321
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201201-18 (bip)");
