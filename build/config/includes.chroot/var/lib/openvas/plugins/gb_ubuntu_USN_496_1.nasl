...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2007-August/000569.html");
  script_id(840171);
  ...
  script_summary("Check for the Version of koffice vulnerability");
