...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2008-February/000664.html");
  script_id(840266);
  ...
  script_summary("Check for the Version of linux-source-2.6.17/20/22 vulnerability");
