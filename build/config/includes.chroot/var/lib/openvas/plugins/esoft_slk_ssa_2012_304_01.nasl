...
# $Id: esoft_slk_ssa_2012_304_01.nasl 12 2013-10-27 11:15:33Z jan $
...
tag_solution = "https://secure1.securityspace.com/smysecure/catid.html?in=SSA:2012-304-01";
...
if(description)
{
 ...
 script_summary("Slackware Advisory SSA:2012-304-01 mozilla-thunderbird ");
...
vuln = 0;
if(isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"16.0.2-i486-1_slack13.37", rls:"SLK13.37")) {
    vuln = 1;
}
if(isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"16.0.2-i486-1_slack14.0", rls:"SLK14.0")) {
    vuln = 1;
}
