...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-February/001244.html");
  script_id(840582);
  ...
  script_summary("Check for the Version of exim4 vulnerabilities");
