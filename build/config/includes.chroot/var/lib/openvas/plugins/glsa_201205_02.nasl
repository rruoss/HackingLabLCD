...
tag_insight = "Multiple vulnerabilities have been found in ConnMan, allowing
    attackers to execute arbitrary code or cause Denial of Service.";
tag_solution = "All ConnMan users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-misc/connman-1.0-r1'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201205-02
http://bugs.gentoo.org/show_bug.cgi?id=415415";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201205-02 (ConnMan)");
