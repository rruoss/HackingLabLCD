...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1329-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001550.html");
  script_id(840865);
