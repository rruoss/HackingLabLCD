...
# $Id: gb_otrs_cust_interface_rest_bypass_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"A flaw exists in CustomerInterface component which fails to restrict
authenticated users from accessing tickets of arbitrary customers";

tag_impact =
"Successful exploitation will allow authenticated attackers to access tickets
of arbitrary customers.

Impact Level: Application";

tag_affected =
"OTRS (Open Ticket Request System) version before 2.2.8";

tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 2.2.8 or later,
For updates refer to http://www.otrs.com/en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/74025");
  script_summary("Determine if the OTRS version is less than 2.2.8");
