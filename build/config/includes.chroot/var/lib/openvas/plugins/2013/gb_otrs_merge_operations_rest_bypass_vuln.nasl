...
# $Id: gb_otrs_merge_operations_rest_bypass_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"A flaw exists in AgentTicketMerge.pm which checks for the rw permission,
instead of the configured merge permission";

tag_impact =
"Successful exploitation will allow authenticated attackers to bypass intended
...
tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 2.3.0-beta4 or
later, For updates refer to http://www.otrs.com/en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/74024");
  script_summary("Determine if the OTRS version is less than 2.3.0-beta4");
