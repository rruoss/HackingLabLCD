...
tag_insight = "USN-1755-1 fixed vulnerabilities in OpenJDK 6. This update provides the
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-March/002031.html");
  script_id(841352);
