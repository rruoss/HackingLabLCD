...
# $Id: deb_2656.nasl 39 2013-11-04 11:37:28Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-03-30 00:00:00 +0100 (Sa, 30 Mär 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2656-1 (bind9 - denial of service)");
