...
if(description)
{
  ...
  * MFSA 2013-31/CVE-2013-0800 (bmo#825721) Out-of-bounds";
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2013-04/msg00009.html");
  script_summary("Check for the Version of Mozilla Firefox and others");
