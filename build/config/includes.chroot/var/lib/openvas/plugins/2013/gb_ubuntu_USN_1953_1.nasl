...
if(description)
{
  ...
  tag_insight = "It was discovered that polkit didn't allow applications to use the pkcheck
...
attacker could use this flaw to possibly escalate privileges.";
  ...
  tag_affected = "policykit-1 on Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-September/002245.html");
