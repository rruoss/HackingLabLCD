...
if(description)
{
  ...
  tag_insight = "Chmouel Boudjnah discovered that Keystone did not properly invalidate user
...
restrictions. (CVE-2013-4294)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002291.html");
