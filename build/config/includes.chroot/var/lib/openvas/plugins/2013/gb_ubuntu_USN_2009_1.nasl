...
if(description)
{
  ...
  tag_insight = "Multiple memory safety issues were discovered in Firefox.
...
the privileges of the user invoking Firefox. (CVE-2013-5603)";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002297.html");
