...
if(description)
{
  ...
  tag_insight = "Yorick Koster discovered that File Roller incorrectly sanitized
...
attacker could create and overwrite files outside of the extraction directory.";
  ...
  tag_affected = "file-roller on Ubuntu 13.04 ,
Ubuntu 12.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-July/002191.html");
