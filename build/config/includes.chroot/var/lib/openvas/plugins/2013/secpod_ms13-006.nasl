...
# $Id: secpod_ms13-006.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/88967");
  ...
  script_summary("Check for the vulnerable 'Ncrypt.dll' file version");
