...
# $Id: deb_2619.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-02-10 00:00:00 +0100 (So, 10 Feb 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2619-1 (xen-qemu-dm-4.0 - buffer overflow)");
