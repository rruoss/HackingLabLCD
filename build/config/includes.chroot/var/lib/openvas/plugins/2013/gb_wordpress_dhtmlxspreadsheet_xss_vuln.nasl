...
# $Id: gb_wordpress_dhtmlxspreadsheet_xss_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
For updates refer to http://wordpress.org/plugins/dhtmlxspreadsheet";
  ...
  script_summary("Check if WordPress dhtmlxspreadsheet Plugin is prone to xss");
