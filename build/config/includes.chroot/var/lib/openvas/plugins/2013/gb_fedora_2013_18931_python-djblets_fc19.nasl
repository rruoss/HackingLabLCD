...
if(description)
{
  ...
  tag_insight = "A collection of useful classes and functions for Django
";

  tag_affected = "python-djblets on Fedora 19";
  ...
  script_summary("Check for the Version of python-djblets");
