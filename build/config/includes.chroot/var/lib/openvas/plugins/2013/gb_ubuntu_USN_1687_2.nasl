...
tag_insight = "USN-1687-1 fixed a vulnerability NSS. This update provides the NSPR needed
  to use the new NSS.
...
tag_affected = "nspr on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-January/001956.html");
  script_id(841276);
