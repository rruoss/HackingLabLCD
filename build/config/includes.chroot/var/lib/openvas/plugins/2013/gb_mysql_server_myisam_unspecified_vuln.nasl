...
# $Id: gb_mysql_server_myisam_unspecified_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "MySQL version 5.1.x before 5.1.61 and 5.5.x before 5.5.20";
tag_insight = "Unspecified error in MySQL Server component related to MyISAM.";
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://www.osvdb.com/81374");
