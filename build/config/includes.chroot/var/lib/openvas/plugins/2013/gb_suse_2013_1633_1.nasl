...
if(description)
{
  ...
  * New function to search for the OpenPGP keys of all
  ...
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2013-11/msg00005.html");
  script_summary("Check for the Version of Mozilla Suite");
