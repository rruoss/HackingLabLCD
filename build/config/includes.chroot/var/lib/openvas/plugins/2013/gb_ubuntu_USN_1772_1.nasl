...
tag_insight = "Guang Yee discovered that Keystone would not always perform all
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-March/002049.html");
  script_id(841370);
