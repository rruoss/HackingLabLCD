...
# $Id: gb_apple_safari_info_disclosure_vuln_win.nasl 66 2013-11-15 15:53:31Z veerendragg $
#
...
if(description)
{
  ...
  script_name("Apple Safari 'Webkit' Information Disclosure Vulnerability (Win)");
...
Impact Level: Application";
  ...
  tag_affected =
"Apple Safari before 6.1 on Windows";
...
For updates refer to 'http://www.apple.com/support'";
  ...
  script_xref(name : "URL" , value : "http://www.osvdb.com/98879");
  script_xref(name : "URL" , value : "http://lists.apple.com/archives/security-announce/2013/Oct/msg00003.html");
  script_copyright("Copyright (c) 2013 Greenbone Networks GmbH");
  script_summary("Check for the vulnerable version of Apple Safari on Windows");
...
safVer = get_app_version(cpe:CPE, nvt:SCRIPT_OID);
if(!safVer){
  exit(0);
}
## Check for Apple Safari Versions less than 6.1 (5.1.7-->5.34.57.2)
