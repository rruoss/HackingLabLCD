...
# $Id: secpod_ms13-036.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'Win32k.sys' and 'Ntfs.sys' file version");
...
else if(hotfix_check_sp(winVista:3, win2008:3) > 0)
{
  ...
  if(version_is_less(version:Win32sysVer, test_version:"6.0.6002.18800") ||
     ...
     version_is_less(version:ntfsVer, test_version:"6.0.6002.18799") ||
...
else if(hotfix_check_sp(win7:2, win7x64:2, win2008r2:2) > 0)
{
  ...
  if(version_is_less(version:Win32sysVer, test_version:"6.1.7600.17266") ||
     ...
     version_is_less(version:ntfsVer, test_version:"6.1.7600.17281") ||
