...
# $Id: gb_wordpress_complete_gallery_file_upload_09_13.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(str >< buf2) {
  desc = desc + '\n\nThe scanner was able to upload a file to ' + l_path[1] + '. Please remove this file.';
