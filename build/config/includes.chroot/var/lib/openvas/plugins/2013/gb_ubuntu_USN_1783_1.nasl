...
tag_affected = "bind9 on Ubuntu 12.10 ,
  ...
  Ubuntu 11.10 ,
  Ubuntu 10.04 LTS";
tag_insight = "Matthew Horsfall discovered that Bind incorrectly handled regular
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-March/002063.html");
  script_id(841381);
