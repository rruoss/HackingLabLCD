...
# $Id: gb_oracle_vm_virtualbox_unspecified_vuln_feb13_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Oracle VM VirtualBox versions 4.0, 4.1 and 4.2 on Mac OS X";
...
if(description)
{
  ...
  script_summary("Check the vulnerable version of Oracle VM VirtualBox on Mac OS X");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (c) 2013 Greenbone Networks GmbH");
  script_family("General");
  script_dependencies("secpod_oracle_virtualbox_detect_macosx.nasl", "ssh_authorization_init.nasl");
