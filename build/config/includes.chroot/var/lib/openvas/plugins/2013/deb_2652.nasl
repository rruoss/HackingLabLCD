...
# $Id: deb_2652.nasl 39 2013-11-04 11:37:28Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-03-24 00:00:00 +0100 (So, 24 Mär 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2652-1 (libxml2 - external entity expansion)");
