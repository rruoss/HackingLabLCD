...
if(description)
{
  ...
  tag_insight = "It was discovered that libKDcraw incorrectly handled photo files. If a user
...
resulting in a denial of service. (CVE-2013-1438, CVE-2013-1439)";
  ...
  tag_affected = "libkdcraw on Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-September/002267.html");
