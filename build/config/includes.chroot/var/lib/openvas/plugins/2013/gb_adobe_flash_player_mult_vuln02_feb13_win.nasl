...
# $Id: gb_adobe_flash_player_mult_vuln02_feb13_win.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(playerVer != NULL)
{
  if(version_is_less(version:playerVer, test_version:"10.3.183.63") ||
     version_in_range(version:playerVer, test_version:"11.0",
                                         test_version2:"11.6.602.167"))
  {
    security_hole(0);
    exit(0);
  }
