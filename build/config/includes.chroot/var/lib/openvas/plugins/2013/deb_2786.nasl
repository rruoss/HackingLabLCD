...
# $Id: deb_2786.nasl 56 2013-11-11 15:55:30Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-10-27 00:00:00 +0200 (So, 27 Okt 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2786-1 (icu - several vulnerabilities)");
