...
# $Id: secpod_ms13-017.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight = "- Race condition errors when handling certain objects in memory can be
...
{
  ## Grep for ntoskrnl.exe < 5.1.2600.6335
...
{
  ## Grep for ntoskrnl.exe version < 5.2.3790.5107
