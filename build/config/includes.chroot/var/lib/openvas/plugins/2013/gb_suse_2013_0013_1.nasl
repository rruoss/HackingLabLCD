...
tag_affected = "mysql-community-server on openSUSE 12.1";
tag_insight = "mysql community server was updated to 5.5.28, fixing bugs
...
if(description)
{
  ...
  script_xref(name: "openSUSE-SU", value: "2013:0013_1");
  script_name("SuSE Update for mysql-community-server openSUSE-SU-2013:0013-1 (mysql-community-server)");

  script_description(desc);
  script_summary("Check for the Version of mysql-community-server");
