...
information or alter encrypted communications. (CVE-2013-4238)";
  ...
  tag_affected = "python3.2 on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002272.html");
  script_summary("Check for the Version of python3.2");
