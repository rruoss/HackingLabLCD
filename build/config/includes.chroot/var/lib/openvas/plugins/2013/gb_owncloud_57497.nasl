...
# $Id: gb_owncloud_57497.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_summary = "ownCloud is prone to an arbitrary-code execution vulnerability,
multiple HTML-injection vulnerabilities and multiple cross-site
...
credentials or control how the site is rendered to the user and to
execute arbitrary code in the context of the web server. Other
...
desc = "
 ...
 script_summary("Determine if it is possible to inject javascript code");
