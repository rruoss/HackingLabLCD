...
# $Id: deb_2696.nasl 49 2013-11-07 12:55:54Z mime $
...
tag_summary   = "A vulnerability has been discovered in the Open Ticket Request System,
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2696-1 (otrs2 - privilege escalation)");
...
res = "";
report = "";
if ((res = isdpkgvuln(pkg:"otrs", ver:"3.1.7+dfsg1-8+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
if ((res = isdpkgvuln(pkg:"otrs2", ver:"3.1.7+dfsg1-8+deb7u1", rls:"DEB7.0")) != NULL) {
    report += res;
}
