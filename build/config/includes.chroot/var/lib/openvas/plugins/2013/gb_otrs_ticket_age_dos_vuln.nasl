...
# $Id: gb_otrs_ticket_age_dos_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"An error exists in AgentTicketSearch.pm which fails to restrict the ticket
...
tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 3.0.0-beta7 or
later, For updates refer to http://www.otrs.com/en/";
  ...
  script_summary("Determine if the OTRS version is less than  3.0.0-beta7");
