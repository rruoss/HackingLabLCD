...
# $Id: gb_perl_cgipm_module_header_inje_vuln_win.nasl 11 2013-10-27 10:12:02Z jan $
#
# Strawberry Perl CGI.pm 'Set-Cookie' and 'P3P' HTTP Header Injection Vulnerability (Win)
#
# Authors:
...
if(description)
{
  ...
  script_name("Strawberry Perl CGI.pm 'Set-Cookie' and 'P3P' HTTP Header Injection Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  script_summary("Check for the vulnerable version of Strawberry Perl CGI.pm module on Windows ");
