...
# $Id: gb_otrs_agentticketforward_info_disclosure_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"An error exists in AgentTicketForward feature which fails to remove inline
images from HTML e-mail messages";

tag_impact =
"Successful exploitation will allow remote users to obtain potentially sensitive
...
tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 2.4.7 or later,
For updates refer to http://www.otrs.com/en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/74101");
  script_summary("Determine if the OTRS version is less than 2.4.7");
