...
# $Id: deb_2767.nasl 55 2013-11-11 15:38:51Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-09-29 00:00:00 +0200 (So, 29 Sep 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2767-1 (proftpd-dfsg - denial of service)");
