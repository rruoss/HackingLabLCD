...
tag_insight = "python-bcrypt is a Python wrapper of OpenBSD's Blowfish password hashing
...
tag_affected = "py-bcrypt on Fedora 18";
...
if(description)
{
  ...
  script_summary("Check for the Version of py-bcrypt");
