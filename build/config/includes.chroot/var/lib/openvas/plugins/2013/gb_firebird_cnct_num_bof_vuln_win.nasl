...
# $Id: gb_firebird_cnct_num_bof_vuln_win.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  script_name("Firebird Relational Database CNCT Group Number Buffer Overflow Vulnerability (Win)");
  desc = "
  Summary:
  " + tag_summary + "
  ...
  script_summary("Check if Firebird Server is vulnerable to Buffer overflow");
  script_category(ACT_DENIAL);
  script_copyright("Copyright (C) 2013 Greenbone Networks GmbH");
  script_family("Buffer overflow");
  script_dependencies("remote-detect-firebird.nasl", "os_fingerprint.nasl");
