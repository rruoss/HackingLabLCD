...
# $Id: gb_otrs_email_multiple_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"-An error exists in Kernel/System/EmailParser.pm in PostmasterPOP3.pl which
...
tag_affected =
"OTRS (Open Ticket Request System) version before 2.2.7";

tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 2.2.7 or later,
For updates refer to http://www.otrs.com/en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/74026");
  script_xref(name : "URL" , value : "http://osvdb.org/74027");
  script_summary("Determine if the OTRS version is less than 2.2.7");
