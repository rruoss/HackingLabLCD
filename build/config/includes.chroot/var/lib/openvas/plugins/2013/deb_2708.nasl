...
# $Id: deb_2708.nasl 49 2013-11-07 12:55:54Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-06-16 00:00:00 +0200 (So, 16 Jun 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2708-1 (fail2ban - denial of service)");
