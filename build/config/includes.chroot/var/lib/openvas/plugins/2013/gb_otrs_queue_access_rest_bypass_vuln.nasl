...
# $Id: gb_otrs_queue_access_rest_bypass_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 2.3.5 or later,
For updates refer to http://www.otrs.com/en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/74103");
  script_summary("Determine if the OTRS version is less than 2.3.5");
