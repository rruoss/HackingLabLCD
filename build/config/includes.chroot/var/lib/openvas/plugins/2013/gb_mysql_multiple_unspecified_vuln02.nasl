...
# $Id: gb_mysql_multiple_unspecified_vuln02.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "MySQL version 5.6.x before 5.6.11";
tag_insight = "Unspecified error in Data Manipulation Language, Server Privileges,
  MemCached and InnoDB.";
tag_solution = "Upgrade to MySQL version 5.6.11 or later,
...
if(description)
{
  ...
  script_cve_id("CVE-2013-2395", "CVE-2013-2381", "CVE-2013-1570", "CVE-2013-1567",
                                                                   "CVE-2013-1566");
  ...
  script_xref(name : "URL" , value : "http://www.osvdb.com/92462");
  script_xref(name : "URL" , value : "http://www.osvdb.com/92481");
  script_xref(name : "URL" , value : "http://www.osvdb.com/92478");
  script_xref(name : "URL" , value : "http://www.osvdb.com/92480");
  script_xref(name : "URL" , value : "http://www.osvdb.com/92468");
