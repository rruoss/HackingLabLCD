...
if(description)
{
  ...
  tag_insight = "Hamid Zamani discovered multiple security issues in the Network Audio
...
denial of service or execute arbitrary code. (CVE-2013-4256, CVE-2013-4257)";
  ...
  tag_affected = "nas on Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002274.html");
