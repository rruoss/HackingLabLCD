...
tag_insight = "Maksim Otstavnov discovered that telepathy-gabble incorrectly handled
...
tag_affected = "telepathy-gabble on Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
...
if(description)
{
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-June/002157.html");
  script_summary("Check for the Version of telepathy-gabble");
