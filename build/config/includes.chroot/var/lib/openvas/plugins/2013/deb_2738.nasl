...
# $Id: deb_2738.nasl 55 2013-11-11 15:38:51Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-08-18 00:00:00 +0200 (So, 18 Aug 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2738-1 (ruby1.9.1 - several vulnerabilities)");
