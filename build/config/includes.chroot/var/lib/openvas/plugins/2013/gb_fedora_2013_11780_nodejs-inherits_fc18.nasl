...
if(description)
{
  ...
  tag_insight = "A tiny simple way to do classic inheritance in js.
";

  tag_affected = "nodejs-inherits on Fedora 18";
  ...
  script_summary("Check for the Version of nodejs-inherits");
