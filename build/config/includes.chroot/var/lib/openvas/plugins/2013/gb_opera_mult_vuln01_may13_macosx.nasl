...
# $Id: gb_opera_mult_vuln01_may13_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_affected = "Opera version before 12.15 on Mac OS X";
...
if(description)
{
  ...
  script_summary("Check for the vulnerable version of Opera for Mac OS X");
