...
if(description)
{
  ...
  tag_insight = "It was discovered that Puppet incorrectly handled the resource_type
...
(CVE-2013-4956)";
  ...
  tag_affected = "puppet on Ubuntu 13.04 ,
  Ubuntu 12.10 ,
  Ubuntu 12.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-August/002216.html");
