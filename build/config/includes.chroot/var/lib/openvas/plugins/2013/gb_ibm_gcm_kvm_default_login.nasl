...
# $Id: gb_ibm_gcm_kvm_default_login.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_summary = 'The remote IBM GCM16 or GCM32 KVM is prone to a default account
...
if(!egrep(pattern:'<title>GCM(16|32) Explorer</title>', string:buf) || ">User Login" >!< buf)exit(0);

set_kb_item(name:"GCM_16_32/installed", value:TRUE);
