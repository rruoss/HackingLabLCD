...
# $Id: deb_2655.nasl 39 2013-11-04 11:37:28Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-03-28 00:00:00 +0100 (Do, 28 Mär 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2655-1 (rails - several vulnerabilities)");
