...
if(description)
{
  ...
  tag_insight = "
  Adobe Flash Player was updated to 11.2.202.280:
  ...
  * APSB13-11, CVE-2013-1378, CVE-2013-1379, CVE-2013-1380,
  ...
  script_xref(name: "openSUSE-SU", value: "2013:0675_1");
  script_xref(name: "URL" , value: "http://lists.opensuse.org/opensuse-security-announce/2013-04/msg00019.html");
