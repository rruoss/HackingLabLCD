...
if(description)
{
  ...
  tag_insight = "It was discovered that HPLIP incorrectly handled temporary files when using
...
(CVE-2013-0200)";
  ...
  tag_affected = "hplip on Ubuntu 12.10 ,
  Ubuntu 12.04 LTS ,
  Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-September/002269.html");
