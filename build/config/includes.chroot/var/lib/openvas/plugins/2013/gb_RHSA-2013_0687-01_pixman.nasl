...
if(description)
{
  ...
  script_summary("Check for the Version of pixman");
...
if(release == "RHENT_6")
{
  ...
  if ((res = isrpmvuln(pkg:"pixman", rpm:"pixman~0.26.2~5.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_hole(data:res + '\n' + desc);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pixman-debuginfo", rpm:"pixman-debuginfo~0.26.2~5.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_hole(data:res + '\n' + desc);
    exit(0);
  }

  if ((res = isrpmvuln(pkg:"pixman-devel", rpm:"pixman-devel~0.26.2~5.el6_4", rls:"RHENT_6")) != NULL)
  {
    security_hole(data:res + '\n' + desc);
    exit(0);
  }
