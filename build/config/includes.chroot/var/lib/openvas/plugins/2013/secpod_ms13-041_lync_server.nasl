...
# $Id: secpod_ms13-041_lync_server.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the vulnerable 'microsoft.rtc.internal.autodiscover.dll' file versions");
