...
# $Id: gb_imagemagick_integer_overflow_vuln03_jun13_win.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://www.osvdb.com/80555");
...
if(version_is_less(version:imageVer, test_version:"6.7.5.9"))
{
  security_warning(0);
  exit(0);
}
