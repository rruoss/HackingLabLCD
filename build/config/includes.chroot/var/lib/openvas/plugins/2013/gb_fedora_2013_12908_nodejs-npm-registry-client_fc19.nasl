...
if(description)
{
  ...
  tag_insight = "Client for the npm registry, or private servers using the npm registry software.
";

  tag_affected = "nodejs-npm-registry-client on Fedora 19";
  ...
  script_summary("Check for the Version of nodejs-npm-registry-client");
