...
# $Id: deb_2607.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-01-15 00:00:00 +0100 (Di, 15 Jan 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2607-1 (qemu-kvm - buffer overflow)");
