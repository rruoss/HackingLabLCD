...
# $Id: deb_2649.nasl 39 2013-11-04 11:37:28Z mime $
...
if(description)
{
    ...
    script_summary("Debian Security Advisory DSA 2649-1 (lighttpd - fixed socket name in world-writable directory)");
