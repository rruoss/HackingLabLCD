...
if(description)
{
  ...
  tag_insight = "pyrad is an implementation of a RADIUS client as described in RFC2865.
It takes care of all the details like building RADIUS packets, sending
them and decoding responses.
";

  tag_affected = "python-pyrad on Fedora 18";
  ...
  script_summary("Check for the Version of python-pyrad");
