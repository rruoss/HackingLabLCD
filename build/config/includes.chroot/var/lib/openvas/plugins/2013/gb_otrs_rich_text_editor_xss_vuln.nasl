...
# $Id: gb_otrs_rich_text_editor_xss_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
tag_insight =
"An error exists in rich-text-editor component which fails to validate user
supplied input";

tag_impact =
"Successful exploitation will allow remote authenticated users to inject
arbitrary web script.

Impact Level: Application";

tag_affected =
"OTRS (Open Ticket Request System) version before 3.0.0-beta2";

tag_solution =
"Upgrade to OTRS (Open Ticket Request System) version 3.0.0-beta2 or
later, For updates refer to http://www.otrs.com/en/";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/74097");
  script_summary("Determine if the OTRS version is less than  3.0.0-beta2");
