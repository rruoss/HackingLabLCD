...
if(description)
{
  ...
  tag_insight = "Paul Collins discovered that libimobiledevice incorrectly handled temporary
...
this issue should be mitigated by the Yama link restrictions.";
  ...
  tag_affected = "libimobiledevice on Ubuntu 13.04 ,
  Ubuntu 12.10";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-August/002215.html");
  script_summary("Check for the Version of libimobiledevice");
