...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/001994.html");
  script_id(841318);
  ...
  script_summary("Check for the Version of jquery");
