...
# $Id: deb_2601.nasl 11 2013-10-27 10:12:02Z jan $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-01-06 00:00:00 +0100 (So, 06 Jan 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2601-1 (gnupg, gnupg2 - missing input sanitation)");
