...
# $Id: deb_2639.nasl 32 2013-10-31 13:05:08Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-03-05 00:00:00 +0100 (Di, 05 Mär 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2639-1 (php5 - several vulnerabilities)");
