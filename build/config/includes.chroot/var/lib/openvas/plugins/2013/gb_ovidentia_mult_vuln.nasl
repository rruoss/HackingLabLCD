...
# $Id: gb_ovidentia_mult_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  tag_summary =
"This host is running Ovidentia and is prone to multiple vulnerabilities.";
...
read the cookie or not.";
  ...
  tag_insight =
"Input passed via several parameters is not properly sanitized before being
...
or manipulate SQL queries by injecting arbitrary SQL code.";
  ...
  tag_affected =
"Ovidentia version 7.9.4, other versions may also be affected.";

  tag_solution =
"No solution or patch is available as of 22nd August, 2013. Information
regarding this issue will be updated once the solution details are available.
For updates refer to http://www.ovidentia.org";
...
foreach dir (make_list("", "/ovidentia", "/cms", cgi_dirs()))
{
