...
# $Id: gb_gestioip_ip_cmd_inj_vuln.nasl 11 2013-10-27 10:12:02Z jan $
#
...
"GestioIP version 3.0, Other versions may also be affected.";
  ...
  tag_solution =
"No solution available as of October 11, 2013. A patch has been committed to
the source code repository (e.g. GIT, CVS, SVN) that addresses this vulnerability
For updates refer to www.gestioip.net";
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/98245");
   ...
   'WWW-Authenticate: Basic realm="GestioIP"' ><buf)
{
  ...
  {
    desc = desc + '\n\nScanner has created a file ' + file +
