...
# $Id: deb_2721.nasl 49 2013-11-07 12:55:54Z mime $
...
if(description)
{
    ...
    script_tag(name: "creation_date", value:"2013-07-07 00:00:00 +0200 (So, 07 Jul 2013)");
    ...
    script_summary("Debian Security Advisory DSA 2721-1 (nginx - buffer overflow)");
