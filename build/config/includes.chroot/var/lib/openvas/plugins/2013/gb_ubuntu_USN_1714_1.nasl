...
tag_affected = "xserver-xorg-video-qxl on Ubuntu 12.04 LTS ,
  Ubuntu 11.10";
tag_insight = "It was discovered that the QXL graphics driver incorrectly handled
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-February/001986.html");
  script_id(841308);
  ...
  script_summary("Check for the Version of xserver-xorg-video-qxl");
