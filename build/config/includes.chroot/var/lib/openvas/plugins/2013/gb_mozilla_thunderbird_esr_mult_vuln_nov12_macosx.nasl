...
# $Id: gb_mozilla_thunderbird_esr_mult_vuln_nov12_macosx.nasl 11 2013-10-27 10:12:02Z jan $
#
...
if(description)
{
  ...
  script_summary("Check for the version of Mozilla Thunderbird ESR on Mac OS X");
