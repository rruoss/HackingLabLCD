...
if(description)
{
  ...
  tag_insight = "Ryan Sleevi discovered that Python did not properly handle certificates
...
information or alter encrypted communications.";
  ...
  tag_affected = "python2.6 on Ubuntu 10.04 LTS";
  ...
  script_xref(name: "URL" , value: "https://lists.ubuntu.com/archives/ubuntu-security-announce/2013-October/002270.html");
  script_summary("Check for the Version of python2.6");
