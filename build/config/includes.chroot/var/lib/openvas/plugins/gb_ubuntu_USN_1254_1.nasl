...
tag_insight = "It was discovered that CVE-2011-3004, which addressed possible privilege
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1254-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-December/001536.html");
  script_id(840849);
