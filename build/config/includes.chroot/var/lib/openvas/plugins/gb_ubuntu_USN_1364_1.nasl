...
tag_insight = "A flaw was discovered in the XFS filesystem. If a local user mounts a
  ...
  J&#195;&#188;ri Aedla discovered that the kernel incorrectly handled /proc/&lt;pid&gt;/mem
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1364-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001589.html");
  script_id(840951);
