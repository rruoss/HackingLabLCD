...
tag_insight = "USN-1463-1 fixed vulnerabilities in Firefox. The Firefox update exposed a
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1463-2";
tag_affected = "unity-2d on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-June/001722.html");
  script_id(841047);
  ...
  script_summary("Check for the Version of unity-2d");
