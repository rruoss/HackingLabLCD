...
# $Id: MercuryBoard_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
if (description)
{
 ...
 script_summary("Checks for the presence of MercuryBoard");
...
dirs = make_list("/board","/mercuryboard","/forums","/forum",cgi_dirs());
