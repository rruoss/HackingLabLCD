...
# $Id: gb_sit_id_param_xss_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_insight = "The flaw is due to an improper validation of user-supplied input to
  the 'id' parameter in 'index.php', which allows attackers to execute arbitrary
