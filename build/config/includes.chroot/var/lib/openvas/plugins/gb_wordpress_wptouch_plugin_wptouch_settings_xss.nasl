...
# $Id: gb_wordpress_wptouch_plugin_wptouch_settings_xss.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "WordPress WPtouch Plugin 1.9.19.4 and 1.9.20, other versions may also be
  affected.";
...
tag_summary = "This host is installed with WordPress WPtouch Plugin and is prone to
...
if(description)
{
  ...
  Solution:
  " + tag_solution;
  script_xref(name : "URL" , value : "http://osvdb.org/69538");
