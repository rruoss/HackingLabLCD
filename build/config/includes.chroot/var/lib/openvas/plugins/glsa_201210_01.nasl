...
tag_insight = "An error in the hostname matching of w3m might enable remote
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201210-01
http://bugs.gentoo.org/show_bug.cgi?id=325431";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201210-01 (w3m)");
