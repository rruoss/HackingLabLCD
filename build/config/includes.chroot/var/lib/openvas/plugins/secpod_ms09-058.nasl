...
# $Id: secpod_ms09-058.nasl 15 2013-10-27 12:49:54Z jan $
#
...
tag_insight = "Several flaws arise in the Windows kernel due to,
...
if(hotfix_check_sp(winVista:3) > 0)
{
  ...
  {
    # Grep for ntoskrnl.exe version < 6.0.6001.18304
  ...
  if("Service Pack 2" >< SP)
  {
    # Grep for ntoskrnl.exe version < 6.0.6002.18082
