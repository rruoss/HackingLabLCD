...
# $Id: net2ftp_detect.nasl 43 2013-11-04 19:51:40Z jan $
#
# net2ftp Detection
#
# Authors:
...
tag_summary = "This host is running net2ftp, a web based FTP client.";
...
if (description)
{
 ...
 script_summary("Checks for the presence of net2ftp");
...
dirs = make_list("/ftp","/webftp","/net2ftp",cgi_dirs());
...
foreach dir (dirs) {
 ...
 { 
    ...
    ### try to get version 
    version = eregmatch(string: buf, pattern: "<!-- net2ftp version ([0-9.]+) -->",icase:TRUE, multiline: TRUE);
