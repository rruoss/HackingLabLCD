...
tag_affected = "erlang on Fedora 15";
tag_insight = "Erlang is a general-purpose programming language and runtime
...
if(description)
{
  ...
  script_summary("Check for the Version of erlang");
