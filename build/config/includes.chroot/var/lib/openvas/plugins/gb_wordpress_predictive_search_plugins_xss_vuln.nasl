...
# $Id: gb_wordpress_predictive_search_plugins_xss_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
if(description)
{
  ...
  script_xref(name : "URL" , value : "http://osvdb.org/87890");
  script_xref(name : "URL" , value : "http://osvdb.org/87891");
