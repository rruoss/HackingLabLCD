...
tag_insight = "A vulnerability in libjpeg-turbo could result in execution of
arbitrary code or Denial of Service.";
tag_solution = "All libjpeg-turbo users should upgrade to the latest version:
...
http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201209-13
http://bugs.gentoo.org/show_bug.cgi?id=426938";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201209-13 (libjpeg-turbo)");
