...
tag_insight = "It was discovered that Puppet would allow remote ralsh under certain
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1365-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-February/001590.html");
  script_id(840898);
