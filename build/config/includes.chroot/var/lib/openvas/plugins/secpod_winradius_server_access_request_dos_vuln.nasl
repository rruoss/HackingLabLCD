...
# $Id: secpod_winradius_server_access_request_dos_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_affected = "WinRadius Server version 2009";
tag_insight = "The flaw is due to an error when parsing Access-Request packets and
  can be exploited to crash the server via specially crafted requests with a
  long password field.";
tag_solution = "No solution or patch is available as of 29th June, 2012. Information
  regarding this issue will be updated once the solution details are available.
  For updates refer to http://www.elite-school.com/saas/WinRadius/";
...
if(description)
{
  ...
  script_require_keys("Services/udp/radius");
