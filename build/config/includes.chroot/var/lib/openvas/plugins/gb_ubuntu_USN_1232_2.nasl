...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1232-2";
tag_affected = "xorg-server on Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-October/001449.html");
  script_id(840774);
