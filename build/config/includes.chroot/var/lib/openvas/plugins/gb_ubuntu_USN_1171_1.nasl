...
tag_insight = "It was discovered that an SQL injection vulnerability exists in the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1171-1";
tag_affected = "likewise-open on Ubuntu 11.04 ,
  Ubuntu 10.10 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-July/001377.html");
  script_id(840706);
  ...
  script_summary("Check for the Version of likewise-open");
