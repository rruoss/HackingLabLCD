...
tag_affected = "perl-HTML-Template-Pro on Fedora 17";
tag_insight = "A fast and lightweight C/Perl+XS HTML Template engine implementation.";
...
if(description)
{
  ...
  script_summary("Check for the Version of perl-HTML-Template-Pro");
