...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1340-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-January/001560.html");
  script_id(840875);
