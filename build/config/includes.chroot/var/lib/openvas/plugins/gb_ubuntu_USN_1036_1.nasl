...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2011-January/001220.html");
  script_id(840561);
  ...
  script_summary("Check for the Version of CUPS update");
