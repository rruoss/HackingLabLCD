...
# $Id: secpod_wordpress_mingle_forum_plugin_xss_vuln.nasl 12 2013-10-27 11:15:33Z jan $
#
...
tag_insight = "The flaw is due to an input passed via the 'search' parameter is not
  properly sanitized before being returned to the user.";
tag_solution = "No solution or patch is available as of 27th March, 2012. Information
...
foreach forum (make_list("/forum", "/forums", "/le-forum"))
{
  ...
  if("<script>alert(document.cookie)</script>" >< mfRes)
  {
