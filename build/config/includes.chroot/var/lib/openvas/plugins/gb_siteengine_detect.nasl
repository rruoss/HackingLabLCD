...
# $Id: gb_siteengine_detect.nasl 14 2013-10-27 12:33:37Z jan $
#
...
tag_summary = "This script finds the running SiteEngine version and saves
  the result in KB.";
...
if(description)
{
 ...
 script_version("$Revision: 14 $");
  ...
  script_summary("Set the version of SiteEngine in KB");
...
foreach dir (make_list("/", "/SiteEngine/", cgi_dirs()))
{
