...
tag_insight = "USN-1400-1 fixed vulnerabilities in Firefox. This update provides the
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1400-3";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-March/001634.html");
  script_id(840958);
