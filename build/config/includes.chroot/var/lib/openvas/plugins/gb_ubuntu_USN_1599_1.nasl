...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1599-1";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001858.html");
  script_id(841180);
