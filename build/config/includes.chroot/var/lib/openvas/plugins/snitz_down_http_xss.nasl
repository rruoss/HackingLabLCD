...
# $Id: snitz_down_http_xss.nasl 17 2013-10-27 14:01:43Z jan $
...
tag_summary = "The remote host is using Snitz Forums 2000 - an ASP based forum/bbs.
...
if(description)
{
 ...
 name = "Snitz Forums 2000 HTTP Response Splitting";
