...
tag_insight = "It was discovered that libgssglue incorrectly handled the GSSAPI_MECH_CONF
...
tag_summary = "Ubuntu Update for Linux kernel vulnerabilities USN-1612-1";
tag_affected = "libgssglue on Ubuntu 12.04 LTS ,
  Ubuntu 11.10 ,
  Ubuntu 11.04 ,
  Ubuntu 10.04 LTS";
...
if(description)
{
  script_xref(name : "URL" , value : "https://lists.ubuntu.com/archives/ubuntu-security-announce/2012-October/001871.html");
  script_id(841191);
  ...
  script_summary("Check for the Version of libgssglue");
