...
# $Id: gb_bluesoft_relcms_sql_inj_vuln.nasl 13 2013-10-27 12:16:33Z jan $
#
...
tag_affected = "Real Estate Listings CMS.";
tag_insight = "The flaw is due to input passed via the 'realtor' parameter to
  'search.php', which is not properly sanitised before being used in
  a SQL query.";
...
tag_summary = "This host is running BlueSoft RELCMS and is prone to SQL injection
  vulnerability.";
...
if(description)
{
  ...
  script_summary("Check if BlueSoft RELCMS is vulnerable for SQL Injection attack");
...
foreach dir (make_list("/cms", "/relcms", cgi_dirs()))
{
