...
# $Id: tcp_port_zero.nasl 17 2013-10-27 14:01:43Z jan $
...
# if (s) 
# {
#  security_warning(port: 0);	# OpenVAS API cannot really handle this
#  close(s);
# }
...
for (i = 0; i < 3; i ++)
{
  ...
  if (reply)
  {
    ...
    if ((flags & TH_SYN) && (flags & TH_ACK))
      security_hole(port: 0); # OpenVAS API cannot really handle this
    exit(0);
  }
}
