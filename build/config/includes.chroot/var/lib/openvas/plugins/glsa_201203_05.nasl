...
tag_insight = "A hash collision vulnerability in Rack allows remote attackers to
    cause a Denial of Service condition.";
tag_solution = "All Rack users should upgrade to the latest version:

      # emerge --sync
      # emerge --ask --oneshot --verbose '>=dev-ruby/rack-1.1.3'
    

http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201203-05
http://bugs.gentoo.org/show_bug.cgi?id=396455";
...
if(description)
{
 ...
 script_summary("Gentoo Security Advisory GLSA 201203-05 (rack)");
