...
# $Id: deb_2210_1.nasl 13 2013-10-27 12:16:33Z jan $
...
tag_insight = "Several vulnearbilities were discovered in the TIFF manipulation and
conversion library:
...
if(description)
{
 ...
 script_summary("Debian Security Advisory DSA 2210-1 (tiff)");
